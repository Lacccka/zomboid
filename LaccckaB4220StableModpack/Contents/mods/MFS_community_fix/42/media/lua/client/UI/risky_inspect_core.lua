...
function riskyUI:prerender()
    ...
    if self.scene then
        ...
        if self.settingbutton then
            self.settingbutton:setX(930)
            self.settingbutton:setY(590)
            self.settingbutton:setWidth(64)
            self.settingbutton:setHeight(64)
        end
    end
end
...
function riskyUI:createChildren()
    ...
    self.settingbutton = ISButton:new(930, 590, 64, 64, "", self, self.openSettingPanel);
