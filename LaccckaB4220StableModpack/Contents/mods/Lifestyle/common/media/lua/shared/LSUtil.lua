...
function LSUtil.getObjContextMenu(context, spriteName)
	local subMenu
...
---------- Water
function LSUtil.objHasWater(obj, amount)
	local minAmount = amount or 0.1
	return obj and obj:hasWater() and obj:getFluidAmount() >= minAmount
end
