...
table.insert(ProceduralDistributions["list"]["ArmyStorageGuns"].items, "Base.545Clip");
...
table.insert(ProceduralDistributions["list"]["PoliceStorageGuns"].items, "Base.545Clip");
...
table.insert(ProceduralDistributions["list"]["GunStoreDisplayCase"].items, "Base.545Clip");
table.insert(ProceduralDistributions["list"]["GunStoreDisplayCase"].items, 2);
table.insert(ProceduralDistributions["list"]["GarageFirearms"].items, "Base.545Clip");
...
table.insert(ProceduralDistributions["list"]["GunStoreAmmunition"].items, "Base.545Clip");
table.insert(ProceduralDistributions["list"]["GunStoreAmmunition"].items, 2);
table.insert(ProceduralDistributions["list"]["ArmyStorageAmmunition"].items, "Base.545Clip");
table.insert(ProceduralDistributions["list"]["ArmyStorageAmmunition"].items, 2);
table.insert(ProceduralDistributions["list"]["ArmySurplusCases"].items, "Base.545Clip");
table.insert(ProceduralDistributions["list"]["ArmySurplusCases"].items, 2);
table.insert(ProceduralDistributions["list"]["LockerArmyBedroom"].items, "Base.545Clip");
table.insert(ProceduralDistributions["list"]["LockerArmyBedroom"].items, 2);
table.insert(ProceduralDistributions["list"]["LockerArmyBedroomHome"].items, "Base.545Clip");
table.insert(ProceduralDistributions["list"]["LockerArmyBedroomHome"].items, 2);
table.insert(ProceduralDistributions["list"]["ArmySurplusAmmoBoxes"].items, "Base.545Clip");
table.insert(ProceduralDistributions["list"]["ArmySurplusAmmoBoxes"].items, 2);
table.insert(ProceduralDistributions["list"]["PoliceStorageAmmunition"].items, "Base.545Clip");
table.insert(ProceduralDistributions["list"]["PoliceStorageAmmunition"].items, 2);
table.insert(ProceduralDistributions["list"]["PrisonArmoryShotguns"].items, "Base.545Clip");
