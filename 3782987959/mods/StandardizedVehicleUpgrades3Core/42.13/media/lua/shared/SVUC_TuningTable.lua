...
function SVUC_TemplateVehicle()
	...
	SVUC.useWheelChain = { ATA2__ATAProtectionWheelsChain = 1, }
	SVUC.useRoofRack = { SteelBar = 2, SteelBarHalf = 10, SteelPiece = 6, BlowTorch = 1, }
	SVUC.useRoofLight = { LightBulb = 1, Screws = 8, }
	...
	SVUC.useRoofLightbar = { LightBulb = 1, SteelBar = 2, SmallSheetMetal = 1, SteelBarHalf = 2, Screws = 6, }
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2Bullbar"] = {
		Small = {
			...
			gasUsage = SVUC.protectionBullbarSmallGasUsage,
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2Bullbar"].Medium.gasUsage = SVUC.protectionBullbarMediumGasUsage
	TemplateTuningTable["TemplateVehicle"].parts["ATA2Bullbar"].Medium.install.use = SVUC.useBullbarMedium
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2Bullbar"].Large.gasUsage = SVUC.protectionBullbarLargeGasUsage
	TemplateTuningTable["TemplateVehicle"].parts["ATA2Bullbar"].Large.install.use = SVUC.useBullbarLarge
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2Bullbar"].LargeSpiked.install.use = SVUC.useBullbarLargeSpiked
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2Bullbar"].Plow.gasUsage = SVUC.protectionPlowGasUsage
	TemplateTuningTable["TemplateVehicle"].parts["ATA2Bullbar"].Plow.install.use = SVUC.usePlow
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2Bullbar"].PlowSpiked.install.use = SVUC.usePlowSpiked
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].Heavy.gasUsage = SVUC.protectionHeavyGasUsage
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].Heavy.install.use = SVUC.useHeavy
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].LightSpiked.install.use = SVUC.useLightSpiked
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].HeavySpiked.install.use = SVUC.useHeavySpiked

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].LightSpikedRusted = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].LightSpiked)
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].HeavySpikedRusted = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].HeavySpiked)
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].Reinforced.gasUsage = SVUC.protectionReinforcedGasUsage
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].Reinforced.install.use = SVUC.useReinforced
	...
	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].Paper = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].Heavy)
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].Paper.name = "IGUI_VehiclePartATA2ProtectionWindowFrontLeftPaper"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].Paper.category = SVUC.protectionPaper
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].Paper.protectionHealthDelta = SVUC.protectionPaperHealthDelta
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].Paper.install.use = {SheetPaper2 = 4,}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].Paper.install.skills = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].Paper.install.tools = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].Paper.install.time = SVUC.timePaper
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].Paper.uninstall.skills = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].Paper.uninstall.tools = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].Paper.uninstall.time = SVUC.timePaper

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].PaperSpiked = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].Paper)
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].PaperSpiked.name = "IGUI_VehiclePartATA2ProtectionWindowFrontLeftPaperSpiked"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontLeft"].PaperSpiked.category = SVUC.protectionPaperSpiked
	]]--
	...
	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontRight"].Paper.name = "IGUI_VehiclePartATA2ProtectionWindowFrontRightPaper"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontRight"].Paper.protection = {"WindowFrontRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontRight"].Paper.install.requireInstalled = {"WindowFrontRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontRight"].Paper.disableOpenWindowFromSeat = "SeatFrontRight"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontRight"].Paper.install.area = "TireFrontRight"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontRight"].Paper.uninstall.area = "TireFrontRight"

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontRight"].PaperSpiked.name = "IGUI_VehiclePartATA2ProtectionWindowFrontRightPaperSpiked"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontRight"].PaperSpiked.protection = {"WindowFrontRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontRight"].PaperSpiked.install.requireInstalled = {"WindowFrontRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontRight"].PaperSpiked.disableOpenWindowFromSeat = "SeatFrontRight"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontRight"].PaperSpiked.install.area = "TireFrontRight"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowFrontRight"].PaperSpiked.uninstall.area = "TireFrontRight"
	]]--
	...
	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearLeft"].Paper.name = "IGUI_VehiclePartATA2ProtectionWindowRearLeftPaper"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearLeft"].Paper.protection = {"WindowRearLeft"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearLeft"].Paper.install.requireInstalled = {"WindowRearLeft"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearLeft"].Paper.disableOpenWindowFromSeat = "SeatRearLeft"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearLeft"].Paper.install.area = "TireRearLeft"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearLeft"].Paper.uninstall.area = "TireRearLeft"

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearLeft"].PaperSpiked.name = "IGUI_VehiclePartATA2ProtectionWindowRearLeftPaperSpiked"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearLeft"].PaperSpiked.protection = {"WindowRearLeft"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearLeft"].PaperSpiked.install.requireInstalled = {"WindowRearLeft"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearLeft"].PaperSpiked.disableOpenWindowFromSeat = "SeatRearLeft"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearLeft"].PaperSpiked.install.area = "TireRearLeft"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearLeft"].PaperSpiked.uninstall.area = "TireRearLeft"
	]]--
	...
	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearRight"].Paper.name = "IGUI_VehiclePartATA2ProtectionWindowRearRightPaper"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearRight"].Paper.protection = {"WindowRearRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearRight"].Paper.install.requireInstalled = {"WindowRearRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearRight"].Paper.disableOpenWindowFromSeat = "SeatRearRight"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearRight"].Paper.install.area = "TireRearRight"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearRight"].Paper.uninstall.area = "TireRearRight"

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearRight"].PaperSpiked.name = "IGUI_VehiclePartATA2ProtectionWindowRearRightPaperSpiked"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearRight"].PaperSpiked.protection = {"WindowRearRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearRight"].PaperSpiked.install.requireInstalled = {"WindowRearRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearRight"].PaperSpiked.disableOpenWindowFromSeat = "SeatRearRight"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearRight"].PaperSpiked.install.area = "TireRearRight"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowRearRight"].PaperSpiked.uninstall.area = "TireRearRight"
	]]--
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleLeft"].ReinforcedRusted.name = "IGUI_VehiclePartATA2ProtectionWindowMiddleLeftReinforcedRusted"
	...
	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleLeft"].Paper.name = "IGUI_VehiclePartATA2ProtectionWindowMiddleLeftPaper"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleLeft"].Paper.protection = {"WindowMiddleLeft"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleLeft"].Paper.install.requireInstalled = {"WindowMiddleLeft"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleLeft"].Paper.disableOpenWindowFromSeat = nil
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleLeft"].Paper.install.area = "TireFrontLeft"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleLeft"].Paper.uninstall.area = "TireFrontLeft"

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleLeft"].PaperSpiked.name = "IGUI_VehiclePartATA2ProtectionWindowMiddleLeftPaperSpiked"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleLeft"].PaperSpiked.protection = {"WindowMiddleLeft"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleLeft"].PaperSpiked.install.requireInstalled = {"WindowMiddleLeft"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleLeft"].PaperSpiked.disableOpenWindowFromSeat = nil
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleLeft"].PaperSpiked.install.area = "TireFrontLeft"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleLeft"].PaperSpiked.uninstall.area = "TireFrontLeft"
	]]--
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleRight"].ReinforcedRusted.name = "IGUI_VehiclePartATA2ProtectionWindowMiddleRightReinforcedRusted"
	...
	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleRight"].Paper.name = "IGUI_VehiclePartATA2ProtectionWindowMiddleRightPaper"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleRight"].Paper.protection = {"WindowMiddleRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleRight"].Paper.install.requireInstalled = {"WindowMiddleRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleRight"].Paper.disableOpenWindowFromSeat = nil
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleRight"].Paper.install.area = "TireFrontRight"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleRight"].Paper.uninstall.area = "TireFrontRight"

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleRight"].PaperSpiked.name = "IGUI_VehiclePartATA2ProtectionWindowMiddleRightPaperSpiked"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleRight"].PaperSpiked.protection = {"WindowMiddleRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleRight"].PaperSpiked.install.requireInstalled = {"WindowMiddleRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleRight"].PaperSpiked.disableOpenWindowFromSeat = nil
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleRight"].PaperSpiked.install.area = "TireFrontRight"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindowMiddleRight"].PaperSpiked.uninstall.area = "TireFrontRight"
	]]--
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].Heavy.gasUsage = SVUC.protectionHeavyGasUsage
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].Heavy.install.use = SVUC.useHeavy
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].LightSpiked.install.use = SVUC.useLightSpiked
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].HeavySpiked.install.use = SVUC.useHeavySpiked

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].LightSpikedRusted = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].LightSpiked)
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].HeavySpikedRusted = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].HeavySpiked)
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].Reinforced.gasUsage = SVUC.protectionReinforcedGasUsage
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].Reinforced.install.use = SVUC.useReinforced
	...
	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].Paper = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].Heavy)
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].Paper.name = "IGUI_VehiclePartATA2ProtectionWindshieldPaper"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].Paper.category = SVUC.protectionPaper
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].Paper.protectionHealthDelta = SVUC.protectionPaperHealthDelta
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].Paper.install.use = {SheetPaper2 = 4,}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].Paper.install.skills = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].Paper.install.tools = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].Paper.install.time = SVUC.timePaper
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].Paper.uninstall.skills = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].Paper.uninstall.tools = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].Paper.uninstall.time = SVUC.timePaper

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].PaperSpiked = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].Paper)
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].PaperSpiked.name = "IGUI_VehiclePartATA2ProtectionWindshieldPaperSpiked"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshield"].PaperSpiked.category = SVUC.protectionPaperSpiked
	]]--
	...
	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshieldRear"].Paper.name = "IGUI_VehiclePartATA2ProtectionWindshieldRearPaper"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshieldRear"].Paper.protection = {"WindshieldRear"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshieldRear"].Paper.install.requireInstalled = {"WindshieldRear"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshieldRear"].Paper.install.area = "TireRearRight"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshieldRear"].Paper.uninstall.area = "TireRearRight"

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshieldRear"].PaperSpiked.name = "IGUI_VehiclePartATA2ProtectionWindshieldRearPaperSpiked"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshieldRear"].PaperSpiked.protection = {"WindshieldRear"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshieldRear"].PaperSpiked.install.requireInstalled = {"WindshieldRear"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshieldRear"].PaperSpiked.install.area = "TireRearRight"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionWindshieldRear"].PaperSpiked.uninstall.area = "TireRearRight"
	]]--
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].Heavy.gasUsage = SVUC.protectionHeavyGasUsage
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].Heavy.install.use = SVUC.useHeavy
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].LightSpikedRusted = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].LightSpiked)
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].LightSpikedRusted.install.use = SVUC.useLightSpiked
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].HeavySpikedRusted = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].HeavySpiked)
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].HeavySpikedRusted.install.use = SVUC.useHeavySpiked
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].Reinforced.gasUsage = SVUC.protectionReinforcedGasUsage
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].Reinforced.install.use = SVUC.useReinforced
	...
	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].Paper = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].Heavy)
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].Paper.name = "IGUI_VehiclePartATA2ProtectionTrunkPaper"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].Paper.category = SVUC.protectionPaper
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].Paper.protectionHealthDelta = SVUC.protectionPaperHealthDelta
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].Paper.install.use = {SheetPaper2 = 6,}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].Paper.install.skills = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].Paper.install.tools = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].Paper.install.time = SVUC.timePaper
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].Paper.uninstall.skills = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].Paper.uninstall.tools = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].Paper.uninstall.time = SVUC.timePaper

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].PaperSpiked = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].Paper)
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].PaperSpiked.name = "IGUI_VehiclePartATA2ProtectionTrunkPaperSpiked"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"].PaperSpiked.category = SVUC.protectionPaperSpiked
	]]--

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTruckBedOpen"] = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTruckBedOpen"] = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"])
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTruckBedOpen"].Light.protection = {"TruckBedOpen", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTruckBedOpen"].Heavy.protection = {"TruckBedOpen", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTruckBedOpen"].LightRusted.protection = {"TruckBedOpen", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTruckBedOpen"].HeavyRusted.protection = {"TruckBedOpen", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTruckBedOpen"].LightSpiked.protection = {"TruckBedOpen", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTruckBedOpen"].HeavySpiked.protection = {"TruckBedOpen", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTruckBedOpen"].LightSpikedRusted.protection = {"TruckBedOpen", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTruckBedOpen"].HeavySpikedRusted.protection = {"TruckBedOpen", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTruckBedOpen"].Reinforced.protection = {"TruckBedOpen", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTruckBedOpen"].ReinforcedRusted.protection = {"TruckBedOpen", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}
	--TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTruckBedOpen"].Paper.protection = {"TruckBedOpen", "GasTank"}
	--TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTruckBedOpen"].PaperSpiked.protection = {"TruckBedOpen", "GasTank"}

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunkTrailer"] = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunkTrailer"] = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"])
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunkTrailer"].Light.protection = {"TruckBed"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunkTrailer"].Heavy.protection = {"TruckBed"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunkTrailer"].LightRusted.protection = {"TruckBed"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunkTrailer"].HeavyRusted.protection = {"TruckBed"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunkTrailer"].LightSpiked.protection = {"TruckBed"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunkTrailer"].HeavySpiked.protection = {"TruckBed"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunkTrailer"].LightSpikedRusted.protection = {"TruckBed"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunkTrailer"].HeavySpikedRusted.protection = {"TruckBed"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunkTrailer"].Reinforced.protection = {"TruckBed"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunkTrailer"].ReinforcedRusted.protection = {"TruckBed"}
	--TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunkTrailer"].Paper.protection = {"TruckBed"}
	--TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunkTrailer"].PaperSpiked.protection = {"TruckBed"}

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRearTrailer"] = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRearTrailer"] = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionTrunk"])
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRearTrailer"].Light.protection = {"TruckBed", "DoorRear"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRearTrailer"].Heavy.protection = {"TruckBed", "DoorRear"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRearTrailer"].LightRusted.protection = {"TruckBed", "DoorRear"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRearTrailer"].HeavyRusted.protection = {"TruckBed", "DoorRear"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRearTrailer"].LightSpiked.protection = {"TruckBed", "DoorRear"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRearTrailer"].HeavySpiked.protection = {"TruckBed", "DoorRear"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRearTrailer"].LightSpikedRusted.protection = {"TruckBed", "DoorRear"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRearTrailer"].HeavySpikedRusted.protection = {"TruckBed", "DoorRear"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRearTrailer"].Reinforced.protection = {"TruckBed", "DoorRear"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRearTrailer"].ReinforcedRusted.protection = {"TruckBed", "DoorRear"}
	--TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRearTrailer"].Paper.protection = {"TruckBed", "DoorRear"}
	--TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRearTrailer"].PaperSpiked.protection = {"TruckBed", "DoorRear"}
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRear"].Light.protection = {"TruckBed", "DoorRear", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRear"].Heavy.protection = {"TruckBed", "DoorRear", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRear"].LightSpiked.protection = {"TruckBed", "DoorRear", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRear"].HeavySpiked.protection = {"TruckBed", "DoorRear", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRear"].LightRusted.protection = {"TruckBed", "DoorRear", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRear"].HeavyRusted.protection = {"TruckBed", "DoorRear", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRear"].LightSpikedRusted.protection = {"TruckBed", "DoorRear", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRear"].HeavySpikedRusted.protection = {"TruckBed", "DoorRear", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRear"].Reinforced.protection = {"TruckBed", "DoorRear", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRear"].ReinforcedRusted.protection = {"TruckBed", "DoorRear", "GasTank", "HeadlightRearLeft", "HeadlightRearRight"}

	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRear"].Paper.name = "IGUI_VehiclePartATA2ProtectionDoorsRearPaper"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRear"].Paper.protection = {"TruckBed", "DoorRear", "GasTank"}

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRear"].PaperSpiked.name = "IGUI_VehiclePartATA2ProtectionDoorsRearPaperSpiked"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorsRear"].PaperSpiked.protection = {"TruckBed", "DoorRear", "GasTank"}
	]]--
	...
	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHood"].Paper.name = "IGUI_VehiclePartATA2ProtectionHoodPaper"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHood"].Paper.protection = {"EngineDoor"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHood"].Paper.install.requireInstalled = {"EngineDoor"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHood"].Paper.install.requireUninstalled = {"ATA2AirScoop"}

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHood"].PaperSpiked.name = "IGUI_VehiclePartATA2ProtectionHoodPaperSpiked"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHood"].PaperSpiked.protection = {"EngineDoor"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHood"].PaperSpiked.install.requireInstalled = {"EngineDoor"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHood"].PaperSpiked.install.requireUninstalled = {"ATA2AirScoop"}
	]]--
	...
	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHood"].PaperScoop = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHood"].Paper)
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHood"].PaperScoop.name = "IGUI_VehiclePartATA2ProtectionHoodPaperScoop"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHood"].PaperScoop.install.requireInstalled = {"EngineDoor", "ATA2AirScoop"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHood"].PaperScoop.install.requireUninstalled = nil

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHood"].PaperSpikedScoop = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHood"].PaperSpiked)
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHood"].PaperSpikedScoop.name = "IGUI_VehiclePartATA2ProtectionHoodPaperSpikedScoop"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHood"].PaperSpikedScoop.install.requireInstalled = {"EngineDoor", "ATA2AirScoop"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHood"].PaperSpikedScoop.install.requireUninstalled = nil
	]]--
	...
	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHoodNoScoop"].Paper.name = "IGUI_VehiclePartATA2ProtectionHoodPaper"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHoodNoScoop"].Paper.protection = {"EngineDoor"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHoodNoScoop"].Paper.install.requireInstalled = {"EngineDoor"}

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHoodNoScoop"].PaperSpiked.name = "IGUI_VehiclePartATA2ProtectionHoodPaperSpiked"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHoodNoScoop"].PaperSpiked.protection = {"EngineDoor"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionHoodNoScoop"].PaperSpiked.install.requireInstalled = {"EngineDoor"}
	]]--
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].Heavy.gasUsage = SVUC.protectionHeavyGasUsage
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].Heavy.install.use = SVUC.useHeavy
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].LightSpiked.install.use = SVUC.useLightSpiked
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].HeavySpiked.install.use = SVUC.useHeavySpiked

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].LightSpikedRusted = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].LightSpiked)
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].HeavySpikedRusted = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].HeavySpiked)
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].Reinforced.gasUsage = SVUC.protectionReinforcedGasUsage
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].Reinforced.install.use = SVUC.useReinforced
	...
	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].Paper = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].Heavy)
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].Paper.name = "IGUI_VehiclePartATA2ProtectionDoorFrontLeftPaper"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].Paper.category = SVUC.protectionPaper
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].Paper.install.use = {SheetPaper2 = 6,}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].Paper.install.skills = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].Paper.install.tools = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].Paper.install.time = SVUC.timePaper
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].Paper.uninstall.skills = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].Paper.uninstall.tools = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].Paper.uninstall.time = SVUC.timePaper

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].PaperSpiked = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].Paper)
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].PaperSpiked.name = "IGUI_VehiclePartATA2ProtectionDoorFrontLeftPaperSpiked"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontLeft"].PaperSpiked.category = SVUC.protectionPaperSpiked
	]]--
	...
	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontRight"].Paper.protection = {"DoorFrontRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontRight"].Paper.name = "IGUI_VehiclePartATA2ProtectionDoorFrontRightPaper"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontRight"].Paper.install.requireInstalled = {"DoorFrontRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontRight"].Paper.install.area = "TireFrontRight"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontRight"].Paper.uninstall.area = "TireFrontRight"

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontRight"].PaperSpiked.protection = {"DoorFrontRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontRight"].PaperSpiked.name = "IGUI_VehiclePartATA2ProtectionDoorFrontRightPaperSpiked"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontRight"].PaperSpiked.install.requireInstalled = {"DoorFrontRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontRight"].PaperSpiked.install.area = "TireFrontRight"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorFrontRight"].PaperSpiked.uninstall.area = "TireFrontRight"
	]]--
	...
	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearLeft"].Paper.name = "IGUI_VehiclePartATA2ProtectionDoorRearLeftPaper"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearLeft"].Paper.protection = {"DoorRearLeft"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearLeft"].Paper.install.requireInstalled = {"DoorRearLeft"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearLeft"].Paper.install.area = "TireRearLeft"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearLeft"].Paper.uninstall.area = "TireRearLeft"

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearLeft"].PaperSpiked.name = "IGUI_VehiclePartATA2ProtectionDoorRearLeftPaperSpiked"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearLeft"].PaperSpiked.protection = {"DoorRearLeft"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearLeft"].PaperSpiked.install.requireInstalled = {"DoorRearLeft"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearLeft"].PaperSpiked.install.area = "TireRearLeft"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearLeft"].PaperSpiked.uninstall.area = "TireRearLeft"
	]]--
	...
	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleLeft"].Paper.protection = {"DoorMiddleLeft"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleLeft"].Paper.name = "IGUI_VehiclePartATA2ProtectionDoorMiddleLeftPaper"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleLeft"].Paper.install.requireInstalled = {"DoorMiddleLeft"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleLeft"].Paper.install.area = "TireFrontLeft"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleLeft"].Paper.uninstall.area = "TireFrontLeft"

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleLeft"].PaperSpiked.protection = {"DoorMiddleLeft"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleLeft"].PaperSpiked.name = "IGUI_VehiclePartATA2ProtectionDoorMiddleLeftPaperSpiked"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleLeft"].PaperSpiked.install.requireInstalled = {"DoorMiddleLeft"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleLeft"].PaperSpiked.install.area = "TireFrontLeft"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleLeft"].PaperSpiked.uninstall.area = "TireFrontLeft"
	]]--
	...
	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleRight"].Paper.protection = {"DoorMiddleRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleRight"].Paper.name = "IGUI_VehiclePartATA2ProtectionDoorMiddleRightPaper"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleRight"].Paper.install.requireInstalled = {"DoorMiddleRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleRight"].Paper.install.area = "TireFrontRight"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleRight"].Paper.uninstall.area = "TireFrontRight"

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleRight"].PaperSpiked.protection = {"DoorMiddleRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleRight"].PaperSpiked.name = "IGUI_VehiclePartATA2ProtectionDoorMiddleRightPaperSpiked"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleRight"].PaperSpiked.install.requireInstalled = {"DoorMiddleRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleRight"].PaperSpiked.install.area = "TireFrontRight"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorMiddleRight"].PaperSpiked.uninstall.area = "TireFrontRight"
	]]--
	...
	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearRight"].Paper.protection = {"DoorRearRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearRight"].Paper.name = "IGUI_VehiclePartATA2ProtectionDoorRearRightPaper"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearRight"].Paper.install.requireInstalled = {"DoorRearRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearRight"].Paper.install.area = "TireRearRight"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearRight"].Paper.uninstall.area = "TireRearRight"

	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearRight"].PaperSpiked.protection = {"DoorRearRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearRight"].PaperSpiked.name = "IGUI_VehiclePartATA2ProtectionDoorRearRightPaperSpiked"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearRight"].PaperSpiked.install.requireInstalled = {"DoorRearRight"}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearRight"].PaperSpiked.install.area = "TireRearRight"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2ProtectionDoorRearRight"].PaperSpiked.uninstall.area = "TireRearRight"
	]]--
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2RoofTaxiSign"] = {
		Default = {
			...
			category = SVUC.protectionAccessories,
			name = "IGUI_VehiclePartATA2RoofTaxiSign",
			spawnChance = 100,
			install = {
				area = "Engine",
				use = SVUC.useMegaphone,
				tools = {
					primary = "Base.Wrench",
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2RoofLightbar"].Flat = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2RoofLightbar"].Normal)
	TemplateTuningTable["TemplateVehicle"].parts["ATA2RoofLightbar"].Flat.name = "IGUI_VehiclePartATA2RoofLightbarFlat"
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2Megaphone"].Megaphone.install.use = SVUC.useMegaphone
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2Megaphone"].Megaphone.uninstall.result = "auto"
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2Megaphone"].MegaphoneRusted.install.use = SVUC.useMegaphone
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2Megaphone"].MegaphoneRusted.uninstall.result = "auto"
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"] = {
		Small = {
			...
			gasUsage = SVUC.protectionEngineSmallGasUsage,
			removeIfBroken = true,
			install = {
				area = "Engine",
				use = SVUC.useScoopSmall,
				tools = {
					bodylocation = "Base.WeldingMask", 
					primary = "Base.Wrench",
					secondary = "Base.Screwdriver",
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].Medium.gasUsage = SVUC.protectionEngineMediumGasUsage
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].Medium.install.use = SVUC.useScoopMedium
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].Medium.install.skills = {Mechanics = 4, MetalWelding = 4}
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].Large.gasUsage = SVUC.protectionEngineLargeGasUsage
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].Large.install.use = SVUC.useScoopLarge
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].Large.install.skills = {Mechanics = 6, MetalWelding = 6}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].Large.uninstall.skills = {Mechanics = 5, MetalWelding = 5}
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].Piped.gasUsage = SVUC.protectionEnginePipedGasUsage
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].Piped.install.use = SVUC.useScoopPiped
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].Piped.install.skills = {Mechanics = 8, MetalWelding = 8}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].Piped.uninstall.skills = {Mechanics = 7, MetalWelding = 7}
	...
	--[[
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].PipedPaper = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].Piped)
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].PipedPaper.icon = "media/ui/tuning2/delorean_protection_hood_bttf.png"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].PipedPaper.name = "IGUI_VehiclePartATA2AirScoopPipedPaper"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].PipedPaper.powerIncrease = SVUC.protectionEnginePaperPowerIncrease
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].PipedPaper.install.use = {SheetPaper2 = 6,}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].PipedPaper.install.skills = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].PipedPaper.install.tools = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].PipedPaper.uninstall.skills = {}
	TemplateTuningTable["TemplateVehicle"].parts["ATA2AirScoop"].PipedPaper.uninstall.tools = {}
	]]--
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2Snorkel"].SnorkelLeft.gasUsage = SVUC.protectionEngineSnorkelGasUsage
	TemplateTuningTable["TemplateVehicle"].parts["ATA2Snorkel"].SnorkelLeft.install.use = SVUC.useSnorkel
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2WheelType"] = {
		AmericanSedan = {
			icon = "media/ui/tuning2/delorean_protection_hood_bttf.png",
			category = SVUC.protectionWheelMods,
			name = "IGUI_VehiclePartATA2WheelTypeAmericanSedan",
			spawnChance = 100,
			removeIfBroken = true,
			install = {
				area = "TireFrontLeft",
	...
	TemplateTuningTable["TemplateVehicle"].parts["ATA2WheelType"].Hubcap = copy(TemplateTuningTable["TemplateVehicle"].parts["ATA2WheelType"].AmericanSedan)
	TemplateTuningTable["TemplateVehicle"].parts["ATA2WheelType"].Hubcap.icon = "media/ui/tuning2/delorean_protection_hood_bttf.png"
	TemplateTuningTable["TemplateVehicle"].parts["ATA2WheelType"].Hubcap.name = "IGUI_VehiclePartATA2WheelTypeHubcap"

	TemplateTuningTable["TemplateVehicle"].parts["ATA2Turret"] = {
		Default = {
			icon = "media/ui/tuning2/delorean_protection_hood_bttf.png",
			category = SVUC.protectionMods,
			name = "IGUI_VehiclePartATA2Turret",
			spawnChance = 100,
			removeIfBroken = true,
			install = {
				area = "TireFrontLeft",
