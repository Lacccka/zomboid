...
function DTNPCGenerator.CreateMVPData(mvpData, options)
    ...
    local npcData = {
        ...
        enableRangedSightAnim = false,
        enableMeleeCombatAnim = false,
        combatResumeState = nil,
        isPlayerFactionTrader = options.isPlayerFactionTrader == true,
        tasks = {},
        combatOrder = nil,
        guardCombatOrder = nil,
        guardAttackMode = nil,
        combatTargetID = nil,
        combatFallbackAnnouncedAt = nil,
        protectNoticeSerial = 0,
        protectNoticeText = nil,
        protectNoticeSentiment = "neutral",
        protectNoticeDialogueStatus = nil,
        protectNoticeDialogueState = nil,
        skillXP = {
            Melee = 0,
            Shooting = 0,
        },
