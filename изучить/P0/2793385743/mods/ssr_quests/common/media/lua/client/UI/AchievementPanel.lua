...
local label_hidden = string.gsub(getTextOrNull("UI_Achievement_Hidden") or "%d hidden achievements remaining|Details for each achievement will be revealed once unlocked", "%%d", "%d")
...
function AchievementPanel:new(x, y)
    ...
    o.tex_locked = getTexture("media/ui/QSystem/achievement_locked.png");
    o.tex_unlocked = getTexture("media/ui/QSystem/achievement_unlocked.png");
