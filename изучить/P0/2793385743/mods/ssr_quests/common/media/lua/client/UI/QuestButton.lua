...
function QuestButton:new(x, y)
    ...
    o.readTexture = getTexture("media/ui/QSystem/journal_00.png");
    o.unreadTexture = getTexture("media/ui/QSystem/journal_05.png");
	...
	o.texture = {}
	for i=0, 5 do
      o.texture[i+1] = getTexture("media/ui/QSystem/journal_0"..tostring(i)..".png");
    end
...
function QDebugButton:new(x, y)
    ...
    o.icon = getTexture("media/ui/QSystem/debugger.png");
...
Events.OnQSystemStart.Add(function()
	...
	if isClient() then
		if getPlayer() and getPlayer():getRole():hasAdminTool() then -- multiplayer with access level
			allowDebugger = true;
		end
