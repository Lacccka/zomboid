...
function QuestDebugger:createChildren()
    ...
    self.checkbox_load = ISTickBox:new(10*SSRLoader.scale, offset_y + 20*SSRLoader.scale*2, 200*SSRLoader.scale, 20*SSRLoader.scale, "", self, QuestDebugger.onTickLoadProgress);
