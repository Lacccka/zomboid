...
local function QPSC_getInventoryItemsByFullType(
    ...
    if inventory == nil or target == "" then
        return result
    end
            ...
            if item ~= nil then
                ...
                if item.getFullType ~= nil then
                    ...
                    if okType and value ~= nil then
                        itemFullType = tostring(value)
                    end
                end

                if itemFullType == target then
...
print("[QPSC] Build 42 client loaded v1.3.2 Production.")
