...
BWOMenu.AddFlicker = function(player, square)
    local effects = {
        {
            x = 12676,
            y = 6399,
            z = 0,
            prg = {true, true, true, true, false, false, false, false, false, false, false, false, false, false, false, false,
        ...
        },
        {
            ...
            y = 6399,
            z = 0,
            prg = {false, false, false, false, false, false, false, false, true, true, true, true, false, false, false, false,
                   false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false,}
        },
        {
            x = 12678,
    ...
    for index, pos in ipairs(path) do
        ...
        for frame = 0,31 do
            local d = (frame - (index-1)) % 32

            -- 4-light snake
            prg[#prg+1] = (d >= 0 and d < 4)
        end
...
function BWOMenu.WorldContextMenuPre(playerID, context, worldobjects, test)
    ...
    if isDebugEnabled() or isAdmin() then
        ...
        context:addOption("Add Flicker", player, BWOMenu.AddFlicker, square)

        local vehicle = square:getVehicleContainer()
        if vehicle then
            vehicle:setSteering(-1)
        end
