...
function PagerMod.deployTower(item)
    ...
    -- Only a CARRIED tower can be set up. The deployed tower is itself a
    -- PagerTower world item (no container); without this guard, "setting up"
    -- that ground object consumed nothing and duped towers.
