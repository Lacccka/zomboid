...
AWCWF_SilencerSet.Canon["kriss_muzzle_d_Silencer"] = {
    SoundVolumeModifier = 0.20,
    SoundRadiusModifier = 0.20,
...
AWCWF_SilencerSet.Canon["M82_cat_Silencer"] = {
    ...
    SilenceSound = "M82_cat_s"
}

AWCWF_SilencerSet.Canon["XY_SnipeX"] = {
    SoundVolumeModifier = 0.40,
    SoundRadiusModifier = 0.40,
    SilenceSound = "M82_cat_s"
}

AWCWF_SilencerSet.Canon["wave_dd_slience"] = {
    SoundVolumeModifier = 0.35,
    SoundRadiusModifier = 0.35,
    SilenceSound = "XY_5"
}
...
AWCWF_SilencerSet.Canon["XY_baoguo"] = {
    SoundVolumeModifier = 0.25,
    SoundRadiusModifier = 0.25,
    SilenceSound = "XY_6"
}
...
AWCWF_SilencerSet.Canon["XY_SP"] = {
    SoundVolumeModifier = 0.80,
    SoundRadiusModifier = 0.80,
    SilenceSound = nil
}
