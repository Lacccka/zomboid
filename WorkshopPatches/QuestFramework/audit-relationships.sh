...
require_pattern 'function QuestService\.AddEventListener' "$quest_service" "composable quest event listener API missing"
require_pattern 'QuestService\.AddEventListener\(onQuestEvent\)' "$relationship_bridge" "live quest completion listener missing"
