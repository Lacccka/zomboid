local HDCP_IVP_PrimeVehicle = {}

function HDCP_IVP_PrimeVehicle.new(deps)
    ...
    ---@class PrimeVehicleAction : ISBaseTimedAction
    ---@field vehicle BaseVehicle
    ---@field counter number
    ---@field totalAreas number
    ---@field requiredUses number
    ---@field surface string
    local module = BaseTimedAction:derive('PrimeVehicleAction')

    ---@param self PrimeVehicleAction
    ...
    function module:perform()
        ...
        if self.counter == self.totalAreas then
            ...
            self.vehicle:getModData().IVP['isPrimed'] = true
