...
extends EventListener {
    ...
    public void proxySelectStart(@NotNull Call call, @NotNull HttpUrl url) {
        ...
        this.logWithTime("proxySelectStart: " + url);
    }
    ...
    public void proxySelectEnd(@NotNull Call call, @NotNull HttpUrl url, @NotNull List<? extends Proxy> proxies) {
        ...
        this.logWithTime("proxySelectEnd: " + proxies);
    }
    ...
    public void secureConnectEnd(@NotNull Call call, @Nullable Handshake handshake2) {
        Intrinsics.checkNotNullParameter(call, "call");
        this.logWithTime("secureConnectEnd: " + handshake2);
    }
    ...
    public void satisfactionFailure(@NotNull Call call, @NotNull Response response) {
        Intrinsics.checkNotNullParameter(call, "call");
        Intrinsics.checkNotNullParameter(response, "response");
        this.logWithTime("satisfactionFailure: " + response);
    }
    ...
    public void cacheHit(@NotNull Call call, @NotNull Response response) {
        Intrinsics.checkNotNullParameter(call, "call");
        Intrinsics.checkNotNullParameter(response, "response");
        this.logWithTime("cacheHit: " + response);
    }
    ...
    public void cacheConditionalHit(@NotNull Call call, @NotNull Response cachedResponse) {
        ...
        this.logWithTime("cacheConditionalHit: " + cachedResponse);
    }
    ...
    implements EventListener.Factory {
        ...
        public /* synthetic */ Factory(HttpLoggingInterceptor.Logger logger, int n, DefaultConstructorMarker defaultConstructorMarker) {
            if ((n & 1) != 0) {
