...
implements Iterable<Object> {
    ...
    public JSONArray(String source2, JSONParserConfiguration jsonParserConfiguration) throws JSONException {
    ...
    public String toString(int indentFactor) throws JSONException {
        ...
        StringBuilderWriter sw = new StringBuilderWriter(Math.max(initialSize, 16));
