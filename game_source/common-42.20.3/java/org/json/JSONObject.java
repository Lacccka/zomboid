...
public class JSONObject {
    ...
    public JSONObject(JSONTokener x, JSONParserConfiguration jsonParserConfiguration) throws JSONException {
        this();
        boolean isInitial;
        boolean bl = isInitial = x.getPrevious() == '\u0000';
        if (x.nextClean() != '{') {
        ...
        block9: while (true) {
            ...
            switch (c) {
                ...
                case '}': {
                    if (isInitial && jsonParserConfiguration.isStrictMode() && x.nextClean() != '\u0000') {
            ...
            if (key != null) {
                boolean keyExists;
                boolean bl2 = keyExists = this.opt(key) != null;
    ...
    private JSONObject(Map<?, ?> m, int recursionDepth, JSONParserConfiguration jsonParserConfiguration) {
        ...
        if (m == null) {
            ...
            for (Map.Entry<?, ?> e : m.entrySet()) {
                ...
                if (value == null && !jsonParserConfiguration.isUseNativeNulls()) continue;
    ...
    public JSONObject(String source2) throws JSONException {
        this(source2, new JSONParserConfiguration());
    }

    public JSONObject(String source2, JSONParserConfiguration jsonParserConfiguration) throws JSONException {
        this(new JSONTokener(source2, jsonParserConfiguration), jsonParserConfiguration);
    }
    ...
    public static String quote(String string) {
        ...
        StringBuilderWriter sw = new StringBuilderWriter(string.length() + 2);
        try {
    ...
    public String toString(int indentFactor) throws JSONException {
        ...
        StringBuilderWriter w = new StringBuilderWriter(Math.max(initialSize, 16));
