...
public class JSONTokener {
    ...
    public JSONTokener(InputStream inputStream2) {
        this(inputStream2, new JSONParserConfiguration());
    }

    public JSONTokener(InputStream inputStream2, JSONParserConfiguration jsonParserConfiguration) {
        this(new InputStreamReader(inputStream2, Charset.forName("UTF-8")), jsonParserConfiguration);
    }

    public JSONTokener(String source2) {
        this(new StringReader(source2));
    }

    public JSONTokener(String source2, JSONParserConfiguration jsonParserConfiguration) {
        this(new StringReader(source2), jsonParserConfiguration);
    }
                    ...
                    switch (c) {
                        ...
                        case 'u': {
                            ...
                            try {
                                ...
                                throw this.syntaxError("Illegal escape. \\u must be followed by a 4 digit hexadecimal number. \\" + next + " is not valid.", e);
                            }
                        }
                        case '\"': 
                        case '\'': 
