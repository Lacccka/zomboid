...
public class GLFWNativeOSMesa {
    ...
    public static boolean glfwGetOSMesaColorBuffer(@NativeType(value="GLFWwindow *") long window, @NativeType(value="int *") @Nullable IntBuffer width, @NativeType(value="int *") @Nullable IntBuffer height, @NativeType(value="int *") @Nullable IntBuffer format, @NativeType(value="void **") @Nullable PointerBuffer buffer) {
        if (Checks.CHECKS) {
    ...
    public static int glfwGetOSMesaDepthBuffer(@NativeType(value="GLFWwindow *") long window, @NativeType(value="int *") @Nullable IntBuffer width, @NativeType(value="int *") @Nullable IntBuffer height, @NativeType(value="int *") @Nullable IntBuffer bytesPerValue, @NativeType(value="void **") @Nullable PointerBuffer buffer) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)width, 1);
            Checks.checkSafe((Buffer)height, 1);
    ...
    @NativeType(value="int")
    public static boolean glfwGetOSMesaColorBuffer(@NativeType(value="GLFWwindow *") long window, @NativeType(value="int *") int @Nullable [] width, @NativeType(value="int *") int @Nullable [] height, @NativeType(value="int *") int @Nullable [] format, @NativeType(value="void **") @Nullable PointerBuffer buffer) {
        long __functionAddress = Functions.GetOSMesaColorBuffer;
        if (Checks.CHECKS) {
            Checks.check(window);
    ...
    public static int glfwGetOSMesaDepthBuffer(@NativeType(value="GLFWwindow *") long window, @NativeType(value="int *") int @Nullable [] width, @NativeType(value="int *") int @Nullable [] height, @NativeType(value="int *") int @Nullable [] bytesPerValue, @NativeType(value="void **") @Nullable PointerBuffer buffer) {
        long __functionAddress = Functions.GetOSMesaDepthBuffer;
        if (Checks.CHECKS) {
            Checks.check(window);
            Checks.checkSafe(width, 1);
