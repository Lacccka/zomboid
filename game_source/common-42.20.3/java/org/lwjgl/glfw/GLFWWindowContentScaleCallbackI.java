...
extends CallbackI {
    ...
    default public void callback(long ret, long args2) {
        this.invoke(MemoryUtil.memGetAddress(MemoryUtil.memGetAddress(args2)), MemoryUtil.memGetFloat(MemoryUtil.memGetAddress(args2 + (long)POINTER_SIZE)), MemoryUtil.memGetFloat(MemoryUtil.memGetAddress(args2 + (long)(2 * POINTER_SIZE))));
    }
