...
public abstract class MappedObject {
    static final boolean CHECKS = LWJGLUtil.getPrivilegedBoolean((String)"org.lwjgl.util.mapped.Checks");
    ...
    final void checkRange(int bytes) {
        ...
        if ((long)this.preventGC.capacity() < this.viewAddress - MemoryUtil.getAddress0((Buffer)this.preventGC) + (long)bytes) {
