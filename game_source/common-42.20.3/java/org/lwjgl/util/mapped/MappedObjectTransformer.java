...
public class MappedObjectTransformer {
    static final boolean PRINT_ACTIVITY = LWJGLUtil.DEBUG && LWJGLUtil.getPrivilegedBoolean((String)"org.lwjgl.util.mapped.PrintActivity");
    static final boolean PRINT_TIMING = PRINT_ACTIVITY && LWJGLUtil.getPrivilegedBoolean((String)"org.lwjgl.util.mapped.PrintTiming");
    static final boolean PRINT_BYTECODE = LWJGLUtil.DEBUG && LWJGLUtil.getPrivilegedBoolean((String)"org.lwjgl.util.mapped.PrintBytecode");
    ...
    private static FieldInfo registerField(boolean autoGenerateOffsets, String className, long advancingOffset, Field field) {
        ...
        if (PRINT_ACTIVITY) {
            LWJGLUtil.log((CharSequence)(MappedObjectTransformer.class.getSimpleName() + ": " + className + "." + field.getName() + " [type=" + field.getType().getSimpleName() + ", offset=" + byteOffset + "]"));
        }
    ...
    private static void printBytecode(byte[] bytecode) {
        ...
        LWJGLUtil.log((CharSequence)dump);
    }
    ...
    extends ClassAdapter {
        ...
        public FieldVisitor visitField(int access, String name, String desc, String signature, Object value) {
            ...
            if (mappedSubtype != null && mappedSubtype.fields.containsKey(name)) {
                if (PRINT_ACTIVITY) {
                    LWJGLUtil.log((CharSequence)(MappedObjectTransformer.class.getSimpleName() + ": discarding field: " + this.className + "." + name + ":" + desc));
                }
                return null;
            }
            if ((access & 8) == 0) {
