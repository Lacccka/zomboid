...
public class WaveData {
    ...
    public static WaveData create(URL path) {
        try {
            ...
            LWJGLUtil.log((CharSequence)("Unable to create from: " + path + ", " + e.getMessage()));
            return null;
        }
    }
    ...
    public static WaveData create(InputStream is) {
        try {
            ...
            LWJGLUtil.log((CharSequence)("Unable to create from inputstream, " + e.getMessage()));
            return null;
        }
    }
    ...
    public static WaveData create(byte[] buffer) {
        try {
            ...
            LWJGLUtil.log((CharSequence)("Unable to create from byte array, " + e.getMessage()));
            return null;
        }
    }
    ...
    public static WaveData create(ByteBuffer buffer) {
        try {
            ...
            LWJGLUtil.log((CharSequence)("Unable to create from ByteBuffer, " + e.getMessage()));
            return null;
        }
    }
