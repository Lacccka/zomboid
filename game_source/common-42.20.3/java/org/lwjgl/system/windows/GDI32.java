...
public class GDI32 {
    ...
    public static native int nChoosePixelFormat(long var0, long var2, long var4, long var6);
    ...
    public static int nChoosePixelFormat(long _GetLastError, long hdc, long pixelFormatDescriptor) {
        ...
        return org.lwjgl.system.windows.GDI32.nChoosePixelFormat(_GetLastError, hdc, pixelFormatDescriptor, __functionAddress);
    }

    public static int ChoosePixelFormat(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HDC") long hdc, @NativeType(value="PIXELFORMATDESCRIPTOR const *") PIXELFORMATDESCRIPTOR pixelFormatDescriptor) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return org.lwjgl.system.windows.GDI32.nChoosePixelFormat(MemoryUtil.memAddressSafe(_GetLastError), hdc, pixelFormatDescriptor.address());
    }

    public static native int nDescribePixelFormat(long var0, long var2, int var4, int var5, long var6, long var8);
    ...
    public static int nDescribePixelFormat(long _GetLastError, long hdc, int pixelFormat, int bytes, long pixelFormatDescriptor) {
        ...
        return org.lwjgl.system.windows.GDI32.nDescribePixelFormat(_GetLastError, hdc, pixelFormat, bytes, pixelFormatDescriptor, __functionAddress);
    }

    public static int DescribePixelFormat(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HDC") long hdc, int pixelFormat, @NativeType(value="UINT") int bytes, @NativeType(value="LPPIXELFORMATDESCRIPTOR") @Nullable PIXELFORMATDESCRIPTOR pixelFormatDescriptor) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return org.lwjgl.system.windows.GDI32.nDescribePixelFormat(MemoryUtil.memAddressSafe(_GetLastError), hdc, pixelFormat, bytes, MemoryUtil.memAddressSafe(pixelFormatDescriptor));
    }

    public static int DescribePixelFormat(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HDC") long hdc, int pixelFormat, @NativeType(value="LPPIXELFORMATDESCRIPTOR") @Nullable PIXELFORMATDESCRIPTOR pixelFormatDescriptor) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return org.lwjgl.system.windows.GDI32.nDescribePixelFormat(MemoryUtil.memAddressSafe(_GetLastError), hdc, pixelFormat, PIXELFORMATDESCRIPTOR.SIZEOF, MemoryUtil.memAddressSafe(pixelFormatDescriptor));
    }

    public static native int nGetPixelFormat(long var0, long var2, long var4);
    ...
    public static int nGetPixelFormat(long _GetLastError, long hdc) {
        ...
        return org.lwjgl.system.windows.GDI32.nGetPixelFormat(_GetLastError, hdc, __functionAddress);
    }

    public static int GetPixelFormat(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HDC") long hdc) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return org.lwjgl.system.windows.GDI32.nGetPixelFormat(MemoryUtil.memAddressSafe(_GetLastError), hdc);
    }

    public static native int nSetPixelFormat(long var0, long var2, int var4, long var5, long var7);
    ...
    public static int nSetPixelFormat(long _GetLastError, long hdc, int pixelFormat, long pixelFormatDescriptor) {
        ...
        return org.lwjgl.system.windows.GDI32.nSetPixelFormat(_GetLastError, hdc, pixelFormat, pixelFormatDescriptor, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean SetPixelFormat(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HDC") long hdc, int pixelFormat, @NativeType(value="PIXELFORMATDESCRIPTOR const *") @Nullable PIXELFORMATDESCRIPTOR pixelFormatDescriptor) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return org.lwjgl.system.windows.GDI32.nSetPixelFormat(MemoryUtil.memAddressSafe(_GetLastError), hdc, pixelFormat, MemoryUtil.memAddressSafe(pixelFormatDescriptor)) != 0;
    }

    public static native int nSwapBuffers(long var0, long var2, long var4);
    ...
    public static int nSwapBuffers(long _GetLastError, long dc) {
        ...
        return org.lwjgl.system.windows.GDI32.nSwapBuffers(_GetLastError, dc, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean SwapBuffers(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HDC") long dc) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return org.lwjgl.system.windows.GDI32.nSwapBuffers(MemoryUtil.memAddressSafe(_GetLastError), dc) != 0;
    }
