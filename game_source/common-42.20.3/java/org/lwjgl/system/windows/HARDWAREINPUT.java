...
implements NativeResource {
    ...
    public static int nuMsg(long struct) {
        return MemoryUtil.memGetInt(struct + (long)UMSG);
    }

    public static short nwParamL(long struct) {
        return MemoryUtil.memGetShort(struct + (long)WPARAML);
    }

    public static short nwParamH(long struct) {
        return MemoryUtil.memGetShort(struct + (long)WPARAMH);
    }

    public static void nuMsg(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)UMSG, value);
    }

    public static void nwParamL(long struct, short value) {
        MemoryUtil.memPutShort(struct + (long)WPARAML, value);
    }

    public static void nwParamH(long struct, short value) {
        MemoryUtil.memPutShort(struct + (long)WPARAMH, value);
    }
