...
public class User32 {
    ...
    public static native short nRegisterClassEx(long var0, long var2, long var4);
    ...
    public static short nRegisterClassEx(long _GetLastError, long lpwcx) {
        ...
        return User32.nRegisterClassEx(_GetLastError, lpwcx, __functionAddress);
    }

    @NativeType(value="ATOM")
    public static short RegisterClassEx(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="WNDCLASSEX const *") WNDCLASSEX lpwcx) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nRegisterClassEx(MemoryUtil.memAddressSafe(_GetLastError), lpwcx.address());
    }

    public static native int nUnregisterClass(long var0, long var2, long var4, long var6);
    ...
    public static int nUnregisterClass(long _GetLastError, long lpClassName, long hInstance) {
        ...
        return User32.nUnregisterClass(_GetLastError, lpClassName, hInstance, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean UnregisterClass(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="LPCTSTR") ByteBuffer lpClassName, @NativeType(value="HINSTANCE") long hInstance) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
            Checks.checkNT2(lpClassName);
        }
        return User32.nUnregisterClass(MemoryUtil.memAddressSafe(_GetLastError), MemoryUtil.memAddress(lpClassName), hInstance) != 0;
    }
     ...
     */
    @NativeType(value="BOOL")
    public static boolean UnregisterClass(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="LPCTSTR") CharSequence lpClassName, @NativeType(value="HINSTANCE") long hInstance) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        ...
        try {
            ...
            boolean bl = User32.nUnregisterClass(MemoryUtil.memAddressSafe(_GetLastError), lpClassNameEncoded, hInstance) != 0;
            return bl;
        }
        finally {
    ...
    public static native long nCreateWindowEx(long var0, int var2, long var3, long var5, int var7, int var8, int var9, int var10, int var11, long var12, long var14, long var16, long var18, long var20);
    ...
    public static long nCreateWindowEx(long _GetLastError, int dwExStyle, long lpClassName, long lpWindowName, int dwStyle, int x, int y, int nWidth, int nHeight, long hWndParent, long hMenu, long hInstance, long lpParam) {
        ...
        return User32.nCreateWindowEx(_GetLastError, dwExStyle, lpClassName, lpWindowName, dwStyle, x, y, nWidth, nHeight, hWndParent, hMenu, hInstance, lpParam, __functionAddress);
    }

    @NativeType(value="HWND")
    public static long CreateWindowEx(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="DWORD") int dwExStyle, @NativeType(value="LPCTSTR") @Nullable ByteBuffer lpClassName, @NativeType(value="LPCTSTR") @Nullable ByteBuffer lpWindowName, @NativeType(value="DWORD") int dwStyle, int x, int y, int nWidth, int nHeight, @NativeType(value="HWND") long hWndParent, @NativeType(value="HMENU") long hMenu, @NativeType(value="HINSTANCE") long hInstance, @NativeType(value="LPVOID") long lpParam) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
            Checks.checkNT2Safe(lpClassName);
            Checks.checkNT2Safe(lpWindowName);
        }
        return User32.nCreateWindowEx(MemoryUtil.memAddressSafe(_GetLastError), dwExStyle, MemoryUtil.memAddressSafe(lpClassName), MemoryUtil.memAddressSafe(lpWindowName), dwStyle, x, y, nWidth, nHeight, hWndParent, hMenu, hInstance, lpParam);
    }
     ...
     */
    @NativeType(value="HWND")
    public static long CreateWindowEx(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="DWORD") int dwExStyle, @NativeType(value="LPCTSTR") @Nullable CharSequence lpClassName, @NativeType(value="LPCTSTR") @Nullable CharSequence lpWindowName, @NativeType(value="DWORD") int dwStyle, int x, int y, int nWidth, int nHeight, @NativeType(value="HWND") long hWndParent, @NativeType(value="HMENU") long hMenu, @NativeType(value="HINSTANCE") long hInstance, @NativeType(value="LPVOID") long lpParam) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        MemoryStack stack = MemoryStack.stackGet();
        ...
        try {
            ...
            long l = User32.nCreateWindowEx(MemoryUtil.memAddressSafe(_GetLastError), dwExStyle, lpClassNameEncoded, lpWindowNameEncoded, dwStyle, x, y, nWidth, nHeight, hWndParent, hMenu, hInstance, lpParam);
            return l;
        }
        finally {
            stack.setPointer(stackPointer);
    ...
    public static native int nDestroyWindow(long var0, long var2, long var4);
    ...
    public static int nDestroyWindow(long _GetLastError, long hWnd) {
        ...
        return User32.nDestroyWindow(_GetLastError, hWnd, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean DestroyWindow(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HWND") long hWnd) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nDestroyWindow(MemoryUtil.memAddressSafe(_GetLastError), hWnd) != 0;
    }
    ...
    public static native int nSetWindowPos(long var0, long var2, long var4, int var6, int var7, int var8, int var9, int var10, long var11);
    ...
    public static int nSetWindowPos(long _GetLastError, long hWnd, long hWndInsertAfter, int X, int Y, int cx, int cy, int uFlags) {
        ...
        return User32.nSetWindowPos(_GetLastError, hWnd, hWndInsertAfter, X, Y, cx, cy, uFlags, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean SetWindowPos(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HWND") long hWnd, @NativeType(value="HWND") long hWndInsertAfter, int X, int Y, int cx, int cy, @NativeType(value="UINT") int uFlags) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nSetWindowPos(MemoryUtil.memAddressSafe(_GetLastError), hWnd, hWndInsertAfter, X, Y, cx, cy, uFlags) != 0;
    }

    public static native int nSetWindowText(long var0, long var2, long var4, long var6);
    ...
    public static int nSetWindowText(long _GetLastError, long hWnd, long lpString) {
        ...
        return User32.nSetWindowText(_GetLastError, hWnd, lpString, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean SetWindowText(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HWND") long hWnd, @NativeType(value="LPCTSTR") ByteBuffer lpString) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
            Checks.checkNT2(lpString);
        }
        return User32.nSetWindowText(MemoryUtil.memAddressSafe(_GetLastError), hWnd, MemoryUtil.memAddress(lpString)) != 0;
    }
     ...
     */
    @NativeType(value="BOOL")
    public static boolean SetWindowText(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HWND") long hWnd, @NativeType(value="LPCTSTR") CharSequence lpString) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        MemoryStack stack = MemoryStack.stackGet();
        ...
        try {
            ...
            boolean bl = User32.nSetWindowText(MemoryUtil.memAddressSafe(_GetLastError), hWnd, lpStringEncoded) != 0;
            return bl;
        }
        finally {
            stack.setPointer(stackPointer);
    ...
    public static native int nGetMessage(long var0, long var2, long var4, int var6, int var7, long var8);
    ...
    public static int nGetMessage(long _GetLastError, long lpMsg, long hWnd, int wMsgFilterMin, int wMsgFilterMax) {
        ...
        return User32.nGetMessage(_GetLastError, lpMsg, hWnd, wMsgFilterMin, wMsgFilterMax, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean GetMessage(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="LPMSG") MSG lpMsg, @NativeType(value="HWND") long hWnd, @NativeType(value="UINT") int wMsgFilterMin, @NativeType(value="UINT") int wMsgFilterMax) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nGetMessage(MemoryUtil.memAddressSafe(_GetLastError), lpMsg.address(), hWnd, wMsgFilterMin, wMsgFilterMax) != 0;
    }
    ...
    public static native int nWaitMessage(long var0, long var2);

    public static int nWaitMessage(long _GetLastError) {
        long __functionAddress = Functions.WaitMessage;
        return User32.nWaitMessage(_GetLastError, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean WaitMessage(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nWaitMessage(MemoryUtil.memAddressSafe(_GetLastError)) != 0;
    }
    ...
    public static native int nPostMessage(long var0, long var2, int var4, long var5, long var7, long var9);
    ...
    public static int nPostMessage(long _GetLastError, long hWnd, int Msg, long wParam, long lParam) {
        ...
        return User32.nPostMessage(_GetLastError, hWnd, Msg, wParam, lParam, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean PostMessage(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HWND") long hWnd, @NativeType(value="UINT") int Msg, @NativeType(value="WPARAM") long wParam, @NativeType(value="LPARAM") long lParam) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nPostMessage(MemoryUtil.memAddressSafe(_GetLastError), hWnd, Msg, wParam, lParam) != 0;
    }

    public static native int nSendMessage(long var0, long var2, int var4, long var5, long var7, long var9);
    ...
    public static int nSendMessage(long _GetLastError, long hWnd, int Msg, long wParam, long lParam) {
        ...
        return User32.nSendMessage(_GetLastError, hWnd, Msg, wParam, lParam, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean SendMessage(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HWND") long hWnd, @NativeType(value="UINT") int Msg, @NativeType(value="WPARAM") long wParam, @NativeType(value="LPARAM") long lParam) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nSendMessage(MemoryUtil.memAddressSafe(_GetLastError), hWnd, Msg, wParam, lParam) != 0;
    }

    public static native int nAdjustWindowRectEx(long var0, long var2, int var4, int var5, int var6, long var7);
    ...
    public static int nAdjustWindowRectEx(long _GetLastError, long lpRect, int dwStyle, int bMenu, int dwExStyle) {
        ...
        return User32.nAdjustWindowRectEx(_GetLastError, lpRect, dwStyle, bMenu, dwExStyle, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean AdjustWindowRectEx(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="LPRECT") RECT lpRect, @NativeType(value="DWORD") int dwStyle, @NativeType(value="BOOL") boolean bMenu, @NativeType(value="DWORD") int dwExStyle) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nAdjustWindowRectEx(MemoryUtil.memAddressSafe(_GetLastError), lpRect.address(), dwStyle, bMenu ? 1 : 0, dwExStyle) != 0;
    }

    public static native int nGetWindowRect(long var0, long var2, long var4, long var6);
    ...
    public static int nGetWindowRect(long _GetLastError, long hWnd, long lpRect) {
        ...
        return User32.nGetWindowRect(_GetLastError, hWnd, lpRect, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean GetWindowRect(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HWND") long hWnd, @NativeType(value="LPRECT") RECT lpRect) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nGetWindowRect(MemoryUtil.memAddressSafe(_GetLastError), hWnd, lpRect.address()) != 0;
    }

    public static native int nMoveWindow(long var0, long var2, int var4, int var5, int var6, int var7, int var8, long var9);
    ...
    public static int nMoveWindow(long _GetLastError, long hWnd, int X, int Y, int nWidth, int nHeight, int bRepaint) {
        ...
        return User32.nMoveWindow(_GetLastError, hWnd, X, Y, nWidth, nHeight, bRepaint, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean MoveWindow(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HWND") long hWnd, int X, int Y, int nWidth, int nHeight, @NativeType(value="BOOL") boolean bRepaint) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nMoveWindow(MemoryUtil.memAddressSafe(_GetLastError), hWnd, X, Y, nWidth, nHeight, bRepaint ? 1 : 0) != 0;
    }

    public static native int nGetWindowPlacement(long var0, long var2, long var4, long var6);
    ...
    public static int nGetWindowPlacement(long _GetLastError, long hWnd, long lpwndpl) {
        ...
        return User32.nGetWindowPlacement(_GetLastError, hWnd, lpwndpl, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean GetWindowPlacement(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HWND") long hWnd, @NativeType(value="WINDOWPLACEMENT *") WINDOWPLACEMENT lpwndpl) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nGetWindowPlacement(MemoryUtil.memAddressSafe(_GetLastError), hWnd, lpwndpl.address()) != 0;
    }

    public static native int nSetWindowPlacement(long var0, long var2, long var4, long var6);
    ...
    public static int nSetWindowPlacement(long _GetLastError, long hWnd, long lpwndpl) {
        ...
        return User32.nSetWindowPlacement(_GetLastError, hWnd, lpwndpl, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean SetWindowPlacement(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HWND") long hWnd, @NativeType(value="WINDOWPLACEMENT const *") WINDOWPLACEMENT lpwndpl) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nSetWindowPlacement(MemoryUtil.memAddressSafe(_GetLastError), hWnd, lpwndpl.address()) != 0;
    }
    ...
    public static native long nSetWindowLongPtr(long var0, long var2, int var4, long var5, long var7);
    ...
    public static long nSetWindowLongPtr(long _GetLastError, long hWnd, int nIndex, long dwNewLong) {
        ...
        return User32.nSetWindowLongPtr(_GetLastError, hWnd, nIndex, dwNewLong, __functionAddress);
    }

    @NativeType(value="LONG_PTR")
    public static long SetWindowLongPtr(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HWND") long hWnd, int nIndex, @NativeType(value="LONG_PTR") long dwNewLong) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nSetWindowLongPtr(MemoryUtil.memAddressSafe(_GetLastError), hWnd, nIndex, dwNewLong);
    }

    public static native long nGetWindowLongPtr(long var0, long var2, int var4, long var5);
    ...
    public static long nGetWindowLongPtr(long _GetLastError, long hWnd, int nIndex) {
        ...
        return User32.nGetWindowLongPtr(_GetLastError, hWnd, nIndex, __functionAddress);
    }

    @NativeType(value="LONG_PTR")
    public static long GetWindowLongPtr(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HWND") long hWnd, int nIndex) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nGetWindowLongPtr(MemoryUtil.memAddressSafe(_GetLastError), hWnd, nIndex);
    }

    public static native long nSetClassLongPtr(long var0, long var2, int var4, long var5, long var7);
    ...
    public static long nSetClassLongPtr(long _GetLastError, long hWnd, int nIndex, long dwNewLong) {
        ...
        return User32.nSetClassLongPtr(_GetLastError, hWnd, nIndex, dwNewLong, __functionAddress);
    }

    @NativeType(value="LONG_PTR")
    public static long SetClassLongPtr(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HWND") long hWnd, int nIndex, @NativeType(value="LONG_PTR") long dwNewLong) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nSetClassLongPtr(MemoryUtil.memAddressSafe(_GetLastError), hWnd, nIndex, dwNewLong);
    }

    public static native long nGetClassLongPtr(long var0, long var2, int var4, long var5);
    ...
    public static long nGetClassLongPtr(long _GetLastError, long hWnd, int nIndex) {
        ...
        return User32.nGetClassLongPtr(_GetLastError, hWnd, nIndex, __functionAddress);
    }

    @NativeType(value="LONG_PTR")
    public static long GetClassLongPtr(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HWND") long hWnd, int nIndex) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nGetClassLongPtr(MemoryUtil.memAddressSafe(_GetLastError), hWnd, nIndex);
    }

    public static native int nSetLayeredWindowAttributes(long var0, long var2, int var4, byte var5, int var6, long var7);
    ...
    public static int nSetLayeredWindowAttributes(long _GetLastError, long hwnd, int crKey, byte bAlpha, int dwFlags) {
        ...
        return User32.nSetLayeredWindowAttributes(_GetLastError, hwnd, crKey, bAlpha, dwFlags, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean SetLayeredWindowAttributes(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HWND") long hwnd, @NativeType(value="COLORREF") int crKey, @NativeType(value="BYTE") byte bAlpha, @NativeType(value="DWORD") int dwFlags) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nSetLayeredWindowAttributes(MemoryUtil.memAddressSafe(_GetLastError), hwnd, crKey, bAlpha, dwFlags) != 0;
    }

    public static native long nLoadIcon(long var0, long var2, long var4, long var6);

    public static long nLoadIcon(long _GetLastError, long instance, long iconName) {
        long __functionAddress = Functions.LoadIcon;
        return User32.nLoadIcon(_GetLastError, instance, iconName, __functionAddress);
    }

    @NativeType(value="HICON")
    public static long LoadIcon(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HINSTANCE") long instance, @NativeType(value="LPCTSTR") ByteBuffer iconName) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
            Checks.checkNT2(iconName);
        }
        return User32.nLoadIcon(MemoryUtil.memAddressSafe(_GetLastError), instance, MemoryUtil.memAddress(iconName));
    }
     ...
     */
    @NativeType(value="HICON")
    public static long LoadIcon(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HINSTANCE") long instance, @NativeType(value="LPCTSTR") CharSequence iconName) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        MemoryStack stack = MemoryStack.stackGet();
        ...
        try {
            ...
            long l = User32.nLoadIcon(MemoryUtil.memAddressSafe(_GetLastError), instance, iconNameEncoded);
            return l;
        }
        finally {
            stack.setPointer(stackPointer);
    ...
    public static native long nLoadCursor(long var0, long var2, long var4, long var6);
    ...
    public static long nLoadCursor(long _GetLastError, long instance, long cursorName) {
        ...
        return User32.nLoadCursor(_GetLastError, instance, cursorName, __functionAddress);
    }

    @NativeType(value="HCURSOR")
    public static long LoadCursor(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HINSTANCE") long instance, @NativeType(value="LPCTSTR") ByteBuffer cursorName) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
            Checks.checkNT2(cursorName);
        }
        return User32.nLoadCursor(MemoryUtil.memAddressSafe(_GetLastError), instance, MemoryUtil.memAddress(cursorName));
    }
     ...
     */
    @NativeType(value="HCURSOR")
    public static long LoadCursor(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HINSTANCE") long instance, @NativeType(value="LPCTSTR") CharSequence cursorName) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        MemoryStack stack = MemoryStack.stackGet();
        ...
        try {
            ...
            long l = User32.nLoadCursor(MemoryUtil.memAddressSafe(_GetLastError), instance, cursorNameEncoded);
            return l;
        }
        finally {
            stack.setPointer(stackPointer);
    ...
    public static native int nRegisterTouchWindow(long var0, long var2, int var4, long var5);
    ...
    public static int nRegisterTouchWindow(long _GetLastError, long hWnd, int ulFlags) {
        ...
        return User32.nRegisterTouchWindow(_GetLastError, hWnd, ulFlags, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean RegisterTouchWindow(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HWND") long hWnd, @NativeType(value="ULONG") int ulFlags) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nRegisterTouchWindow(MemoryUtil.memAddressSafe(_GetLastError), hWnd, ulFlags) != 0;
    }

    public static native int nUnregisterTouchWindow(long var0, long var2, long var4);
    ...
    public static int nUnregisterTouchWindow(long _GetLastError, long hWnd) {
        ...
        return User32.nUnregisterTouchWindow(_GetLastError, hWnd, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean UnregisterTouchWindow(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HWND") long hWnd) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nUnregisterTouchWindow(MemoryUtil.memAddressSafe(_GetLastError), hWnd) != 0;
    }
    ...
    @NativeType(value="BOOL")
    public static boolean IsTouchWindow(@NativeType(value="HWND") long hWnd, @NativeType(value="PULONG") @Nullable IntBuffer pulFlags) {
        if (Checks.CHECKS) {
    ...
    public static native int nGetTouchInputInfo(long var0, long var2, int var4, long var5, int var7, long var8);
    ...
    public static int nGetTouchInputInfo(long _GetLastError, long hTouchInput, int cInputs, long pInputs, int cbSize) {
        ...
        return User32.nGetTouchInputInfo(_GetLastError, hTouchInput, cInputs, pInputs, cbSize, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean GetTouchInputInfo(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HTOUCHINPUT") long hTouchInput, @NativeType(value="PTOUCHINPUT") TOUCHINPUT.Buffer pInputs, int cbSize) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nGetTouchInputInfo(MemoryUtil.memAddressSafe(_GetLastError), hTouchInput, pInputs.remaining(), pInputs.address(), cbSize) != 0;
    }

    public static native int nCloseTouchInputHandle(long var0, long var2, long var4);
    ...
    public static int nCloseTouchInputHandle(long _GetLastError, long hTouchInput) {
        ...
        return User32.nCloseTouchInputHandle(_GetLastError, hTouchInput, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean CloseTouchInputHandle(@NativeType(value="DWORD *") @Nullable IntBuffer _GetLastError, @NativeType(value="HTOUCHINPUT") long hTouchInput) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_GetLastError, 1);
        }
        return User32.nCloseTouchInputHandle(MemoryUtil.memAddressSafe(_GetLastError), hTouchInput) != 0;
    }
    ...
    @NativeType(value="BOOL")
    public static boolean EnumDisplayDevices(@NativeType(value="LPCTSTR") @Nullable ByteBuffer lpDevice, @NativeType(value="DWORD") int iDevNum, @NativeType(value="PDISPLAY_DEVICE") DISPLAY_DEVICE lpDisplayDevice, @NativeType(value="DWORD") int dwFlags) {
        if (Checks.CHECKS) {
     ...
     */
    @NativeType(value="BOOL")
    public static boolean EnumDisplayDevices(@NativeType(value="LPCTSTR") @Nullable CharSequence lpDevice, @NativeType(value="DWORD") int iDevNum, @NativeType(value="PDISPLAY_DEVICE") DISPLAY_DEVICE lpDisplayDevice, @NativeType(value="DWORD") int dwFlags) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
    ...
    @NativeType(value="BOOL")
    public static boolean EnumDisplaySettingsEx(@NativeType(value="LPCTSTR") @Nullable ByteBuffer lpszDeviceName, @NativeType(value="DWORD") int iModeNum, @NativeType(value="DEVMODE *") DEVMODE lpDevMode, @NativeType(value="DWORD") int dwFlags) {
        if (Checks.CHECKS) {
     ...
     */
    @NativeType(value="BOOL")
    public static boolean EnumDisplaySettingsEx(@NativeType(value="LPCTSTR") @Nullable CharSequence lpszDeviceName, @NativeType(value="DWORD") int iModeNum, @NativeType(value="DEVMODE *") DEVMODE lpDevMode, @NativeType(value="DWORD") int dwFlags) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
    ...
    public static int ChangeDisplaySettingsEx(@NativeType(value="LPCTSTR") @Nullable ByteBuffer lpszDeviceName, @NativeType(value="DEVMODE *") @Nullable DEVMODE lpDevMode, @NativeType(value="HWND") long hwnd, @NativeType(value="DWORD") int dwflags, @NativeType(value="LPVOID") long lParam) {
        if (Checks.CHECKS) {
            Checks.checkNT2Safe(lpszDeviceName);
        }
     ...
     */
    @NativeType(value="LONG")
    public static int ChangeDisplaySettingsEx(@NativeType(value="LPCTSTR") @Nullable CharSequence lpszDeviceName, @NativeType(value="DEVMODE *") @Nullable DEVMODE lpDevMode, @NativeType(value="HWND") long hwnd, @NativeType(value="DWORD") int dwflags, @NativeType(value="LPVOID") long lParam) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            stack.nUTF16Safe(lpszDeviceName, true);
    ...
    @NativeType(value="BOOL")
    public static boolean ClipCursor(@NativeType(value="RECT const *") @Nullable RECT rect) {
    ...
    @NativeType(value="BOOL")
    public static boolean IsTouchWindow(@NativeType(value="HWND") long hWnd, @NativeType(value="PULONG") int @Nullable [] pulFlags) {
        long __functionAddress = Functions.IsTouchWindow;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(hWnd);
    ...
    public static long GetWindowLongPtr(@NativeType(value="HWND") long hWnd, int nIndex) {
        return User32.nGetWindowLongPtr(0L, hWnd, nIndex);
    }
