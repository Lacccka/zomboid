...
extends CallbackI {
    ...
    default public void callback(long ret, long args2) {
        boolean __result = this.invoke(MemoryUtil.memGetAddress(MemoryUtil.memGetAddress(args2)), MemoryUtil.memGetAddress(MemoryUtil.memGetAddress(args2 + (long)POINTER_SIZE)), MemoryUtil.memGetAddress(MemoryUtil.memGetAddress(args2 + (long)(2 * POINTER_SIZE))), MemoryUtil.memGetByte(MemoryUtil.memGetAddress(args2 + (long)(3 * POINTER_SIZE))) != 0, MemoryUtil.memGetInt(MemoryUtil.memGetAddress(args2 + (long)(4 * POINTER_SIZE))));
