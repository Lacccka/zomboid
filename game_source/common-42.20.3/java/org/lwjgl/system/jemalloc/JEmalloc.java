...
public class JEmalloc {
    ...
    public static @Nullable ByteBuffer je_malloc(@NativeType(value="size_t") long size) {
    ...
    @NativeType(value="void *")
    public static @Nullable ByteBuffer je_calloc(@NativeType(value="size_t") long num, @NativeType(value="size_t") long size) {
    ...
    @NativeType(value="void *")
    public static @Nullable ByteBuffer je_aligned_alloc(@NativeType(value="size_t") long alignment, @NativeType(value="size_t") long size) {
    ...
    @NativeType(value="void *")
    public static @Nullable ByteBuffer je_realloc(@NativeType(value="void *") @Nullable ByteBuffer ptr, @NativeType(value="size_t") long size) {
    ...
    public static void je_free(@NativeType(value="void *") @Nullable ByteBuffer ptr) {
        JEmalloc.nje_free(MemoryUtil.memAddressSafe(ptr));
    }

    public static void je_free(@NativeType(value="void *") @Nullable ShortBuffer ptr) {
        JEmalloc.nje_free(MemoryUtil.memAddressSafe(ptr));
    }

    public static void je_free(@NativeType(value="void *") @Nullable IntBuffer ptr) {
        JEmalloc.nje_free(MemoryUtil.memAddressSafe(ptr));
    }

    public static void je_free(@NativeType(value="void *") @Nullable LongBuffer ptr) {
        JEmalloc.nje_free(MemoryUtil.memAddressSafe(ptr));
    }

    public static void je_free(@NativeType(value="void *") @Nullable FloatBuffer ptr) {
        JEmalloc.nje_free(MemoryUtil.memAddressSafe(ptr));
    }

    public static void je_free(@NativeType(value="void *") @Nullable DoubleBuffer ptr) {
        JEmalloc.nje_free(MemoryUtil.memAddressSafe(ptr));
    }

    public static void je_free(@NativeType(value="void *") @Nullable PointerBuffer ptr) {
        JEmalloc.nje_free(MemoryUtil.memAddressSafe(ptr));
    }
    ...
    public static void je_free_sized(@NativeType(value="void *") @Nullable ByteBuffer ptr) {
        JEmalloc.nje_free_sized(MemoryUtil.memAddressSafe(ptr), Checks.remainingSafe(ptr));
    }

    public static void je_free_sized(@NativeType(value="void *") @Nullable ShortBuffer ptr) {
        JEmalloc.nje_free_sized(MemoryUtil.memAddressSafe(ptr), Integer.toUnsignedLong(Checks.remainingSafe(ptr)) << 1);
    }

    public static void je_free_sized(@NativeType(value="void *") @Nullable IntBuffer ptr) {
        JEmalloc.nje_free_sized(MemoryUtil.memAddressSafe(ptr), Integer.toUnsignedLong(Checks.remainingSafe(ptr)) << 2);
    }

    public static void je_free_sized(@NativeType(value="void *") @Nullable LongBuffer ptr) {
        JEmalloc.nje_free_sized(MemoryUtil.memAddressSafe(ptr), Integer.toUnsignedLong(Checks.remainingSafe(ptr)) << 3);
    }

    public static void je_free_sized(@NativeType(value="void *") @Nullable FloatBuffer ptr) {
        JEmalloc.nje_free_sized(MemoryUtil.memAddressSafe(ptr), Integer.toUnsignedLong(Checks.remainingSafe(ptr)) << 2);
    }

    public static void je_free_sized(@NativeType(value="void *") @Nullable DoubleBuffer ptr) {
        JEmalloc.nje_free_sized(MemoryUtil.memAddressSafe(ptr), Integer.toUnsignedLong(Checks.remainingSafe(ptr)) << 3);
    }

    public static void je_free_sized(@NativeType(value="void *") @Nullable PointerBuffer ptr) {
    ...
    public static void je_free_aligned_sized(@NativeType(value="void *") @Nullable ByteBuffer ptr, @NativeType(value="size_t") long alignment) {
        JEmalloc.nje_free_aligned_sized(MemoryUtil.memAddressSafe(ptr), alignment, Checks.remainingSafe(ptr));
    }

    public static void je_free_aligned_sized(@NativeType(value="void *") @Nullable ShortBuffer ptr, @NativeType(value="size_t") long alignment) {
    ...
    public static void je_free_aligned_sized(@NativeType(value="void *") @Nullable IntBuffer ptr, @NativeType(value="size_t") long alignment) {
    ...
    public static void je_free_aligned_sized(@NativeType(value="void *") @Nullable LongBuffer ptr, @NativeType(value="size_t") long alignment) {
    ...
    public static void je_free_aligned_sized(@NativeType(value="void *") @Nullable FloatBuffer ptr, @NativeType(value="size_t") long alignment) {
        JEmalloc.nje_free_aligned_sized(MemoryUtil.memAddressSafe(ptr), alignment, Integer.toUnsignedLong(Checks.remainingSafe(ptr)) << 2);
    }

    public static void je_free_aligned_sized(@NativeType(value="void *") @Nullable DoubleBuffer ptr, @NativeType(value="size_t") long alignment) {
        JEmalloc.nje_free_aligned_sized(MemoryUtil.memAddressSafe(ptr), alignment, Integer.toUnsignedLong(Checks.remainingSafe(ptr)) << 3);
    }

    public static void je_free_aligned_sized(@NativeType(value="void *") @Nullable PointerBuffer ptr, @NativeType(value="size_t") long alignment) {
    ...
    @NativeType(value="void *")
    public static @Nullable ByteBuffer je_mallocx(@NativeType(value="size_t") long size, int flags) {
    ...
    @NativeType(value="void *")
    public static @Nullable ByteBuffer je_rallocx(@NativeType(value="void *") @Nullable ByteBuffer ptr, @NativeType(value="size_t") long size, int flags) {
    ...
    public static long je_xallocx(@NativeType(value="void *") @Nullable ByteBuffer ptr, @NativeType(value="size_t") long size, @NativeType(value="size_t") long extra, int flags) {
    ...
    @NativeType(value="void *")
    public static @Nullable ByteBuffer je_nallocx(@NativeType(value="size_t") long size, int flags) {
    ...
    public static int je_mallctl(@NativeType(value="char const *") ByteBuffer name, @NativeType(value="void *") @Nullable ByteBuffer oldp, @NativeType(value="size_t *") @Nullable PointerBuffer oldlenp, @NativeType(value="void *") @Nullable ByteBuffer newp) {
        if (Checks.CHECKS) {
     ...
     */
    public static int je_mallctl(@NativeType(value="char const *") CharSequence name, @NativeType(value="void *") @Nullable ByteBuffer oldp, @NativeType(value="size_t *") @Nullable PointerBuffer oldlenp, @NativeType(value="void *") @Nullable ByteBuffer newp) {
        if (Checks.CHECKS) {
            Checks.checkSafe(oldlenp, 1);
        }
    ...
    public static int je_mallctlbymib(@NativeType(value="size_t const *") PointerBuffer mib, @NativeType(value="void *") @Nullable ByteBuffer oldp, @NativeType(value="size_t *") @Nullable PointerBuffer oldlenp, @NativeType(value="void *") @Nullable ByteBuffer newp) {
        if (Checks.CHECKS) {
            Checks.checkSafe(oldlenp, 1);
        }
    ...
    public static void je_malloc_stats_print(@NativeType(value="void (*) (void *, char const *)") @Nullable MallocMessageCallbackI write_cb, @NativeType(value="void *") long cbopaque, @NativeType(value="char const *") @Nullable ByteBuffer opts) {
        if (Checks.CHECKS) {
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void je_malloc_stats_print(@NativeType(value="void (*) (void *, char const *)") @Nullable MallocMessageCallbackI write_cb, @NativeType(value="void *") long cbopaque, @NativeType(value="char const *") @Nullable CharSequence opts) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
