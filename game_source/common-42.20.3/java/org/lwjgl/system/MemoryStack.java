...
implements AutoCloseable {
    ...
    public ByteBuffer malloc(int alignment, int size) {
        ...
        return MemoryUtil.wrapBufferByte(this.nmalloc(alignment, size), size);
    }
    ...
    public ByteBuffer calloc(int alignment, int size) {
        ...
        return MemoryUtil.wrapBufferByte(this.ncalloc(alignment, size, 1), size);
    }

    public ByteBuffer malloc(int size) {
        return MemoryUtil.wrapBufferByte(this.nmalloc(POINTER_SIZE, size), size);
    }

    public ByteBuffer calloc(int size) {
        return MemoryUtil.wrapBufferByte(this.ncalloc(POINTER_SIZE, size, 1), size);
    }
    ...
    public ShortBuffer mallocShort(int size) {
        return MemoryUtil.wrapBufferShort(this.nmalloc(2, size << 1), size);
    }
    ...
    public IntBuffer mallocInt(int size) {
        return MemoryUtil.wrapBufferInt(this.nmalloc(4, size << 2), size);
    }
    ...
    public LongBuffer mallocLong(int size) {
        return MemoryUtil.wrapBufferLong(this.nmalloc(8, size << 3), size);
    }
    ...
    public FloatBuffer mallocFloat(int size) {
        return MemoryUtil.wrapBufferFloat(this.nmalloc(4, size << 2), size);
    }
    ...
    public DoubleBuffer mallocDouble(int size) {
        return MemoryUtil.wrapBufferDouble(this.nmalloc(8, size << 3), size);
    }
