...
public class DynamicLinkLoader {
    ...
    public static long dlopen(@NativeType(value="char const *") @Nullable ByteBuffer filename, int mode) {
        if (Checks.CHECKS) {
     ...
     */
    @NativeType(value="void *")
    public static long dlopen(@NativeType(value="char const *") @Nullable CharSequence filename, int mode) {
