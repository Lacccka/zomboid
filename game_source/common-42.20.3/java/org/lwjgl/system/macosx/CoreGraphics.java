...
public class CoreGraphics {
    ...
    public static long CGEventCreate(@NativeType(value="CGEventSourceRef") long source2) {
        long __functionAddress = Functions.EventCreate;
        return JNI.invokePP(source2, __functionAddress);
    }
    ...
    public static long nCGEventCreateMouseEvent(long source2, int mouseType, long mouseCursorPosition, int mouseButton) {
        long __functionAddress = Functions.EventCreateMouseEvent;
        return CoreGraphics.nCGEventCreateMouseEvent(source2, mouseType, mouseCursorPosition, mouseButton, __functionAddress);
    }

    @NativeType(value="CGEventRef")
    public static long CGEventCreateMouseEvent(@NativeType(value="CGEventSourceRef") long source2, @NativeType(value="CGEventType") int mouseType, CGPoint mouseCursorPosition, @NativeType(value="CGMouseButton") int mouseButton) {
        return CoreGraphics.nCGEventCreateMouseEvent(source2, mouseType, mouseCursorPosition.address(), mouseButton);
    }

    @NativeType(value="CGEventRef")
    public static long CGEventCreateKeyboardEvent(@NativeType(value="CGEventSourceRef") long source2, @NativeType(value="CGKeyCode") short virtualKey, @NativeType(value="bool") boolean keyDown) {
        long __functionAddress = Functions.EventCreateKeyboardEvent;
        return JNI.invokePCP(source2, virtualKey, keyDown, __functionAddress);
    }

    @NativeType(value="CGEventRef")
    public static long CGEventCreateScrollWheelEvent(@NativeType(value="CGEventSourceRef") long source2, @NativeType(value="CGScrollEventUnit") int units, @NativeType(value="uint32_t") int wheelCount, @NativeType(value="int32_t") int wheel1) {
        long __functionAddress = Functions.EventCreateScrollWheelEvent;
        return JNI.invokePP(source2, units, wheelCount, wheel1, __functionAddress);
    }

    @NativeType(value="CGEventRef")
    public static long CGEventCreateScrollWheelEvent(@NativeType(value="CGEventSourceRef") long source2, @NativeType(value="CGScrollEventUnit") int units, @NativeType(value="int32_t") int wheel1) {
        long __functionAddress = Functions.EventCreateScrollWheelEvent;
        return JNI.invokePP(source2, units, 1, wheel1, __functionAddress);
    }

    @NativeType(value="CGEventRef")
    public static long CGEventCreateScrollWheelEvent2(@NativeType(value="CGEventSourceRef") long source2, @NativeType(value="CGScrollEventUnit") int units, @NativeType(value="uint32_t") int wheelCount, @NativeType(value="int32_t") int wheel1, @NativeType(value="int32_t") int wheel2, @NativeType(value="int32_t") int wheel3) {
        long __functionAddress = Functions.EventCreateScrollWheelEvent2;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
        }
        return JNI.invokePP(source2, units, wheelCount, wheel1, wheel2, wheel3, __functionAddress);
    }
    ...
    public static void CGEventSetSource(@NativeType(value="CGEventRef") long event, @NativeType(value="CGEventSourceRef") long source2) {
        long __functionAddress = Functions.EventSetSource;
        JNI.invokePPV(event, source2, __functionAddress);
    }
    ...
    public static void CGEventKeyboardGetUnicodeString(@NativeType(value="CGEventRef") long event, @NativeType(value="UniCharCount *") @Nullable CLongBuffer actualStringLength, @NativeType(value="UniChar *") @Nullable ShortBuffer unicodeString) {
        if (Checks.CHECKS) {
    ...
    public static int CGGetEventTapList(@NativeType(value="CGEventTapInformation *") @Nullable CGEventTapInformation.Buffer tapList, @NativeType(value="uint32_t *") @Nullable IntBuffer eventTapCount) {
        if (Checks.CHECKS) {
    ...
    public static void CGEventKeyboardGetUnicodeString(@NativeType(value="CGEventRef") long event, @NativeType(value="UniCharCount *") @Nullable CLongBuffer actualStringLength, @NativeType(value="UniChar *") short @Nullable [] unicodeString) {
        long __functionAddress = Functions.EventKeyboardGetUnicodeString;
        if (Checks.CHECKS) {
            Checks.checkSafe(actualStringLength, 1);
        }
    ...
    @NativeType(value="CGError")
    public static int CGGetEventTapList(@NativeType(value="CGEventTapInformation *") @Nullable CGEventTapInformation.Buffer tapList, @NativeType(value="uint32_t *") int @Nullable [] eventTapCount) {
        long __functionAddress = Functions.GetEventTapList;
        if (Checks.CHECKS) {
    ...
    public static final class Functions {
        ...
        public static final long EventTapCreateForPid = APIUtil.apiGetFunctionAddress(CoreGraphics.access$000(), "CGEventTapCreateForPid");
        ...
        public static final long EventPostToPid = APIUtil.apiGetFunctionAddress(CoreGraphics.access$000(), "CGEventPostToPid");
