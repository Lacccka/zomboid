...
public class ObjCRuntime {
    ...
    public static @Nullable String object_getClassName(@NativeType(value="id") long obj) {
    ...
    public static int objc_getClassList(@NativeType(value="Class *") @Nullable PointerBuffer buffer) {
    ...
    @NativeType(value="char const *")
    public static @Nullable String class_getName(@NativeType(value="Class") long cls) {
     ...
     */
    @NativeType(value="Ivar *")
    public static @Nullable PointerBuffer class_copyIvarList(@NativeType(value="Class") long cls) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        IntBuffer outCount = stack.callocInt(1);
        try {
     ...
     */
    @NativeType(value="Method *")
    public static @Nullable PointerBuffer class_copyMethodList(@NativeType(value="Class") long cls) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        IntBuffer outCount = stack.callocInt(1);
        try {
    ...
    public static @Nullable PointerBuffer class_copyProtocolList(@NativeType(value="Class") long cls) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        IntBuffer outCount = stack.callocInt(1);
        try {
     ...
     */
    @NativeType(value="objc_property_t *")
    public static @Nullable PointerBuffer class_copyPropertyList(@NativeType(value="Class") long cls) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        IntBuffer outCount = stack.callocInt(1);
        try {
    ...
    public static @Nullable String class_getIvarLayout(@NativeType(value="Class") long cls) {
    ...
    @NativeType(value="uint8_t const *")
    public static @Nullable String class_getWeakIvarLayout(@NativeType(value="Class") long cls) {
    ...
    @NativeType(value="id")
    public static long objc_constructInstance(@NativeType(value="Class") long cls, @NativeType(value="void *") @Nullable ByteBuffer bytes) {
    ...
    @NativeType(value="char const *")
    public static @Nullable String method_getTypeEncoding(@NativeType(value="Method") long m) {
    ...
    public static @Nullable String method_copyReturnType(@NativeType(value="Method") long m) {
     ...
     */
    @NativeType(value="char *")
    public static @Nullable String method_copyArgumentType(@NativeType(value="Method") long m, @NativeType(value="unsigned int") int index) {
        long __result = 0L;
        try {
    ...
    @NativeType(value="char const *")
    public static @Nullable String ivar_getName(@NativeType(value="Ivar") long v) {
    ...
    @NativeType(value="char const *")
    public static @Nullable String ivar_getTypeEncoding(@NativeType(value="Ivar") long v) {
    ...
    @NativeType(value="char const *")
    public static @Nullable String property_getName(@NativeType(value="objc_property_t") long property) {
    ...
    @NativeType(value="char const *")
    public static @Nullable String property_getAttributes(@NativeType(value="objc_property_t") long property) {
    ...
    public static @Nullable ObjCPropertyAttribute.Buffer property_copyAttributeList(@NativeType(value="objc_property_t") long property) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        IntBuffer outCount = stack.callocInt(1);
        try {
     ...
     */
    @NativeType(value="char *")
    public static @Nullable String property_copyAttributeValue(@NativeType(value="objc_property_t") long property, @NativeType(value="char const *") ByteBuffer attributeName) {
        if (Checks.CHECKS) {
     ...
     */
    @NativeType(value="char *")
    public static @Nullable String property_copyAttributeValue(@NativeType(value="objc_property_t") long property, @NativeType(value="char const *") CharSequence attributeName) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        long __result = 0L;
        try {
    ...
    @NativeType(value="char const *")
    public static @Nullable String protocol_getName(@NativeType(value="Protocol *") long p) {
     ...
     */
    @NativeType(value="struct objc_method_description *")
    public static @Nullable ObjCMethodDescription.Buffer protocol_copyMethodDescriptionList(@NativeType(value="Protocol *") long p, @NativeType(value="BOOL") boolean isRequiredMethod, @NativeType(value="BOOL") boolean isInstanceMethod) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        IntBuffer outCount = stack.callocInt(1);
        try {
     ...
     */
    @NativeType(value="objc_property_t *")
    public static @Nullable PointerBuffer protocol_copyPropertyList(@NativeType(value="Protocol *") long proto) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        IntBuffer outCount = stack.callocInt(1);
        try {
     ...
     */
    @NativeType(value="Protocol **")
    public static @Nullable PointerBuffer protocol_copyProtocolList(@NativeType(value="Protocol *") long proto) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        IntBuffer outCount = stack.callocInt(1);
        try {
    ...
    @NativeType(value="char const *")
    public static @Nullable String class_getImageName(@NativeType(value="Class") long cls) {
     ...
     */
    @NativeType(value="char const **")
    public static @Nullable PointerBuffer objc_copyClassNamesForImage(@NativeType(value="char const *") ByteBuffer image) {
        if (Checks.CHECKS) {
     ...
     */
    @NativeType(value="char const **")
    public static @Nullable PointerBuffer objc_copyClassNamesForImage(@NativeType(value="char const *") CharSequence image) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            IntBuffer outCount = stack.callocInt(1);
    ...
    @NativeType(value="char const *")
    public static @Nullable String sel_getName(@NativeType(value="SEL") long sel) {
    ...
    @NativeType(value="id")
    public static long objc_loadWeak(@NativeType(value="id *") @Nullable PointerBuffer location) {
        if (Checks.CHECKS) {
