...
public class DynamicLinkLoader {
    ...
    public static long dlopen(@NativeType(value="char const *") @Nullable ByteBuffer path, int mode) {
        if (Checks.CHECKS) {
     ...
     */
    @NativeType(value="void *")
    public static long dlopen(@NativeType(value="char const *") @Nullable CharSequence path, int mode) {
