...
implements NativeResource {
    ...
    public static int nrequest(long struct) {
        return MemoryUtil.memGetInt(struct + (long)REQUEST);
    }

    public static int nfirst_keycode(long struct) {
        return MemoryUtil.memGetInt(struct + (long)FIRST_KEYCODE);
    }
    ...
    public static void nrequest(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)REQUEST, value);
    }

    public static void nfirst_keycode(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)FIRST_KEYCODE, value);
    }
