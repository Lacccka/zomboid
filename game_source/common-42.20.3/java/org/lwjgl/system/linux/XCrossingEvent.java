...
implements NativeResource {
    ...
    public static int nx_root(long struct) {
        return MemoryUtil.memGetInt(struct + (long)X_ROOT);
    }

    public static int ny_root(long struct) {
        return MemoryUtil.memGetInt(struct + (long)Y_ROOT);
    }
    ...
    public static int ndetail(long struct) {
        return MemoryUtil.memGetInt(struct + (long)DETAIL);
    }

    public static int nsame_screen(long struct) {
        return MemoryUtil.memGetInt(struct + (long)SAME_SCREEN);
    }

    public static int nfocus(long struct) {
        return MemoryUtil.memGetInt(struct + (long)FOCUS);
    }
    ...
    public static void nx_root(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)X_ROOT, value);
    }

    public static void ny_root(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)Y_ROOT, value);
    }
    ...
    public static void ndetail(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)DETAIL, value);
    }

    public static void nsame_screen(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)SAME_SCREEN, value);
    }

    public static void nfocus(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)FOCUS, value);
    }
