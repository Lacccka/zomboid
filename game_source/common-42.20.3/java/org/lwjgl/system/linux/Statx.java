...
implements NativeResource {
    ...
    public static int nstx_mask(long struct) {
        return MemoryUtil.memGetInt(struct + (long)STX_MASK);
    }

    public static int nstx_blksize(long struct) {
        return MemoryUtil.memGetInt(struct + (long)STX_BLKSIZE);
    }

    public static long nstx_attributes(long struct) {
        return MemoryUtil.memGetLong(struct + (long)STX_ATTRIBUTES);
    }

    public static int nstx_nlink(long struct) {
        return MemoryUtil.memGetInt(struct + (long)STX_NLINK);
    }

    public static int nstx_uid(long struct) {
        return MemoryUtil.memGetInt(struct + (long)STX_UID);
    }

    public static int nstx_gid(long struct) {
        return MemoryUtil.memGetInt(struct + (long)STX_GID);
    }

    public static short nstx_mode(long struct) {
        return MemoryUtil.memGetShort(struct + (long)STX_MODE);
    }
    ...
    public static short n__spare0(long struct, int index) {
        return MemoryUtil.memGetShort(struct + (long)__SPARE0 + Checks.check(index, 1) * 2L);
    }

    public static long nstx_ino(long struct) {
        return MemoryUtil.memGetLong(struct + (long)STX_INO);
    }

    public static long nstx_size(long struct) {
        return MemoryUtil.memGetLong(struct + (long)STX_SIZE);
    }

    public static long nstx_blocks(long struct) {
        return MemoryUtil.memGetLong(struct + (long)STX_BLOCKS);
    }

    public static long nstx_attributes_mask(long struct) {
        return MemoryUtil.memGetLong(struct + (long)STX_ATTRIBUTES_MASK);
    }
    ...
    public static int nstx_rdev_major(long struct) {
        return MemoryUtil.memGetInt(struct + (long)STX_RDEV_MAJOR);
    }

    public static int nstx_rdev_minor(long struct) {
        return MemoryUtil.memGetInt(struct + (long)STX_RDEV_MINOR);
    }

    public static int nstx_dev_major(long struct) {
        return MemoryUtil.memGetInt(struct + (long)STX_DEV_MAJOR);
    }

    public static int nstx_dev_minor(long struct) {
        return MemoryUtil.memGetInt(struct + (long)STX_DEV_MINOR);
    }

    public static long nstx_mnt_id(long struct) {
        return MemoryUtil.memGetLong(struct + (long)STX_MNT_ID);
    }

    public static long n__spare2(long struct) {
        return MemoryUtil.memGetLong(struct + (long)__SPARE2);
    }
    ...
    public static long n__spare3(long struct, int index) {
        return MemoryUtil.memGetLong(struct + (long)__SPARE3 + Checks.check(index, 12) * 8L);
    }

    public static void nstx_mask(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)STX_MASK, value);
    }

    public static void nstx_blksize(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)STX_BLKSIZE, value);
    }

    public static void nstx_attributes(long struct, long value) {
        MemoryUtil.memPutLong(struct + (long)STX_ATTRIBUTES, value);
    }

    public static void nstx_nlink(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)STX_NLINK, value);
    }

    public static void nstx_uid(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)STX_UID, value);
    }

    public static void nstx_gid(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)STX_GID, value);
    }

    public static void nstx_mode(long struct, short value) {
        MemoryUtil.memPutShort(struct + (long)STX_MODE, value);
    }
    ...
    public static void n__spare0(long struct, int index, short value) {
        MemoryUtil.memPutShort(struct + (long)__SPARE0 + Checks.check(index, 1) * 2L, value);
    }

    public static void nstx_ino(long struct, long value) {
        MemoryUtil.memPutLong(struct + (long)STX_INO, value);
    }

    public static void nstx_size(long struct, long value) {
        MemoryUtil.memPutLong(struct + (long)STX_SIZE, value);
    }

    public static void nstx_blocks(long struct, long value) {
        MemoryUtil.memPutLong(struct + (long)STX_BLOCKS, value);
    }

    public static void nstx_attributes_mask(long struct, long value) {
        MemoryUtil.memPutLong(struct + (long)STX_ATTRIBUTES_MASK, value);
    }
    ...
    public static void nstx_rdev_major(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)STX_RDEV_MAJOR, value);
    }

    public static void nstx_rdev_minor(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)STX_RDEV_MINOR, value);
    }

    public static void nstx_dev_major(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)STX_DEV_MAJOR, value);
    }

    public static void nstx_dev_minor(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)STX_DEV_MINOR, value);
    }

    public static void nstx_mnt_id(long struct, long value) {
        MemoryUtil.memPutLong(struct + (long)STX_MNT_ID, value);
    }

    public static void n__spare2(long struct, long value) {
        MemoryUtil.memPutLong(struct + (long)__SPARE2, value);
    }
    ...
    public static void n__spare3(long struct, int index, long value) {
        MemoryUtil.memPutLong(struct + (long)__SPARE3 + Checks.check(index, 12) * 8L, value);
    }
