...
public class X11 {
    ...
    public static long XOpenDisplay(@NativeType(value="char const *") @Nullable ByteBuffer display_name) {
        if (Checks.CHECKS) {
     ...
     */
    @NativeType(value="Display *")
    public static long XOpenDisplay(@NativeType(value="char const *") @Nullable CharSequence display_name) {
    ...
    public static @Nullable XTimeCoord.Buffer XGetMotionEvents(@NativeType(value="Display *") long display, @NativeType(value="Window") long w, @NativeType(value="Time") long start, @NativeType(value="Time") long stop) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
