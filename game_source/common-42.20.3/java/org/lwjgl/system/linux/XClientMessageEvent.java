...
implements NativeResource {
    ...
    public static byte ndata_b(long struct, int index) {
        return MemoryUtil.memGetByte(struct + (long)DATA_B + Checks.check(index, 20) * 1L);
    }
    ...
    public static short ndata_s(long struct, int index) {
        return MemoryUtil.memGetShort(struct + (long)DATA_S + Checks.check(index, 10) * 2L);
    }
    ...
    public static void ndata_b(long struct, int index, byte value) {
        MemoryUtil.memPutByte(struct + (long)DATA_B + Checks.check(index, 20) * 1L, value);
    }
    ...
    public static void ndata_s(long struct, int index, short value) {
        MemoryUtil.memPutShort(struct + (long)DATA_S + Checks.check(index, 10) * 2L, value);
    }
