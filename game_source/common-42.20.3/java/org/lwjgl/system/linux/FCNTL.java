...
public class FCNTL {
    ...
    public static native int nopen(long var0, long var2, int var4, int var5);

    public static int open(@NativeType(value="int *") @Nullable IntBuffer _errno, @NativeType(value="char const *") ByteBuffer pathname, int flags, @NativeType(value="mode_t") int mode) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_errno, 1);
            Checks.checkNT1(pathname);
        }
        return FCNTL.nopen(MemoryUtil.memAddressSafe(_errno), MemoryUtil.memAddress(pathname), flags, mode);
    }

    /*
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static int open(@NativeType(value="int *") @Nullable IntBuffer _errno, @NativeType(value="char const *") CharSequence pathname, int flags, @NativeType(value="mode_t") int mode) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_errno, 1);
        }
        ...
        try {
            ...
            int n = FCNTL.nopen(MemoryUtil.memAddressSafe(_errno), pathnameEncoded, flags, mode);
            return n;
        }
        finally {
    ...
    public static native int nopenat(long var0, int var2, long var3, int var5, int var6);

    public static int openat(@NativeType(value="int *") @Nullable IntBuffer _errno, int dirfd, @NativeType(value="char const *") ByteBuffer pathname, int flags, @NativeType(value="mode_t") int mode) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_errno, 1);
            Checks.checkNT1(pathname);
        }
        return FCNTL.nopenat(MemoryUtil.memAddressSafe(_errno), dirfd, MemoryUtil.memAddress(pathname), flags, mode);
    }

    /*
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static int openat(@NativeType(value="int *") @Nullable IntBuffer _errno, int dirfd, @NativeType(value="char const *") CharSequence pathname, int flags, @NativeType(value="mode_t") int mode) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_errno, 1);
        }
        MemoryStack stack = MemoryStack.stackGet();
        ...
        try {
            stack.nUTF8(pathname, true);
            long pathnameEncoded = stack.getPointerAddress();
            int n = FCNTL.nopenat(MemoryUtil.memAddressSafe(_errno), dirfd, pathnameEncoded, flags, mode);
            return n;
        }
        finally {
            stack.setPointer(stackPointer);
    ...
    public static native int ncreat(long var0, long var2, int var4);

    public static int creat(@NativeType(value="int *") @Nullable IntBuffer _errno, @NativeType(value="char const *") ByteBuffer pathname, @NativeType(value="mode_t") int mode) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_errno, 1);
            Checks.checkNT1(pathname);
        }
        return FCNTL.ncreat(MemoryUtil.memAddressSafe(_errno), MemoryUtil.memAddress(pathname), mode);
    }

    /*
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static int creat(@NativeType(value="int *") @Nullable IntBuffer _errno, @NativeType(value="char const *") CharSequence pathname, @NativeType(value="mode_t") int mode) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_errno, 1);
        }
        MemoryStack stack = MemoryStack.stackGet();
        ...
        try {
            stack.nUTF8(pathname, true);
            long pathnameEncoded = stack.getPointerAddress();
            int n = FCNTL.ncreat(MemoryUtil.memAddressSafe(_errno), pathnameEncoded, mode);
            return n;
        }
        finally {
            stack.setPointer(stackPointer);
    ...
    public static native int nfcntl(long var0, int var2, int var3);

    public static int fcntl(@NativeType(value="int *") @Nullable IntBuffer _errno, int fd, int cmd) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_errno, 1);
        }
        return FCNTL.nfcntl(MemoryUtil.memAddressSafe(_errno), fd, cmd);
    }

    public static native int nfcntli(long var0, int var2, int var3, int var4);

    public static int fcntli(@NativeType(value="int *") @Nullable IntBuffer _errno, int fd, int cmd, int arg) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_errno, 1);
        }
        return FCNTL.nfcntli(MemoryUtil.memAddressSafe(_errno), fd, cmd, arg);
    }

    public static native int nfcntlp(long var0, int var2, int var3, long var4);

    public static int fcntlp(@NativeType(value="int *") @Nullable IntBuffer _errno, int fd, int cmd, @NativeType(value="void *") long arg) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)_errno, 1);
            Checks.check(arg);
        }
        return FCNTL.nfcntlp(MemoryUtil.memAddressSafe(_errno), fd, cmd, arg);
    }
