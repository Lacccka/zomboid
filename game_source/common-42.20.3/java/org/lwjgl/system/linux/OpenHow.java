...
implements NativeResource {
    ...
    public static long nmode(long struct) {
        return MemoryUtil.memGetLong(struct + (long)MODE);
    }

    public static long nresolve(long struct) {
        return MemoryUtil.memGetLong(struct + (long)RESOLVE);
    }
    ...
    public static void nmode(long struct, long value) {
        MemoryUtil.memPutLong(struct + (long)MODE, value);
    }

    public static void nresolve(long struct, long value) {
        MemoryUtil.memPutLong(struct + (long)RESOLVE, value);
    }
