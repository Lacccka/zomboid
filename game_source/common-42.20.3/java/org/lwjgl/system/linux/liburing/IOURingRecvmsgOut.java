...
implements NativeResource {
    ...
    public static int nnamelen(long struct) {
        return MemoryUtil.memGetInt(struct + (long)NAMELEN);
    }

    public static int ncontrollen(long struct) {
        return MemoryUtil.memGetInt(struct + (long)CONTROLLEN);
    }

    public static int npayloadlen(long struct) {
        return MemoryUtil.memGetInt(struct + (long)PAYLOADLEN);
    }
    ...
    public static void nnamelen(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)NAMELEN, value);
    }

    public static void ncontrollen(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)CONTROLLEN, value);
    }

    public static void npayloadlen(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)PAYLOADLEN, value);
    }
