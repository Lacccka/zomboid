...
import org.lwjgl.system.linux.liburing.IOURingClockRegister;
import org.lwjgl.system.linux.liburing.IOURingMemRegionReg;
...
import org.lwjgl.system.linux.liburing.IOURingRegWait;
...
import org.lwjgl.system.linux.liburing.IOURingZCRXIfqReg;
...
public class LibURing {
    ...
    public static @Nullable IOURingProbe io_uring_get_probe_ring(@NativeType(value="struct io_uring *") IOURing ring) {
    ...
    public static int io_uring_wait_cqes(@NativeType(value="struct io_uring *") IOURing ring, @NativeType(value="struct io_uring_cqe **") PointerBuffer cqe_ptr, @NativeType(value="struct __kernel_timespec *") @Nullable KernelTimespec ts, @NativeType(value="sigset_t *") long sigmask) {
    ...
    public static native int nio_uring_wait_cqes_min_timeout(long var0, long var2, int var4, long var5, int var7, long var8);

    public static int io_uring_wait_cqes_min_timeout(@NativeType(value="struct io_uring *") IOURing ring, @NativeType(value="struct io_uring_cqe **") PointerBuffer cqe_ptr, @NativeType(value="struct __kernel_timespec *") @Nullable KernelTimespec ts, @NativeType(value="unsigned int") int min_ts_usec, @NativeType(value="sigset_t *") long sigmask) {
        return LibURing.nio_uring_wait_cqes_min_timeout(ring.address(), MemoryUtil.memAddress(cqe_ptr), cqe_ptr.remaining(), MemoryUtil.memAddressSafe(ts), min_ts_usec, sigmask);
    }

    public static native int nio_uring_wait_cqe_timeout(long var0, long var2, long var4);

    public static int io_uring_wait_cqe_timeout(@NativeType(value="struct io_uring *") IOURing ring, @NativeType(value="struct io_uring_cqe **") PointerBuffer cqe_ptr, @NativeType(value="struct __kernel_timespec *") @Nullable KernelTimespec ts) {
        if (Checks.CHECKS) {
    ...
    public static int io_uring_submit_and_wait_timeout(@NativeType(value="struct io_uring *") IOURing ring, @NativeType(value="struct io_uring_cqe **") PointerBuffer cqe_ptr, @NativeType(value="struct __kernel_timespec *") @Nullable KernelTimespec ts, @NativeType(value="sigset_t *") long sigmask) {
    ...
    public static native int nio_uring_submit_and_wait_min_timeout(long var0, long var2, int var4, long var5, int var7, long var8);

    public static int io_uring_submit_and_wait_min_timeout(@NativeType(value="struct io_uring *") IOURing ring, @NativeType(value="struct io_uring_cqe **") PointerBuffer cqe_ptr, @NativeType(value="struct __kernel_timespec *") @Nullable KernelTimespec ts, @NativeType(value="unsigned") int min_wait, @NativeType(value="sigset_t *") long sigmask) {
        return LibURing.nio_uring_submit_and_wait_min_timeout(ring.address(), MemoryUtil.memAddress(cqe_ptr), cqe_ptr.remaining(), MemoryUtil.memAddressSafe(ts), min_wait, sigmask);
    }

    public static native int nio_uring_submit_and_wait_reg(long var0, long var2, int var4, int var5);

    public static int io_uring_submit_and_wait_reg(@NativeType(value="struct io_uring *") IOURing ring, @NativeType(value="struct io_uring_cqe **") PointerBuffer cqe_ptr, int reg_index) {
        return LibURing.nio_uring_submit_and_wait_reg(ring.address(), MemoryUtil.memAddress(cqe_ptr), cqe_ptr.remaining(), reg_index);
    }

    public static native int nio_uring_register_wait_reg(long var0, long var2, int var4);

    public static int io_uring_register_wait_reg(@NativeType(value="struct io_uring *") IOURing ring, @NativeType(value="struct io_uring_reg_wait *") IOURingRegWait reg, int nr) {
        return LibURing.nio_uring_register_wait_reg(ring.address(), reg.address(), nr);
    }

    public static native int nio_uring_resize_rings(long var0, long var2);

    public static int io_uring_resize_rings(@NativeType(value="struct io_uring *") IOURing ring, @NativeType(value="struct io_uring_params *") IOURingParams p) {
        return LibURing.nio_uring_resize_rings(ring.address(), p.address());
    }

    public static native int nio_uring_clone_buffers_offset(long var0, long var2, int var4, int var5, int var6, int var7);

    public static int io_uring_clone_buffers_offset(@NativeType(value="struct io_uring *") IOURing dst, @NativeType(value="struct io_uring *") IOURing src, @NativeType(value="unsigned") int dst_off, @NativeType(value="unsigned") int src_off, @NativeType(value="unsigned") int nr, @NativeType(value="unsigned") int flags) {
        return LibURing.nio_uring_clone_buffers_offset(dst.address(), src.address(), dst_off, src_off, nr, flags);
    }

    public static native int nio_uring_clone_buffers(long var0, long var2);

    public static int io_uring_clone_buffers(@NativeType(value="struct io_uring *") IOURing dst, @NativeType(value="struct io_uring *") IOURing src) {
        return LibURing.nio_uring_clone_buffers(dst.address(), src.address());
    }
    ...
    public static int io_uring_register_iowq_max_workers(@NativeType(value="struct io_uring *") IOURing ring, @NativeType(value="unsigned int *") IntBuffer values2) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)values2, 2);
        }
        return LibURing.nio_uring_register_iowq_max_workers(ring.address(), MemoryUtil.memAddress(values2));
    }
    ...
    public static native int nio_uring_register_ifq(long var0, long var2);

    public static int io_uring_register_ifq(@NativeType(value="struct io_uring *") IOURing ring, @NativeType(value="struct io_uring_zcrx_ifq_reg *") IOURingZCRXIfqReg reg) {
        return LibURing.nio_uring_register_ifq(ring.address(), reg.address());
    }

    public static native int nio_uring_register_clock(long var0, long var2);

    public static int io_uring_register_clock(@NativeType(value="struct io_uring *") IOURing ring, @NativeType(value="struct io_uring_clock_register *") IOURingClockRegister arg) {
        return LibURing.nio_uring_register_clock(ring.address(), arg.address());
    }
    ...
    public static int io_uring_enter2(@NativeType(value="unsigned int") int fd, @NativeType(value="unsigned int") int to_submit, @NativeType(value="unsigned int") int min_complete, @NativeType(value="unsigned int") int flags, @NativeType(value="void *") ByteBuffer arg) {
        return LibURing.nio_uring_enter2(fd, to_submit, min_complete, flags, MemoryUtil.memAddress(arg), arg.remaining());
    }
    ...
    public static native int nio_uring_register_region(long var0, long var2);

    public static int io_uring_register_region(@NativeType(value="struct io_uring *") IOURing ring, @NativeType(value="struct io_uring_mem_region_reg *") IOURingMemRegionReg reg) {
        return LibURing.nio_uring_register_region(ring.address(), reg.address());
    }
    ...
    public static @Nullable IOURingBufRing io_uring_setup_buf_ring(@NativeType(value="struct io_uring *") IOURing ring, @NativeType(value="unsigned int") int nentries, int bgid, @NativeType(value="unsigned int") int flags, @NativeType(value="int *") IntBuffer err) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)err, 1);
        }
        long __result = LibURing.nio_uring_setup_buf_ring(ring.address(), nentries, bgid, flags, MemoryUtil.memAddress(err));
    ...
    public static native int nio_uring_set_iowait(long var0, boolean var2);

    public static int io_uring_set_iowait(@NativeType(value="struct io_uring *") IOURing ring, @NativeType(value="bool") boolean enable_iowait) {
        return LibURing.nio_uring_set_iowait(ring.address(), enable_iowait);
    }

    @NativeType(value="unsigned")
    public static native int io_uring_cqe_shift_from_flags(@NativeType(value="unsigned") int var0);

    public static native int nio_uring_cqe_shift(long var0);

    @NativeType(value="unsigned")
    public static int io_uring_cqe_shift(@NativeType(value="struct io_uring const *") IOURing ring) {
        if (Checks.CHECKS) {
            IOURing.validate(ring.address());
        }
        return LibURing.nio_uring_cqe_shift(ring.address());
    }

    public static native int nio_uring_cqe_nr(long var0);

    @NativeType(value="unsigned")
    public static int io_uring_cqe_nr(@NativeType(value="struct io_uring_cqe const *") IOURingCQE cqe) {
        return LibURing.nio_uring_cqe_nr(cqe.address());
    }

    public static native void nio_uring_cq_advance(long var0, int var2);

    public static void io_uring_cq_advance(@NativeType(value="struct io_uring *") IOURing ring, @NativeType(value="unsigned") int nr) {
        LibURing.nio_uring_cq_advance(ring.address(), nr);
    }
    ...
    public static native void nio_uring_sqe_set_buf_group(long var0, int var2);

    public static void io_uring_sqe_set_buf_group(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int bgid) {
        LibURing.nio_uring_sqe_set_buf_group(sqe.address(), bgid);
    }

    public static native void nio_uring_initialize_sqe(long var0);

    public static void io_uring_initialize_sqe(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe) {
        LibURing.nio_uring_initialize_sqe(sqe.address());
    }
    ...
    public static native void nio_uring_prep_read_fixed(long var0, int var2, long var3, int var5, long var6, int var8);

    public static void io_uring_prep_read_fixed(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="void *") ByteBuffer buf, @NativeType(value="__u64") long offset, int buf_index) {
        LibURing.nio_uring_prep_read_fixed(sqe.address(), fd, MemoryUtil.memAddress(buf), buf.remaining(), offset, buf_index);
    }

    public static native void nio_uring_prep_readv_fixed(long var0, int var2, long var3, int var5, long var6, int var8, int var9);

    public static void io_uring_prep_readv_fixed(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="struct iovec const *") IOVec.Buffer iovecs, @NativeType(value="__u64") long offset, int flags, int buf_index) {
        LibURing.nio_uring_prep_readv_fixed(sqe.address(), fd, iovecs.address(), iovecs.remaining(), offset, flags, buf_index);
    }

    public static native void nio_uring_prep_writev(long var0, int var2, long var3, int var5, long var6);

    public static void io_uring_prep_writev(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="struct iovec const *") IOVec.Buffer iovecs, @NativeType(value="__u64") long offset) {
        LibURing.nio_uring_prep_writev(sqe.address(), fd, iovecs.address(), iovecs.remaining(), offset);
    }

    public static native void nio_uring_prep_writev2(long var0, int var2, long var3, int var5, long var6, int var8);

    public static void io_uring_prep_writev2(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="struct iovec const *") IOVec.Buffer iovecs, @NativeType(value="__u64") long offset, int flags) {
        LibURing.nio_uring_prep_writev2(sqe.address(), fd, iovecs.address(), iovecs.remaining(), offset, flags);
    }

    public static native void nio_uring_prep_write_fixed(long var0, int var2, long var3, int var5, long var6, int var8);

    public static void io_uring_prep_write_fixed(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="void const *") ByteBuffer buf, @NativeType(value="__u64") long offset, int buf_index) {
        LibURing.nio_uring_prep_write_fixed(sqe.address(), fd, MemoryUtil.memAddress(buf), buf.remaining(), offset, buf_index);
    }

    public static native void nio_uring_prep_writev_fixed(long var0, int var2, long var3, int var5, long var6, int var8, int var9);

    public static void io_uring_prep_writev_fixed(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="struct iovec const *") IOVec.Buffer iovecs, @NativeType(value="__u64") long offset, int flags, int buf_index) {
        LibURing.nio_uring_prep_writev_fixed(sqe.address(), fd, iovecs.address(), iovecs.remaining(), offset, flags, buf_index);
    }

    public static native void nio_uring_prep_recvmsg(long var0, int var2, long var3, int var5);

    public static void io_uring_prep_recvmsg(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="struct msghdr *") Msghdr msg, @NativeType(value="unsigned") int flags) {
    ...
    public static void io_uring_prep_sendmsg(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="struct msghdr const *") Msghdr msg, @NativeType(value="unsigned") int flags) {
        if (Checks.CHECKS) {
    ...
    public static void io_uring_prep_poll_add(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="unsigned") int poll_mask) {
    ...
    public static void io_uring_prep_poll_multishot(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="unsigned") int poll_mask) {
    ...
    public static void io_uring_prep_poll_update(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, @NativeType(value="__u64") long old_user_data, @NativeType(value="__u64") long new_user_data, @NativeType(value="unsigned") int poll_mask, @NativeType(value="unsigned") int flags) {
    ...
    public static void io_uring_prep_fsync(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="unsigned") int fsync_flags) {
    ...
    public static native void nio_uring_prep_nop128(long var0);

    public static void io_uring_prep_nop128(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe) {
        LibURing.nio_uring_prep_nop128(sqe.address());
    }

    public static native void nio_uring_prep_timeout(long var0, long var2, int var4, int var5);

    public static void io_uring_prep_timeout(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, @NativeType(value="struct __kernel_timespec const *") KernelTimespec ts, @NativeType(value="unsigned") int count, @NativeType(value="unsigned") int flags) {
    ...
    public static void io_uring_prep_timeout_remove(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, @NativeType(value="__u64") long user_data, @NativeType(value="unsigned") int flags) {
    ...
    public static void io_uring_prep_timeout_update(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, @NativeType(value="struct __kernel_timespec const *") KernelTimespec ts, @NativeType(value="__u64") long user_data, @NativeType(value="unsigned") int flags) {
    ...
    public static void io_uring_prep_link_timeout(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, @NativeType(value="struct __kernel_timespec const *") KernelTimespec ts, @NativeType(value="unsigned") int flags) {
    ...
    public static native void nio_uring_prep_bind(long var0, int var2, long var3, int var5);

    public static void io_uring_prep_bind(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="struct sockaddr const *") Sockaddr addr, @NativeType(value="socklen_t") int addrlen) {
        LibURing.nio_uring_prep_bind(sqe.address(), fd, addr.address(), addrlen);
    }

    public static native void nio_uring_prep_listen(long var0, int var2, int var3);

    public static void io_uring_prep_listen(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, int backlog) {
        LibURing.nio_uring_prep_listen(sqe.address(), fd, backlog);
    }

    public static native void nio_uring_prep_epoll_wait(long var0, int var2, long var3, int var5, int var6);

    public static void io_uring_prep_epoll_wait(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="struct epoll_event *") EpollEvent.Buffer events, @NativeType(value="unsigned") int flags) {
        LibURing.nio_uring_prep_epoll_wait(sqe.address(), fd, events.address(), events.remaining(), flags);
    }

    public static native void nio_uring_prep_files_update(long var0, long var2, int var4, int var5);

    public static void io_uring_prep_files_update(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, @NativeType(value="int const *") IntBuffer fds, int offset) {
    ...
    public static void io_uring_prep_fallocate(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, int mode, @NativeType(value="__u64") long offset, @NativeType(value="__u64") long len) {
    ...
    public static native void nio_uring_prep_open(long var0, long var2, int var4, int var5);

    public static void io_uring_prep_open(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, @NativeType(value="char const *") ByteBuffer path, int flags, @NativeType(value="mode_t") int mode) {
        if (Checks.CHECKS) {
            Checks.checkNT1(path);
        }
        LibURing.nio_uring_prep_open(sqe.address(), MemoryUtil.memAddress(path), flags, mode);
    }

    /*
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void io_uring_prep_open(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, @NativeType(value="char const *") CharSequence path, int flags, @NativeType(value="mode_t") int mode) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            stack.nUTF8(path, true);
            long pathEncoded = stack.getPointerAddress();
            LibURing.nio_uring_prep_open(sqe.address(), pathEncoded, flags, mode);
        }
        finally {
            stack.setPointer(stackPointer);
        }
    ...
    public static native void nio_uring_prep_open_direct(long var0, long var2, int var4, int var5, int var6);

    public static void io_uring_prep_open_direct(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, @NativeType(value="char const *") ByteBuffer path, int flags, @NativeType(value="mode_t") int mode, @NativeType(value="unsigned") int file_index) {
        if (Checks.CHECKS) {
            Checks.checkNT1(path);
        }
        LibURing.nio_uring_prep_open_direct(sqe.address(), MemoryUtil.memAddress(path), flags, mode, file_index);
    }

    /*
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void io_uring_prep_open_direct(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, @NativeType(value="char const *") CharSequence path, int flags, @NativeType(value="mode_t") int mode, @NativeType(value="unsigned") int file_index) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            stack.nUTF8(path, true);
            long pathEncoded = stack.getPointerAddress();
            LibURing.nio_uring_prep_open_direct(sqe.address(), pathEncoded, flags, mode, file_index);
        }
        finally {
            stack.setPointer(stackPointer);
        }
    ...
    public static native void nio_uring_prep_read(long var0, int var2, long var3, int var5, long var6);

    public static void io_uring_prep_read(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="void *") ByteBuffer buf, @NativeType(value="__u64") long offset) {
    ...
    public static native void nio_uring_prep_write(long var0, int var2, long var3, int var5, long var6);

    public static void io_uring_prep_write(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="void const *") ByteBuffer buf, @NativeType(value="__u64") long offset) {
    ...
    public static void io_uring_prep_statx(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int dfd, @NativeType(value="char const *") ByteBuffer path, int flags, @NativeType(value="unsigned") int mask, @NativeType(value="struct statx *") Statx statxbuf) {
        if (Checks.CHECKS) {
            Checks.checkNT1(path);
        }
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void io_uring_prep_statx(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int dfd, @NativeType(value="char const *") CharSequence path, int flags, @NativeType(value="unsigned") int mask, @NativeType(value="struct statx *") Statx statxbuf) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            stack.nUTF8(path, true);
    ...
    public static native void nio_uring_prep_fadvise(long var0, int var2, long var3, int var5, int var6);

    public static void io_uring_prep_fadvise(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="__u64") long offset, @NativeType(value="__u32") int len, int advice) {
        LibURing.nio_uring_prep_fadvise(sqe.address(), fd, offset, len, advice);
    }

    public static native void nio_uring_prep_madvise(long var0, long var2, int var4, int var5);
    ...
    public static native void nio_uring_prep_fadvise64(long var0, int var2, long var3, long var5, int var7);

    public static void io_uring_prep_fadvise64(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="__u64") long offset, @NativeType(value="off_t") long len, int advice) {
        LibURing.nio_uring_prep_fadvise64(sqe.address(), fd, offset, len, advice);
    }

    public static native void nio_uring_prep_madvise64(long var0, long var2, long var4, int var6);

    public static void io_uring_prep_madvise64(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, @NativeType(value="void *") ByteBuffer addr, int advice) {
        LibURing.nio_uring_prep_madvise64(sqe.address(), MemoryUtil.memAddress(addr), addr.remaining(), advice);
    }
    ...
    public static native void nio_uring_prep_send_bundle(long var0, int var2, long var3, int var5);

    public static void io_uring_prep_send_bundle(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int sockfd, @NativeType(value="size_t") long len, int flags) {
        LibURing.nio_uring_prep_send_bundle(sqe.address(), sockfd, len, flags);
    }
    ...
    public static native void nio_uring_prep_sendmsg_zc_fixed(long var0, int var2, long var3, int var5, int var6);

    public static void io_uring_prep_sendmsg_zc_fixed(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="struct msghdr const *") Msghdr msg, @NativeType(value="unsigned") int flags, @NativeType(value="unsigned") int buf_index) {
        if (Checks.CHECKS) {
            Msghdr.validate(msg.address());
        }
        LibURing.nio_uring_prep_sendmsg_zc_fixed(sqe.address(), fd, msg.address(), flags, buf_index);
    }
    ...
    public static @Nullable IOURingRecvmsgOut io_uring_recvmsg_validate(@NativeType(value="void *") ByteBuffer buf, @NativeType(value="struct msghdr *") Msghdr msgh) {
    ...
    public static @Nullable CMsghdr io_uring_recvmsg_cmsg_firsthdr(@NativeType(value="struct io_uring_recvmsg_out *") IOURingRecvmsgOut o, @NativeType(value="struct msghdr *") Msghdr msgh) {
    ...
    @NativeType(value="struct cmsghdr *")
    public static @Nullable CMsghdr io_uring_recvmsg_cmsg_nexthdr(@NativeType(value="struct io_uring_recvmsg_out *") IOURingRecvmsgOut o, @NativeType(value="struct msghdr *") Msghdr msgh, @NativeType(value="struct cmsghdr *") CMsghdr cmsg) {
    ...
    public static void io_uring_prep_openat2(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int dfd, @NativeType(value="char const *") ByteBuffer path, @NativeType(value="struct open_how const *") OpenHow how) {
        if (Checks.CHECKS) {
            Checks.checkNT1(path);
        }
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void io_uring_prep_openat2(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int dfd, @NativeType(value="char const *") CharSequence path, @NativeType(value="struct open_how const *") OpenHow how) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            stack.nUTF8(path, true);
    ...
    public static void io_uring_prep_openat2_direct(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int dfd, @NativeType(value="char const *") ByteBuffer path, @NativeType(value="struct open_how const *") OpenHow how, @NativeType(value="unsigned") int file_index) {
        if (Checks.CHECKS) {
            Checks.checkNT1(path);
        }
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void io_uring_prep_openat2_direct(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int dfd, @NativeType(value="char const *") CharSequence path, @NativeType(value="struct open_how const *") OpenHow how, @NativeType(value="unsigned") int file_index) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            stack.nUTF8(path, true);
    ...
    public static void io_uring_prep_epoll_ctl(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int epfd, int fd, int op, @NativeType(value="struct epoll_event const *") EpollEvent ev) {
    ...
    public static native void nio_uring_prep_sync_file_range(long var0, int var2, int var3, long var4, int var6);

    public static void io_uring_prep_sync_file_range(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="unsigned") int len, @NativeType(value="__u64") long offset, int flags) {
    ...
    public static void io_uring_prep_socket_direct(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int domain, int type, int protocol, @NativeType(value="unsigned") int file_index, @NativeType(value="unsigned int") int flags) {
    ...
    public static native void nio_uring_prep_uring_cmd(long var0, int var2, int var3);

    public static void io_uring_prep_uring_cmd(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int cmd_op, int fd) {
        LibURing.nio_uring_prep_uring_cmd(sqe.address(), cmd_op, fd);
    }

    public static native void nio_uring_prep_uring_cmd128(long var0, int var2, int var3);

    public static void io_uring_prep_uring_cmd128(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int cmd_op, int fd) {
        LibURing.nio_uring_prep_uring_cmd128(sqe.address(), cmd_op, fd);
    }
    ...
    public static native void nio_uring_prep_cmd_getsockname(long var0, int var2, long var3, long var5, int var7);

    public static void io_uring_prep_cmd_getsockname(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="struct sockaddr *") Sockaddr sockaddr, @NativeType(value="socklen_t *") IntBuffer sockaddr_len, int peer) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)sockaddr_len, 1);
        }
        LibURing.nio_uring_prep_cmd_getsockname(sqe.address(), fd, sockaddr.address(), MemoryUtil.memAddress(sockaddr_len), peer);
    }
    ...
    public static void io_uring_prep_futex_wake(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, @NativeType(value="uint32_t const *") IntBuffer futex, @NativeType(value="uint64_t") long val, @NativeType(value="uint64_t") long mask, @NativeType(value="uint32_t") int futex_flags, @NativeType(value="unsigned int") int flags) {
        if (Checks.CHECKS) {
    ...
    public static void io_uring_prep_futex_wait(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, @NativeType(value="uint32_t const *") IntBuffer futex, @NativeType(value="uint64_t") long val, @NativeType(value="uint64_t") long mask, @NativeType(value="uint32_t") int futex_flags, @NativeType(value="unsigned int") int flags) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)futex, 1);
        }
    ...
    public static void io_uring_prep_futex_waitv(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, @NativeType(value="struct futex_waitv const *") PointerBuffer futex, @NativeType(value="unsigned int") int flags) {
    ...
    public static native void nio_uring_prep_cmd_discard(long var0, int var2, long var3, long var5);

    public static void io_uring_prep_cmd_discard(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, int fd, @NativeType(value="uint64_t") long offset, @NativeType(value="uint64_t") long nbytes) {
        LibURing.nio_uring_prep_cmd_discard(sqe.address(), fd, offset, nbytes);
    }

    public static native void nio_uring_prep_pipe(long var0, long var2, int var4);

    public static void io_uring_prep_pipe(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, @NativeType(value="int *") IntBuffer fds, int pipe_flags) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)fds, 2);
        }
        LibURing.nio_uring_prep_pipe(sqe.address(), MemoryUtil.memAddress(fds), pipe_flags);
    }

    public static native void nio_uring_prep_pipe_direct(long var0, long var2, int var4, int var5);

    public static void io_uring_prep_pipe_direct(@NativeType(value="struct io_uring_sqe *") IOURingSQE sqe, @NativeType(value="int *") IntBuffer fds, int pipe_flags, @NativeType(value="unsigned int") int file_index) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)fds, 2);
        }
        LibURing.nio_uring_prep_pipe_direct(sqe.address(), MemoryUtil.memAddress(fds), pipe_flags, file_index);
    }

    public static native int nio_uring_load_sq_head(long var0);

    @NativeType(value="unsigned")
    public static int io_uring_load_sq_head(@NativeType(value="struct io_uring const *") IOURing ring) {
        if (Checks.CHECKS) {
            IOURing.validate(ring.address());
        }
        return LibURing.nio_uring_load_sq_head(ring.address());
    }
    ...
    @NativeType(value="unsigned")
    public static native int io_uring_sqe_shift_from_flags(@NativeType(value="unsigned") int var0);

    public static native int nio_uring_sqe_shift(long var0);

    @NativeType(value="unsigned")
    public static int io_uring_sqe_shift(@NativeType(value="struct io_uring const *") IOURing ring) {
        if (Checks.CHECKS) {
            IOURing.validate(ring.address());
        }
        return LibURing.nio_uring_sqe_shift(ring.address());
    }
    ...
    public static @Nullable IOURingSQE io_uring_get_sqe(@NativeType(value="struct io_uring *") IOURing ring) {
        long __result = LibURing.nio_uring_get_sqe(ring.address());
        return IOURingSQE.createSafe(__result);
    }

    public static native long nio_uring_get_sqe128(long var0);

    @NativeType(value="struct io_uring_sqe *")
    public static @Nullable IOURingSQE io_uring_get_sqe128(@NativeType(value="struct io_uring *") IOURing ring) {
        long __result = LibURing.nio_uring_get_sqe128(ring.address());
        return IOURingSQE.createSafe(__result);
    }
    ...
    public static native long io_uring_memory_size(@NativeType(value="unsigned") int var0, @NativeType(value="unsigned") int var1);

    public static native long nio_uring_memory_size_params(int var0, long var1);

    @NativeType(value="ssize_t")
    public static long io_uring_memory_size_params(@NativeType(value="unsigned") int entries, @NativeType(value="struct io_uring_params *") IOURingParams p) {
        return LibURing.nio_uring_memory_size_params(entries, p.address());
    }
