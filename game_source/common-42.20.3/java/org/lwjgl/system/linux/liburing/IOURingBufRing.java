...
implements NativeResource {
    ...
    public static long nresv1(long struct) {
        return MemoryUtil.memGetLong(struct + (long)RESV1);
    }

    public static int nresv2(long struct) {
        return MemoryUtil.memGetInt(struct + (long)RESV2);
    }

    public static short nresv3(long struct) {
        return MemoryUtil.memGetShort(struct + (long)RESV3);
    }

    public static short ntail(long struct) {
        return MemoryUtil.memGetShort(struct + (long)TAIL);
    }
    ...
    public static void nresv1(long struct, long value) {
        MemoryUtil.memPutLong(struct + (long)RESV1, value);
    }

    public static void nresv2(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)RESV2, value);
    }

    public static void nresv3(long struct, short value) {
        MemoryUtil.memPutShort(struct + (long)RESV3, value);
    }

    public static void ntail(long struct, short value) {
        MemoryUtil.memPutShort(struct + (long)TAIL, value);
    }
