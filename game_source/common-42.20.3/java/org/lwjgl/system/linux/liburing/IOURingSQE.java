...
implements NativeResource {
    ...
    public int pipe_flags() {
        return IOURingSQE.npipe_flags(this.address());
    }
    ...
    public int zcrx_ifq_idx() {
        return IOURingSQE.nzcrx_ifq_idx(this.address());
    }
    ...
    public long attr_ptr() {
        return IOURingSQE.nattr_ptr(this.address());
    }

    @NativeType(value="__u64")
    public long attr_type_mask() {
        return IOURingSQE.nattr_type_mask(this.address());
    }
    ...
    public IOURingSQE nop_flags(@NativeType(value="__u32") int value) {
        IOURingSQE.nnop_flags(this.address(), value);
        return this;
    }

    public IOURingSQE pipe_flags(@NativeType(value="__u32") int value) {
        IOURingSQE.npipe_flags(this.address(), value);
        return this;
    }
    ...
    public IOURingSQE zcrx_ifq_idx(@NativeType(value="__u32") int value) {
        IOURingSQE.nzcrx_ifq_idx(this.address(), value);
        return this;
    }
    ...
    public IOURingSQE attr_ptr(@NativeType(value="__u64") long value) {
        IOURingSQE.nattr_ptr(this.address(), value);
        return this;
    }

    public IOURingSQE attr_type_mask(@NativeType(value="__u64") long value) {
        IOURingSQE.nattr_type_mask(this.address(), value);
        return this;
    }
    ...
    public static short nioprio(long struct) {
        return MemoryUtil.memGetShort(struct + (long)IOPRIO);
    }
    ...
    public static long naddr2(long struct) {
        return MemoryUtil.memGetLong(struct + (long)ADDR2);
    }

    public static int ncmd_op(long struct) {
        return MemoryUtil.memGetInt(struct + (long)CMD_OP);
    }

    public static int n__pad1(long struct) {
        return MemoryUtil.memGetInt(struct + (long)__PAD1);
    }
    ...
    public static long nsplice_off_in(long struct) {
        return MemoryUtil.memGetLong(struct + (long)SPLICE_OFF_IN);
    }
    ...
    public static int noptname(long struct) {
        return MemoryUtil.memGetInt(struct + (long)OPTNAME);
    }
    ...
    public static int nrw_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)RW_FLAGS);
    }

    public static int nfsync_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)FSYNC_FLAGS);
    }

    public static short npoll_events(long struct) {
        return MemoryUtil.memGetShort(struct + (long)POLL_EVENTS);
    }

    public static int npoll32_events(long struct) {
        return MemoryUtil.memGetInt(struct + (long)POLL32_EVENTS);
    }

    public static int nsync_range_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)SYNC_RANGE_FLAGS);
    }

    public static int nmsg_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)MSG_FLAGS);
    }

    public static int ntimeout_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)TIMEOUT_FLAGS);
    }

    public static int naccept_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)ACCEPT_FLAGS);
    }

    public static int ncancel_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)CANCEL_FLAGS);
    }

    public static int nopen_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)OPEN_FLAGS);
    }

    public static int nstatx_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)STATX_FLAGS);
    }

    public static int nfadvise_advice(long struct) {
        return MemoryUtil.memGetInt(struct + (long)FADVISE_ADVICE);
    }

    public static int nsplice_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)SPLICE_FLAGS);
    }

    public static int nrename_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)RENAME_FLAGS);
    }

    public static int nunlink_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)UNLINK_FLAGS);
    }

    public static int nhardlink_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)HARDLINK_FLAGS);
    }

    public static int nxattr_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)XATTR_FLAGS);
    }

    public static int nmsg_ring_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)MSG_RING_FLAGS);
    }

    public static int nuring_cmd_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)URING_CMD_FLAGS);
    }

    public static int nwaitid_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)WAITID_FLAGS);
    }

    public static int nfutex_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)FUTEX_FLAGS);
    }

    public static int ninstall_fd_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)INSTALL_FD_FLAGS);
    }

    public static int nnop_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)NOP_FLAGS);
    }

    public static int npipe_flags(long struct) {
        return MemoryUtil.memGetInt(struct + (long)PIPE_FLAGS);
    }

    public static long nuser_data(long struct) {
        return MemoryUtil.memGetLong(struct + (long)USER_DATA);
    }

    public static short nbuf_index(long struct) {
        return MemoryUtil.memGetShort(struct + (long)BUF_INDEX);
    }

    public static short nbuf_group(long struct) {
        return MemoryUtil.memGetShort(struct + (long)BUF_GROUP);
    }

    public static short npersonality(long struct) {
        return MemoryUtil.memGetShort(struct + (long)PERSONALITY);
    }

    public static int nsplice_fd_in(long struct) {
        return MemoryUtil.memGetInt(struct + (long)SPLICE_FD_IN);
    }

    public static int nfile_index(long struct) {
        return MemoryUtil.memGetInt(struct + (long)FILE_INDEX);
    }

    public static int nzcrx_ifq_idx(long struct) {
        return MemoryUtil.memGetInt(struct + (long)ZCRX_IFQ_IDX);
    }

    public static int noptlen(long struct) {
        return MemoryUtil.memGetInt(struct + (long)OPTLEN);
    }

    public static short naddr_len(long struct) {
        return MemoryUtil.memGetShort(struct + (long)ADDR_LEN);
    }
    ...
    public static short n__pad3(long struct, int index) {
        return MemoryUtil.memGetShort(struct + (long)__PAD3 + Checks.check(index, 1) * 2L);
    }

    public static long naddr3(long struct) {
        return MemoryUtil.memGetLong(struct + (long)ADDR3);
    }
    ...
    public static long n__pad2(long struct, int index) {
        return MemoryUtil.memGetLong(struct + (long)__PAD2 + Checks.check(index, 1) * 8L);
    }

    public static long nattr_ptr(long struct) {
        return MemoryUtil.memGetLong(struct + (long)ATTR_PTR);
    }

    public static long nattr_type_mask(long struct) {
        return MemoryUtil.memGetLong(struct + (long)ATTR_TYPE_MASK);
    }

    public static long noptval(long struct) {
        return MemoryUtil.memGetLong(struct + (long)OPTVAL);
    }
    ...
    public static byte ncmd(long struct, int index) {
        return MemoryUtil.memGetByte(struct + (long)CMD + Checks.check(index, 0) * 1L);
    }
    ...
    public static void nflags(long struct, byte value) {
        MemoryUtil.memPutByte(struct + (long)FLAGS, value);
    }

    public static void nioprio(long struct, short value) {
        MemoryUtil.memPutShort(struct + (long)IOPRIO, value);
    }
    ...
    public static void naddr2(long struct, long value) {
        MemoryUtil.memPutLong(struct + (long)ADDR2, value);
    }

    public static void ncmd_op(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)CMD_OP, value);
    }

    public static void n__pad1(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)__PAD1, value);
    }
    ...
    public static void nsplice_off_in(long struct, long value) {
        MemoryUtil.memPutLong(struct + (long)SPLICE_OFF_IN, value);
    }
    ...
    public static void noptname(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)OPTNAME, value);
    }
    ...
    public static void n__pad3(long struct, int index, short value) {
        MemoryUtil.memPutShort(struct + (long)__PAD3 + Checks.check(index, 1) * 2L, value);
    }

    public static void naddr3(long struct, long value) {
        MemoryUtil.memPutLong(struct + (long)ADDR3, value);
    }
    ...
    public static void n__pad2(long struct, int index, long value) {
        MemoryUtil.memPutLong(struct + (long)__PAD2 + Checks.check(index, 1) * 8L, value);
    }

    public static void nattr_ptr(long struct, long value) {
        MemoryUtil.memPutLong(struct + (long)ATTR_PTR, value);
    }

    public static void nattr_type_mask(long struct, long value) {
        MemoryUtil.memPutLong(struct + (long)ATTR_TYPE_MASK, value);
    }

    public static void noptval(long struct, long value) {
        MemoryUtil.memPutLong(struct + (long)OPTVAL, value);
    }
    ...
    public static void ncmd(long struct, int index, byte value) {
        MemoryUtil.memPutByte(struct + (long)CMD + Checks.check(index, 0) * 1L, value);
    }

    static {
        Struct.Layout layout = IOURingSQE.__struct(IOURingSQE.__member(1), IOURingSQE.__member(1), IOURingSQE.__member(2), IOURingSQE.__member(4), IOURingSQE.__union(IOURingSQE.__member(8), IOURingSQE.__member(8), IOURingSQE.__struct(IOURingSQE.__member(4), IOURingSQE.__member(4))), IOURingSQE.__union(IOURingSQE.__member(8), IOURingSQE.__member(8), IOURingSQE.__struct(IOURingSQE.__member(4), IOURingSQE.__member(4))), IOURingSQE.__member(4), IOURingSQE.__union(IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(2), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4)), IOURingSQE.__member(8), IOURingSQE.__union(IOURingSQE.__member(2), IOURingSQE.__member(2)), IOURingSQE.__member(2), IOURingSQE.__union(IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__member(4), IOURingSQE.__struct(IOURingSQE.__member(2), IOURingSQE.__array(2, 1))), IOURingSQE.__union(IOURingSQE.__struct(IOURingSQE.__member(8), IOURingSQE.__array(8, 1)), IOURingSQE.__struct(IOURingSQE.__member(8), IOURingSQE.__member(8)), IOURingSQE.__member(8), IOURingSQE.__array(1, 0)));
    ...
    implements NativeResource {
        ...
        public Buffer nop_flags(@NativeType(value="__u32") int value) {
            IOURingSQE.nnop_flags(this.address(), value);
            return this;
        }

        public Buffer pipe_flags(@NativeType(value="__u32") int value) {
            IOURingSQE.npipe_flags(this.address(), value);
            return this;
        }
        ...
        public Buffer zcrx_ifq_idx(@NativeType(value="__u32") int value) {
            IOURingSQE.nzcrx_ifq_idx(this.address(), value);
            return this;
        }
        ...
        public Buffer attr_ptr(@NativeType(value="__u64") long value) {
            IOURingSQE.nattr_ptr(this.address(), value);
            return this;
        }

        public Buffer attr_type_mask(@NativeType(value="__u64") long value) {
            IOURingSQE.nattr_type_mask(this.address(), value);
            return this;
        }
