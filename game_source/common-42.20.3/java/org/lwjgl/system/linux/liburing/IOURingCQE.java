...
implements NativeResource {
    ...
    public static int nres(long struct) {
        return MemoryUtil.memGetInt(struct + (long)RES);
    }
    ...
    public static long nbig_cqe(long struct, int index) {
        return MemoryUtil.memGetLong(struct + (long)BIG_CQE + Checks.check(index, 0) * 8L);
    }
    ...
    public static void nres(long struct, int value) {
        MemoryUtil.memPutInt(struct + (long)RES, value);
    }
    ...
    public static void nbig_cqe(long struct, int index, long value) {
        MemoryUtil.memPutLong(struct + (long)BIG_CQE + Checks.check(index, 0) * 8L, value);
    }
