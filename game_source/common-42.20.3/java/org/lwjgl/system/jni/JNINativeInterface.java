...
public class JNINativeInterface {
    ...
    public static final int JNI_VERSION_24 = 0x180000;
    ...
    public static native @Nullable Method nToReflectedMethod(Class<?> var0, long var1, boolean var3);

    @NativeType(value="jobject")
    public static @Nullable Method ToReflectedMethod(@NativeType(value="jclass") Class<?> cls, @NativeType(value="jmethodID") long methodID, @NativeType(value="jboolean") boolean isStatic) {
        if (Checks.CHECKS) {
    ...
    public static native @Nullable Field nToReflectedField(Class<?> var0, long var1, boolean var3);

    @NativeType(value="jobject")
    public static @Nullable Field ToReflectedField(@NativeType(value="jclass") Class<?> cls, @NativeType(value="jfieldID") long fieldID, @NativeType(value="jboolean") boolean isStatic) {
        if (Checks.CHECKS) {
    ...
    public static @Nullable ByteBuffer GetBooleanArrayElements(@NativeType(value="jbooleanArray") byte[] array, @NativeType(value="jboolean *") @Nullable ByteBuffer isCopy) {
        if (Checks.CHECKS) {
    ...
    public static @Nullable ByteBuffer GetByteArrayElements(@NativeType(value="jbyteArray") byte[] array, @NativeType(value="jboolean *") @Nullable ByteBuffer isCopy) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)isCopy, 1);
        }
    ...
    public static @Nullable ShortBuffer GetCharArrayElements(@NativeType(value="jcharArray") char[] array, @NativeType(value="jboolean *") @Nullable ByteBuffer isCopy) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)isCopy, 1);
        }
    ...
    public static @Nullable ShortBuffer GetShortArrayElements(@NativeType(value="jshortArray") short[] array, @NativeType(value="jboolean *") @Nullable ByteBuffer isCopy) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)isCopy, 1);
        }
    ...
    @NativeType(value="jint *")
    public static @Nullable IntBuffer GetIntArrayElements(@NativeType(value="jintArray") int[] array, @NativeType(value="jboolean *") @Nullable ByteBuffer isCopy) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)isCopy, 1);
        }
    ...
    public static @Nullable LongBuffer GetLongArrayElements(@NativeType(value="jlongArray") long[] array, @NativeType(value="jboolean *") @Nullable ByteBuffer isCopy) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)isCopy, 1);
        }
    ...
    public static @Nullable FloatBuffer GetFloatArrayElements(@NativeType(value="jfloatArray") float[] array, @NativeType(value="jboolean *") @Nullable ByteBuffer isCopy) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)isCopy, 1);
        }
    ...
    public static @Nullable DoubleBuffer GetDoubleArrayElements(@NativeType(value="jdoubleArray") double[] array, @NativeType(value="jboolean *") @Nullable ByteBuffer isCopy) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)isCopy, 1);
        }
    ...
    public static native @Nullable ByteBuffer nNewDirectByteBuffer(long var0, long var2);

    @NativeType(value="jobject")
    public static @Nullable ByteBuffer NewDirectByteBuffer(@NativeType(value="void *") long address, @NativeType(value="jlong") long capacity) {
        if (Checks.CHECKS) {
