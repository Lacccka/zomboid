...
public class LibCLocale {
    ...
    public static @Nullable String setlocale(int category, @NativeType(value="char const *") ByteBuffer locale) {
        if (Checks.CHECKS) {
     ...
     */
    @NativeType(value="char *")
    public static @Nullable String setlocale(int category, @NativeType(value="char const *") CharSequence locale) {
