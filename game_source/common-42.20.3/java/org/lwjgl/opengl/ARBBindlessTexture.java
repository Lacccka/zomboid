...
public class ARBBindlessTexture {
    ...
    public static void glUniformHandleui64vARB(@NativeType(value="GLint") int location, @NativeType(value="GLuint64 const *") LongBuffer values2) {
        ARBBindlessTexture.nglUniformHandleui64vARB(location, values2.remaining(), MemoryUtil.memAddress(values2));
    }
    ...
    public static void glProgramUniformHandleui64vARB(@NativeType(value="GLuint") int program, @NativeType(value="GLint") int location, @NativeType(value="GLuint64 const *") LongBuffer values2) {
        ARBBindlessTexture.nglProgramUniformHandleui64vARB(program, location, values2.remaining(), MemoryUtil.memAddress(values2));
    }
    ...
    public static void glUniformHandleui64vARB(@NativeType(value="GLint") int location, @NativeType(value="GLuint64 const *") long[] values2) {
        long __functionAddress = GL.getICD().glUniformHandleui64vARB;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
        }
        JNI.callPV(location, values2.length, values2, __functionAddress);
    }

    public static void glProgramUniformHandleui64vARB(@NativeType(value="GLuint") int program, @NativeType(value="GLint") int location, @NativeType(value="GLuint64 const *") long[] values2) {
        long __functionAddress = GL.getICD().glProgramUniformHandleui64vARB;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
        }
        JNI.callPV(program, location, values2.length, values2, __functionAddress);
    }
