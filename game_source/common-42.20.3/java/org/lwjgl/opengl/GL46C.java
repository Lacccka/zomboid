...
extends GL45C {
    ...
    public static void glSpecializeShader(@NativeType(value="GLuint") int shader, @NativeType(value="GLchar const *") ByteBuffer pEntryPoint, @NativeType(value="GLuint const *") @Nullable IntBuffer pConstantIndex, @NativeType(value="GLuint const *") @Nullable IntBuffer pConstantValue) {
        if (Checks.CHECKS) {
     ...
     */
    public static void glSpecializeShader(@NativeType(value="GLuint") int shader, @NativeType(value="GLchar const *") CharSequence pEntryPoint, @NativeType(value="GLuint const *") @Nullable IntBuffer pConstantIndex, @NativeType(value="GLuint const *") @Nullable IntBuffer pConstantValue) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)pConstantValue, Checks.remainingSafe(pConstantIndex));
        }
    ...
    public static void glSpecializeShader(@NativeType(value="GLuint") int shader, @NativeType(value="GLchar const *") ByteBuffer pEntryPoint, @NativeType(value="GLuint const *") int @Nullable [] pConstantIndex, @NativeType(value="GLuint const *") int @Nullable [] pConstantValue) {
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void glSpecializeShader(@NativeType(value="GLuint") int shader, @NativeType(value="GLchar const *") CharSequence pEntryPoint, @NativeType(value="GLuint const *") int @Nullable [] pConstantIndex, @NativeType(value="GLuint const *") int @Nullable [] pConstantValue) {
        long __functionAddress = GL.getICD().glSpecializeShader;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.checkSafe(pConstantValue, Checks.lengthSafe(pConstantIndex));
