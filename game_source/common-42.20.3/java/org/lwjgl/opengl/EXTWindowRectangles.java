...
public class EXTWindowRectangles {
    ...
    public static void glWindowRectanglesEXT(@NativeType(value="GLenum") int mode, @NativeType(value="GLint const *") @Nullable IntBuffer box) {
        EXTWindowRectangles.nglWindowRectanglesEXT(mode, Checks.remainingSafe(box) >> 2, MemoryUtil.memAddressSafe(box));
    }

    public static void glWindowRectanglesEXT(@NativeType(value="GLenum") int mode, @NativeType(value="GLint const *") int @Nullable [] box) {
