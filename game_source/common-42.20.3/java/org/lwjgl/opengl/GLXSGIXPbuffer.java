...
public class GLXSGIXPbuffer {
    ...
    public static long glXCreateGLXPbufferSGIX(@NativeType(value="Display *") long display, @NativeType(value="GLXFBConfig") long config, @NativeType(value="unsigned int") int width, @NativeType(value="unsigned int") int height, @NativeType(value="int *") @Nullable IntBuffer attrib_list) {
        if (Checks.CHECKS) {
    ...
    @NativeType(value="GLXPbuffer")
    public static long glXCreateGLXPbufferSGIX(@NativeType(value="Display *") long display, @NativeType(value="GLXFBConfig") long config, @NativeType(value="unsigned int") int width, @NativeType(value="unsigned int") int height, @NativeType(value="int *") int @Nullable [] attrib_list) {
        long __functionAddress = GL.getCapabilitiesGLXClient().glXCreateGLXPbufferSGIX;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(display);
