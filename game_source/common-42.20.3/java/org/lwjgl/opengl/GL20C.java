...
extends GL15C {
    ...
    public static void glShaderSource(@NativeType(value="GLuint") int shader, @NativeType(value="GLchar const * const *") PointerBuffer strings, @NativeType(value="GLint const *") @Nullable IntBuffer length) {
        if (Checks.CHECKS) {
    ...
    public static void glGetShaderInfoLog(@NativeType(value="GLuint") int shader, @NativeType(value="GLsizei *") @Nullable IntBuffer length, @NativeType(value="GLchar *") ByteBuffer infoLog) {
        if (Checks.CHECKS) {
    ...
    public static void glGetProgramInfoLog(@NativeType(value="GLuint") int program, @NativeType(value="GLsizei *") @Nullable IntBuffer length, @NativeType(value="GLchar *") ByteBuffer infoLog) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)length, 1);
        }
    ...
    public static void glGetAttachedShaders(@NativeType(value="GLuint") int program, @NativeType(value="GLsizei *") @Nullable IntBuffer count, @NativeType(value="GLuint *") IntBuffer shaders) {
        if (Checks.CHECKS) {
    ...
    public static void glGetActiveUniform(@NativeType(value="GLuint") int program, @NativeType(value="GLuint") int index, @NativeType(value="GLsizei *") @Nullable IntBuffer length, @NativeType(value="GLint *") IntBuffer size, @NativeType(value="GLenum *") IntBuffer type, @NativeType(value="GLchar *") ByteBuffer name) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)length, 1);
    ...
    public static void glGetShaderSource(@NativeType(value="GLuint") int shader, @NativeType(value="GLsizei *") @Nullable IntBuffer length, @NativeType(value="GLchar *") ByteBuffer source2) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)length, 1);
        }
        GL20C.nglGetShaderSource(shader, source2.remaining(), MemoryUtil.memAddressSafe(length), MemoryUtil.memAddress(source2));
    }
    ...
    public static String glGetShaderSource(@NativeType(value="GLuint") int shader, @NativeType(value="GLsizei") int maxLength) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        ByteBuffer source2 = MemoryUtil.memAlloc(maxLength);
        try {
            IntBuffer length = stack.ints(0);
            GL20C.nglGetShaderSource(shader, maxLength, MemoryUtil.memAddress(length), MemoryUtil.memAddress(source2));
            String string = MemoryUtil.memUTF8(source2, length.get(0));
            return string;
        }
        finally {
            MemoryUtil.memFree(source2);
            stack.setPointer(stackPointer);
        }
    }
    ...
    public static void glGetActiveAttrib(@NativeType(value="GLuint") int program, @NativeType(value="GLuint") int index, @NativeType(value="GLsizei *") @Nullable IntBuffer length, @NativeType(value="GLint *") IntBuffer size, @NativeType(value="GLenum *") IntBuffer type, @NativeType(value="GLchar *") ByteBuffer name) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)length, 1);
            Checks.check((Buffer)size, 1);
            Checks.check((Buffer)type, 1);
    ...
    public static void glShaderSource(@NativeType(value="GLuint") int shader, @NativeType(value="GLchar const * const *") PointerBuffer strings, @NativeType(value="GLint const *") int @Nullable [] length) {
    ...
    public static void glGetShaderInfoLog(@NativeType(value="GLuint") int shader, @NativeType(value="GLsizei *") int @Nullable [] length, @NativeType(value="GLchar *") ByteBuffer infoLog) {
    ...
    public static void glGetProgramInfoLog(@NativeType(value="GLuint") int program, @NativeType(value="GLsizei *") int @Nullable [] length, @NativeType(value="GLchar *") ByteBuffer infoLog) {
    ...
    public static void glGetAttachedShaders(@NativeType(value="GLuint") int program, @NativeType(value="GLsizei *") int @Nullable [] count, @NativeType(value="GLuint *") int[] shaders) {
    ...
    public static void glGetActiveUniform(@NativeType(value="GLuint") int program, @NativeType(value="GLuint") int index, @NativeType(value="GLsizei *") int @Nullable [] length, @NativeType(value="GLint *") int[] size, @NativeType(value="GLenum *") int[] type, @NativeType(value="GLchar *") ByteBuffer name) {
    ...
    public static void glGetShaderSource(@NativeType(value="GLuint") int shader, @NativeType(value="GLsizei *") int @Nullable [] length, @NativeType(value="GLchar *") ByteBuffer source2) {
        long __functionAddress = GL.getICD().glGetShaderSource;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.checkSafe(length, 1);
        }
        JNI.callPPV(shader, source2.remaining(), length, MemoryUtil.memAddress(source2), __functionAddress);
    }
    ...
    public static void glGetActiveAttrib(@NativeType(value="GLuint") int program, @NativeType(value="GLuint") int index, @NativeType(value="GLsizei *") int @Nullable [] length, @NativeType(value="GLint *") int[] size, @NativeType(value="GLenum *") int[] type, @NativeType(value="GLchar *") ByteBuffer name) {
