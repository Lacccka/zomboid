...
public class ARBRobustness {
    ...
    public static void glGetnSeparableFilterARB(@NativeType(value="GLenum") int target, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="void *") ByteBuffer row, @NativeType(value="void *") ByteBuffer column, @NativeType(value="void *") @Nullable ByteBuffer span) {
    ...
    public static void glGetnHistogramARB(@NativeType(value="GLenum") int target, @NativeType(value="GLboolean") boolean reset, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="GLsizei") int bufSize, @NativeType(value="void *") long values2) {
        ARBRobustness.nglGetnHistogramARB(target, reset, format, type, bufSize, values2);
    }

    public static void glGetnHistogramARB(@NativeType(value="GLenum") int target, @NativeType(value="GLboolean") boolean reset, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="void *") ByteBuffer values2) {
        ARBRobustness.nglGetnHistogramARB(target, reset, format, type, values2.remaining(), MemoryUtil.memAddress(values2));
    }

    public static native void nglGetnMinmaxARB(int var0, boolean var1, int var2, int var3, int var4, long var5);

    public static void glGetnMinmaxARB(@NativeType(value="GLenum") int target, @NativeType(value="GLboolean") boolean reset, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="GLsizei") int bufSize, @NativeType(value="void *") long values2) {
        ARBRobustness.nglGetnMinmaxARB(target, reset, format, type, bufSize, values2);
    }

    public static void glGetnMinmaxARB(@NativeType(value="GLenum") int target, @NativeType(value="GLboolean") boolean reset, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="void *") ByteBuffer values2) {
        ARBRobustness.nglGetnMinmaxARB(target, reset, format, type, values2.remaining(), MemoryUtil.memAddress(values2));
    }
