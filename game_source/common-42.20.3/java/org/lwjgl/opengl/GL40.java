...
extends GL33 {
    ...
    public static void nglGetActiveSubroutineUniformiv(int program, int shadertype, int index, int pname, long values2) {
        GL40C.nglGetActiveSubroutineUniformiv(program, shadertype, index, pname, values2);
    }
    ...
    public static void glGetActiveSubroutineUniformiv(@NativeType(value="GLuint") int program, @NativeType(value="GLenum") int shadertype, @NativeType(value="GLuint") int index, @NativeType(value="GLenum") int pname, @NativeType(value="GLint *") IntBuffer values2) {
        GL40C.glGetActiveSubroutineUniformiv(program, shadertype, index, pname, values2);
    }
    ...
    public static void glGetActiveSubroutineUniformName(@NativeType(value="GLuint") int program, @NativeType(value="GLenum") int shadertype, @NativeType(value="GLuint") int index, @NativeType(value="GLsizei *") @Nullable IntBuffer length, @NativeType(value="GLchar *") ByteBuffer name) {
    ...
    public static void glGetActiveSubroutineName(@NativeType(value="GLuint") int program, @NativeType(value="GLenum") int shadertype, @NativeType(value="GLuint") int index, @NativeType(value="GLsizei *") @Nullable IntBuffer length, @NativeType(value="GLchar *") ByteBuffer name) {
    ...
    public static void nglGetProgramStageiv(int program, int shadertype, int pname, long values2) {
        GL40C.nglGetProgramStageiv(program, shadertype, pname, values2);
    }
    ...
    public static void glGetProgramStageiv(@NativeType(value="GLuint") int program, @NativeType(value="GLenum") int shadertype, @NativeType(value="GLenum") int pname, @NativeType(value="GLint *") IntBuffer values2) {
        GL40C.glGetProgramStageiv(program, shadertype, pname, values2);
    }
    ...
    public static void nglPatchParameterfv(int pname, long values2) {
        GL40C.nglPatchParameterfv(pname, values2);
    }

    public static void glPatchParameterfv(@NativeType(value="GLenum") int pname, @NativeType(value="GLfloat const *") FloatBuffer values2) {
        GL40C.glPatchParameterfv(pname, values2);
    }
    ...
    public static void glGetActiveSubroutineUniformName(@NativeType(value="GLuint") int program, @NativeType(value="GLenum") int shadertype, @NativeType(value="GLuint") int index, @NativeType(value="GLsizei *") int @Nullable [] length, @NativeType(value="GLchar *") ByteBuffer name) {
        GL40C.glGetActiveSubroutineUniformName(program, shadertype, index, length, name);
    }

    public static void glGetActiveSubroutineName(@NativeType(value="GLuint") int program, @NativeType(value="GLenum") int shadertype, @NativeType(value="GLuint") int index, @NativeType(value="GLsizei *") int @Nullable [] length, @NativeType(value="GLchar *") ByteBuffer name) {
        GL40C.glGetActiveSubroutineName(program, shadertype, index, length, name);
    }
    ...
    public static void glPatchParameterfv(@NativeType(value="GLenum") int pname, @NativeType(value="GLfloat const *") float[] values2) {
        GL40C.glPatchParameterfv(pname, values2);
    }
