...
public final class GLCapabilities {
    ...
    /*
     * Opcode count of 13638 triggered aggressive code reduction.  Override with --aggressivesizethreshold.
     */
    GLCapabilities(FunctionProvider provider, Set<String> ext, boolean fc, IntFunction<PointerBuffer> bufferFactory) {
        ...
        PointerBuffer caps = bufferFactory.apply(2236);
        ...
        this.GL_EXT_fragment_shading_rate = GLCapabilities.check_EXT_fragment_shading_rate(provider, caps, ext);
        this.GL_EXT_fragment_shading_rate_attachment = ext.contains("GL_EXT_fragment_shading_rate_attachment");
        this.GL_EXT_fragment_shading_rate_primitive = ext.contains("GL_EXT_fragment_shading_rate_primitive");
        ...
        this.GL_EXT_mesh_shader = GLCapabilities.check_EXT_mesh_shader(provider, caps, ext);
        ...
        this.GL_EXT_shader_realtime_clock = ext.contains("GL_EXT_shader_realtime_clock");
        this.GL_EXT_shader_samples_identical = ext.contains("GL_EXT_shader_samples_identical");
        this.GL_EXT_shader_texture_samples = ext.contains("GL_EXT_shader_texture_samples");
        ...
        this.glShadingRateEXT = caps.get(1732);
        this.glShadingRateCombinerOpsEXT = caps.get(1733);
        this.glFramebufferShadingRateEXT = caps.get(1734);
        this.glGetFragmentShadingRatesEXT = caps.get(1735);
        this.glBlitFramebufferEXT = caps.get(1736);
        this.glBlitFramebufferLayersEXT = caps.get(1737);
        this.glBlitFramebufferLayerEXT = caps.get(1738);
        this.glRenderbufferStorageMultisampleEXT = caps.get(1739);
        this.glIsRenderbufferEXT = caps.get(1740);
        this.glBindRenderbufferEXT = caps.get(1741);
        this.glDeleteRenderbuffersEXT = caps.get(1742);
        this.glGenRenderbuffersEXT = caps.get(1743);
        this.glRenderbufferStorageEXT = caps.get(1744);
        this.glGetRenderbufferParameterivEXT = caps.get(1745);
        this.glIsFramebufferEXT = caps.get(1746);
        this.glBindFramebufferEXT = caps.get(1747);
        this.glDeleteFramebuffersEXT = caps.get(1748);
        this.glGenFramebuffersEXT = caps.get(1749);
        this.glCheckFramebufferStatusEXT = caps.get(1750);
        this.glFramebufferTexture1DEXT = caps.get(1751);
        this.glFramebufferTexture2DEXT = caps.get(1752);
        this.glFramebufferTexture3DEXT = caps.get(1753);
        this.glFramebufferRenderbufferEXT = caps.get(1754);
        this.glGetFramebufferAttachmentParameterivEXT = caps.get(1755);
        this.glGenerateMipmapEXT = caps.get(1756);
        this.glProgramParameteriEXT = caps.get(1757);
        this.glFramebufferTextureEXT = caps.get(1758);
        this.glFramebufferTextureLayerEXT = caps.get(1759);
        this.glFramebufferTextureFaceEXT = caps.get(1760);
        this.glProgramEnvParameters4fvEXT = caps.get(1761);
        this.glProgramLocalParameters4fvEXT = caps.get(1762);
        this.glVertexAttribI1iEXT = caps.get(1763);
        this.glVertexAttribI2iEXT = caps.get(1764);
        this.glVertexAttribI3iEXT = caps.get(1765);
        this.glVertexAttribI4iEXT = caps.get(1766);
        this.glVertexAttribI1uiEXT = caps.get(1767);
        this.glVertexAttribI2uiEXT = caps.get(1768);
        this.glVertexAttribI3uiEXT = caps.get(1769);
        this.glVertexAttribI4uiEXT = caps.get(1770);
        this.glVertexAttribI1ivEXT = caps.get(1771);
        this.glVertexAttribI2ivEXT = caps.get(1772);
        this.glVertexAttribI3ivEXT = caps.get(1773);
        this.glVertexAttribI4ivEXT = caps.get(1774);
        this.glVertexAttribI1uivEXT = caps.get(1775);
        this.glVertexAttribI2uivEXT = caps.get(1776);
        this.glVertexAttribI3uivEXT = caps.get(1777);
        this.glVertexAttribI4uivEXT = caps.get(1778);
        this.glVertexAttribI4bvEXT = caps.get(1779);
        this.glVertexAttribI4svEXT = caps.get(1780);
        this.glVertexAttribI4ubvEXT = caps.get(1781);
        this.glVertexAttribI4usvEXT = caps.get(1782);
        this.glVertexAttribIPointerEXT = caps.get(1783);
        this.glGetVertexAttribIivEXT = caps.get(1784);
        this.glGetVertexAttribIuivEXT = caps.get(1785);
        this.glGetUniformuivEXT = caps.get(1786);
        this.glBindFragDataLocationEXT = caps.get(1787);
        this.glGetFragDataLocationEXT = caps.get(1788);
        this.glUniform1uiEXT = caps.get(1789);
        this.glUniform2uiEXT = caps.get(1790);
        this.glUniform3uiEXT = caps.get(1791);
        this.glUniform4uiEXT = caps.get(1792);
        this.glUniform1uivEXT = caps.get(1793);
        this.glUniform2uivEXT = caps.get(1794);
        this.glUniform3uivEXT = caps.get(1795);
        this.glUniform4uivEXT = caps.get(1796);
        this.glGetUnsignedBytevEXT = caps.get(1797);
        this.glGetUnsignedBytei_vEXT = caps.get(1798);
        this.glDeleteMemoryObjectsEXT = caps.get(1799);
        this.glIsMemoryObjectEXT = caps.get(1800);
        this.glCreateMemoryObjectsEXT = caps.get(1801);
        this.glMemoryObjectParameterivEXT = caps.get(1802);
        this.glGetMemoryObjectParameterivEXT = caps.get(1803);
        this.glTexStorageMem2DEXT = caps.get(1804);
        this.glTexStorageMem2DMultisampleEXT = caps.get(1805);
        this.glTexStorageMem3DEXT = caps.get(1806);
        this.glTexStorageMem3DMultisampleEXT = caps.get(1807);
        this.glBufferStorageMemEXT = caps.get(1808);
        this.glTextureStorageMem2DEXT = caps.get(1809);
        this.glTextureStorageMem2DMultisampleEXT = caps.get(1810);
        this.glTextureStorageMem3DEXT = caps.get(1811);
        this.glTextureStorageMem3DMultisampleEXT = caps.get(1812);
        this.glNamedBufferStorageMemEXT = caps.get(1813);
        this.glTexStorageMem1DEXT = caps.get(1814);
        this.glTextureStorageMem1DEXT = caps.get(1815);
        this.glImportMemoryFdEXT = caps.get(1816);
        this.glImportMemoryWin32HandleEXT = caps.get(1817);
        this.glImportMemoryWin32NameEXT = caps.get(1818);
        this.glDrawMeshTasksEXT = caps.get(1819);
        this.glDrawMeshTasksIndirectEXT = caps.get(1820);
        this.glMultiDrawMeshTasksIndirectEXT = caps.get(1821);
        this.glMultiDrawMeshTasksIndirectCountEXT = caps.get(1822);
        this.glPointParameterfEXT = caps.get(1823);
        this.glPointParameterfvEXT = caps.get(1824);
        this.glPolygonOffsetClampEXT = caps.get(1825);
        this.glProvokingVertexEXT = caps.get(1826);
        this.glRasterSamplesEXT = caps.get(1827);
        this.glSecondaryColor3bEXT = caps.get(1828);
        this.glSecondaryColor3sEXT = caps.get(1829);
        this.glSecondaryColor3iEXT = caps.get(1830);
        this.glSecondaryColor3fEXT = caps.get(1831);
        this.glSecondaryColor3dEXT = caps.get(1832);
        this.glSecondaryColor3ubEXT = caps.get(1833);
        this.glSecondaryColor3usEXT = caps.get(1834);
        this.glSecondaryColor3uiEXT = caps.get(1835);
        this.glSecondaryColor3bvEXT = caps.get(1836);
        this.glSecondaryColor3svEXT = caps.get(1837);
        this.glSecondaryColor3ivEXT = caps.get(1838);
        this.glSecondaryColor3fvEXT = caps.get(1839);
        this.glSecondaryColor3dvEXT = caps.get(1840);
        this.glSecondaryColor3ubvEXT = caps.get(1841);
        this.glSecondaryColor3usvEXT = caps.get(1842);
        this.glSecondaryColor3uivEXT = caps.get(1843);
        this.glSecondaryColorPointerEXT = caps.get(1844);
        this.glGenSemaphoresEXT = caps.get(1845);
        this.glDeleteSemaphoresEXT = caps.get(1846);
        this.glIsSemaphoreEXT = caps.get(1847);
        this.glSemaphoreParameterui64vEXT = caps.get(1848);
        this.glGetSemaphoreParameterui64vEXT = caps.get(1849);
        this.glWaitSemaphoreEXT = caps.get(1850);
        this.glSignalSemaphoreEXT = caps.get(1851);
        this.glImportSemaphoreFdEXT = caps.get(1852);
        this.glImportSemaphoreWin32HandleEXT = caps.get(1853);
        this.glImportSemaphoreWin32NameEXT = caps.get(1854);
        this.glUseShaderProgramEXT = caps.get(1855);
        this.glActiveProgramEXT = caps.get(1856);
        this.glCreateShaderProgramEXT = caps.get(1857);
        this.glFramebufferFetchBarrierEXT = caps.get(1858);
        this.glBindImageTextureEXT = caps.get(1859);
        this.glMemoryBarrierEXT = caps.get(1860);
        this.glStencilClearTagEXT = caps.get(1861);
        this.glActiveStencilFaceEXT = caps.get(1862);
        this.glTexBufferEXT = caps.get(1863);
        this.glClearColorIiEXT = caps.get(1864);
        this.glClearColorIuiEXT = caps.get(1865);
        this.glTexParameterIivEXT = caps.get(1866);
        this.glTexParameterIuivEXT = caps.get(1867);
        this.glGetTexParameterIivEXT = caps.get(1868);
        this.glGetTexParameterIuivEXT = caps.get(1869);
        this.glTexStorage1DEXT = caps.get(1870);
        this.glTexStorage2DEXT = caps.get(1871);
        this.glTexStorage3DEXT = caps.get(1872);
        this.glGetQueryObjecti64vEXT = caps.get(1873);
        this.glGetQueryObjectui64vEXT = caps.get(1874);
        this.glBindBufferRangeEXT = caps.get(1875);
        this.glBindBufferOffsetEXT = caps.get(1876);
        this.glBindBufferBaseEXT = caps.get(1877);
        this.glBeginTransformFeedbackEXT = caps.get(1878);
        this.glEndTransformFeedbackEXT = caps.get(1879);
        this.glTransformFeedbackVaryingsEXT = caps.get(1880);
        this.glGetTransformFeedbackVaryingEXT = caps.get(1881);
        this.glVertexAttribL1dEXT = caps.get(1882);
        this.glVertexAttribL2dEXT = caps.get(1883);
        this.glVertexAttribL3dEXT = caps.get(1884);
        this.glVertexAttribL4dEXT = caps.get(1885);
        this.glVertexAttribL1dvEXT = caps.get(1886);
        this.glVertexAttribL2dvEXT = caps.get(1887);
        this.glVertexAttribL3dvEXT = caps.get(1888);
        this.glVertexAttribL4dvEXT = caps.get(1889);
        this.glVertexAttribLPointerEXT = caps.get(1890);
        this.glGetVertexAttribLdvEXT = caps.get(1891);
        this.glAcquireKeyedMutexWin32EXT = caps.get(1892);
        this.glReleaseKeyedMutexWin32EXT = caps.get(1893);
        this.glWindowRectanglesEXT = caps.get(1894);
        this.glImportSyncEXT = caps.get(1895);
        this.glFrameTerminatorGREMEDY = caps.get(1896);
        this.glStringMarkerGREMEDY = caps.get(1897);
        this.glApplyFramebufferAttachmentCMAAINTEL = caps.get(1898);
        this.glSyncTextureINTEL = caps.get(1899);
        this.glUnmapTexture2DINTEL = caps.get(1900);
        this.glMapTexture2DINTEL = caps.get(1901);
        this.glBeginPerfQueryINTEL = caps.get(1902);
        this.glCreatePerfQueryINTEL = caps.get(1903);
        this.glDeletePerfQueryINTEL = caps.get(1904);
        this.glEndPerfQueryINTEL = caps.get(1905);
        this.glGetFirstPerfQueryIdINTEL = caps.get(1906);
        this.glGetNextPerfQueryIdINTEL = caps.get(1907);
        this.glGetPerfCounterInfoINTEL = caps.get(1908);
        this.glGetPerfQueryDataINTEL = caps.get(1909);
        this.glGetPerfQueryIdByNameINTEL = caps.get(1910);
        this.glGetPerfQueryInfoINTEL = caps.get(1911);
        this.glBlendBarrierKHR = caps.get(1912);
        this.glMaxShaderCompilerThreadsKHR = caps.get(1913);
        this.glFramebufferParameteriMESA = caps.get(1914);
        this.glGetFramebufferParameterivMESA = caps.get(1915);
        this.glAlphaToCoverageDitherControlNV = caps.get(1916);
        this.glMultiDrawArraysIndirectBindlessNV = caps.get(1917);
        this.glMultiDrawElementsIndirectBindlessNV = caps.get(1918);
        this.glMultiDrawArraysIndirectBindlessCountNV = caps.get(1919);
        this.glMultiDrawElementsIndirectBindlessCountNV = caps.get(1920);
        this.glGetTextureHandleNV = caps.get(1921);
        this.glGetTextureSamplerHandleNV = caps.get(1922);
        this.glMakeTextureHandleResidentNV = caps.get(1923);
        this.glMakeTextureHandleNonResidentNV = caps.get(1924);
        this.glGetImageHandleNV = caps.get(1925);
        this.glMakeImageHandleResidentNV = caps.get(1926);
        this.glMakeImageHandleNonResidentNV = caps.get(1927);
        this.glUniformHandleui64NV = caps.get(1928);
        this.glUniformHandleui64vNV = caps.get(1929);
        this.glProgramUniformHandleui64NV = caps.get(1930);
        this.glProgramUniformHandleui64vNV = caps.get(1931);
        this.glIsTextureHandleResidentNV = caps.get(1932);
        this.glIsImageHandleResidentNV = caps.get(1933);
        this.glBlendParameteriNV = caps.get(1934);
        this.glBlendBarrierNV = caps.get(1935);
        this.glViewportPositionWScaleNV = caps.get(1936);
        this.glCreateStatesNV = caps.get(1937);
        this.glDeleteStatesNV = caps.get(1938);
        this.glIsStateNV = caps.get(1939);
        this.glStateCaptureNV = caps.get(1940);
        this.glGetCommandHeaderNV = caps.get(1941);
        this.glGetStageIndexNV = caps.get(1942);
        this.glDrawCommandsNV = caps.get(1943);
        this.glDrawCommandsAddressNV = caps.get(1944);
        this.glDrawCommandsStatesNV = caps.get(1945);
        this.glDrawCommandsStatesAddressNV = caps.get(1946);
        this.glCreateCommandListsNV = caps.get(1947);
        this.glDeleteCommandListsNV = caps.get(1948);
        this.glIsCommandListNV = caps.get(1949);
        this.glListDrawCommandsStatesClientNV = caps.get(1950);
        this.glCommandListSegmentsNV = caps.get(1951);
        this.glCompileCommandListNV = caps.get(1952);
        this.glCallCommandListNV = caps.get(1953);
        this.glBeginConditionalRenderNV = caps.get(1954);
        this.glEndConditionalRenderNV = caps.get(1955);
        this.glSubpixelPrecisionBiasNV = caps.get(1956);
        this.glConservativeRasterParameterfNV = caps.get(1957);
        this.glConservativeRasterParameteriNV = caps.get(1958);
        this.glCopyImageSubDataNV = caps.get(1959);
        this.glDepthRangedNV = caps.get(1960);
        this.glClearDepthdNV = caps.get(1961);
        this.glDepthBoundsdNV = caps.get(1962);
        this.glDrawTextureNV = caps.get(1963);
        this.glDrawVkImageNV = caps.get(1964);
        this.glGetVkProcAddrNV = caps.get(1965);
        this.glWaitVkSemaphoreNV = caps.get(1966);
        this.glSignalVkSemaphoreNV = caps.get(1967);
        this.glSignalVkFenceNV = caps.get(1968);
        this.glGetMultisamplefvNV = caps.get(1969);
        this.glSampleMaskIndexedNV = caps.get(1970);
        this.glTexRenderbufferNV = caps.get(1971);
        this.glDeleteFencesNV = caps.get(1972);
        this.glGenFencesNV = caps.get(1973);
        this.glIsFenceNV = caps.get(1974);
        this.glTestFenceNV = caps.get(1975);
        this.glGetFenceivNV = caps.get(1976);
        this.glFinishFenceNV = caps.get(1977);
        this.glSetFenceNV = caps.get(1978);
        this.glFragmentCoverageColorNV = caps.get(1979);
        this.glCoverageModulationTableNV = caps.get(1980);
        this.glGetCoverageModulationTableNV = caps.get(1981);
        this.glCoverageModulationNV = caps.get(1982);
        this.glRenderbufferStorageMultisampleCoverageNV = caps.get(1983);
        this.glRenderGpuMaskNV = caps.get(1984);
        this.glMulticastBufferSubDataNV = caps.get(1985);
        this.glMulticastCopyBufferSubDataNV = caps.get(1986);
        this.glMulticastCopyImageSubDataNV = caps.get(1987);
        this.glMulticastBlitFramebufferNV = caps.get(1988);
        this.glMulticastFramebufferSampleLocationsfvNV = caps.get(1989);
        this.glMulticastBarrierNV = caps.get(1990);
        this.glMulticastWaitSyncNV = caps.get(1991);
        this.glMulticastGetQueryObjectivNV = caps.get(1992);
        this.glMulticastGetQueryObjectuivNV = caps.get(1993);
        this.glMulticastGetQueryObjecti64vNV = caps.get(1994);
        this.glMulticastGetQueryObjectui64vNV = caps.get(1995);
        this.glVertex2hNV = caps.get(1996);
        this.glVertex2hvNV = caps.get(1997);
        this.glVertex3hNV = caps.get(1998);
        this.glVertex3hvNV = caps.get(1999);
        this.glVertex4hNV = caps.get(2000);
        this.glVertex4hvNV = caps.get(2001);
        this.glNormal3hNV = caps.get(2002);
        this.glNormal3hvNV = caps.get(2003);
        this.glColor3hNV = caps.get(2004);
        this.glColor3hvNV = caps.get(2005);
        this.glColor4hNV = caps.get(2006);
        this.glColor4hvNV = caps.get(2007);
        this.glTexCoord1hNV = caps.get(2008);
        this.glTexCoord1hvNV = caps.get(2009);
        this.glTexCoord2hNV = caps.get(2010);
        this.glTexCoord2hvNV = caps.get(2011);
        this.glTexCoord3hNV = caps.get(2012);
        this.glTexCoord3hvNV = caps.get(2013);
        this.glTexCoord4hNV = caps.get(2014);
        this.glTexCoord4hvNV = caps.get(2015);
        this.glMultiTexCoord1hNV = caps.get(2016);
        this.glMultiTexCoord1hvNV = caps.get(2017);
        this.glMultiTexCoord2hNV = caps.get(2018);
        this.glMultiTexCoord2hvNV = caps.get(2019);
        this.glMultiTexCoord3hNV = caps.get(2020);
        this.glMultiTexCoord3hvNV = caps.get(2021);
        this.glMultiTexCoord4hNV = caps.get(2022);
        this.glMultiTexCoord4hvNV = caps.get(2023);
        this.glFogCoordhNV = caps.get(2024);
        this.glFogCoordhvNV = caps.get(2025);
        this.glSecondaryColor3hNV = caps.get(2026);
        this.glSecondaryColor3hvNV = caps.get(2027);
        this.glVertexWeighthNV = caps.get(2028);
        this.glVertexWeighthvNV = caps.get(2029);
        this.glVertexAttrib1hNV = caps.get(2030);
        this.glVertexAttrib1hvNV = caps.get(2031);
        this.glVertexAttrib2hNV = caps.get(2032);
        this.glVertexAttrib2hvNV = caps.get(2033);
        this.glVertexAttrib3hNV = caps.get(2034);
        this.glVertexAttrib3hvNV = caps.get(2035);
        this.glVertexAttrib4hNV = caps.get(2036);
        this.glVertexAttrib4hvNV = caps.get(2037);
        this.glVertexAttribs1hvNV = caps.get(2038);
        this.glVertexAttribs2hvNV = caps.get(2039);
        this.glVertexAttribs3hvNV = caps.get(2040);
        this.glVertexAttribs4hvNV = caps.get(2041);
        this.glGetInternalformatSampleivNV = caps.get(2042);
        this.glGetMemoryObjectDetachedResourcesuivNV = caps.get(2043);
        this.glResetMemoryObjectParameterNV = caps.get(2044);
        this.glTexAttachMemoryNV = caps.get(2045);
        this.glBufferAttachMemoryNV = caps.get(2046);
        this.glTextureAttachMemoryNV = caps.get(2047);
        this.glNamedBufferAttachMemoryNV = caps.get(2048);
        this.glBufferPageCommitmentMemNV = caps.get(2049);
        this.glNamedBufferPageCommitmentMemNV = caps.get(2050);
        this.glTexPageCommitmentMemNV = caps.get(2051);
        this.glTexturePageCommitmentMemNV = caps.get(2052);
        this.glDrawMeshTasksNV = caps.get(2053);
        this.glDrawMeshTasksIndirectNV = caps.get(2054);
        this.glMultiDrawMeshTasksIndirectNV = caps.get(2055);
        this.glMultiDrawMeshTasksIndirectCountNV = caps.get(2056);
        this.glPathCommandsNV = caps.get(2057);
        this.glPathCoordsNV = caps.get(2058);
        this.glPathSubCommandsNV = caps.get(2059);
        this.glPathSubCoordsNV = caps.get(2060);
        this.glPathStringNV = caps.get(2061);
        this.glPathGlyphsNV = caps.get(2062);
        this.glPathGlyphRangeNV = caps.get(2063);
        this.glPathGlyphIndexArrayNV = caps.get(2064);
        this.glPathMemoryGlyphIndexArrayNV = caps.get(2065);
        this.glCopyPathNV = caps.get(2066);
        this.glWeightPathsNV = caps.get(2067);
        this.glInterpolatePathsNV = caps.get(2068);
        this.glTransformPathNV = caps.get(2069);
        this.glPathParameterivNV = caps.get(2070);
        this.glPathParameteriNV = caps.get(2071);
        this.glPathParameterfvNV = caps.get(2072);
        this.glPathParameterfNV = caps.get(2073);
        this.glPathDashArrayNV = caps.get(2074);
        this.glGenPathsNV = caps.get(2075);
        this.glDeletePathsNV = caps.get(2076);
        this.glIsPathNV = caps.get(2077);
        this.glPathStencilFuncNV = caps.get(2078);
        this.glPathStencilDepthOffsetNV = caps.get(2079);
        this.glStencilFillPathNV = caps.get(2080);
        this.glStencilStrokePathNV = caps.get(2081);
        this.glStencilFillPathInstancedNV = caps.get(2082);
        this.glStencilStrokePathInstancedNV = caps.get(2083);
        this.glPathCoverDepthFuncNV = caps.get(2084);
        this.glPathColorGenNV = caps.get(2085);
        this.glPathTexGenNV = caps.get(2086);
        this.glPathFogGenNV = caps.get(2087);
        this.glCoverFillPathNV = caps.get(2088);
        this.glCoverStrokePathNV = caps.get(2089);
        this.glCoverFillPathInstancedNV = caps.get(2090);
        this.glCoverStrokePathInstancedNV = caps.get(2091);
        this.glStencilThenCoverFillPathNV = caps.get(2092);
        this.glStencilThenCoverStrokePathNV = caps.get(2093);
        this.glStencilThenCoverFillPathInstancedNV = caps.get(2094);
        this.glStencilThenCoverStrokePathInstancedNV = caps.get(2095);
        this.glPathGlyphIndexRangeNV = caps.get(2096);
        this.glProgramPathFragmentInputGenNV = caps.get(2097);
        this.glGetPathParameterivNV = caps.get(2098);
        this.glGetPathParameterfvNV = caps.get(2099);
        this.glGetPathCommandsNV = caps.get(2100);
        this.glGetPathCoordsNV = caps.get(2101);
        this.glGetPathDashArrayNV = caps.get(2102);
        this.glGetPathMetricsNV = caps.get(2103);
        this.glGetPathMetricRangeNV = caps.get(2104);
        this.glGetPathSpacingNV = caps.get(2105);
        this.glGetPathColorGenivNV = caps.get(2106);
        this.glGetPathColorGenfvNV = caps.get(2107);
        this.glGetPathTexGenivNV = caps.get(2108);
        this.glGetPathTexGenfvNV = caps.get(2109);
        this.glIsPointInFillPathNV = caps.get(2110);
        this.glIsPointInStrokePathNV = caps.get(2111);
        this.glGetPathLengthNV = caps.get(2112);
        this.glPointAlongPathNV = caps.get(2113);
        this.glMatrixLoad3x2fNV = caps.get(2114);
        this.glMatrixLoad3x3fNV = caps.get(2115);
        this.glMatrixLoadTranspose3x3fNV = caps.get(2116);
        this.glMatrixMult3x2fNV = caps.get(2117);
        this.glMatrixMult3x3fNV = caps.get(2118);
        this.glMatrixMultTranspose3x3fNV = caps.get(2119);
        this.glGetProgramResourcefvNV = caps.get(2120);
        this.glPixelDataRangeNV = caps.get(2121);
        this.glFlushPixelDataRangeNV = caps.get(2122);
        this.glPointParameteriNV = caps.get(2123);
        this.glPointParameterivNV = caps.get(2124);
        this.glPrimitiveRestartNV = caps.get(2125);
        this.glPrimitiveRestartIndexNV = caps.get(2126);
        this.glQueryResourceNV = caps.get(2127);
        this.glGenQueryResourceTagNV = caps.get(2128);
        this.glDeleteQueryResourceTagNV = caps.get(2129);
        this.glQueryResourceTagNV = caps.get(2130);
        this.glFramebufferSampleLocationsfvNV = caps.get(2131);
        this.glNamedFramebufferSampleLocationsfvNV = caps.get(2132);
        this.glResolveDepthValuesNV = caps.get(2133);
        this.glScissorExclusiveArrayvNV = caps.get(2134);
        this.glScissorExclusiveNV = caps.get(2135);
        this.glMakeBufferResidentNV = caps.get(2136);
        this.glMakeBufferNonResidentNV = caps.get(2137);
        this.glIsBufferResidentNV = caps.get(2138);
        this.glMakeNamedBufferResidentNV = caps.get(2139);
        this.glMakeNamedBufferNonResidentNV = caps.get(2140);
        this.glIsNamedBufferResidentNV = caps.get(2141);
        this.glGetBufferParameterui64vNV = caps.get(2142);
        this.glGetNamedBufferParameterui64vNV = caps.get(2143);
        this.glGetIntegerui64vNV = caps.get(2144);
        this.glUniformui64NV = caps.get(2145);
        this.glUniformui64vNV = caps.get(2146);
        this.glProgramUniformui64NV = caps.get(2147);
        this.glProgramUniformui64vNV = caps.get(2148);
        this.glBindShadingRateImageNV = caps.get(2149);
        this.glShadingRateImagePaletteNV = caps.get(2150);
        this.glGetShadingRateImagePaletteNV = caps.get(2151);
        this.glShadingRateImageBarrierNV = caps.get(2152);
        this.glShadingRateSampleOrderNV = caps.get(2153);
        this.glShadingRateSampleOrderCustomNV = caps.get(2154);
        this.glGetShadingRateSampleLocationivNV = caps.get(2155);
        this.glTextureBarrierNV = caps.get(2156);
        this.glTexImage2DMultisampleCoverageNV = caps.get(2157);
        this.glTexImage3DMultisampleCoverageNV = caps.get(2158);
        this.glTextureImage2DMultisampleNV = caps.get(2159);
        this.glTextureImage3DMultisampleNV = caps.get(2160);
        this.glTextureImage2DMultisampleCoverageNV = caps.get(2161);
        this.glTextureImage3DMultisampleCoverageNV = caps.get(2162);
        this.glCreateSemaphoresNV = caps.get(2163);
        this.glSemaphoreParameterivNV = caps.get(2164);
        this.glGetSemaphoreParameterivNV = caps.get(2165);
        this.glBeginTransformFeedbackNV = caps.get(2166);
        this.glEndTransformFeedbackNV = caps.get(2167);
        this.glTransformFeedbackAttribsNV = caps.get(2168);
        this.glBindBufferRangeNV = caps.get(2169);
        this.glBindBufferOffsetNV = caps.get(2170);
        this.glBindBufferBaseNV = caps.get(2171);
        this.glTransformFeedbackVaryingsNV = caps.get(2172);
        this.glActiveVaryingNV = caps.get(2173);
        this.glGetVaryingLocationNV = caps.get(2174);
        this.glGetActiveVaryingNV = caps.get(2175);
        this.glGetTransformFeedbackVaryingNV = caps.get(2176);
        this.glTransformFeedbackStreamAttribsNV = caps.get(2177);
        this.glBindTransformFeedbackNV = caps.get(2178);
        this.glDeleteTransformFeedbacksNV = caps.get(2179);
        this.glGenTransformFeedbacksNV = caps.get(2180);
        this.glIsTransformFeedbackNV = caps.get(2181);
        this.glPauseTransformFeedbackNV = caps.get(2182);
        this.glResumeTransformFeedbackNV = caps.get(2183);
        this.glDrawTransformFeedbackNV = caps.get(2184);
        this.glVertexArrayRangeNV = caps.get(2185);
        this.glFlushVertexArrayRangeNV = caps.get(2186);
        this.glVertexAttribL1i64NV = caps.get(2187);
        this.glVertexAttribL2i64NV = caps.get(2188);
        this.glVertexAttribL3i64NV = caps.get(2189);
        this.glVertexAttribL4i64NV = caps.get(2190);
        this.glVertexAttribL1i64vNV = caps.get(2191);
        this.glVertexAttribL2i64vNV = caps.get(2192);
        this.glVertexAttribL3i64vNV = caps.get(2193);
        this.glVertexAttribL4i64vNV = caps.get(2194);
        this.glVertexAttribL1ui64NV = caps.get(2195);
        this.glVertexAttribL2ui64NV = caps.get(2196);
        this.glVertexAttribL3ui64NV = caps.get(2197);
        this.glVertexAttribL4ui64NV = caps.get(2198);
        this.glVertexAttribL1ui64vNV = caps.get(2199);
        this.glVertexAttribL2ui64vNV = caps.get(2200);
        this.glVertexAttribL3ui64vNV = caps.get(2201);
        this.glVertexAttribL4ui64vNV = caps.get(2202);
        this.glGetVertexAttribLi64vNV = caps.get(2203);
        this.glGetVertexAttribLui64vNV = caps.get(2204);
        this.glVertexAttribLFormatNV = caps.get(2205);
        this.glBufferAddressRangeNV = caps.get(2206);
        this.glVertexFormatNV = caps.get(2207);
        this.glNormalFormatNV = caps.get(2208);
        this.glColorFormatNV = caps.get(2209);
        this.glIndexFormatNV = caps.get(2210);
        this.glTexCoordFormatNV = caps.get(2211);
        this.glEdgeFlagFormatNV = caps.get(2212);
        this.glSecondaryColorFormatNV = caps.get(2213);
        this.glFogCoordFormatNV = caps.get(2214);
        this.glVertexAttribFormatNV = caps.get(2215);
        this.glVertexAttribIFormatNV = caps.get(2216);
        this.glGetIntegerui64i_vNV = caps.get(2217);
        this.glViewportSwizzleNV = caps.get(2218);
        this.glBeginConditionalRenderNVX = caps.get(2219);
        this.glEndConditionalRenderNVX = caps.get(2220);
        this.glAsyncCopyImageSubDataNVX = caps.get(2221);
        this.glAsyncCopyBufferSubDataNVX = caps.get(2222);
        this.glUploadGpuMaskNVX = caps.get(2223);
        this.glMulticastViewportArrayvNVX = caps.get(2224);
        this.glMulticastScissorArrayvNVX = caps.get(2225);
        this.glMulticastViewportPositionWScaleNVX = caps.get(2226);
        this.glCreateProgressFenceNVX = caps.get(2227);
        this.glSignalSemaphoreui64NVX = caps.get(2228);
        this.glWaitSemaphoreui64NVX = caps.get(2229);
        this.glClientWaitSemaphoreui64NVX = caps.get(2230);
        this.glFramebufferTextureMultiviewOVR = caps.get(2231);
        this.glNamedFramebufferTextureMultiviewOVR = caps.get(2232);
    ...
    private static boolean check_EXT_fragment_shading_rate(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1732, 1733, 1734, 1735}, "glShadingRateEXT", "glShadingRateCombinerOpsEXT", "glFramebufferShadingRateEXT", "glGetFragmentShadingRatesEXT") || Checks.reportMissing("GL", "GL_EXT_fragment_shading_rate");
    }
    ...
    private static boolean check_EXT_framebuffer_blit(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1736}, "glBlitFramebufferEXT") || Checks.reportMissing("GL", "GL_EXT_framebuffer_blit");
    }
    ...
    private static boolean check_EXT_framebuffer_blit_layers(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1737, 1738}, "glBlitFramebufferLayersEXT", "glBlitFramebufferLayerEXT") || Checks.reportMissing("GL", "GL_EXT_framebuffer_blit_layers");
    }
    ...
    private static boolean check_EXT_framebuffer_multisample(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1739}, "glRenderbufferStorageMultisampleEXT") || Checks.reportMissing("GL", "GL_EXT_framebuffer_multisample");
    }
    ...
    private static boolean check_EXT_geometry_shader4(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1757, 1758, 1759, 1760}, "glProgramParameteriEXT", "glFramebufferTextureEXT", "glFramebufferTextureLayerEXT", "glFramebufferTextureFaceEXT") || Checks.reportMissing("GL", "GL_EXT_geometry_shader4");
    }
    ...
    private static boolean check_EXT_gpu_program_parameters(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1761, 1762}, "glProgramEnvParameters4fvEXT", "glProgramLocalParameters4fvEXT") || Checks.reportMissing("GL", "GL_EXT_gpu_program_parameters");
    }
    ...
    private static boolean check_EXT_memory_object(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        int flag0 = GLCapabilities.hasDSA(ext) ? 0 : Integer.MIN_VALUE;
        return Checks.checkFunctions(provider, caps, new int[]{1797, 1798, 1799, 1800, 1801, 1802, 1803, 1804, 1805, 1806, 1807, 1808, flag0 + 1809, flag0 + 1810, flag0 + 1811, flag0 + 1812, flag0 + 1813, 1814, flag0 + 1815}, "glGetUnsignedBytevEXT", "glGetUnsignedBytei_vEXT", "glDeleteMemoryObjectsEXT", "glIsMemoryObjectEXT", "glCreateMemoryObjectsEXT", "glMemoryObjectParameterivEXT", "glGetMemoryObjectParameterivEXT", "glTexStorageMem2DEXT", "glTexStorageMem2DMultisampleEXT", "glTexStorageMem3DEXT", "glTexStorageMem3DMultisampleEXT", "glBufferStorageMemEXT", "glTextureStorageMem2DEXT", "glTextureStorageMem2DMultisampleEXT", "glTextureStorageMem3DEXT", "glTextureStorageMem3DMultisampleEXT", "glNamedBufferStorageMemEXT", "glTexStorageMem1DEXT", "glTextureStorageMem1DEXT") || Checks.reportMissing("GL", "GL_EXT_memory_object");
    }
    ...
    private static boolean check_EXT_memory_object_fd(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1816}, "glImportMemoryFdEXT") || Checks.reportMissing("GL", "GL_EXT_memory_object_fd");
    }
    ...
    private static boolean check_EXT_memory_object_win32(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1817, 1818}, "glImportMemoryWin32HandleEXT", "glImportMemoryWin32NameEXT") || Checks.reportMissing("GL", "GL_EXT_memory_object_win32");
    }
    ...
    private static boolean check_EXT_mesh_shader(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1819, 1820, 1821, 1822}, "glDrawMeshTasksEXT", "glDrawMeshTasksIndirectEXT", "glMultiDrawMeshTasksIndirectEXT", "glMultiDrawMeshTasksIndirectCountEXT") || Checks.reportMissing("GL", "GL_EXT_mesh_shader");
    }
    ...
    private static boolean check_EXT_point_parameters(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1823, 1824}, "glPointParameterfEXT", "glPointParameterfvEXT") || Checks.reportMissing("GL", "GL_EXT_point_parameters");
    }
    ...
    private static boolean check_EXT_polygon_offset_clamp(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1825}, "glPolygonOffsetClampEXT") || Checks.reportMissing("GL", "GL_EXT_polygon_offset_clamp");
    }
    ...
    private static boolean check_EXT_provoking_vertex(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1826}, "glProvokingVertexEXT") || Checks.reportMissing("GL", "GL_EXT_provoking_vertex");
    }
    ...
    private static boolean check_EXT_raster_multisample(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1827}, "glRasterSamplesEXT") || Checks.reportMissing("GL", "GL_EXT_raster_multisample");
    }
    ...
    private static boolean check_EXT_semaphore(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1797, 1798, 1845, 1846, 1847, 1848, 1849, 1850, 1851}, "glGetUnsignedBytevEXT", "glGetUnsignedBytei_vEXT", "glGenSemaphoresEXT", "glDeleteSemaphoresEXT", "glIsSemaphoreEXT", "glSemaphoreParameterui64vEXT", "glGetSemaphoreParameterui64vEXT", "glWaitSemaphoreEXT", "glSignalSemaphoreEXT") || Checks.reportMissing("GL", "GL_EXT_semaphore");
    }
    ...
    private static boolean check_EXT_semaphore_fd(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1852}, "glImportSemaphoreFdEXT") || Checks.reportMissing("GL", "GL_EXT_semaphore_fd");
    }
    ...
    private static boolean check_EXT_semaphore_win32(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1853, 1854}, "glImportSemaphoreWin32HandleEXT", "glImportSemaphoreWin32NameEXT") || Checks.reportMissing("GL", "GL_EXT_semaphore_win32");
    }
    ...
    private static boolean check_EXT_separate_shader_objects(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1855, 1856, 1857}, "glUseShaderProgramEXT", "glActiveProgramEXT", "glCreateShaderProgramEXT") || Checks.reportMissing("GL", "GL_EXT_separate_shader_objects");
    }
    ...
    private static boolean check_EXT_shader_framebuffer_fetch_non_coherent(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1858}, "glFramebufferFetchBarrierEXT") || Checks.reportMissing("GL", "GL_EXT_shader_framebuffer_fetch_non_coherent");
    }
    ...
    private static boolean check_EXT_shader_image_load_store(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1859, 1860}, "glBindImageTextureEXT", "glMemoryBarrierEXT") || Checks.reportMissing("GL", "GL_EXT_shader_image_load_store");
    }
    ...
    private static boolean check_EXT_stencil_clear_tag(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1861}, "glStencilClearTagEXT") || Checks.reportMissing("GL", "GL_EXT_stencil_clear_tag");
    }
    ...
    private static boolean check_EXT_stencil_two_side(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1862}, "glActiveStencilFaceEXT") || Checks.reportMissing("GL", "GL_EXT_stencil_two_side");
    }
    ...
    private static boolean check_EXT_texture_array(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1759}, "glFramebufferTextureLayerEXT") || Checks.reportMissing("GL", "GL_EXT_texture_array");
    }
    ...
    private static boolean check_EXT_texture_buffer_object(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1863}, "glTexBufferEXT") || Checks.reportMissing("GL", "GL_EXT_texture_buffer_object");
    }
    ...
    private static boolean check_EXT_texture_integer(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1864, 1865, 1866, 1867, 1868, 1869}, "glClearColorIiEXT", "glClearColorIuiEXT", "glTexParameterIivEXT", "glTexParameterIuivEXT", "glGetTexParameterIivEXT", "glGetTexParameterIuivEXT") || Checks.reportMissing("GL", "GL_EXT_texture_integer");
    }
    ...
    private static boolean check_EXT_texture_storage(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        int flag0 = GLCapabilities.hasDSA(ext) ? 0 : Integer.MIN_VALUE;
        return Checks.checkFunctions(provider, caps, new int[]{1870, 1871, 1872, flag0 + 1375, flag0 + 1376, flag0 + 1377}, "glTexStorage1DEXT", "glTexStorage2DEXT", "glTexStorage3DEXT", "glTextureStorage1DEXT", "glTextureStorage2DEXT", "glTextureStorage3DEXT") || Checks.reportMissing("GL", "GL_EXT_texture_storage");
    }
    ...
    private static boolean check_EXT_timer_query(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1873, 1874}, "glGetQueryObjecti64vEXT", "glGetQueryObjectui64vEXT") || Checks.reportMissing("GL", "GL_EXT_timer_query");
    }
    ...
    private static boolean check_EXT_vertex_attrib_64bit(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        int flag0 = ext.contains("GL_EXT_direct_state_access") ? 0 : Integer.MIN_VALUE;
        return Checks.checkFunctions(provider, caps, new int[]{1882, 1883, 1884, 1885, 1886, 1887, 1888, 1889, 1890, 1891, flag0 + 1384}, "glVertexAttribL1dEXT", "glVertexAttribL2dEXT", "glVertexAttribL3dEXT", "glVertexAttribL4dEXT", "glVertexAttribL1dvEXT", "glVertexAttribL2dvEXT", "glVertexAttribL3dvEXT", "glVertexAttribL4dvEXT", "glVertexAttribLPointerEXT", "glGetVertexAttribLdvEXT", "glVertexArrayVertexAttribLOffsetEXT") || Checks.reportMissing("GL", "GL_EXT_vertex_attrib_64bit");
    }
    ...
    private static boolean check_EXT_win32_keyed_mutex(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1892, 1893}, "glAcquireKeyedMutexWin32EXT", "glReleaseKeyedMutexWin32EXT") || Checks.reportMissing("GL", "GL_EXT_win32_keyed_mutex");
    }
    ...
    private static boolean check_EXT_window_rectangles(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1894}, "glWindowRectanglesEXT") || Checks.reportMissing("GL", "GL_EXT_window_rectangles");
    }
    ...
    private static boolean check_EXT_x11_sync_object(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1895}, "glImportSyncEXT") || Checks.reportMissing("GL", "GL_EXT_x11_sync_object");
    }
    ...
    private static boolean check_GREMEDY_frame_terminator(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1896}, "glFrameTerminatorGREMEDY") || Checks.reportMissing("GL", "GL_GREMEDY_frame_terminator");
    }
    ...
    private static boolean check_GREMEDY_string_marker(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1897}, "glStringMarkerGREMEDY") || Checks.reportMissing("GL", "GL_GREMEDY_string_marker");
    }
    ...
    private static boolean check_INTEL_framebuffer_CMAA(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1898}, "glApplyFramebufferAttachmentCMAAINTEL") || Checks.reportMissing("GL", "GL_INTEL_framebuffer_CMAA");
    }
    ...
    private static boolean check_INTEL_map_texture(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1899, 1900, 1901}, "glSyncTextureINTEL", "glUnmapTexture2DINTEL", "glMapTexture2DINTEL") || Checks.reportMissing("GL", "GL_INTEL_map_texture");
    }
    ...
    private static boolean check_KHR_blend_equation_advanced(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1912}, "glBlendBarrierKHR") || Checks.reportMissing("GL", "GL_KHR_blend_equation_advanced");
    }
    ...
    private static boolean check_KHR_parallel_shader_compile(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1913}, "glMaxShaderCompilerThreadsKHR") || Checks.reportMissing("GL", "GL_KHR_parallel_shader_compile");
    }
    ...
    private static boolean check_MESA_framebuffer_flip_y(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1914, 1915}, "glFramebufferParameteriMESA", "glGetFramebufferParameterivMESA") || Checks.reportMissing("GL", "GL_MESA_framebuffer_flip_y");
    }
    ...
    private static boolean check_NV_alpha_to_coverage_dither_control(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1916}, "glAlphaToCoverageDitherControlNV") || Checks.reportMissing("GL", "GL_NV_alpha_to_coverage_dither_control");
    }
    ...
    private static boolean check_NV_bindless_multi_draw_indirect(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1917, 1918}, "glMultiDrawArraysIndirectBindlessNV", "glMultiDrawElementsIndirectBindlessNV") || Checks.reportMissing("GL", "GL_NV_bindless_multi_draw_indirect");
    }
    ...
    private static boolean check_NV_bindless_multi_draw_indirect_count(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1919, 1920}, "glMultiDrawArraysIndirectBindlessCountNV", "glMultiDrawElementsIndirectBindlessCountNV") || Checks.reportMissing("GL", "GL_NV_bindless_multi_draw_indirect_count");
    }
    ...
    private static boolean check_NV_blend_equation_advanced(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1934, 1935}, "glBlendParameteriNV", "glBlendBarrierNV") || Checks.reportMissing("GL", "GL_NV_blend_equation_advanced");
    }
    ...
    private static boolean check_NV_clip_space_w_scaling(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1936}, "glViewportPositionWScaleNV") || Checks.reportMissing("GL", "GL_NV_clip_space_w_scaling");
    }
    ...
    private static boolean check_NV_conditional_render(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1954, 1955}, "glBeginConditionalRenderNV", "glEndConditionalRenderNV") || Checks.reportMissing("GL", "GL_NV_conditional_render");
    }
    ...
    private static boolean check_NV_conservative_raster(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1956}, "glSubpixelPrecisionBiasNV") || Checks.reportMissing("GL", "GL_NV_conservative_raster");
    }
    ...
    private static boolean check_NV_conservative_raster_dilate(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1957}, "glConservativeRasterParameterfNV") || Checks.reportMissing("GL", "GL_NV_conservative_raster_dilate");
    }
    ...
    private static boolean check_NV_conservative_raster_pre_snap_triangles(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1958}, "glConservativeRasterParameteriNV") || Checks.reportMissing("GL", "GL_NV_conservative_raster_pre_snap_triangles");
    }
    ...
    private static boolean check_NV_copy_image(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1959}, "glCopyImageSubDataNV") || Checks.reportMissing("GL", "GL_NV_copy_image");
    }
    ...
    private static boolean check_NV_depth_buffer_float(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1960, 1961, 1962}, "glDepthRangedNV", "glClearDepthdNV", "glDepthBoundsdNV") || Checks.reportMissing("GL", "GL_NV_depth_buffer_float");
    }
    ...
    private static boolean check_NV_draw_texture(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1963}, "glDrawTextureNV") || Checks.reportMissing("GL", "GL_NV_draw_texture");
    }
    ...
    private static boolean check_NV_draw_vulkan_image(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1964, 1965, 1966, 1967, 1968}, "glDrawVkImageNV", "glGetVkProcAddrNV", "glWaitVkSemaphoreNV", "glSignalVkSemaphoreNV", "glSignalVkFenceNV") || Checks.reportMissing("GL", "GL_NV_draw_vulkan_image");
    }
    ...
    private static boolean check_NV_explicit_multisample(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1969, 1970, 1971}, "glGetMultisamplefvNV", "glSampleMaskIndexedNV", "glTexRenderbufferNV") || Checks.reportMissing("GL", "GL_NV_explicit_multisample");
    }
    ...
    private static boolean check_NV_fence(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1972, 1973, 1974, 1975, 1976, 1977, 1978}, "glDeleteFencesNV", "glGenFencesNV", "glIsFenceNV", "glTestFenceNV", "glGetFenceivNV", "glFinishFenceNV", "glSetFenceNV") || Checks.reportMissing("GL", "GL_NV_fence");
    }
    ...
    private static boolean check_NV_fragment_coverage_to_color(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1979}, "glFragmentCoverageColorNV") || Checks.reportMissing("GL", "GL_NV_fragment_coverage_to_color");
    }
    ...
    private static boolean check_NV_framebuffer_mixed_samples(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1827, 1980, 1981, 1982}, "glRasterSamplesEXT", "glCoverageModulationTableNV", "glGetCoverageModulationTableNV", "glCoverageModulationNV") || Checks.reportMissing("GL", "GL_NV_framebuffer_mixed_samples");
    }
    ...
    private static boolean check_NV_framebuffer_multisample_coverage(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{1983}, "glRenderbufferStorageMultisampleCoverageNV") || Checks.reportMissing("GL", "GL_NV_framebuffer_multisample_coverage");
    }
    ...
    private static boolean check_NV_internalformat_sample_query(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{2042}, "glGetInternalformatSampleivNV") || Checks.reportMissing("GL", "GL_NV_internalformat_sample_query");
    }
    ...
    private static boolean check_NV_memory_object_sparse(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{2049, 2050, 2051, 2052}, "glBufferPageCommitmentMemNV", "glNamedBufferPageCommitmentMemNV", "glTexPageCommitmentMemNV", "glTexturePageCommitmentMemNV") || Checks.reportMissing("GL", "GL_NV_memory_object_sparse");
    }
    ...
    private static boolean check_NV_mesh_shader(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{2053, 2054, 2055, 2056}, "glDrawMeshTasksNV", "glDrawMeshTasksIndirectNV", "glMultiDrawMeshTasksIndirectNV", "glMultiDrawMeshTasksIndirectCountNV") || Checks.reportMissing("GL", "GL_NV_mesh_shader");
    }
    ...
    private static boolean check_NV_pixel_data_range(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{2121, 2122}, "glPixelDataRangeNV", "glFlushPixelDataRangeNV") || Checks.reportMissing("GL", "GL_NV_pixel_data_range");
    }
    ...
    private static boolean check_NV_point_sprite(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{2123, 2124}, "glPointParameteriNV", "glPointParameterivNV") || Checks.reportMissing("GL", "GL_NV_point_sprite");
    }
    ...
    private static boolean check_NV_primitive_restart(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{2125, 2126}, "glPrimitiveRestartNV", "glPrimitiveRestartIndexNV") || Checks.reportMissing("GL", "GL_NV_primitive_restart");
    }
    ...
    private static boolean check_NV_query_resource(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{2127}, "glQueryResourceNV") || Checks.reportMissing("GL", "GL_NV_query_resource");
    }
    ...
    private static boolean check_NV_query_resource_tag(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{2128, 2129, 2130}, "glGenQueryResourceTagNV", "glDeleteQueryResourceTagNV", "glQueryResourceTagNV") || Checks.reportMissing("GL", "GL_NV_query_resource_tag");
    }
    ...
    private static boolean check_NV_sample_locations(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{2131, 2132, 2133}, "glFramebufferSampleLocationsfvNV", "glNamedFramebufferSampleLocationsfvNV", "glResolveDepthValuesNV") || Checks.reportMissing("GL", "GL_NV_sample_locations");
    }
    ...
    private static boolean check_NV_scissor_exclusive(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{2134, 2135}, "glScissorExclusiveArrayvNV", "glScissorExclusiveNV") || Checks.reportMissing("GL", "GL_NV_scissor_exclusive");
    }
    ...
    private static boolean check_NV_shader_buffer_load(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{2136, 2137, 2138, 2139, 2140, 2141, 2142, 2143, 2144, 2145, 2146, 1075, 2147, 2148}, "glMakeBufferResidentNV", "glMakeBufferNonResidentNV", "glIsBufferResidentNV", "glMakeNamedBufferResidentNV", "glMakeNamedBufferNonResidentNV", "glIsNamedBufferResidentNV", "glGetBufferParameterui64vNV", "glGetNamedBufferParameterui64vNV", "glGetIntegerui64vNV", "glUniformui64NV", "glUniformui64vNV", "glGetUniformui64vNV", "glProgramUniformui64NV", "glProgramUniformui64vNV") || Checks.reportMissing("GL", "GL_NV_shader_buffer_load");
    }
    ...
    private static boolean check_NV_texture_barrier(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{2156}, "glTextureBarrierNV") || Checks.reportMissing("GL", "GL_NV_texture_barrier");
    }
    ...
    private static boolean check_NV_timeline_semaphore(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{2163, 2164, 2165}, "glCreateSemaphoresNV", "glSemaphoreParameterivNV", "glGetSemaphoreParameterivNV") || Checks.reportMissing("GL", "GL_NV_timeline_semaphore");
    }
    ...
    private static boolean check_NV_vertex_array_range(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{2185, 2186}, "glVertexArrayRangeNV", "glFlushVertexArrayRangeNV") || Checks.reportMissing("GL", "GL_NV_vertex_array_range");
    }
    ...
    private static boolean check_NV_viewport_swizzle(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{2218}, "glViewportSwizzleNV") || Checks.reportMissing("GL", "GL_NV_viewport_swizzle");
    }
    ...
    private static boolean check_NVX_conditional_render(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{2219, 2220}, "glBeginConditionalRenderNVX", "glEndConditionalRenderNVX") || Checks.reportMissing("GL", "GL_NVX_conditional_render");
    }
    ...
    private static boolean check_NVX_gpu_multicast2(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{2221, 2222, 2223, 2224, 2225, 2226}, "glAsyncCopyImageSubDataNVX", "glAsyncCopyBufferSubDataNVX", "glUploadGpuMaskNVX", "glMulticastViewportArrayvNVX", "glMulticastScissorArrayvNVX", "glMulticastViewportPositionWScaleNVX") || Checks.reportMissing("GL", "GL_NVX_gpu_multicast2");
    }
    ...
    private static boolean check_NVX_progress_fence(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        return Checks.checkFunctions(provider, caps, new int[]{2227, 2228, 2229, 2230}, "glCreateProgressFenceNVX", "glSignalSemaphoreui64NVX", "glWaitSemaphoreui64NVX", "glClientWaitSemaphoreui64NVX") || Checks.reportMissing("GL", "GL_NVX_progress_fence");
    }
    ...
    private static boolean check_OVR_multiview(FunctionProvider provider, PointerBuffer caps, Set<String> ext) {
        ...
        int flag0 = GLCapabilities.hasDSA(ext) ? 0 : Integer.MIN_VALUE;
        return Checks.checkFunctions(provider, caps, new int[]{2231, flag0 + 2232}, "glFramebufferTextureMultiviewOVR", "glNamedFramebufferTextureMultiviewOVR") || Checks.reportMissing("GL", "GL_OVR_multiview");
    }
