...
extends GL14 {
    ...
    @NativeType(value="void *")
    public static @Nullable ByteBuffer glMapBuffer(@NativeType(value="GLenum") int target, @NativeType(value="GLenum") int access) {
        return GL15C.glMapBuffer(target, access);
    }

    @NativeType(value="void *")
    public static @Nullable ByteBuffer glMapBuffer(@NativeType(value="GLenum") int target, @NativeType(value="GLenum") int access, @Nullable ByteBuffer old_buffer) {
        return GL15C.glMapBuffer(target, access, old_buffer);
    }

    @NativeType(value="void *")
    public static @Nullable ByteBuffer glMapBuffer(@NativeType(value="GLenum") int target, @NativeType(value="GLenum") int access, long length, @Nullable ByteBuffer old_buffer) {
