...
public class GLXAMDGPUAssociation {
    ...
    @NativeType(value="unsigned int")
    public static int glXGetGPUIDsAMD(@NativeType(value="unsigned int *") @Nullable IntBuffer ids) {
    ...
    @NativeType(value="unsigned int")
    public static int glXGetGPUIDsAMD(@NativeType(value="unsigned int *") int @Nullable [] ids) {
        long __functionAddress = GL.getCapabilitiesGLXClient().glXGetGPUIDsAMD;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
        }
