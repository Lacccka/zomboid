...
public class ARBShadingLanguageInclude {
    ...
    public static void glCompileShaderIncludeARB(@NativeType(value="GLuint") int shader, @NativeType(value="GLchar const * const *") PointerBuffer path, @NativeType(value="GLint const *") @Nullable IntBuffer length) {
        if (Checks.CHECKS) {
    ...
    public static void glGetNamedStringARB(@NativeType(value="GLchar const *") ByteBuffer name, @NativeType(value="GLint *") @Nullable IntBuffer stringlen, @NativeType(value="GLchar *") ByteBuffer string) {
        if (Checks.CHECKS) {
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void glGetNamedStringARB(@NativeType(value="GLchar const *") CharSequence name, @NativeType(value="GLint *") @Nullable IntBuffer stringlen, @NativeType(value="GLchar *") ByteBuffer string) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)stringlen, 1);
        }
        MemoryStack stack = MemoryStack.stackGet();
    ...
    public static void glCompileShaderIncludeARB(@NativeType(value="GLuint") int shader, @NativeType(value="GLchar const * const *") PointerBuffer path, @NativeType(value="GLint const *") int @Nullable [] length) {
    ...
    public static void glGetNamedStringARB(@NativeType(value="GLchar const *") ByteBuffer name, @NativeType(value="GLint *") int @Nullable [] stringlen, @NativeType(value="GLchar *") ByteBuffer string) {
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void glGetNamedStringARB(@NativeType(value="GLchar const *") CharSequence name, @NativeType(value="GLint *") int @Nullable [] stringlen, @NativeType(value="GLchar *") ByteBuffer string) {
        long __functionAddress = GL.getICD().glGetNamedStringARB;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.checkSafe(stringlen, 1);
