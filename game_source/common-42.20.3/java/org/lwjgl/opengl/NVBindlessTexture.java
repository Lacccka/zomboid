...
public class NVBindlessTexture {
    ...
    public static void glUniformHandleui64vNV(@NativeType(value="GLint") int location, @NativeType(value="GLuint64 const *") LongBuffer values2) {
        NVBindlessTexture.nglUniformHandleui64vNV(location, values2.remaining(), MemoryUtil.memAddress(values2));
    }
    ...
    public static void glProgramUniformHandleui64vNV(@NativeType(value="GLuint") int program, @NativeType(value="GLint") int location, @NativeType(value="GLuint64 const *") LongBuffer values2) {
        NVBindlessTexture.nglProgramUniformHandleui64vNV(program, location, values2.remaining(), MemoryUtil.memAddress(values2));
    }
    ...
    public static void glUniformHandleui64vNV(@NativeType(value="GLint") int location, @NativeType(value="GLuint64 const *") long[] values2) {
    ...
    public static void glProgramUniformHandleui64vNV(@NativeType(value="GLuint") int program, @NativeType(value="GLint") int location, @NativeType(value="GLuint64 const *") long[] values2) {
