...
public class EXTTransformFeedback {
    ...
    public static void glGetTransformFeedbackVaryingEXT(@NativeType(value="GLuint") int program, @NativeType(value="GLuint") int index, @NativeType(value="GLsizei *") @Nullable IntBuffer length, @NativeType(value="GLsizei *") IntBuffer size, @NativeType(value="GLenum *") IntBuffer type, @NativeType(value="GLchar *") ByteBuffer name) {
        if (Checks.CHECKS) {
    ...
    public static void glGetTransformFeedbackVaryingEXT(@NativeType(value="GLuint") int program, @NativeType(value="GLuint") int index, @NativeType(value="GLsizei *") int @Nullable [] length, @NativeType(value="GLsizei *") int[] size, @NativeType(value="GLenum *") int[] type, @NativeType(value="GLchar *") ByteBuffer name) {
