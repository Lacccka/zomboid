...
public class AMDPerformanceMonitor {
    ...
    public static void glGetPerfMonitorGroupsAMD(@NativeType(value="GLint *") @Nullable IntBuffer numGroups, @NativeType(value="GLuint *") @Nullable IntBuffer groups2) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)numGroups, 1);
        }
        AMDPerformanceMonitor.nglGetPerfMonitorGroupsAMD(MemoryUtil.memAddressSafe(numGroups), Checks.remainingSafe(groups2), MemoryUtil.memAddressSafe(groups2));
    }
    ...
    public static void glGetPerfMonitorCounterStringAMD(@NativeType(value="GLuint") int group, @NativeType(value="GLuint") int counter, @NativeType(value="GLsizei *") @Nullable IntBuffer length, @NativeType(value="GLchar *") @Nullable ByteBuffer counterString) {
        if (Checks.CHECKS) {
    ...
    public static void glGetPerfMonitorCounterDataAMD(@NativeType(value="GLuint") int monitor, @NativeType(value="GLenum") int pname, @NativeType(value="GLuint *") IntBuffer data, @NativeType(value="GLint *") @Nullable IntBuffer bytesWritten) {
        if (Checks.CHECKS) {
    ...
    public static void glGetPerfMonitorGroupsAMD(@NativeType(value="GLint *") int @Nullable [] numGroups, @NativeType(value="GLuint *") int @Nullable [] groups2) {
        long __functionAddress = GL.getICD().glGetPerfMonitorGroupsAMD;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.checkSafe(numGroups, 1);
        }
        JNI.callPPV(numGroups, Checks.lengthSafe(groups2), groups2, __functionAddress);
    }
    ...
    public static void glGetPerfMonitorCounterStringAMD(@NativeType(value="GLuint") int group, @NativeType(value="GLuint") int counter, @NativeType(value="GLsizei *") int @Nullable [] length, @NativeType(value="GLchar *") @Nullable ByteBuffer counterString) {
    ...
    public static void glGetPerfMonitorCounterDataAMD(@NativeType(value="GLuint") int monitor, @NativeType(value="GLenum") int pname, @NativeType(value="GLuint *") int[] data, @NativeType(value="GLint *") int @Nullable [] bytesWritten) {
