...
public class ARBVertexShader {
    ...
    public static void glGetActiveAttribARB(@NativeType(value="GLhandleARB") int programObj, @NativeType(value="GLuint") int index, @NativeType(value="GLsizei *") @Nullable IntBuffer length, @NativeType(value="GLint *") IntBuffer size, @NativeType(value="GLenum *") IntBuffer type, @NativeType(value="GLchar *") ByteBuffer name) {
        if (Checks.CHECKS) {
    ...
    public static void glGetActiveAttribARB(@NativeType(value="GLhandleARB") int programObj, @NativeType(value="GLuint") int index, @NativeType(value="GLsizei *") int @Nullable [] length, @NativeType(value="GLint *") int[] size, @NativeType(value="GLenum *") int[] type, @NativeType(value="GLchar *") ByteBuffer name) {
