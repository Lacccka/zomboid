...
public class WGLARBPixelFormat {
    ...
    public static int nwglGetPixelFormatAttribivARB(long hdc, int pixelFormat, int layerPlane, int n, long attributes, long values2) {
        long __functionAddress = GL.getCapabilitiesWGL().wglGetPixelFormatAttribivARB;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(hdc);
        }
        return JNI.callPPPI(hdc, pixelFormat, layerPlane, n, attributes, values2, __functionAddress);
    }

    @NativeType(value="BOOL")
    public static boolean wglGetPixelFormatAttribivARB(@NativeType(value="HDC") long hdc, int pixelFormat, int layerPlane, @NativeType(value="int const *") IntBuffer attributes, @NativeType(value="int *") IntBuffer values2) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)values2, attributes.remaining());
        }
        return WGLARBPixelFormat.nwglGetPixelFormatAttribivARB(hdc, pixelFormat, layerPlane, attributes.remaining(), MemoryUtil.memAddress(attributes), MemoryUtil.memAddress(values2)) != 0;
    }
     ...
     */
    @NativeType(value="BOOL")
    public static boolean wglGetPixelFormatAttribiARB(@NativeType(value="HDC") long hdc, int pixelFormat, int layerPlane, @NativeType(value="int const *") int attribute, @NativeType(value="int *") IntBuffer values2) {
        if (Checks.CHECKS) {
        ...
        try {
            ...
            boolean bl = WGLARBPixelFormat.nwglGetPixelFormatAttribivARB(hdc, pixelFormat, layerPlane, 1, MemoryUtil.memAddress(attributes), MemoryUtil.memAddress(values2)) != 0;
            return bl;
        }
        finally {
    ...
    public static int nwglGetPixelFormatAttribfvARB(long hdc, int pixelFormat, int layerPlane, int n, long attributes, long values2) {
    ...
    @NativeType(value="BOOL")
    public static boolean wglGetPixelFormatAttribfvARB(@NativeType(value="HDC") long hdc, int pixelFormat, int layerPlane, @NativeType(value="int const *") IntBuffer attributes, @NativeType(value="FLOAT *") FloatBuffer values2) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)values2, attributes.remaining());
        }
        return WGLARBPixelFormat.nwglGetPixelFormatAttribfvARB(hdc, pixelFormat, layerPlane, attributes.remaining(), MemoryUtil.memAddress(attributes), MemoryUtil.memAddress(values2)) != 0;
    }
     ...
     */
    @NativeType(value="BOOL")
    public static boolean wglGetPixelFormatAttribfARB(@NativeType(value="HDC") long hdc, int pixelFormat, int layerPlane, @NativeType(value="int const *") int attribute, @NativeType(value="FLOAT *") FloatBuffer values2) {
        if (Checks.CHECKS) {
            Checks.check((Buffer)values2, 1);
        }
        MemoryStack stack = MemoryStack.stackGet();
        ...
        try {
            IntBuffer attributes = stack.ints(attribute);
            boolean bl = WGLARBPixelFormat.nwglGetPixelFormatAttribfvARB(hdc, pixelFormat, layerPlane, 1, MemoryUtil.memAddress(attributes), MemoryUtil.memAddress(values2)) != 0;
            return bl;
        }
        finally {
            stack.setPointer(stackPointer);
    ...
    @NativeType(value="BOOL")
    public static boolean wglChoosePixelFormatARB(@NativeType(value="HDC") long hdc, @NativeType(value="int const *") @Nullable IntBuffer attribIList, @NativeType(value="FLOAT const *") @Nullable FloatBuffer attribFList, @NativeType(value="int *") IntBuffer formats, @NativeType(value="UINT *") IntBuffer numFormats) {
        if (Checks.CHECKS) {
    ...
    @NativeType(value="BOOL")
    public static boolean wglGetPixelFormatAttribivARB(@NativeType(value="HDC") long hdc, int pixelFormat, int layerPlane, @NativeType(value="int const *") int[] attributes, @NativeType(value="int *") int[] values2) {
        long __functionAddress = GL.getCapabilitiesWGL().wglGetPixelFormatAttribivARB;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(hdc);
            Checks.check(values2, attributes.length);
        }
        return JNI.callPPPI(hdc, pixelFormat, layerPlane, attributes.length, attributes, values2, __functionAddress) != 0;
    }

    @NativeType(value="BOOL")
    public static boolean wglGetPixelFormatAttribfvARB(@NativeType(value="HDC") long hdc, int pixelFormat, int layerPlane, @NativeType(value="int const *") int[] attributes, @NativeType(value="FLOAT *") float[] values2) {
        long __functionAddress = GL.getCapabilitiesWGL().wglGetPixelFormatAttribfvARB;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(hdc);
    ...
    @NativeType(value="BOOL")
    public static boolean wglChoosePixelFormatARB(@NativeType(value="HDC") long hdc, @NativeType(value="int const *") int @Nullable [] attribIList, @NativeType(value="FLOAT const *") float @Nullable [] attribFList, @NativeType(value="int *") int[] formats, @NativeType(value="UINT *") int[] numFormats) {
        long __functionAddress = GL.getCapabilitiesWGL().wglChoosePixelFormatARB;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(hdc);
