...
extends GL15 {
    ...
    public static void nglGetShaderSource(int shader, int maxLength, long length, long source2) {
        GL20C.nglGetShaderSource(shader, maxLength, length, source2);
    }
    ...
    public static void glGetShaderSource(@NativeType(value="GLuint") int shader, @NativeType(value="GLsizei *") @Nullable IntBuffer length, @NativeType(value="GLchar *") ByteBuffer source2) {
        GL20C.glGetShaderSource(shader, length, source2);
    }
