...
public class WGLARBRenderTexture {
    ...
    @NativeType(value="BOOL")
    public static boolean wglSetPbufferAttribARB(@NativeType(value="HPBUFFERARB") long pbuffer, @NativeType(value="int const *") @Nullable IntBuffer attribList) {
        if (Checks.CHECKS) {
    ...
    @NativeType(value="BOOL")
    public static boolean wglSetPbufferAttribARB(@NativeType(value="HPBUFFERARB") long pbuffer, @NativeType(value="int const *") int @Nullable [] attribList) {
        long __functionAddress = GL.getCapabilitiesWGL().wglSetPbufferAttribARB;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(pbuffer);
