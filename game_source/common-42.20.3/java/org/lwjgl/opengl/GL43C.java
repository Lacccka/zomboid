...
extends GL42C {
    ...
    public static void glDebugMessageControl(@NativeType(value="GLenum") int source2, @NativeType(value="GLenum") int type, @NativeType(value="GLenum") int severity, @NativeType(value="GLuint const *") @Nullable IntBuffer ids, @NativeType(value="GLboolean") boolean enabled) {
        GL43C.nglDebugMessageControl(source2, type, severity, Checks.remainingSafe(ids), MemoryUtil.memAddressSafe(ids), enabled);
    }
    ...
    public static void glDebugMessageControl(@NativeType(value="GLenum") int source2, @NativeType(value="GLenum") int type, @NativeType(value="GLenum") int severity, @NativeType(value="GLuint const *") int id, @NativeType(value="GLboolean") boolean enabled) {
        ...
        try {
            ...
            GL43C.nglDebugMessageControl(source2, type, severity, 1, MemoryUtil.memAddress(ids), enabled);
        }
        finally {
    ...
    public static void glDebugMessageInsert(@NativeType(value="GLenum") int source2, @NativeType(value="GLenum") int type, @NativeType(value="GLuint") int id, @NativeType(value="GLenum") int severity, @NativeType(value="GLchar const *") ByteBuffer message) {
        GL43C.nglDebugMessageInsert(source2, type, id, severity, message.remaining(), MemoryUtil.memAddress(message));
    }
    ...
    public static void glDebugMessageInsert(@NativeType(value="GLenum") int source2, @NativeType(value="GLenum") int type, @NativeType(value="GLuint") int id, @NativeType(value="GLenum") int severity, @NativeType(value="GLchar const *") CharSequence message) {
        ...
        try {
            ...
            GL43C.nglDebugMessageInsert(source2, type, id, severity, messageEncodedLength, messageEncoded);
        }
        finally {
            stack.setPointer(stackPointer);
        }
    ...
    public static void glPushDebugGroup(@NativeType(value="GLenum") int source2, @NativeType(value="GLuint") int id, @NativeType(value="GLchar const *") ByteBuffer message) {
        GL43C.nglPushDebugGroup(source2, id, message.remaining(), MemoryUtil.memAddress(message));
    }
    ...
    public static void glPushDebugGroup(@NativeType(value="GLenum") int source2, @NativeType(value="GLuint") int id, @NativeType(value="GLchar const *") CharSequence message) {
        ...
        try {
            int messageEncodedLength = stack.nUTF8(message, false);
            long messageEncoded = stack.getPointerAddress();
            GL43C.nglPushDebugGroup(source2, id, messageEncodedLength, messageEncoded);
        }
        finally {
            stack.setPointer(stackPointer);
        }
    ...
    public static void glGetProgramResourceName(@NativeType(value="GLuint") int program, @NativeType(value="GLenum") int programInterface, @NativeType(value="GLuint") int index, @NativeType(value="GLsizei *") @Nullable IntBuffer length, @NativeType(value="GLchar *") ByteBuffer name) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)length, 1);
        }
    ...
    public static void glGetProgramResourceiv(@NativeType(value="GLuint") int program, @NativeType(value="GLenum") int programInterface, @NativeType(value="GLuint") int index, @NativeType(value="GLenum const *") IntBuffer props, @NativeType(value="GLsizei *") @Nullable IntBuffer length, @NativeType(value="GLint *") IntBuffer params) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)length, 1);
        }
    ...
    public static void glDebugMessageControl(@NativeType(value="GLenum") int source2, @NativeType(value="GLenum") int type, @NativeType(value="GLenum") int severity, @NativeType(value="GLuint const *") int @Nullable [] ids, @NativeType(value="GLboolean") boolean enabled) {
        ...
        JNI.callPV(source2, type, severity, Checks.lengthSafe(ids), ids, enabled, __functionAddress);
    }
    ...
    public static void glGetProgramResourceName(@NativeType(value="GLuint") int program, @NativeType(value="GLenum") int programInterface, @NativeType(value="GLuint") int index, @NativeType(value="GLsizei *") int @Nullable [] length, @NativeType(value="GLchar *") ByteBuffer name) {
    ...
    public static void glGetProgramResourceiv(@NativeType(value="GLuint") int program, @NativeType(value="GLenum") int programInterface, @NativeType(value="GLuint") int index, @NativeType(value="GLenum const *") int[] props, @NativeType(value="GLsizei *") int @Nullable [] length, @NativeType(value="GLint *") int[] params) {
