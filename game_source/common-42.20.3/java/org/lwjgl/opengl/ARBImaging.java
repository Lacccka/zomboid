...
public class ARBImaging {
    ...
    public static void glGetSeparableFilter(@NativeType(value="GLenum") int target, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="void *") ByteBuffer row, @NativeType(value="void *") ByteBuffer column, @NativeType(value="void *") @Nullable ByteBuffer span) {
    ...
    public static void glGetSeparableFilter(@NativeType(value="GLenum") int target, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="void *") long row, @NativeType(value="void *") long column, @NativeType(value="void *") @Nullable ByteBuffer span) {
    ...
    public static void glGetHistogram(@NativeType(value="GLenum") int target, @NativeType(value="GLboolean") boolean reset, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="void *") ByteBuffer values2) {
        ARBImaging.nglGetHistogram(target, reset, format, type, MemoryUtil.memAddress(values2));
    }

    public static void glGetHistogram(@NativeType(value="GLenum") int target, @NativeType(value="GLboolean") boolean reset, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="void *") long values2) {
        ARBImaging.nglGetHistogram(target, reset, format, type, values2);
    }
    ...
    public static void glGetMinmax(@NativeType(value="GLenum") int target, @NativeType(value="GLboolean") boolean reset, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="void *") ByteBuffer values2) {
        ARBImaging.nglGetMinmax(target, reset, format, type, MemoryUtil.memAddress(values2));
    }

    public static void glGetMinmax(@NativeType(value="GLenum") int target, @NativeType(value="GLboolean") boolean reset, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="void *") long values2) {
        ARBImaging.nglGetMinmax(target, reset, format, type, values2);
    }
