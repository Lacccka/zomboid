...
public class ARBVertexBufferObject {
    ...
    @NativeType(value="void *")
    public static @Nullable ByteBuffer glMapBufferARB(@NativeType(value="GLenum") int target, @NativeType(value="GLenum") int access) {
    ...
    @NativeType(value="void *")
    public static @Nullable ByteBuffer glMapBufferARB(@NativeType(value="GLenum") int target, @NativeType(value="GLenum") int access, @Nullable ByteBuffer old_buffer) {
        long __result = ARBVertexBufferObject.nglMapBufferARB(target, access);
    ...
    @NativeType(value="void *")
    public static @Nullable ByteBuffer glMapBufferARB(@NativeType(value="GLenum") int target, @NativeType(value="GLenum") int access, long length, @Nullable ByteBuffer old_buffer) {
        long __result = ARBVertexBufferObject.nglMapBufferARB(target, access);
