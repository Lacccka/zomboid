...
public class WGLARBCreateContext {
    ...
    public static long wglCreateContextAttribsARB(@NativeType(value="HDC") long hdc, @NativeType(value="HGLRC") long shareContext, @NativeType(value="int const *") @Nullable IntBuffer attribList) {
        if (Checks.CHECKS) {
    ...
    @NativeType(value="HGLRC")
    public static long wglCreateContextAttribsARB(@NativeType(value="HDC") long hdc, @NativeType(value="HGLRC") long shareContext, @NativeType(value="int const *") int @Nullable [] attribList) {
        long __functionAddress = GL.getCapabilitiesWGL().wglCreateContextAttribsARB;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(hdc);
