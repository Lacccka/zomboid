...
public class ARBDebugOutput {
    ...
    public static void glDebugMessageControlARB(@NativeType(value="GLenum") int source2, @NativeType(value="GLenum") int type, @NativeType(value="GLenum") int severity, @NativeType(value="GLuint const *") @Nullable IntBuffer ids, @NativeType(value="GLboolean") boolean enabled) {
        ARBDebugOutput.nglDebugMessageControlARB(source2, type, severity, Checks.remainingSafe(ids), MemoryUtil.memAddressSafe(ids), enabled);
    }

    /*
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void glDebugMessageControlARB(@NativeType(value="GLenum") int source2, @NativeType(value="GLenum") int type, @NativeType(value="GLenum") int severity, @NativeType(value="GLuint const *") int id, @NativeType(value="GLboolean") boolean enabled) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            IntBuffer ids = stack.ints(id);
            ARBDebugOutput.nglDebugMessageControlARB(source2, type, severity, 1, MemoryUtil.memAddress(ids), enabled);
        }
        finally {
    ...
    public static void glDebugMessageInsertARB(@NativeType(value="GLenum") int source2, @NativeType(value="GLenum") int type, @NativeType(value="GLuint") int id, @NativeType(value="GLenum") int severity, @NativeType(value="GLchar const *") ByteBuffer buf) {
        ARBDebugOutput.nglDebugMessageInsertARB(source2, type, id, severity, buf.remaining(), MemoryUtil.memAddress(buf));
    }

    /*
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static void glDebugMessageInsertARB(@NativeType(value="GLenum") int source2, @NativeType(value="GLenum") int type, @NativeType(value="GLuint") int id, @NativeType(value="GLenum") int severity, @NativeType(value="GLchar const *") CharSequence buf) {
        MemoryStack stack = MemoryStack.stackGet();
        int stackPointer = stack.getPointer();
        try {
            int bufEncodedLength = stack.nUTF8(buf, false);
            long bufEncoded = stack.getPointerAddress();
            ARBDebugOutput.nglDebugMessageInsertARB(source2, type, id, severity, bufEncodedLength, bufEncoded);
        }
        finally {
            stack.setPointer(stackPointer);
        }
    ...
    public static void glDebugMessageCallbackARB(@NativeType(value="GLDEBUGPROCARB") @Nullable GLDebugMessageARBCallbackI callback, @NativeType(value="void const *") long userParam) {
    ...
    public static void glDebugMessageControlARB(@NativeType(value="GLenum") int source2, @NativeType(value="GLenum") int type, @NativeType(value="GLenum") int severity, @NativeType(value="GLuint const *") int @Nullable [] ids, @NativeType(value="GLboolean") boolean enabled) {
