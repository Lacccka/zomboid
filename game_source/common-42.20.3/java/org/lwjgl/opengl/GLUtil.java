...
public final class GLUtil {
    ...
    public static @Nullable Callback setupDebugMessageCallback() {
    ...
    public static @Nullable Callback setupDebugMessageCallback(PrintStream stream) {
        ...
        if (caps.OpenGL43) {
            ...
            GLDebugMessageCallback proc = GLDebugMessageCallback.create((source2, type, id, severity, length, message, userParam) -> {
                StringBuilder sb = new StringBuilder(300);
                sb.append("[LWJGL] OpenGL debug message\n");
                GLUtil.printDetail(sb, "ID", "0x" + Integer.toHexString(id).toUpperCase());
                GLUtil.printDetail(sb, "Source", GLUtil.getDebugSource(source2));
        ...
        if (caps.GL_ARB_debug_output) {
            ...
            GLDebugMessageARBCallback proc = GLDebugMessageARBCallback.create((source2, type, id, severity, length, message, userParam) -> {
                StringBuilder sb = new StringBuilder(300);
                sb.append("[LWJGL] ARB_debug_output message\n");
                GLUtil.printDetail(sb, "ID", "0x" + Integer.toHexString(id).toUpperCase());
                GLUtil.printDetail(sb, "Source", GLUtil.getSourceARB(source2));
    ...
    private static String getDebugSource(int source2) {
        switch (source2) {
            case 33350: {
                return "API";
            }
        ...
        return APIUtil.apiUnknownToken(source2);
    }
    ...
    private static String getSourceARB(int source2) {
        switch (source2) {
            case 33350: {
                return "API";
            }
