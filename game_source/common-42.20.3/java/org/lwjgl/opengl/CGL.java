...
public class CGL {
    ...
    @NativeType(value="CGLError")
    public static int CGLTexImagePBuffer(@NativeType(value="CGLContextObj") long ctx, @NativeType(value="CGLPBufferObj") long pbuffer, @NativeType(value="GLenum") int source2) {
        long __functionAddress = Functions.TexImagePBuffer;
        if (Checks.CHECKS) {
            Checks.check(ctx);
            Checks.check(pbuffer);
        }
        return JNI.callPPI(ctx, pbuffer, source2, __functionAddress);
    }
    ...
    public static @Nullable String CGLErrorString(@NativeType(value="CGLError") int error) {
