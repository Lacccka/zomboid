...
extends GL44 {
    ...
    public static void glClearNamedBufferData(@NativeType(value="GLuint") int buffer, @NativeType(value="GLenum") int internalformat, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="void const *") @Nullable ByteBuffer data) {
        GL45C.glClearNamedBufferData(buffer, internalformat, format, type, data);
    }

    public static void glClearNamedBufferData(@NativeType(value="GLuint") int buffer, @NativeType(value="GLenum") int internalformat, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="void const *") @Nullable ShortBuffer data) {
        GL45C.glClearNamedBufferData(buffer, internalformat, format, type, data);
    }

    public static void glClearNamedBufferData(@NativeType(value="GLuint") int buffer, @NativeType(value="GLenum") int internalformat, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="void const *") @Nullable IntBuffer data) {
        GL45C.glClearNamedBufferData(buffer, internalformat, format, type, data);
    }

    public static void glClearNamedBufferData(@NativeType(value="GLuint") int buffer, @NativeType(value="GLenum") int internalformat, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="void const *") @Nullable FloatBuffer data) {
        GL45C.glClearNamedBufferData(buffer, internalformat, format, type, data);
    }
    ...
    @NativeType(value="void *")
    public static @Nullable ByteBuffer glMapNamedBuffer(@NativeType(value="GLuint") int buffer, @NativeType(value="GLenum") int access) {
        return GL45C.glMapNamedBuffer(buffer, access);
    }

    @NativeType(value="void *")
    public static @Nullable ByteBuffer glMapNamedBuffer(@NativeType(value="GLuint") int buffer, @NativeType(value="GLenum") int access, @Nullable ByteBuffer old_buffer) {
        return GL45C.glMapNamedBuffer(buffer, access, old_buffer);
    }

    @NativeType(value="void *")
    public static @Nullable ByteBuffer glMapNamedBuffer(@NativeType(value="GLuint") int buffer, @NativeType(value="GLenum") int access, long length, @Nullable ByteBuffer old_buffer) {
    ...
    @NativeType(value="void *")
    public static @Nullable ByteBuffer glMapNamedBufferRange(@NativeType(value="GLuint") int buffer, @NativeType(value="GLintptr") long offset, @NativeType(value="GLsizeiptr") long length, @NativeType(value="GLbitfield") int access) {
        return GL45C.glMapNamedBufferRange(buffer, offset, length, access);
    }

    @NativeType(value="void *")
    public static @Nullable ByteBuffer glMapNamedBufferRange(@NativeType(value="GLuint") int buffer, @NativeType(value="GLintptr") long offset, @NativeType(value="GLsizeiptr") long length, @NativeType(value="GLbitfield") int access, @Nullable ByteBuffer old_buffer) {
    ...
    public static void glVertexArrayVertexBuffers(@NativeType(value="GLuint") int vaobj, @NativeType(value="GLuint") int first, @NativeType(value="GLuint const *") @Nullable IntBuffer buffers, @NativeType(value="GLintptr const *") @Nullable PointerBuffer offsets, @NativeType(value="GLsizei const *") @Nullable IntBuffer strides) {
    ...
    public static void glGetnSeparableFilter(@NativeType(value="GLenum") int target, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="GLsizei") int rowBufSize, @NativeType(value="void *") long row, @NativeType(value="GLsizei") int columnBufSize, @NativeType(value="void *") long column, @NativeType(value="void *") @Nullable ByteBuffer span) {
        GL45.nglGetnSeparableFilter(target, format, type, rowBufSize, row, columnBufSize, column, MemoryUtil.memAddressSafe(span));
    }

    public static void glGetnSeparableFilter(@NativeType(value="GLenum") int target, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="void *") ByteBuffer row, @NativeType(value="void *") ByteBuffer column, @NativeType(value="void *") @Nullable ByteBuffer span) {
    ...
    public static void glGetnHistogram(@NativeType(value="GLenum") int target, @NativeType(value="GLboolean") boolean reset, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="GLsizei") int bufSize, @NativeType(value="void *") long values2) {
        GL45.nglGetnHistogram(target, reset, format, type, bufSize, values2);
    }

    public static void glGetnHistogram(@NativeType(value="GLenum") int target, @NativeType(value="GLboolean") boolean reset, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="void *") ByteBuffer values2) {
        GL45.nglGetnHistogram(target, reset, format, type, values2.remaining(), MemoryUtil.memAddress(values2));
    }

    public static native void nglGetnMinmax(int var0, boolean var1, int var2, int var3, int var4, long var5);

    public static void glGetnMinmax(@NativeType(value="GLenum") int target, @NativeType(value="GLboolean") boolean reset, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="GLsizei") int bufSize, @NativeType(value="void *") long values2) {
        GL45.nglGetnMinmax(target, reset, format, type, bufSize, values2);
    }

    public static void glGetnMinmax(@NativeType(value="GLenum") int target, @NativeType(value="GLboolean") boolean reset, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="void *") ByteBuffer values2) {
        GL45.nglGetnMinmax(target, reset, format, type, values2.remaining(), MemoryUtil.memAddress(values2));
    }
    ...
    public static void glClearNamedBufferData(@NativeType(value="GLuint") int buffer, @NativeType(value="GLenum") int internalformat, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="void const *") short @Nullable [] data) {
        GL45C.glClearNamedBufferData(buffer, internalformat, format, type, data);
    }

    public static void glClearNamedBufferData(@NativeType(value="GLuint") int buffer, @NativeType(value="GLenum") int internalformat, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="void const *") int @Nullable [] data) {
        GL45C.glClearNamedBufferData(buffer, internalformat, format, type, data);
    }

    public static void glClearNamedBufferData(@NativeType(value="GLuint") int buffer, @NativeType(value="GLenum") int internalformat, @NativeType(value="GLenum") int format, @NativeType(value="GLenum") int type, @NativeType(value="void const *") float @Nullable [] data) {
        GL45C.glClearNamedBufferData(buffer, internalformat, format, type, data);
    }
    ...
    public static void glVertexArrayVertexBuffers(@NativeType(value="GLuint") int vaobj, @NativeType(value="GLuint") int first, @NativeType(value="GLuint const *") int @Nullable [] buffers, @NativeType(value="GLintptr const *") @Nullable PointerBuffer offsets, @NativeType(value="GLsizei const *") int @Nullable [] strides) {
        GL45C.glVertexArrayVertexBuffers(vaobj, first, buffers, offsets, strides);
    }
