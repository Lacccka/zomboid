...
public class WGLNVVertexArrayRange {
    ...
    public static @Nullable ByteBuffer wglAllocateMemoryNV(@NativeType(value="GLsizei") int size, @NativeType(value="GLfloat") float readfreq, @NativeType(value="GLfloat") float writefreq, @NativeType(value="GLfloat") float priority) {
