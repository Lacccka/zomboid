...
public class GLXARBCreateContext {
    ...
    public static long glXCreateContextAttribsARB(@NativeType(value="Display *") long display, @NativeType(value="GLXFBConfig") long config, @NativeType(value="GLXContext") long share_context, @NativeType(value="Bool") boolean direct, @NativeType(value="int const *") @Nullable IntBuffer attrib_list) {
        if (Checks.CHECKS) {
    ...
    @NativeType(value="GLXContext")
    public static long glXCreateContextAttribsARB(@NativeType(value="Display *") long display, @NativeType(value="GLXFBConfig") long config, @NativeType(value="GLXContext") long share_context, @NativeType(value="Bool") boolean direct, @NativeType(value="int const *") int @Nullable [] attrib_list) {
        long __functionAddress = GL.getCapabilitiesGLXClient().glXCreateContextAttribsARB;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(display);
