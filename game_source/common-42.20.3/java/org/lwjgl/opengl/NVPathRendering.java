...
public class NVPathRendering {
    ...
    @NativeType(value="GLboolean")
    public static boolean glPointAlongPathNV(@NativeType(value="GLuint") int path, @NativeType(value="GLsizei") int startSegment, @NativeType(value="GLsizei") int numSegments, @NativeType(value="GLfloat") float distance, @NativeType(value="GLfloat *") @Nullable FloatBuffer x, @NativeType(value="GLfloat *") @Nullable FloatBuffer y, @NativeType(value="GLfloat *") @Nullable FloatBuffer tangentX, @NativeType(value="GLfloat *") @Nullable FloatBuffer tangentY) {
        if (Checks.CHECKS) {
    ...
    public static void glGetProgramResourcefvNV(@NativeType(value="GLuint") int program, @NativeType(value="GLenum") int programInterface, @NativeType(value="GLuint") int index, @NativeType(value="GLenum const *") IntBuffer props, @NativeType(value="GLsizei *") @Nullable IntBuffer length, @NativeType(value="GLfloat *") FloatBuffer params) {
        if (Checks.CHECKS) {
    ...
    @NativeType(value="GLboolean")
    public static boolean glPointAlongPathNV(@NativeType(value="GLuint") int path, @NativeType(value="GLsizei") int startSegment, @NativeType(value="GLsizei") int numSegments, @NativeType(value="GLfloat") float distance, @NativeType(value="GLfloat *") float @Nullable [] x, @NativeType(value="GLfloat *") float @Nullable [] y, @NativeType(value="GLfloat *") float @Nullable [] tangentX, @NativeType(value="GLfloat *") float @Nullable [] tangentY) {
    ...
    public static void glGetProgramResourcefvNV(@NativeType(value="GLuint") int program, @NativeType(value="GLenum") int programInterface, @NativeType(value="GLuint") int index, @NativeType(value="GLenum const *") int[] props, @NativeType(value="GLsizei *") int @Nullable [] length, @NativeType(value="GLfloat *") float[] params) {
