...
public class ARBShaderObjects {
    ...
    public static void glShaderSourceARB(@NativeType(value="GLhandleARB") int shaderObj, @NativeType(value="GLcharARB const **") PointerBuffer string, @NativeType(value="GLint const *") @Nullable IntBuffer length) {
        if (Checks.CHECKS) {
    ...
    public static void glGetInfoLogARB(@NativeType(value="GLhandleARB") int obj, @NativeType(value="GLsizei *") @Nullable IntBuffer length, @NativeType(value="GLcharARB *") ByteBuffer infoLog) {
        if (Checks.CHECKS) {
    ...
    public static void glGetAttachedObjectsARB(@NativeType(value="GLhandleARB") int containerObj, @NativeType(value="GLsizei *") @Nullable IntBuffer count, @NativeType(value="GLhandleARB *") IntBuffer obj) {
        if (Checks.CHECKS) {
    ...
    public static void glGetActiveUniformARB(@NativeType(value="GLhandleARB") int programObj, @NativeType(value="GLuint") int index, @NativeType(value="GLsizei *") @Nullable IntBuffer length, @NativeType(value="GLint *") IntBuffer size, @NativeType(value="GLenum *") IntBuffer type, @NativeType(value="GLcharARB *") ByteBuffer name) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)length, 1);
    ...
    public static void glGetShaderSourceARB(@NativeType(value="GLhandleARB") int obj, @NativeType(value="GLsizei *") @Nullable IntBuffer length, @NativeType(value="GLcharARB *") ByteBuffer source2) {
        if (Checks.CHECKS) {
            Checks.checkSafe((Buffer)length, 1);
        }
        ARBShaderObjects.nglGetShaderSourceARB(obj, source2.remaining(), MemoryUtil.memAddressSafe(length), MemoryUtil.memAddress(source2));
    }
    ...
    public static String glGetShaderSourceARB(@NativeType(value="GLhandleARB") int obj, @NativeType(value="GLsizei") int maxLength) {
        ...
        try {
            IntBuffer length = stack.ints(0);
            ARBShaderObjects.nglGetShaderSourceARB(obj, maxLength, MemoryUtil.memAddress(length), MemoryUtil.memAddress(source2));
    ...
    public static void glShaderSourceARB(@NativeType(value="GLhandleARB") int shaderObj, @NativeType(value="GLcharARB const **") PointerBuffer string, @NativeType(value="GLint const *") int @Nullable [] length) {
    ...
    public static void glGetInfoLogARB(@NativeType(value="GLhandleARB") int obj, @NativeType(value="GLsizei *") int @Nullable [] length, @NativeType(value="GLcharARB *") ByteBuffer infoLog) {
    ...
    public static void glGetAttachedObjectsARB(@NativeType(value="GLhandleARB") int containerObj, @NativeType(value="GLsizei *") int @Nullable [] count, @NativeType(value="GLhandleARB *") int[] obj) {
    ...
    public static void glGetActiveUniformARB(@NativeType(value="GLhandleARB") int programObj, @NativeType(value="GLuint") int index, @NativeType(value="GLsizei *") int @Nullable [] length, @NativeType(value="GLint *") int[] size, @NativeType(value="GLenum *") int[] type, @NativeType(value="GLcharARB *") ByteBuffer name) {
    ...
    public static void glGetShaderSourceARB(@NativeType(value="GLhandleARB") int obj, @NativeType(value="GLsizei *") int @Nullable [] length, @NativeType(value="GLcharARB *") ByteBuffer source2) {
        long __functionAddress = GL.getICD().glGetShaderSourceARB;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.checkSafe(length, 1);
        }
        JNI.callPPV(obj, source2.remaining(), length, MemoryUtil.memAddress(source2), __functionAddress);
    }
