...
public class WGLARBPbuffer {
    ...
    public static long wglCreatePbufferARB(@NativeType(value="HDC") long hdc, int pixelFormat, int width, int height, @NativeType(value="int const *") @Nullable IntBuffer attribList) {
        if (Checks.CHECKS) {
    ...
    @NativeType(value="HPBUFFERARB")
    public static long wglCreatePbufferARB(@NativeType(value="HDC") long hdc, int pixelFormat, int width, int height, @NativeType(value="int const *") int @Nullable [] attribList) {
        long __functionAddress = GL.getCapabilitiesWGL().wglCreatePbufferARB;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(hdc);
