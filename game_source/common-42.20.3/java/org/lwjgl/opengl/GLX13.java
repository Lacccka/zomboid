...
extends GLX12 {
    ...
    public static @Nullable PointerBuffer glXGetFBConfigs(@NativeType(value="Display *") long display, int screen) {
     ...
     */
    @NativeType(value="GLXFBConfig *")
    public static @Nullable PointerBuffer glXChooseFBConfig(@NativeType(value="Display *") long display, int screen, @NativeType(value="int const *") @Nullable IntBuffer attrib_list) {
        if (Checks.CHECKS) {
    ...
    public static @Nullable XVisualInfo glXGetVisualFromFBConfig(@NativeType(value="Display *") long display, @NativeType(value="GLXFBConfig") long config) {
    ...
    public static long glXCreateWindow(@NativeType(value="Display *") long display, @NativeType(value="GLXFBConfig") long config, @NativeType(value="Window") long win, @NativeType(value="int const *") @Nullable IntBuffer attrib_list) {
        if (Checks.CHECKS) {
            Checks.checkNTSafe(attrib_list);
        }
    ...
    public static long glXCreatePixmap(@NativeType(value="Display *") long display, @NativeType(value="GLXFBConfig") long config, @NativeType(value="Pixmap") long pixmap, @NativeType(value="int const *") @Nullable IntBuffer attrib_list) {
        if (Checks.CHECKS) {
            Checks.checkNTSafe(attrib_list);
        }
    ...
    public static long glXCreatePbuffer(@NativeType(value="Display *") long display, @NativeType(value="GLXFBConfig") long config, @NativeType(value="int const *") @Nullable IntBuffer attrib_list) {
        if (Checks.CHECKS) {
            Checks.checkNTSafe(attrib_list);
        }
     ...
     */
    @NativeType(value="GLXFBConfig *")
    public static @Nullable PointerBuffer glXChooseFBConfig(@NativeType(value="Display *") long display, int screen, @NativeType(value="int const *") int @Nullable [] attrib_list) {
        long __functionAddress = GL.getCapabilitiesGLXClient().glXChooseFBConfig;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(display);
    ...
    @NativeType(value="GLXWindow")
    public static long glXCreateWindow(@NativeType(value="Display *") long display, @NativeType(value="GLXFBConfig") long config, @NativeType(value="Window") long win, @NativeType(value="int const *") int @Nullable [] attrib_list) {
        long __functionAddress = GL.getCapabilitiesGLXClient().glXCreateWindow;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(display);
    ...
    @NativeType(value="GLXPixmap")
    public static long glXCreatePixmap(@NativeType(value="Display *") long display, @NativeType(value="GLXFBConfig") long config, @NativeType(value="Pixmap") long pixmap, @NativeType(value="int const *") int @Nullable [] attrib_list) {
        long __functionAddress = GL.getCapabilitiesGLXClient().glXCreatePixmap;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(display);
    ...
    @NativeType(value="GLXPbuffer")
    public static long glXCreatePbuffer(@NativeType(value="Display *") long display, @NativeType(value="GLXFBConfig") long config, @NativeType(value="int const *") int @Nullable [] attrib_list) {
        long __functionAddress = GL.getCapabilitiesGLXClient().glXCreatePbuffer;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(display);
