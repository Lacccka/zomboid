...
public class GLXEXTTextureFromPixmap {
    ...
    public static void glXBindTexImageEXT(@NativeType(value="Display *") long display, @NativeType(value="GLXDrawable") long drawable, int buffer, @NativeType(value="int const *") @Nullable IntBuffer attrib_list) {
        if (Checks.CHECKS) {
    ...
    public static void glXBindTexImageEXT(@NativeType(value="Display *") long display, @NativeType(value="GLXDrawable") long drawable, int buffer, @NativeType(value="int const *") int @Nullable [] attrib_list) {
        long __functionAddress = GL.getCapabilitiesGLXClient().glXBindTexImageEXT;
        if (Checks.CHECKS) {
            Checks.check(__functionAddress);
            Checks.check(display);
