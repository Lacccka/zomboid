...
Serializable {
    ...
    public Date parse(String source2) throws ParseException {
        String normalizedSource = source2.length() == 19 ? source2 + ".000" : source2;
        Date date = this.parse(normalizedSource, new ParsePosition(0));
        if (date == null) {
    ...
    public Date parse(String source2, ParsePosition pos) {
        ...
        Matcher matcher = this.parsePattern.matcher(source2.substring(offset));
