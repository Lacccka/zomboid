...
extends FilterInputStream {
    ...
    public CipherInputStream(InputStream inputStream2, BufferedBlockCipher bufferedBlockCipher, int n) {
        super(inputStream2);
    ...
    public CipherInputStream(InputStream inputStream2, StreamCipher streamCipher, int n) {
        super(inputStream2);
    ...
    public CipherInputStream(InputStream inputStream2, AEADBlockCipher aEADBlockCipher, int n) {
        super(inputStream2);
