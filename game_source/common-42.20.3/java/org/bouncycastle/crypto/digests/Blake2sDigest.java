...
implements ExtendedDigest {
    ...
    private void init() {
        if (this.chainValue == null) {
            ...
            if (this.salt != null) {
                this.chainValue[4] = this.chainValue[4] ^ Pack.littleEndianToInt(this.salt, 0);
                this.chainValue[5] = this.chainValue[5] ^ Pack.littleEndianToInt(this.salt, 4);
            }
            this.chainValue[6] = blake2s_IV[6];
            this.chainValue[7] = blake2s_IV[7];
            if (this.personalization != null) {
                this.chainValue[6] = this.chainValue[6] ^ Pack.littleEndianToInt(this.personalization, 0);
                this.chainValue[7] = this.chainValue[7] ^ Pack.littleEndianToInt(this.personalization, 4);
            }
        }
    }
