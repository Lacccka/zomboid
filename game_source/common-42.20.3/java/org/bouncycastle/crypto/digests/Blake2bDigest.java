...
implements ExtendedDigest {
    ...
    private void G(long l, long l2, int n, int n2, int n3, int n4) {
        ...
        this.internalState[n4] = Blake2bDigest.rotr64(this.internalState[n4] ^ this.internalState[n], 32);
        this.internalState[n3] = this.internalState[n3] + this.internalState[n4];
        this.internalState[n2] = Blake2bDigest.rotr64(this.internalState[n2] ^ this.internalState[n3], 24);
        this.internalState[n] = this.internalState[n] + this.internalState[n2] + l2;
        this.internalState[n4] = Blake2bDigest.rotr64(this.internalState[n4] ^ this.internalState[n], 16);
        this.internalState[n3] = this.internalState[n3] + this.internalState[n4];
        this.internalState[n2] = Blake2bDigest.rotr64(this.internalState[n2] ^ this.internalState[n3], 63);
    }

    private static long rotr64(long l, int n) {
        return l >>> n | l << 64 - n;
    }
