...
public class URLAndHash {
    ...
    public void encode(OutputStream outputStream2) throws IOException {
        ...
        if (this.sha1Hash == null) {
            ...
            TlsUtils.writeUint8(1, outputStream2);
            outputStream2.write(this.sha1Hash);
        }
    }

    public static URLAndHash parse(TlsContext tlsContext, InputStream inputStream2) throws IOException {
        ...
        switch (s) {
            ...
            case 1: {
                byArray2 = TlsUtils.readFully(20, inputStream2);
                break;
            }
            default: {
                throw new TlsFatalAlert(47);
