...
extends AbstractTlsKeyExchange {
    ...
    public void processServerKeyExchange(InputStream inputStream2) throws IOException {
        this.psk_identity_hint = TlsUtils.readOpaque16(inputStream2);
        if (this.keyExchange == 14) {
            ServerDHParams serverDHParams = ServerDHParams.parse(inputStream2);
            ...
            ECDomainParameters eCDomainParameters = TlsECCUtils.readECParameters(this.namedCurves, this.clientECPointFormats, inputStream2);
    ...
    public void generateClientKeyExchange(OutputStream outputStream2) throws IOException {
        if (this.psk_identity_hint == null) {
        ...
        if (this.keyExchange == 14) {
            this.dhAgreePrivateKey = TlsDHUtils.generateEphemeralClientKeyExchange(this.context.getSecureRandom(), this.dhParameters, outputStream2);
        } else if (this.keyExchange == 24) {
            this.ecAgreePrivateKey = TlsECCUtils.generateEphemeralClientKeyExchange(this.context.getSecureRandom(), this.serverECPointFormats, this.ecAgreePublicKey.getParameters(), outputStream2);
        } else if (this.keyExchange == 15) {
            this.premasterSecret = TlsRSAUtils.generateEncryptedPreMasterSecret(this.context, this.rsaServerPublicKey, outputStream2);
        }
    }

    public void processClientKeyExchange(InputStream inputStream2) throws IOException {
        ...
        if (this.keyExchange == 14) {
            ...
            byte[] byArray2 = TlsUtils.readOpaque8(inputStream2);
            ...
            byte[] byArray3 = TlsUtils.isSSL(this.context) ? Streams.readAll(inputStream2) : TlsUtils.readOpaque16(inputStream2);
