...
class RecordStream {
    ...
    RecordStream(TlsProtocol tlsProtocol, InputStream inputStream2, OutputStream outputStream2) {
    ...
    byte[] decodeAndVerify(short s, InputStream inputStream2, int n) throws IOException {
        ...
        OutputStream outputStream2 = this.readCompression.decompress(this.buffer);
        if (outputStream2 != this.buffer) {
            outputStream2.write(byArray2, 0, byArray2.length);
            outputStream2.flush();
    ...
    void writeRecord(short s, byte[] byArray, int n, int n2) throws IOException {
        ...
        OutputStream outputStream2 = this.writeCompression.compress(this.buffer);
