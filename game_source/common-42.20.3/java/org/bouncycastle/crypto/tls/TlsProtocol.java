...
public abstract class TlsProtocol {
    ...
    public TlsProtocol(InputStream inputStream2, OutputStream outputStream2, SecureRandom secureRandom) {
        this.blocking = true;
        this.recordStream = new RecordStream(this, inputStream2, outputStream2);
    ...
    protected static void writeExtensions(OutputStream outputStream2, Hashtable hashtable) throws IOException {
    ...
    protected static void writeSelectedExtensions(OutputStream outputStream2, Hashtable hashtable, boolean bl) throws IOException {
    ...
    protected static void writeSupplementalData(OutputStream outputStream2, Vector vector) throws IOException {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        ...
        byte[] byArray = byteArrayOutputStream.toByteArray();
        TlsUtils.writeOpaque24(byArray, outputStream2);
    }
