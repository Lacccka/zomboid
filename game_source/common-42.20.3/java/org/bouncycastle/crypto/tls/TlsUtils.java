...
public class TlsUtils {
    ...
    public static void writeUint8(short s, OutputStream outputStream2) throws IOException {
        outputStream2.write(s);
    }

    public static void writeUint8(int n, OutputStream outputStream2) throws IOException {
    ...
    public static void writeUint16(int n, OutputStream outputStream2) throws IOException {
        outputStream2.write(n >>> 8);
        outputStream2.write(n);
    }
    ...
    public static void writeUint24(int n, OutputStream outputStream2) throws IOException {
        outputStream2.write((byte)(n >>> 16));
        outputStream2.write((byte)(n >>> 8));
    ...
    public static void writeUint32(long l, OutputStream outputStream2) throws IOException {
    ...
    public static void writeUint48(long l, OutputStream outputStream2) throws IOException {
        outputStream2.write((byte)(l >>> 40));
        outputStream2.write((byte)(l >>> 32));
        outputStream2.write((byte)(l >>> 24));
        outputStream2.write((byte)(l >>> 16));
        outputStream2.write((byte)(l >>> 8));
        outputStream2.write((byte)l);
    ...
    public static void writeUint64(long l, OutputStream outputStream2) throws IOException {
        outputStream2.write((byte)(l >>> 56));
        outputStream2.write((byte)(l >>> 48));
        outputStream2.write((byte)(l >>> 40));
        outputStream2.write((byte)(l >>> 32));
        outputStream2.write((byte)(l >>> 24));
        outputStream2.write((byte)(l >>> 16));
    ...
    public static void writeOpaque8(byte[] byArray, OutputStream outputStream2) throws IOException {
        TlsUtils.checkUint8(byArray.length);
        TlsUtils.writeUint8(byArray.length, outputStream2);
        outputStream2.write(byArray);
    }

    public static void writeOpaque16(byte[] byArray, OutputStream outputStream2) throws IOException {
        TlsUtils.checkUint16(byArray.length);
        TlsUtils.writeUint16(byArray.length, outputStream2);
        outputStream2.write(byArray);
    }

    public static void writeOpaque24(byte[] byArray, OutputStream outputStream2) throws IOException {
        TlsUtils.checkUint24(byArray.length);
        TlsUtils.writeUint24(byArray.length, outputStream2);
        outputStream2.write(byArray);
    }

    public static void writeUint8Array(short[] sArray, OutputStream outputStream2) throws IOException {
        for (int i = 0; i < sArray.length; ++i) {
            TlsUtils.writeUint8(sArray[i], outputStream2);
        }
    }
    ...
    public static void writeUint8ArrayWithUint8Length(short[] sArray, OutputStream outputStream2) throws IOException {
        TlsUtils.checkUint8(sArray.length);
        TlsUtils.writeUint8(sArray.length, outputStream2);
        TlsUtils.writeUint8Array(sArray, outputStream2);
    }
    ...
    public static void writeUint16Array(int[] nArray, OutputStream outputStream2) throws IOException {
        for (int i = 0; i < nArray.length; ++i) {
            TlsUtils.writeUint16(nArray[i], outputStream2);
        }
    }
    ...
    public static void writeUint16ArrayWithUint16Length(int[] nArray, OutputStream outputStream2) throws IOException {
        int n = 2 * nArray.length;
        TlsUtils.checkUint16(n);
        TlsUtils.writeUint16(n, outputStream2);
        TlsUtils.writeUint16Array(nArray, outputStream2);
    }
    ...
    public static short readUint8(InputStream inputStream2) throws IOException {
    ...
    public static int readUint16(InputStream inputStream2) throws IOException {
        int n = inputStream2.read();
    ...
    public static int readUint24(InputStream inputStream2) throws IOException {
        int n = inputStream2.read();
        int n2 = inputStream2.read();
    ...
    public static long readUint32(InputStream inputStream2) throws IOException {
        int n = inputStream2.read();
        int n2 = inputStream2.read();
        int n3 = inputStream2.read();
    ...
    public static long readUint48(InputStream inputStream2) throws IOException {
        int n = TlsUtils.readUint24(inputStream2);
        int n2 = TlsUtils.readUint24(inputStream2);
    ...
    public static byte[] readAllOrNothing(int n, InputStream inputStream2) throws IOException {
        if (n < 1) {
            return EMPTY_BYTES;
        }
        byte[] byArray = new byte[n];
        int n2 = Streams.readFully(inputStream2, byArray);
        if (n2 == 0) {
            return null;
        }
        if (n2 != n) {
    ...
    public static byte[] readFully(int n, InputStream inputStream2) throws IOException {
        if (n < 1) {
            return EMPTY_BYTES;
        }
        byte[] byArray = new byte[n];
        if (n != Streams.readFully(inputStream2, byArray)) {
            throw new EOFException();
        }
        return byArray;
    }

    public static void readFully(byte[] byArray, InputStream inputStream2) throws IOException {
        int n = byArray.length;
        if (n > 0 && n != Streams.readFully(inputStream2, byArray)) {
            throw new EOFException();
        }
    }

    public static byte[] readOpaque8(InputStream inputStream2) throws IOException {
        short s = TlsUtils.readUint8(inputStream2);
        return TlsUtils.readFully(s, inputStream2);
    }

    public static byte[] readOpaque16(InputStream inputStream2) throws IOException {
        int n = TlsUtils.readUint16(inputStream2);
        return TlsUtils.readFully(n, inputStream2);
    }

    public static byte[] readOpaque24(InputStream inputStream2) throws IOException {
        int n = TlsUtils.readUint24(inputStream2);
        return TlsUtils.readFully(n, inputStream2);
    }

    public static short[] readUint8Array(int n, InputStream inputStream2) throws IOException {
    ...
    public static int[] readUint16Array(int n, InputStream inputStream2) throws IOException {
        int[] nArray = new int[n];
        for (int i = 0; i < n; ++i) {
            nArray[i] = TlsUtils.readUint16(inputStream2);
        }
        return nArray;
    }
    ...
    public static ProtocolVersion readVersion(InputStream inputStream2) throws IOException {
        int n = inputStream2.read();
        int n2 = inputStream2.read();
        if (n2 < 0) {
            throw new EOFException();
    ...
    public static int readVersionRaw(InputStream inputStream2) throws IOException {
        int n = inputStream2.read();
        int n2 = inputStream2.read();
        if (n2 < 0) {
            throw new EOFException();
    ...
    public static void writeVersion(ProtocolVersion protocolVersion, OutputStream outputStream2) throws IOException {
        outputStream2.write(protocolVersion.getMajorVersion());
        outputStream2.write(protocolVersion.getMinorVersion());
    }
    ...
    public static void encodeSupportedSignatureAlgorithms(Vector vector, boolean bl, OutputStream outputStream2) throws IOException {
        ...
        for (int i = 0; i < vector.size(); ++i) {
            ...
            signatureAndHashAlgorithm.encode(outputStream2);
        }
    }

    public static Vector parseSupportedSignatureAlgorithms(boolean bl, InputStream inputStream2) throws IOException {
        int n = TlsUtils.readUint16(inputStream2);
        if (n < 2 || (n & 1) != 0) {
            throw new TlsFatalAlert(50);
        }
        ...
        for (int i = 0; i < n2; ++i) {
            SignatureAndHashAlgorithm signatureAndHashAlgorithm = SignatureAndHashAlgorithm.parse(inputStream2);
            if (!bl && signatureAndHashAlgorithm.getSignature() == 0) {
