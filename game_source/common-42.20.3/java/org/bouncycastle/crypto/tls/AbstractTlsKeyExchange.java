...
implements TlsKeyExchange {
    ...
    protected DigitallySigned parseSignature(InputStream inputStream2) throws IOException {
        DigitallySigned digitallySigned = DigitallySigned.parse(this.context, inputStream2);
