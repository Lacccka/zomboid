...
public class TlsSRPUtils {
    ...
    public static BigInteger readSRPParameter(InputStream inputStream2) throws IOException {
        return new BigInteger(1, TlsUtils.readOpaque16(inputStream2));
    }

    public static void writeSRPParameter(BigInteger bigInteger, OutputStream outputStream2) throws IOException {
        TlsUtils.writeOpaque16(BigIntegers.asUnsignedByteArray(bigInteger), outputStream2);
    }
