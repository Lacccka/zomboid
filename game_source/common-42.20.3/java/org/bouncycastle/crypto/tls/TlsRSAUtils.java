...
public class TlsRSAUtils {
    public static byte[] generateEncryptedPreMasterSecret(TlsContext tlsContext, RSAKeyParameters rSAKeyParameters, OutputStream outputStream2) throws IOException {
        ...
        try {
            ...
            if (TlsUtils.isSSL(tlsContext)) {
                ...
                TlsUtils.writeOpaque16(byArray2, outputStream2);
            }
        }
