...
public class TlsECCUtils {
    ...
    public static ECPrivateKeyParameters generateEphemeralClientKeyExchange(SecureRandom secureRandom, short[] sArray, ECDomainParameters eCDomainParameters, OutputStream outputStream2) throws IOException {
        ...
        TlsECCUtils.writeECPoint(sArray, eCPublicKeyParameters.getQ(), outputStream2);
        return (ECPrivateKeyParameters)asymmetricCipherKeyPair.getPrivate();
    }

    static ECPrivateKeyParameters generateEphemeralServerKeyExchange(SecureRandom secureRandom, int[] nArray, short[] sArray, OutputStream outputStream2) throws IOException {
        int n = -1;
        if (nArray == null) {
            n = 23;
        } else {
        ...
        if (n < 0) {
            TlsECCUtils.writeExplicitECParameters(sArray, eCDomainParameters, outputStream2);
        } else {
            TlsECCUtils.writeNamedECParameters(n, outputStream2);
        }
        return TlsECCUtils.generateEphemeralClientKeyExchange(secureRandom, sArray, eCDomainParameters, outputStream2);
    }
    ...
    public static int readECExponent(int n, InputStream inputStream2) throws IOException {
        int n2;
        BigInteger bigInteger = TlsECCUtils.readECParameter(inputStream2);
    ...
    public static BigInteger readECFieldElement(int n, InputStream inputStream2) throws IOException {
        return TlsECCUtils.deserializeECFieldElement(n, TlsUtils.readOpaque8(inputStream2));
    }

    public static BigInteger readECParameter(InputStream inputStream2) throws IOException {
        return new BigInteger(1, TlsUtils.readOpaque8(inputStream2));
    }

    public static ECDomainParameters readECParameters(int[] nArray, short[] sArray, InputStream inputStream2) throws IOException {
        try {
            ...
            switch (s) {
                case 1: {
                    ...
                    BigInteger bigInteger = TlsECCUtils.readECParameter(inputStream2);
                    BigInteger bigInteger2 = TlsECCUtils.readECFieldElement(bigInteger.bitLength(), inputStream2);
                    BigInteger bigInteger3 = TlsECCUtils.readECFieldElement(bigInteger.bitLength(), inputStream2);
                    byte[] byArray = TlsUtils.readOpaque8(inputStream2);
                    BigInteger bigInteger4 = TlsECCUtils.readECParameter(inputStream2);
                    BigInteger bigInteger5 = TlsECCUtils.readECParameter(inputStream2);
                ...
                case 2: {
                    ...
                    int n2 = TlsECCUtils.readECExponent(n, inputStream2);
                    int n3 = -1;
                    int n4 = -1;
                    if (s2 == 2) {
                        n3 = TlsECCUtils.readECExponent(n, inputStream2);
                        n4 = TlsECCUtils.readECExponent(n, inputStream2);
                    }
                    BigInteger bigInteger = TlsECCUtils.readECFieldElement(n, inputStream2);
                    BigInteger bigInteger6 = TlsECCUtils.readECFieldElement(n, inputStream2);
                    byte[] byArray = TlsUtils.readOpaque8(inputStream2);
                    BigInteger bigInteger7 = TlsECCUtils.readECParameter(inputStream2);
                    BigInteger bigInteger8 = TlsECCUtils.readECParameter(inputStream2);
    ...
    public static void writeECExponent(int n, OutputStream outputStream2) throws IOException {
        BigInteger bigInteger = BigInteger.valueOf(n);
        TlsECCUtils.writeECParameter(bigInteger, outputStream2);
    }

    public static void writeECFieldElement(ECFieldElement eCFieldElement, OutputStream outputStream2) throws IOException {
        TlsUtils.writeOpaque8(eCFieldElement.getEncoded(), outputStream2);
    }

    public static void writeECFieldElement(int n, BigInteger bigInteger, OutputStream outputStream2) throws IOException {
        TlsUtils.writeOpaque8(TlsECCUtils.serializeECFieldElement(n, bigInteger), outputStream2);
    }

    public static void writeECParameter(BigInteger bigInteger, OutputStream outputStream2) throws IOException {
        TlsUtils.writeOpaque8(BigIntegers.asUnsignedByteArray(bigInteger), outputStream2);
    }
     ...
     */
    public static void writeExplicitECParameters(short[] sArray, ECDomainParameters eCDomainParameters, OutputStream outputStream2) throws IOException {
        ECCurve eCCurve = eCDomainParameters.getCurve();
        if (ECAlgorithms.isFpCurve(eCCurve)) {
            TlsUtils.writeUint8((short)1, outputStream2);
            TlsECCUtils.writeECParameter(eCCurve.getField().getCharacteristic(), outputStream2);
        } else {
            ...
            TlsUtils.writeUint8((short)2, outputStream2);
            int n = nArray[nArray.length - 1];
            TlsUtils.checkUint16(n);
            TlsUtils.writeUint16(n, outputStream2);
            if (nArray.length == 3) {
                TlsUtils.writeUint8((short)1, outputStream2);
                TlsECCUtils.writeECExponent(nArray[1], outputStream2);
            } else {
                if (nArray.length != 5) throw new IllegalArgumentException("Only trinomial and pentomial curves are supported");
                TlsUtils.writeUint8((short)2, outputStream2);
                TlsECCUtils.writeECExponent(nArray[1], outputStream2);
                TlsECCUtils.writeECExponent(nArray[2], outputStream2);
                TlsECCUtils.writeECExponent(nArray[3], outputStream2);
            }
        }
        TlsECCUtils.writeECFieldElement(eCCurve.getA(), outputStream2);
        TlsECCUtils.writeECFieldElement(eCCurve.getB(), outputStream2);
        TlsUtils.writeOpaque8(TlsECCUtils.serializeECPoint(sArray, eCDomainParameters.getG()), outputStream2);
        TlsECCUtils.writeECParameter(eCDomainParameters.getN(), outputStream2);
        TlsECCUtils.writeECParameter(eCDomainParameters.getH(), outputStream2);
    }

    public static void writeECPoint(short[] sArray, ECPoint eCPoint, OutputStream outputStream2) throws IOException {
        TlsUtils.writeOpaque8(TlsECCUtils.serializeECPoint(sArray, eCPoint), outputStream2);
    }

    public static void writeNamedECParameters(int n, OutputStream outputStream2) throws IOException {
        if (!NamedCurve.refersToASpecificNamedCurve(n)) {
            throw new TlsFatalAlert(80);
        }
        TlsUtils.writeUint8((short)3, outputStream2);
        TlsUtils.checkUint16(n);
        TlsUtils.writeUint16(n, outputStream2);
    }
}
