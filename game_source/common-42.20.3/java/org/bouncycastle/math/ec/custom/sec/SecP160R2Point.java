...
extends ECPoint.AbstractFp {
    ...
    public SecP160R2Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, boolean bl) {
    ...
    SecP160R2Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArray, boolean bl) {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        return new SecP160R2Point(eCCurve, secP160R2FieldElement7, secP160R2FieldElement8, eCFieldElementArray, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        return new SecP160R2Point(eCCurve, secP160R2FieldElement4, secP160R2FieldElement5, new ECFieldElement[]{secP160R2FieldElement6}, this.withCompression);
    }
