...
extends ECPoint.AbstractF2m {
    ...
    public SecT283K1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, boolean bl) {
    ...
    SecT283K1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArray, boolean bl) {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (eCFieldElement5.isZero()) {
            ...
            if (eCFieldElement3.isZero()) {
                return new SecT283K1Point(eCCurve, eCFieldElement3, eCCurve.getB(), this.withCompression);
            }
        ...
        return new SecT283K1Point(eCCurve, eCFieldElement3, eCFieldElement2, new ECFieldElement[]{eCFieldElement}, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElement5.isZero()) {
            return new SecT283K1Point(eCCurve, eCFieldElement5, eCCurve.getB(), this.withCompression);
        }
        ...
        return new SecT283K1Point(eCCurve, eCFieldElement6, eCFieldElement10, new ECFieldElement[]{eCFieldElement7}, this.withCompression);
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (eCFieldElement13.isZero()) {
            return new SecT283K1Point(eCCurve, eCFieldElement13, eCCurve.getB(), this.withCompression);
        }
        ...
        return new SecT283K1Point(eCCurve, eCFieldElement16, eCFieldElement18, new ECFieldElement[]{eCFieldElement17}, this.withCompression);
    }
