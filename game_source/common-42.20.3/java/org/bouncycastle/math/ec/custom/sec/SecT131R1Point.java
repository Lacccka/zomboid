...
extends ECPoint.AbstractF2m {
    ...
    public SecT131R1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, boolean bl) {
    ...
    SecT131R1Point(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArray, boolean bl) {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (eCFieldElement5.isZero()) {
            ...
            if (eCFieldElement3.isZero()) {
                return new SecT131R1Point(eCCurve, eCFieldElement3, eCCurve.getB().sqrt(), this.withCompression);
            }
        ...
        return new SecT131R1Point(eCCurve, eCFieldElement3, eCFieldElement2, new ECFieldElement[]{eCFieldElement}, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElement8.isZero()) {
            return new SecT131R1Point(eCCurve, eCFieldElement8, eCCurve.getB().sqrt(), this.withCompression);
        }
        ...
        return new SecT131R1Point(eCCurve, eCFieldElement9, eCFieldElement12, new ECFieldElement[]{eCFieldElement10}, this.withCompression);
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (eCFieldElement13.isZero()) {
            return new SecT131R1Point(eCCurve, eCFieldElement13, eCCurve.getB().sqrt(), this.withCompression);
        }
        ...
        return new SecT131R1Point(eCCurve, eCFieldElement16, eCFieldElement18, new ECFieldElement[]{eCFieldElement17}, this.withCompression);
    }
