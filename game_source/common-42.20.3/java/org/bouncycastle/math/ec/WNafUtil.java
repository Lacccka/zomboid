...
public abstract class WNafUtil {
    ...
    public static ECPoint mapPointWithPrecomp(ECPoint eCPoint, int n, final boolean bl, final ECPointMap eCPointMap) {
        ...
        eCCurve.precompute(eCPoint2, PRECOMP_NAME, new PreCompCallback(){
    ...
    public static WNafPreCompInfo precompute(final ECPoint eCPoint, final int n, final boolean bl) {
        ...
        return (WNafPreCompInfo)eCCurve.precompute(eCPoint, PRECOMP_NAME, new PreCompCallback(){
            ...
            public PreCompInfo precompute(PreCompInfo preCompInfo) {
                ...
                if (this.checkExisting(wNafPreCompInfo, n2 = 1 << Math.max(0, n - 2), bl)) {
                ...
                if (n3 < n2) {
                    ...
                    if (n2 == 1) {
                        ...
                        if (n2 == 2) {
                            ...
                            if (eCPoint2 == null && !(eCPoint4 = (eCPoint2 = eCPointArray[0].twice())).isInfinity() && ECAlgorithms.isFpCurve(eCCurve) && eCCurve.getFieldSize() >= 64) {
                        ...
                        eCCurve.normalizeAll(eCPointArray, n3, n2 - n3, eCFieldElement);
                    }
                }
                if (bl) {
            ...
            private boolean checkExisting(WNafPreCompInfo wNafPreCompInfo, int n2, boolean bl2) {
                return wNafPreCompInfo != null && this.checkTable(wNafPreCompInfo.getPreComp(), n2) && (!bl2 || this.checkTable(wNafPreCompInfo.getPreCompNeg(), n2));
            }
