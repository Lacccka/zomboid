...
extends CertificateFactorySpi {
    ...
    private java.security.cert.Certificate readPEMCertificate(InputStream inputStream2) throws IOException, CertificateParsingException {
        return this.getCertificate(PEM_CERT_PARSER.readPEMObject(inputStream2));
    }
    ...
    private CRL readPEMCRL(InputStream inputStream2) throws IOException, CRLException {
        return this.getCRL(PEM_CRL_PARSER.readPEMObject(inputStream2));
    }
    ...
    public java.security.cert.Certificate engineGenerateCertificate(InputStream inputStream2) throws CertificateException {
        ...
        try {
            ...
            inputStream3.mark(1);
            int n = inputStream3.read();
            if (n == -1) {
                return null;
            }
            inputStream3.reset();
            if (n != 48) {
                return this.readPEMCertificate(inputStream3);
            }
    ...
    public CRL engineGenerateCRL(InputStream inputStream2) throws CRLException {
        ...
        try {
            ...
            inputStream3.reset();
            if (n != 48) {
                return this.readPEMCRL(inputStream3);
            }
