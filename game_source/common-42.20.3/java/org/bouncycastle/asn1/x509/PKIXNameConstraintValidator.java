...
implements NameConstraintValidator {
    ...
    public String toString() {
        ...
        if (this.permittedSubtreesOtherName != null) {
            ...
            string = string + this.stringifyOtherNameCollection(this.permittedSubtreesOtherName) + "\n";
        }
        ...
        if (!this.excludedSubtreesOtherName.isEmpty()) {
            string = string + "OtherName:\n";
            string = string + this.stringifyOtherNameCollection(this.excludedSubtreesOtherName) + "\n";
        }
        return string;
    }
    ...
    private String stringifyIPCollection(Set set) {
        ...
        while (iterator2.hasNext()) {
            ...
            stringBuilder.append(this.stringifyIP((byte[])iterator2.next()));
        }
        stringBuilder.append("]");
        return stringBuilder.toString();
    }
    ...
    private String stringifyOtherNameCollection(Set set) {
        ...
        while (iterator2.hasNext()) {
            ...
            OtherName otherName = OtherName.getInstance(iterator2.next());
