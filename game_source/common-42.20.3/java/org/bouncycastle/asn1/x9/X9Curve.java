    ...
    public X9Curve(X9FieldID x9FieldID, BigInteger bigInteger, BigInteger bigInteger2, ASN1Sequence aSN1Sequence) {
        ...
        if (this.fieldIdentifier.equals(prime_field)) {
            ...
            if (aSN1ObjectIdentifier.equals(tpBasis)) {
                ...
                n2 = ASN1Integer.getInstance(((ASN1Sequence)object).getObjectAt(0)).getValue().intValue();
                n3 = ASN1Integer.getInstance(((ASN1Sequence)object).getObjectAt(1)).getValue().intValue();
                n4 = ASN1Integer.getInstance(((ASN1Sequence)object).getObjectAt(2)).getValue().intValue();
            } else {
