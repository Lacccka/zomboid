...
public interface BSIObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier aes_cbc_cmac = algorithm.branch("1");
    public static final ASN1ObjectIdentifier id_aes128_CBC_CMAC = aes_cbc_cmac.branch("1");
    public static final ASN1ObjectIdentifier id_aes192_CBC_CMAC = aes_cbc_cmac.branch("1");
    public static final ASN1ObjectIdentifier id_aes256_CBC_CMAC = aes_cbc_cmac.branch("1");
}
