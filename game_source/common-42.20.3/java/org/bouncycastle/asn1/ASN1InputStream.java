...
implements BERTags {
    ...
    public ASN1InputStream(InputStream inputStream2, int n) {
        this(inputStream2, n, false);
    }
    ...
    public ASN1InputStream(InputStream inputStream2, int n, boolean bl) {
        super(inputStream2);
        this.limit = n;
            ...
            switch (n2) {
                case 4: {
                    ...
                    for (int i = 0; i != aSN1OctetStringArray.length; ++i) {
                        aSN1OctetStringArray[i] = (ASN1OctetString)aSN1EncodableVector.get(i);
                    }
    ...
    static int readTagNumber(InputStream inputStream2, int n) throws IOException {
        int n2 = n & 0x1F;
        if (n2 == 31) {
            n2 = 0;
    ...
    static int readLength(InputStream inputStream2, int n) throws IOException {
