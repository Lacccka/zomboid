...
Quaterniondc {
    ...
    public Quaterniond(Quaterniondc source2) {
        this.x = source2.x();
        this.y = source2.y();
        this.z = source2.z();
        this.w = source2.w();
    ...
    public Quaterniond(Quaternionfc source2) {
        this.x = source2.x();
        this.y = source2.y();
        this.z = source2.z();
        this.w = source2.w();
    ...
    public Quaterniond nlerpIterative(Quaterniondc q, double alpha, double dotThreshold, Quaterniond dest) {
        ...
        while (absDot < dotThreshold) {
            ...
            if (alphaN < 0.5) {
                q2x = Math.fma(0.5, q2x, scale1 * q1x);
                q2y = Math.fma(0.5, q2y, scale1 * q1y);
                q2z = Math.fma(0.5, q2z, scale1 * q1z);
                q2w = Math.fma(0.5, q2w, scale1 * q1w);
                ...
                q1x = Math.fma(0.5, q1x, scale1 * q2x);
                q1y = Math.fma(0.5, q1y, scale1 * q2y);
                q1z = Math.fma(0.5, q1z, scale1 * q2z);
                q1w = Math.fma(0.5, q1w, scale1 * q2w);
