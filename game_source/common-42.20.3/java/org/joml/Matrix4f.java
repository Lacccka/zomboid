...
Matrix4fc {
    ...
    public Matrix4f rotateTowardsXY(float dirX, float dirY, Matrix4f dest) {
        ...
        float nm00 = this.m00 * dirY + this.m10 * dirX;
        float nm01 = this.m01 * dirY + this.m11 * dirX;
        float nm02 = this.m02 * dirY + this.m12 * dirX;
        float nm03 = this.m03 * dirY + this.m13 * dirX;
        return dest._m10(this.m00 * -dirX + this.m10 * dirY)._m11(this.m01 * -dirX + this.m11 * dirY)._m12(this.m02 * -dirX + this.m12 * dirY)._m13(this.m03 * -dirX + this.m13 * dirY)._m00(nm00)._m01(nm01)._m02(nm02)._m03(nm03)._m20(this.m20)._m21(this.m21)._m22(this.m22)._m23(this.m23)._m30(this.m30)._m31(this.m31)._m32(this.m32)._m33(this.m33)._properties(this.properties & 0xFFFFFFF2);
    }
    ...
    private Matrix4f rotateXYZInternal(float angleX, float angleY, float angleZ, Matrix4f dest) {
        ...
        return dest._m20(this.m00 * sinY + nm20 * cosY)._m21(this.m01 * sinY + nm21 * cosY)._m22(this.m02 * sinY + nm22 * cosY)._m23(this.m03 * sinY + nm23 * cosY)._m00(nm00 * cosZ + nm10 * sinZ)._m01(nm01 * cosZ + nm11 * sinZ)._m02(nm02 * cosZ + nm12 * sinZ)._m03(nm03 * cosZ + nm13 * sinZ)._m10(nm00 * m_sinZ + nm10 * cosZ)._m11(nm01 * m_sinZ + nm11 * cosZ)._m12(nm02 * m_sinZ + nm12 * cosZ)._m13(nm03 * m_sinZ + nm13 * cosZ)._m30(this.m30)._m31(this.m31)._m32(this.m32)._m33(this.m33)._properties(this.properties & 0xFFFFFFF2);
    }
    ...
    private Matrix4f rotateAffineXYZInternal(float angleX, float angleY, float angleZ, Matrix4f dest) {
        ...
        float nm01 = this.m01 * cosY + nm21 * m_sinY;
        float nm02 = this.m02 * cosY + nm22 * m_sinY;
        return dest._m20(this.m00 * sinY + nm20 * cosY)._m21(this.m01 * sinY + nm21 * cosY)._m22(this.m02 * sinY + nm22 * cosY)._m23(0.0f)._m00(nm00 * cosZ + nm10 * sinZ)._m01(nm01 * cosZ + nm11 * sinZ)._m02(nm02 * cosZ + nm12 * sinZ)._m03(0.0f)._m10(nm00 * m_sinZ + nm10 * cosZ)._m11(nm01 * m_sinZ + nm11 * cosZ)._m12(nm02 * m_sinZ + nm12 * cosZ)._m13(0.0f)._m30(this.m30)._m31(this.m31)._m32(this.m32)._m33(this.m33)._properties(this.properties & 0xFFFFFFF2);
    }
    ...
    private Matrix4f rotateTranslationInternal(float ang, float x, float y, float z, Matrix4f dest) {
        ...
        float rm21 = yz * C - x * s;
        float rm22 = zz * C + c;
        return dest._m20(rm20)._m21(rm21)._m22(rm22)._m00(rm00)._m01(rm01)._m02(rm02)._m03(0.0f)._m10(rm10)._m11(rm11)._m12(rm12)._m13(0.0f)._m30(this.m30)._m31(this.m31)._m32(this.m32)._m33(1.0f)._properties(this.properties & 0xFFFFFFF2);
    }
    ...
    private Matrix4f perspectiveGeneric(float fovy, float aspect, float zNear, float zFar, boolean zZeroToOne, Matrix4f dest) {
        ...
        if (farInf) {
            e = 1.0E-6f;
            rm22 = -0.999999f;
            rm32 = (1.0E-6f - (zZeroToOne ? 1.0f : 2.0f)) * zNear;
        } else if (nearInf) {
            e = 1.0E-6f;
            rm22 = (zZeroToOne ? 0.0f : 1.0f) - 1.0E-6f;
            rm32 = ((zZeroToOne ? 1.0f : 2.0f) - 1.0E-6f) * zFar;
        } else {
    ...
    public Matrix4f setPerspective(float fovy, float aspect, float zNear, float zFar, boolean zZeroToOne) {
        ...
        if (farInf) {
            float e = 1.0E-6f;
            this._m22(-0.999999f)._m32((1.0E-6f - (zZeroToOne ? 1.0f : 2.0f)) * zNear);
        } else if (nearInf) {
            float e = 1.0E-6f;
            this._m22((zZeroToOne ? 0.0f : 1.0f) - 1.0E-6f)._m32(((zZeroToOne ? 1.0f : 2.0f) - 1.0E-6f) * zFar);
        } else {
    ...
    public Vector4f project(float x, float y, float z, int[] viewport, Vector4f winCoordsDest) {
        ...
        return winCoordsDest.set((nx * 0.5f + 0.5f) * (float)viewport[2] + (float)viewport[0], (ny * 0.5f + 0.5f) * (float)viewport[3] + (float)viewport[1], (1.0f + nz) * 0.5f, 1.0f);
    }
    ...
    public Matrix4f setColumn(int column, Vector4fc src) throws IndexOutOfBoundsException {
        if (src instanceof Vector4f) {
            ...
            return MemUtil.INSTANCE.setColumn(vector4f, column, this)._properties(0);
        }
