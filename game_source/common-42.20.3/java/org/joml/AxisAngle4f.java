...
implements Externalizable {
    ...
    public AxisAngle4f set(Matrix3fc m) {
        ...
        if (Math.abs(nm10 - nm01) < 1.0E-4f && Math.abs(nm20 - nm02) < 1.0E-4f && Math.abs(nm21 - nm12) < 1.0E-4f) {
            if (Math.abs(nm10 + nm01) < 0.001f && Math.abs(nm20 + nm02) < 0.001f && Math.abs(nm21 + nm12) < 0.001f && Math.abs(nm00 + nm11 + nm22 - 3.0f) < 0.001f) {
                this.x = 0.0f;
                this.y = 0.0f;
                this.z = 1.0f;
                this.angle = 0.0f;
