...
public class GeometryUtils {
    ...
    public static void computePerpendicularVectors(float x, float y, float z, Vector3f dest1, Vector3f dest2) {
        ...
        float length = Math.sqrt(dest1.x * dest1.x + dest1.y * dest1.y + dest1.z * dest1.z);
