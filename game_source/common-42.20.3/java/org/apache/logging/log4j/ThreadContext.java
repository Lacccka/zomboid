...
public final class ThreadContext {
    ...
    public static void removeAll(Iterable<String> keys2) {
        if (contextMap instanceof CleanableThreadContextMap) {
            ((CleanableThreadContextMap)contextMap).removeAll(keys2);
        } else if (contextMap instanceof DefaultThreadContextMap) {
            ((DefaultThreadContextMap)contextMap).removeAll(keys2);
        } else {
    ...
    public static void push(String message, Object ... args2) {
        contextStack.push(ParameterizedMessage.format(message, args2));
    }
