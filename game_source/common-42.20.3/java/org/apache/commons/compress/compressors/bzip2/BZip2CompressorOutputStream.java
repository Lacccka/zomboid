...
implements BZip2Constants {
    ...
    public void close() throws IOException {
        if (!this.closed) {
            try {
                ...
                IOUtils.close((Closeable)this.out);
            }
        }
    }
    ...
    private void generateMTFValues() {
        ...
        for (int i2 = 0; i2 <= lastShadow; ++i2) {
            byte ll_i = unseqToSeq[block[fmap[i2]] & 0xFF];
            byte tmp = yy[0];
            int j = 0;
            while (ll_i != tmp) {
                byte tmp2 = tmp;
            ...
            while (gs < this.nMTF) {
                ...
                if (nGroups == 6) {
                    ...
                    for (int i = gs; i <= ge; ++i) {
                        ...
                        n = (short)(n + (short)(len_2[icv] & 0xFFFFFFFF));
                    ...
                    for (int i = gs; i <= ge; ++i) {
                        ...
                        while (--n >= 0) {
                            int n2 = n;
                            cost[n2] = (short)(cost[n2] + (short)(len[n][icv] & 0xFFFFFFFF));
                        }
                    }
                }
                int bt = -1;
