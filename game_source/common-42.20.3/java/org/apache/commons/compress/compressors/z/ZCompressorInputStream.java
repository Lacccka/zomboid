...
extends LZWInputStream {
    ...
    public ZCompressorInputStream(InputStream inputStream2) throws IOException {
        this(inputStream2, -1);
    }

    public ZCompressorInputStream(InputStream inputStream2, int memoryLimitInKb) throws IOException {
        super(inputStream2, ByteOrder.LITTLE_ENDIAN);
