...
implements InputStreamStatistics {
    ...
    private void nextBlock() throws IOException {
        ...
        FilterInputStream capped = ((BoundedInputStream.Builder)((BoundedInputStream.Builder)((BoundedInputStream.Builder)BoundedInputStream.builder().setInputStream(this.inputStream)).setMaxCount(realLen)).setPropagateClose(false)).get();
        if (this.expectBlockChecksum) {
