...
final class ExplodingInputStream
extends InputStream
implements InputStreamStatistics {
    ...
    private void init() throws IOException {
        if (this.bits == null) {
            try (BoundedInputStream cis = ((BoundedInputStream.Builder)BoundedInputStream.builder().setInputStream(CloseShieldInputStream.wrap(this.in))).get();){
