...
extends ArchiveInputStream<TarArchiveEntry> {
    ...
    public TarArchiveInputStream(InputStream inputStream2, boolean lenient) {
        this(inputStream2, 10240, 512, null, lenient);
    }

    public TarArchiveInputStream(InputStream inputStream2, int blockSize) {
        this(inputStream2, blockSize, 512);
    }

    public TarArchiveInputStream(InputStream inputStream2, int blockSize, int recordSize) {
        this(inputStream2, blockSize, recordSize, null);
    }

    public TarArchiveInputStream(InputStream inputStream2, int blockSize, int recordSize, String encoding) {
        this(inputStream2, blockSize, recordSize, encoding, false);
    }

    public TarArchiveInputStream(InputStream inputStream2, int blockSize, int recordSize, String encoding, boolean lenient) {
    ...
    public TarArchiveInputStream(InputStream inputStream2, int blockSize, String encoding) {
        this(inputStream2, blockSize, 512, encoding);
    }

    public TarArchiveInputStream(InputStream inputStream2, String encoding) {
        this(inputStream2, 10240, 512, encoding);
    }
    ...
    public void close() throws IOException {
        if (this.sparseInputStreams != null) {
            for (InputStream inputStream2 : this.sparseInputStreams) {
                inputStream2.close();
            }
        }
        this.in.close();
