...
final class BinaryTree {
    ...
    static BinaryTree decode(InputStream inputStream2, int totalNumberOfValues) throws IOException {
        ...
        int size = inputStream2.read() + 1;
        if (size == 0) {
            throw new IOException("Cannot read the size of the encoded tree, unexpected end of stream");
        }
        byte[] encodedTree = IOUtils.readRange(inputStream2, size);
