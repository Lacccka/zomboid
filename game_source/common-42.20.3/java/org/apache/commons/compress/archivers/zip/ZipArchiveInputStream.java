...
implements InputStreamStatistics {
    ...
    public ZipArchiveInputStream(InputStream inputStream2) {
        this(inputStream2, StandardCharsets.UTF_8.name());
    }

    public ZipArchiveInputStream(InputStream inputStream2, String encoding) {
        this(inputStream2, encoding, true);
    }

    public ZipArchiveInputStream(InputStream inputStream2, String encoding, boolean useUnicodeExtraFields) {
        this(inputStream2, encoding, useUnicodeExtraFields, false);
    }

    public ZipArchiveInputStream(InputStream inputStream2, String encoding, boolean useUnicodeExtraFields, boolean allowStoredEntriesWithDataDescriptor) {
        this(inputStream2, encoding, useUnicodeExtraFields, allowStoredEntriesWithDataDescriptor, false);
    }

    public ZipArchiveInputStream(InputStream inputStream2, String encoding, boolean useUnicodeExtraFields, boolean allowStoredEntriesWithDataDescriptor, boolean skipSplitSig) {
        super(inputStream2, encoding);
        this.in = new PushbackInputStream(inputStream2, this.buf.capacity());
