            ...
            for (int m = 0; m < numberOfMethods; ++m) {
                ...
                if (handlerCount != null) {
                    for (int j = 0; j < handlerCount[i]; ++j) {
                        ...
                        entry = new ExceptionTableEntry(handlerStartPCs[i][j], handlerEndPCs[i][j], handlerCatchPCs[i][j], cpHandlerClass);
                ...
                ArrayList<Attribute> methodAttributesList = methodAttributes[c][m];
