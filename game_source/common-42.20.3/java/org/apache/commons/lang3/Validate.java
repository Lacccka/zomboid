...
public class Validate {
    ...
    private static String getMessage(String message, Object ... values2) {
        return ArrayUtils.isEmpty(values2) ? message : String.format(message, values2);
    }
    ...
    public static <T extends Iterable<?>> T noNullElements(T iterable, String message, Object ... values2) {
        ...
        while (it.hasNext()) {
            if (it.next() == null) {
                ...
                throw new IllegalArgumentException(Validate.getMessage(message, values22));
            }
            ++i;
        }
        return iterable;
    ...
    public static <T extends CharSequence> T notBlank(T chars, String message, Object ... values2) {
        Objects.requireNonNull(chars, Validate.toSupplier(message, values2));
    ...
    public static <T extends Collection<?>> T notEmpty(T collection, String message, Object ... values2) {
        Objects.requireNonNull(collection, Validate.toSupplier(message, values2));
    ...
    public static <T extends Map<?, ?>> T notEmpty(T map, String message, Object ... values2) {
        Objects.requireNonNull(map, Validate.toSupplier(message, values2));
        if (map.isEmpty()) {
            throw new IllegalArgumentException(Validate.getMessage(message, values2));
        }
        return map;
    ...
    public static <T> T[] notEmpty(T[] array, String message, Object ... values2) {
        Objects.requireNonNull(array, Validate.toSupplier(message, values2));
        if (array.length == 0) {
            throw new IllegalArgumentException(Validate.getMessage(message, values2));
        }
        return array;
    ...
    public static <T> T notNull(T object, String message, Object ... values2) {
        return Objects.requireNonNull(object, Validate.toSupplier(message, values2));
    }

    private static Supplier<String> toSupplier(String message, Object ... values2) {
        return () -> Validate.getMessage(message, values2);
    }
    ...
    public static <T extends Collection<?>> T validIndex(T collection, int index, String message, Object ... values2) {
        ...
        if (index < 0 || index >= collection.size()) {
            throw new IndexOutOfBoundsException(Validate.getMessage(message, values2));
        }
        return collection;
    }
    ...
    public static void validState(boolean expression, String message, Object ... values2) {
        if (!expression) {
            throw new IllegalStateException(Validate.getMessage(message, values2));
        }
    }
}
