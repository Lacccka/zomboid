...
implements StringEncoder {
    ...
    @Override
    public Object encode(Object source2) throws EncoderException {
        if (!(source2 instanceof String)) {
            throw new EncoderException("BeiderMorseEncoder encode parameter is not of type String");
        }
        return this.encode((String)source2);
    }

    @Override
    public String encode(String source2) throws EncoderException {
        if (source2 == null) {
            return null;
        }
        return this.engine.encode(source2);
    }
