...
public class UnixCrypt {
    ...
    private static final Pattern CRYPT_SALT_PATTERN = Pattern.compile("^[./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz]{2,}$");
    ...
    private static int[] body(int[] schedule2, int eSwap0, int eSwap1) {
        int left = 0;
        int right = 0;
        int t = 0;
        for (int j = 0; j < 25; ++j) {
            for (int i = 0; i < 32; i += 4) {
                left = UnixCrypt.dEncrypt(left, right, i, eSwap0, eSwap1, schedule2);
                right = UnixCrypt.dEncrypt(right, left, i + 2, eSwap0, eSwap1, schedule2);
            }
            t = left;
            left = right;
            right = t;
    ...
    public static String crypt(byte[] original, String salt) {
        ...
        int[] schedule2 = UnixCrypt.desSetKey(key);
        int[] out = UnixCrypt.body(schedule2, eSwap0, eSwap1);
        byte[] b = new byte[9];
