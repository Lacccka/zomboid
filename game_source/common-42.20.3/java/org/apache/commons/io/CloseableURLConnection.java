...
implements AutoCloseable {
    ...
    @Override
    public long getHeaderFieldDate(String name, long Default2) {
        return this.urlConnection.getHeaderFieldDate(name, Default2);
    }

    @Override
    public int getHeaderFieldInt(String name, int Default2) {
        return this.urlConnection.getHeaderFieldInt(name, Default2);
    }
    ...
    @Override
    public long getHeaderFieldLong(String name, long Default2) {
        return this.urlConnection.getHeaderFieldLong(name, Default2);
    }
    ...
    @Override
    public void setConnectTimeout(int timeout2) {
        this.urlConnection.setConnectTimeout(timeout2);
    }
    ...
    public void setReadTimeout(int timeout2) {
        this.urlConnection.setReadTimeout(timeout2);
    }
