        ...
        block6: for (WinNT.SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX info : procInfo) {
            switch (info.relationship) {
                ...
                case 2: {
                    ...
                    caches.add(new CentralProcessor.ProcessorCache(cache.level, cache.associativity, cache.lineSize, cache.cacheSize, CentralProcessor.ProcessorCache.Type.values()[cache.type]));
                    continue block6;
                }
                case 0: {
