...
public final class Win32LogicalDiskToPartition {
    ...
    public static WbemcliUtil.WmiResult<DiskToPartitionProperty> queryDiskToPartition(WmiQueryHandler h) {
        WbemcliUtil.WmiQuery<DiskToPartitionProperty> diskToPartitionQuery = new WbemcliUtil.WmiQuery<DiskToPartitionProperty>(WIN32_LOGICAL_DISK_TO_PARTITION, DiskToPartitionProperty.class);
