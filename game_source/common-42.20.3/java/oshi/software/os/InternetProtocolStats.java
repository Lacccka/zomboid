...
public interface InternetProtocolStats {
    ...
    public static final class IPConnection {
        ...
        public String toString() {
            ...
            return "IPConnection [type=" + this.type + ", localAddress=" + localIp + ", localPort=" + this.localPort + ", foreignAddress=" + foreignIp + ", foreignPort=" + this.foreignPort + ", state=" + String.valueOf((Object)this.state) + ", transmitQueue=" + this.transmitQueue + ", receiveQueue=" + this.receiveQueue + ", owningProcessId=" + this.owningProcessId + "]";
        }
    }
