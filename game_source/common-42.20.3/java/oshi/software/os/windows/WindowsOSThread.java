...
extends AbstractOSThread {
    ...
    public boolean updateAttributes() {
        ...
        Map<Integer, ThreadPerformanceData.PerfCounterBlock> threads = ThreadPerformanceData.buildThreadMapFromPerfCounters(pids, procName, this.getThreadId());
        return this.updateAttributes(procName, threads.get(this.getThreadId()));
    }
