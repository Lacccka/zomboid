...
extends AbstractOSFileStore {
    ...
    public WindowsOSFileStore(String name, String volume, String label, String mount, String options, String uuid, boolean local, String logicalVolume, String description, String fsType, long freeSpace, long usableSpace, long totalSpace, long freeInodes, long totalInodes) {
    ...
    public boolean updateAttributes() {
        ...
        if (this.isLocal()) {
            volumes = WindowsFileSystem.getLocalVolumes(this.getVolume());
        } else {
