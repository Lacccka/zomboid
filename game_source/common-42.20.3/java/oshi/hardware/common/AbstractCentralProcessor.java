...
implements CentralProcessor {
    ...
    public double getSystemCpuLoadBetweenTicks(long[] oldTicks) {
        ...
        return this.getSystemCpuLoadBetweenTicks(oldTicks, this.getSystemCpuLoadTicks());
    }
    ...
    public double[] getProcessorCpuLoadBetweenTicks(long[][] oldTicks) {
        return this.getProcessorCpuLoadBetweenTicks(oldTicks, this.getProcessorCpuLoadTicks());
    }
