...
public interface ByRef {
    ...
    public static class CloseablePROCESSENTRY32ByReference
    ...
    public static class CloseableSizeTByReference
    extends LibCAPI.size_t.ByReference
    implements AutoCloseable {
    ...
    public static class CloseableHANDLEByReference
    ...
    public static class CloseableULONGptrByReference
    extends BaseTSD.ULONG_PTRByReference
    implements AutoCloseable {
        @Override
        public void close() {
            Util.freeMemory(this.getPointer());
    ...
    public static class CloseableLONGLONGByReference
    extends WinDef.LONGLONGByReference
    implements AutoCloseable {
        @Override
        public void close() {
            Util.freeMemory(this.getPointer());
    ...
    public static class CloseablePointerByReference
    ...
    public static class CloseableNativeLongByReference
    ...
    public static class CloseableLongByReference
    ...
    public static class CloseableIntByReference
