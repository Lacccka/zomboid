...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.FieldMaskOrBuilder;
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.FieldMaskProto;
...
implements FieldMaskOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 31, 1, "", FieldMask.class.getName());
    ...
    implements FieldMaskOrBuilder {
        ...
        public Builder addAllPaths(Iterable<String> values2) {
            this.ensurePathsIsMutable();
            AbstractMessageLite.Builder.addAll(values2, this.paths_);
            this.bitField0_ |= 1;
            this.onChanged();
            return this;
        }
