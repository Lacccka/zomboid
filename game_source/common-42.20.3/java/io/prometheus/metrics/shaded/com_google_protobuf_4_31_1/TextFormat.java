...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.InlineMe;
...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.Java8Compatibility;
...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.TextFormatEscaper;
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.TextFormatParseInfoTree;
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.TextFormatParseLocation;
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.TypeRegistry;
...
public final class TextFormat {
    ...
    private static TextGenerator setSingleLineOutput(Appendable output, boolean singleLine, Descriptors.Descriptor rootMessageType, Printer.FieldReporterLevel fieldReporterLevel) {
    ...
    private static final class TextGenerator {
        ...
        private TextGenerator(Appendable output, boolean singleLineMode, Descriptors.Descriptor rootMessageType, Printer.FieldReporterLevel fieldReporterLevel) {
            this.output = output;
    ...
    public static final class Printer {
        ...
        void print(MessageOrBuilder message, Appendable output, FieldReporterLevel level) throws IOException {
            TextGenerator generator = TextFormat.setSingleLineOutput(output, this.singleLine, message.getDescriptorForType(), level);
        ...
        private boolean shouldRedact(Descriptors.FieldDescriptor field, TextGenerator generator) {
            return this.enablingSafeDebugFormat && field.isSensitive();
        }
