...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.StringValueOrBuilder;
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.UninitializedMessageException;
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.WrappersProto;
...
implements StringValueOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 31, 1, "", StringValue.class.getName());
