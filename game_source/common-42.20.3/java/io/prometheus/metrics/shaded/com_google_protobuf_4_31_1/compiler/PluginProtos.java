 ...
 */
package io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.compiler;
...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.DescriptorProtos;
...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.LazyStringArrayList;
...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.ProtocolStringList;
...
public final class PluginProtos {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 31, 1, "", PluginProtos.class.getName());
    ...
    implements CodeGeneratorResponseOrBuilder {
        ...
        static {
            RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 31, 1, "", CodeGeneratorResponse.class.getName());
        ...
        implements CodeGeneratorResponseOrBuilder {
            ...
            public Builder addAllFile(Iterable<? extends File> values2) {
                if (this.fileBuilder_ == null) {
                    this.ensureFileIsMutable();
        ...
        implements FileOrBuilder {
            ...
            static {
                RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 31, 1, "", File.class.getName());
        ...
        public static enum Feature implements ProtocolMessageEnum
        {
            ...
            static {
                RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 31, 1, "", Feature.class.getName());
    ...
    implements CodeGeneratorRequestOrBuilder {
        ...
        static {
            RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 31, 1, "", CodeGeneratorRequest.class.getName());
        ...
        implements CodeGeneratorRequestOrBuilder {
            ...
            public Builder addAllFileToGenerate(Iterable<String> values2) {
                this.ensureFileToGenerateIsMutable();
                AbstractMessageLite.Builder.addAll(values2, this.fileToGenerate_);
                this.bitField0_ |= 1;
                this.onChanged();
                return this;
            }
            ...
            public Builder addAllProtoFile(Iterable<? extends DescriptorProtos.FileDescriptorProto> values2) {
                if (this.protoFileBuilder_ == null) {
                    this.ensureProtoFileIsMutable();
                    AbstractMessageLite.Builder.addAll(values2, this.protoFile_);
                    this.onChanged();
                } else {
                    this.protoFileBuilder_.addAllMessages(values2);
                }
                return this;
            }
            ...
            public Builder addAllSourceFileDescriptors(Iterable<? extends DescriptorProtos.FileDescriptorProto> values2) {
                if (this.sourceFileDescriptorsBuilder_ == null) {
                    this.ensureSourceFileDescriptorsIsMutable();
                    AbstractMessageLite.Builder.addAll(values2, this.sourceFileDescriptors_);
                    this.onChanged();
                } else {
                    this.sourceFileDescriptorsBuilder_.addAllMessages(values2);
                }
                return this;
            }
    ...
    implements VersionOrBuilder {
        ...
        static {
            RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 31, 1, "", Version.class.getName());
