...
public final class RpcUtil {
    ...
    private static <Type extends Message> Type copyAsType(Type typeDefaultInstance, Message source2) {
        return (Type)typeDefaultInstance.newBuilderForType().mergeFrom(source2).build();
    }
