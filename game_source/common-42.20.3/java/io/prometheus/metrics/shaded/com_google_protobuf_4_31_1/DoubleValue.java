...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.DoubleValueOrBuilder;
...
implements DoubleValueOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 31, 1, "", DoubleValue.class.getName());
