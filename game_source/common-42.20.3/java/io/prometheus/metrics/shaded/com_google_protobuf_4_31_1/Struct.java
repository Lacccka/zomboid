...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.MapFieldBuilder;
...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.StructProto;
...
implements StructOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 31, 1, "", Struct.class.getName());
    ...
    implements StructOrBuilder {
        ...
        public Builder putAllFields(Map<String, Value> values2) {
            for (Map.Entry<String, Value> e : values2.entrySet()) {
                if (e.getKey() != null && e.getValue() != null) continue;
                throw new NullPointerException();
            }
            this.internalGetMutableFields().ensureBuilderMap().putAll(values2);
            this.bitField0_ |= 1;
            return this;
        }
