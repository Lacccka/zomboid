...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.SingleFieldBuilderV3;
...
implements AbstractMessage.BuilderParent {
    ...
    @Deprecated
    @CanIgnoreReturnValue
    public RepeatedFieldBuilderV3<MType, BType, IType> addAllMessages(Iterable<? extends MType> values2) {
        for (AbstractMessage value : values2) {
