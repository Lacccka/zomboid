...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.LazyFieldLite;
...
extends ByteOutput {
    ...
    @Deprecated
    @InlineMe(replacement="CodedOutputStream.computeUInt32SizeNoTag(value)", imports={"io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.CodedOutputStream"})
    public static int computeRawVarint32Size(int value) {
        return CodedOutputStream.computeUInt32SizeNoTag(value);
    }

    @Deprecated
    @InlineMe(replacement="CodedOutputStream.computeUInt64SizeNoTag(value)", imports={"io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.CodedOutputStream"})
