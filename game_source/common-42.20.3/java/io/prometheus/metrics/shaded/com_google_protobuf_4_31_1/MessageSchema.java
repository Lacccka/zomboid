...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.FieldInfo;
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.FieldSet;
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.FieldType;
...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.OneofInfo;
...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.StructuralMessageInfo;
...
implements Schema<T> {
    ...
    private void mergeMessage(T targetParent, T sourceParent, int pos) {
        ...
        int typeAndOffset = this.typeAndOffsetAt(pos);
        long offset = MessageSchema.offset(typeAndOffset);
        Object source2 = UNSAFE.getObject(sourceParent, offset);
        if (source2 == null) {
        ...
        if (!this.isFieldPresent(targetParent, pos)) {
            if (!MessageSchema.isMutable(source2)) {
                UNSAFE.putObject(targetParent, offset, source2);
            } else {
                Object copyOfSource = fieldSchema.newInstance();
                fieldSchema.mergeFrom(copyOfSource, source2);
        ...
        fieldSchema.mergeFrom(target, source2);
    }
