...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.EnumOrBuilder;
...
implements EnumOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 31, 1, "", Enum.class.getName());
    ...
    implements EnumOrBuilder {
        ...
        public Builder addAllEnumvalue(Iterable<? extends EnumValue> values2) {
            if (this.enumvalueBuilder_ == null) {
                this.ensureEnumvalueIsMutable();
                AbstractMessageLite.Builder.addAll(values2, this.enumvalue_);
                this.onChanged();
            } else {
                this.enumvalueBuilder_.addAllMessages(values2);
            }
            return this;
        }
