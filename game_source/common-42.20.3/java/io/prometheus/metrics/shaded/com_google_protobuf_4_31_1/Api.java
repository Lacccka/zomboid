...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.ApiOrBuilder;
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.ApiProto;
...
implements ApiOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 31, 1, "", Api.class.getName());
    ...
    implements ApiOrBuilder {
        ...
        public Builder addAllMethods(Iterable<? extends Method> values2) {
            if (this.methodsBuilder_ == null) {
                this.ensureMethodsIsMutable();
                AbstractMessageLite.Builder.addAll(values2, this.methods_);
                this.onChanged();
            } else {
                this.methodsBuilder_.addAllMessages(values2);
            }
            return this;
        }
        ...
        public Builder addAllMixins(Iterable<? extends Mixin> values2) {
            if (this.mixinsBuilder_ == null) {
                this.ensureMixinsIsMutable();
                AbstractMessageLite.Builder.addAll(values2, this.mixins_);
                this.onChanged();
            } else {
                this.mixinsBuilder_.addAllMessages(values2);
            }
            return this;
        }
