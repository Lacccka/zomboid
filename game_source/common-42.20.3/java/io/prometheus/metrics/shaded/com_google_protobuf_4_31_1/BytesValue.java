...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.BytesValueOrBuilder;
...
implements BytesValueOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 31, 1, "", BytesValue.class.getName());
