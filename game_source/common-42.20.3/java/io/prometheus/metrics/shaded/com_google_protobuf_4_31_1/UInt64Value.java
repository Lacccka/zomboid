...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.UInt64ValueOrBuilder;
...
implements UInt64ValueOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 31, 1, "", UInt64Value.class.getName());
