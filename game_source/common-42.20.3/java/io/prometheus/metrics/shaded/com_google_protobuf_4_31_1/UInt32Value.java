...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.UInt32ValueOrBuilder;
...
implements UInt32ValueOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 31, 1, "", UInt32Value.class.getName());
