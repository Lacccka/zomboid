...
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.TypeOrBuilder;
import io.prometheus.metrics.shaded.com_google_protobuf_4_31_1.TypeProto;
...
implements TypeOrBuilder {
    ...
    static {
        RuntimeVersion.validateProtobufGencodeVersion(RuntimeVersion.RuntimeDomain.PUBLIC, 4, 31, 1, "", Type.class.getName());
    ...
    implements TypeOrBuilder {
        ...
        public Builder addAllFields(Iterable<? extends Field> values2) {
            if (this.fieldsBuilder_ == null) {
                this.ensureFieldsIsMutable();
                AbstractMessageLite.Builder.addAll(values2, this.fields_);
                this.onChanged();
            } else {
                this.fieldsBuilder_.addAllMessages(values2);
            }
            return this;
        }
        ...
        public Builder addAllOneofs(Iterable<String> values2) {
            this.ensureOneofsIsMutable();
            AbstractMessageLite.Builder.addAll(values2, this.oneofs_);
            this.bitField0_ |= 4;
            this.onChanged();
            return this;
        }
        ...
        public Builder addAllOptions(Iterable<? extends Option> values2) {
            if (this.optionsBuilder_ == null) {
                this.ensureOptionsIsMutable();
                AbstractMessageLite.Builder.addAll(values2, this.options_);
                this.onChanged();
            } else {
                this.optionsBuilder_.addAllMessages(values2);
            }
            return this;
        }
