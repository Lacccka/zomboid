...
extends GeneratedMessage.ExtendableMessage<GeneratedMessageV3> {
    ...
    implements ExtendableMessageOrBuilder<MessageT> {
        ...
        public final <T> boolean hasExtension(GeneratedMessage.GeneratedExtension<MessageT, T> extension) {
            return ((GeneratedMessage.ExtendableBuilder)this).hasExtension(extension);
        }

        @Override
        @Deprecated
        public final <T> int getExtensionCount(GeneratedMessage.GeneratedExtension<MessageT, List<T>> extension) {
            return ((GeneratedMessage.ExtendableBuilder)this).getExtensionCount(extension);
        }

        @Override
        @Deprecated
        public final <T> T getExtension(GeneratedMessage.GeneratedExtension<MessageT, T> extension) {
            return ((GeneratedMessage.ExtendableBuilder)this).getExtension(extension);
        }

        @Override
        @Deprecated
        public final <T> T getExtension(GeneratedMessage.GeneratedExtension<MessageT, List<T>> extension, int index) {
            return ((GeneratedMessage.ExtendableBuilder)this).getExtension(extension, index);
        }
    ...
    implements ExtendableMessageOrBuilder<MessageT> {
        ...
        @Deprecated
        public final <T> boolean hasExtension(GeneratedMessage.GeneratedExtension<MessageT, T> extension) {
            return ((GeneratedMessage.ExtendableMessage)this).hasExtension(extension);
        }

        @Override
        @Deprecated
        public final <T> int getExtensionCount(GeneratedMessage.GeneratedExtension<MessageT, List<T>> extension) {
            return ((GeneratedMessage.ExtendableMessage)this).getExtensionCount(extension);
        }

        @Override
        @Deprecated
        public final <T> T getExtension(GeneratedMessage.GeneratedExtension<MessageT, T> extension) {
            return ((GeneratedMessage.ExtendableMessage)this).getExtension(extension);
        }

        @Override
        @Deprecated
        public final <T> T getExtension(GeneratedMessage.GeneratedExtension<MessageT, List<T>> extension, int index) {
            return ((GeneratedMessage.ExtendableMessage)this).getExtension(extension, index);
        }
