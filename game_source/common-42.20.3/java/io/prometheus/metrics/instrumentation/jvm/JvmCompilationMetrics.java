...
public class JvmCompilationMetrics {
    ...
    private void register(PrometheusRegistry registry) {
        ...
        ((CounterWithCallback.Builder)((CounterWithCallback.Builder)CounterWithCallback.builder(this.config).name(JVM_COMPILATION_TIME_SECONDS_TOTAL).help("The total time in seconds taken for HotSpot class compilation")).unit(Unit.SECONDS)).callback(callback -> callback.call(Unit.millisToSeconds(this.compilationBean.getTotalCompilationTime()), new String[0])).register(registry);
    }
