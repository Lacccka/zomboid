...
public class JvmRuntimeInfoMetric {
    ...
    private void register(PrometheusRegistry registry) {
        Info jvmInfo = (Info)((Info.Builder)((Info.Builder)Info.builder(this.config).name(JVM_RUNTIME_INFO).help("JVM runtime info")).labelNames("version", "vendor", "runtime")).register(registry);
        jvmInfo.setLabelValues(this.version, this.vendor, this.runtime);
    }
