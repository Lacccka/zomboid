...
Serializable {
    ...
    public Tuple5<T1, T2, T3, T4, T5> update1(T1 value) {
        return new Tuple5<T1, T2, T3, T4, T5>(value, this._2, this._3, this._4, this._5);
    }
    ...
    public Tuple5<T1, T2, T3, T4, T5> update2(T2 value) {
        return new Tuple5<T1, T2, T3, T4, T5>(this._1, value, this._3, this._4, this._5);
    }
    ...
    public Tuple5<T1, T2, T3, T4, T5> update3(T3 value) {
        return new Tuple5<T1, T2, T3, T4, T5>(this._1, this._2, value, this._4, this._5);
    }
    ...
    public Tuple5<T1, T2, T3, T4, T5> update4(T4 value) {
        return new Tuple5<T1, T2, T3, T4, T5>(this._1, this._2, this._3, value, this._5);
    }
    ...
    public Tuple5<T1, T2, T3, T4, T5> update5(T5 value) {
        return new Tuple5<T1, T2, T3, T4, T5>(this._1, this._2, this._3, this._4, value);
    }
    ...
    public <U1, U2, U3, U4, U5> Tuple5<U1, U2, U3, U4, U5> map(Function5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, Tuple5<U1, U2, U3, U4, U5>> mapper) {
        ...
        return mapper.apply(this._1, this._2, this._3, this._4, this._5);
    }
    ...
    @Override
    public Seq<?> toSeq() {
        return List.of(this._1, this._2, this._3, this._4, this._5);
    }

    public <T6> Tuple6<T1, T2, T3, T4, T5, T6> append(T6 t6) {
        return Tuple.of(this._1, this._2, this._3, this._4, this._5, t6);
    }

    public <T6> Tuple6<T1, T2, T3, T4, T5, T6> concat(Tuple1<T6> tuple) {
        Objects.requireNonNull(tuple, "tuple is null");
        return Tuple.of(this._1, this._2, this._3, this._4, this._5, tuple._1);
    }

    public <T6, T7> Tuple7<T1, T2, T3, T4, T5, T6, T7> concat(Tuple2<T6, T7> tuple) {
        Objects.requireNonNull(tuple, "tuple is null");
        return Tuple.of(this._1, this._2, this._3, this._4, this._5, tuple._1, tuple._2);
    }

    public <T6, T7, T8> Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> concat(Tuple3<T6, T7, T8> tuple) {
        Objects.requireNonNull(tuple, "tuple is null");
        return Tuple.of(this._1, this._2, this._3, this._4, this._5, tuple._1, tuple._2, tuple._3);
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this._1, that._1) && Objects.equals(this._2, that._2) && Objects.equals(this._3, that._3) && Objects.equals(this._4, that._4) && Objects.equals(this._5, that._5);
    }

    public int hashCode() {
        return Tuple.hash(this._1, this._2, this._3, this._4, this._5);
    }
