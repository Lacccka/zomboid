...
public final class ServiceManager {
    ...
    public void awaitHealthy(long timeout2, TimeUnit unit) throws TimeoutException {
        this.state.awaitHealthy(timeout2, unit);
    }
    ...
    public void awaitStopped(long timeout2, TimeUnit unit) throws TimeoutException {
        this.state.awaitStopped(timeout2, unit);
    }
    ...
    private static final class ServiceManagerState {
         ...
         * WARNING - Removed try catching itself - possible behaviour change.
         */
        void awaitHealthy(long timeout2, TimeUnit unit) throws TimeoutException {
            this.monitor.enter();
            try {
                if (!this.monitor.waitForUninterruptibly(this.awaitHealthGuard, timeout2, unit)) {
         ...
         * WARNING - Removed try catching itself - possible behaviour change.
         */
        void awaitStopped(long timeout2, TimeUnit unit) throws TimeoutException {
            this.monitor.enter();
            try {
                if (!this.monitor.waitForUninterruptibly(this.stoppedGuard, timeout2, unit)) {
