...
implements TimeLimiter {
    ...
    public <T> T newProxy(final T target, Class<T> interfaceType, final long timeoutDuration, final TimeUnit timeoutUnit) {
        ...
        InvocationHandler handler = new InvocationHandler(){
            ...
            @Override
            public Object invoke(Object obj, final Method method, final Object[] args2) throws Throwable {
    ...
    @Override
    public void runWithTimeout(Runnable runnable2, long timeoutDuration, TimeUnit timeoutUnit) throws TimeoutException, InterruptedException {
    ...
    @Override
    public void runUninterruptiblyWithTimeout(Runnable runnable2, long timeoutDuration, TimeUnit timeoutUnit) throws TimeoutException {
        Preconditions.checkNotNull(runnable2);
        Preconditions.checkNotNull(timeoutUnit);
        SimpleTimeLimiter.checkPositiveTimeout(timeoutDuration);
        Future<?> future = this.executor.submit(runnable2);
