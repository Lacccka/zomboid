...
implements Service {
    ...
    extends Scheduler {
        @Override
        final Future<?> schedule(AbstractService service, ScheduledExecutorService executor, Runnable runnable2) {
            ReschedulableCallable task = new ReschedulableCallable(service, executor, runnable2);
            task.reschedule();
            return task;
        }
        ...
        implements Callable<Void> {
            ...
            ReschedulableCallable(AbstractService service, ScheduledExecutorService executor, Runnable runnable2) {
