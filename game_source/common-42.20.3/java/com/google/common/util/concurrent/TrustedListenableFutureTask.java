...
implements RunnableFuture<V> {
    ...
    static <V> TrustedListenableFutureTask<V> create(Runnable runnable2, @Nullable V result) {
        return new TrustedListenableFutureTask<V>(Executors.callable(runnable2, result));
    }
