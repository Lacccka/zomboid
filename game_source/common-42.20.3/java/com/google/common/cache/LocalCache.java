...
implements ConcurrentMap<K, V> {
    ...
    ImmutableMap<K, V> getAllPresent(Iterable<?> keys2) {
        int hits = 0;
        int misses = 0;
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    ImmutableMap<K, V> getAll(Iterable<? extends K> keys2) throws ExecutionException {
        int hits = 0;
        int misses = 0;
    ...
    @Nullable
    Map<K, V> loadAll(Set<? extends K> keys2, CacheLoader<? super K, V> loader) throws ExecutionException {
        Map<K, V> result;
        ...
        try {
            Map<K, V> map;
            result = map = loader.loadAll(keys2);
            success = true;
        }
        catch (CacheLoader.UnsupportedLoadingOperationException e) {
            success = true;
    ...
    void invalidateAll(Iterable<?> keys2) {
        for (Object key : keys2) {
            this.remove(key);
        }
    }
    ...
    implements LoadingCache<K, V> {
        ...
        public ImmutableMap<K, V> getAll(Iterable<? extends K> keys2) throws ExecutionException {
            return this.localCache.getAll(keys2);
        }
    ...
    Serializable {
        ...
        public ImmutableMap<K, V> getAllPresent(Iterable<?> keys2) {
            return this.localCache.getAllPresent(keys2);
        }
        ...
        public void invalidateAll(Iterable<?> keys2) {
            this.localCache.invalidateAll(keys2);
        }
    ...
    Serializable {
        ...
        @Override
        public ImmutableMap<K, V> getAll(Iterable<? extends K> keys2) throws ExecutionException {
            return this.autoDelegate.getAll(keys2);
        }
