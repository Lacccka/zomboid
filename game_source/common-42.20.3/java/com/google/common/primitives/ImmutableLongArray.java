...
implements Serializable {
    ...
    public static ImmutableLongArray copyOf(long[] values2) {
        return values2.length == 0 ? EMPTY : new ImmutableLongArray(Arrays.copyOf(values2, values2.length));
    }

    public static ImmutableLongArray copyOf(Collection<Long> values2) {
        return values2.isEmpty() ? EMPTY : new ImmutableLongArray(Longs.toArray(values2));
    }

    public static ImmutableLongArray copyOf(Iterable<Long> values2) {
        if (values2 instanceof Collection) {
            return ImmutableLongArray.copyOf((Collection)values2);
        }
        return ImmutableLongArray.builder().addAll(values2).build();
    }
    ...
    public static final class Builder {
        ...
        public Builder addAll(long[] values2) {
        ...
        public Builder addAll(Iterable<Long> values2) {
            if (values2 instanceof Collection) {
        ...
        public Builder addAll(Collection<Long> values2) {
        ...
        public Builder addAll(ImmutableLongArray values2) {
            this.ensureRoomFor(values2.length());
