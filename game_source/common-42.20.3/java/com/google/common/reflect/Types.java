...
final class Types {
    ...
    static enum JavaVersion {
        ...
        JAVA8{
            ...
            String typeName(Type type) {
                try {
                    Method getTypeName2 = Type.class.getMethod("getTypeName", new Class[0]);
                    return (String)getTypeName2.invoke((Object)type, new Object[0]);
                }
    ...
    implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args2) throws Throwable {
            ...
            try {
                return typeVariableMethod.invoke(this.typeVariableImpl, args2);
            }
            catch (InvocationTargetException e) {
                throw e.getCause();
            }
