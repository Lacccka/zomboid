...
public final class Tables {
    ...
    @Beta
    public static <R, C, V> Table<R, C, V> newCustomTable(Map<R, Map<C, V>> backingMap, Supplier<? extends Map<C, V>> factory2) {
        Preconditions.checkArgument(backingMap.isEmpty());
        Preconditions.checkNotNull(factory2);
        return new StandardTable<R, C, V>(backingMap, factory2);
    }
