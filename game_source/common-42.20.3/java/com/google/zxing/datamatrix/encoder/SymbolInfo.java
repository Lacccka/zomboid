...
public class SymbolInfo {
    ...
    public final String toString() {
        ...
        sb.append(", symbol size ").append(this.getSymbolWidth()).append('x').append(this.getSymbolHeight());
        sb.append(", symbol data size ").append(this.getSymbolDataWidth()).append('x').append(this.getSymbolDataHeight());
