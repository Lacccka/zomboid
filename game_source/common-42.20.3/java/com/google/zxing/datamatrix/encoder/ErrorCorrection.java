...
public final class ErrorCorrection {
    ...
    public static String encodeECC200(String codewords, SymbolInfo symbolInfo) {
        ...
        if (blockCount == 1) {
            String ecc = ErrorCorrection.createECCBlock(codewords, symbolInfo.getErrorCodewords());
            sb.append(ecc);
        } else {
            ...
            for (int block = 0; block < blockCount; ++block) {
                ...
                String ecc = ErrorCorrection.createECCBlock(temp.toString(), errorSizes[block]);
                int pos = 0;
