...
extends WinDef {
    ...
    public static final int PBT_POWERSETTINGCHANGE = 32787;

    public HPOWERNOTIFY RegisterPowerSettingNotification(WinNT.HANDLE var1, Guid.GUID var2, int var3);

    public WinDef.BOOL UnregisterPowerSettingNotification(HPOWERNOTIFY var1);

    @Structure.FieldOrder(value={"PowerSetting", "DataLength", "Data"})
    public static class POWERBROADCAST_SETTING
    extends Structure {
        ...
        public final void read() {
            this.Data = new byte[this.getPointer().getInt(this.fieldOffset("DataLength"))];
            super.read();
        }
    }

    public static class HPOWERNOTIFY
