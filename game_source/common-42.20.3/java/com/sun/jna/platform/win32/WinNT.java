...
BaseTSD {
    ...
    public static final Guid.GUID GUID_CONSOLE_DISPLAY_STATE = new Guid.GUID("6FE69556-704A-47A0-8F24-C28D936FDA47");
    ...
    extends ACCESS_ACEStructure {
        ...
        public ACCESS_DENIED_ACE(int Mask2, byte AceFlags, PSID psid) {
            super(Mask2, (byte)1, AceFlags, psid);
        }
    }
    ...
    extends ACCESS_ACEStructure {
        ...
        public ACCESS_ALLOWED_ACE(int Mask2, byte AceFlags, PSID psid) {
            super(Mask2, (byte)0, AceFlags, psid);
        }
    }
    ...
    extends ACE_HEADER {
        ...
        public ACCESS_ACEStructure(int Mask2, byte AceType, byte AceFlags, PSID psid) {
