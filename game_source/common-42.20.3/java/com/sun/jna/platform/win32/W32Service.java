...
implements Closeable {
    ...
    public void stopService(long timeout2) {
        ...
        while (status.dwCurrentState != 1) {
            long msRemainingBeforeTimeout = timeout2 - (System.currentTimeMillis() - startTime);
            if (msRemainingBeforeTimeout < 0L) {
                throw new RuntimeException(String.format("Service stop exceeded timeout time of %d ms", timeout2));
            }
