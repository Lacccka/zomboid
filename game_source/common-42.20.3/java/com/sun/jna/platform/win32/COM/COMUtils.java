        ...
        if (COMUtils.FAILED(hr)) {
            ...
            if (pExcepInfo != null) {
                ...
                if (pExcepInfo.bstrSource != null) {
                    source2 = pExcepInfo.bstrSource.getValue();
                    formatMessage.append("\nSource:      ");
                    formatMessage.append(source2);
                }
            ...
            throw new COMInvokeException(formatMessage.toString(), hr, errorArg, description, helpCtx, helpFile, scode, source2, wCode);
        }
        if (pExcepInfo != null) {
            if (pExcepInfo.bstrSource != null) {
