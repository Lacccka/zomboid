...
extends Library {
    ...
    public int XMoveWindow(Display var1, Window var2, int var3, int var4);

    public int XResizeWindow(Display var1, Window var2, int var3, int var4);

    public int XMoveResizeWindow(Display var1, Window var2, int var3, int var4, int var5, int var6);

    public int XRaiseWindow(Display var1, Window var2);

    public int XLowerWindow(Display var1, Window var2);
