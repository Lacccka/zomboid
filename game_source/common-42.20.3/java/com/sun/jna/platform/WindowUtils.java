        ...
        public void setWindowTransparent(final Window w, final boolean transparent) {
            ...
            this.whenDisplayable(w, new Runnable(){
                ...
                public void run() {
                    ...
                    this.setForceHeavyweightPopups(w, transparent);
                    this.setDoubleBuffered(w, !transparent);
                }
            });
        }
        ...
        private void setWindowShape(final Window w, final PixmapSource src) {
            Runnable action = new Runnable(){
                ...
                public void run() {
                    ...
                    x11.XCloseDisplay(dpy);
                    this.setForceHeavyweightPopups(this.getWindow(w), pm != null);
                }
            };
            this.whenDisplayable(w, action);
        }
        ...
        public void setWindowAlpha(final Window w, final float alpha) {
            ...
            this.whenDisplayable(w, new Runnable(){
                ...
                public void run() {
                    ...
                    this.setForceHeavyweightPopups(w, alpha != 1.0f);
                    this.storeAlpha(w, level);
                }
            });
        }
        ...
        public void setWindowTransparent(final Window w, final boolean transparent) {
            ...
            this.whenDisplayable(w, new Runnable(){
                ...
                public void run() {
                    ...
                    if (transparent && !this.usingUpdateLayeredWindow(w)) {
                        user.SetWindowLong(hWnd, -20, flags |= 0x80000);
                    } else if (!transparent && this.usingUpdateLayeredWindow(w)) {
                        user.SetWindowLong(hWnd, -20, flags &= 0xFFF7FFFF);
                    }
                    this.setLayersTransparent(w, transparent);
                    this.setForceHeavyweightPopups(w, transparent);
            ...
            this.whenDisplayable(w, new Runnable(){
                ...
                public void run() {
                    ...
                    try {
                        ...
                        this.setForceHeavyweightPopups(this.getWindow(w), hrgn != null);
                    }
                    finally {
