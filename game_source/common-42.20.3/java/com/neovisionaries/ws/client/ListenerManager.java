...
class ListenerManager {
    ...
    public void callOnThreadCreated(ThreadType threadType, Thread thread2) {
        for (WebSocketListener listener : this.getSynchronizedListeners()) {
            try {
                listener.onThreadCreated(this.mWebSocket, threadType, thread2);
            }
            catch (Throwable t) {
                this.callHandleCallbackError(listener, t);
            }
    ...
    public void callOnThreadStarted(ThreadType threadType, Thread thread2) {
        for (WebSocketListener listener : this.getSynchronizedListeners()) {
            try {
                listener.onThreadStarted(this.mWebSocket, threadType, thread2);
            }
            catch (Throwable t) {
                this.callHandleCallbackError(listener, t);
            }
    ...
    public void callOnThreadStopping(ThreadType threadType, Thread thread2) {
        for (WebSocketListener listener : this.getSynchronizedListeners()) {
            try {
                listener.onThreadStopping(this.mWebSocket, threadType, thread2);
            }
            catch (Throwable t) {
                this.callHandleCallbackError(listener, t);
            }
