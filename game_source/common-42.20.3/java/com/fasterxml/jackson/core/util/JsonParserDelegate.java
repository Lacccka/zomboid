...
extends JsonParser {
    ...
    @Override
    public JsonParser overrideStdFeatures(int values2, int mask) {
        this.delegate.overrideStdFeatures(values2, mask);
        return this;
    }

    @Override
    public JsonParser overrideFormatFeatures(int values2, int mask) {
        this.delegate.overrideFormatFeatures(values2, mask);
        return this;
    }
