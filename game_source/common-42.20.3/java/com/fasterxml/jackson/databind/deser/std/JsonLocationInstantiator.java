...
extends ValueInstantiator.Base {
    ...
    public Object createFromObjectWith(DeserializationContext ctxt, Object[] args2) {
        return new JsonLocation(args2[0], JsonLocationInstantiator._long(args2[1]), JsonLocationInstantiator._long(args2[2]), JsonLocationInstantiator._int(args2[3]), JsonLocationInstantiator._int(args2[4]));
    }
