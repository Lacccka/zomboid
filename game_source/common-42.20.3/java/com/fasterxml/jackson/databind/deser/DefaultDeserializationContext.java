...
implements Serializable {
    ...
    protected DefaultDeserializationContext(DefaultDeserializationContext src, DeserializationConfig config, JsonParser p, InjectableValues values2) {
        super(src, config, p, values2);
    }
    ...
    extends DefaultDeserializationContext {
        ...
        private Impl(Impl src, DeserializationConfig config, JsonParser p, InjectableValues values2) {
            super(src, config, p, values2);
        }
        ...
        @Override
        public DefaultDeserializationContext createInstance(DeserializationConfig config, JsonParser p, InjectableValues values2) {
            return new Impl(this, config, p, values2);
        }
