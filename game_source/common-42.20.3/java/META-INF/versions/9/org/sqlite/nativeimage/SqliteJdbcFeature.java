...
implements Feature {
    public void beforeAnalysis(Feature.BeforeAnalysisAccess a) {
        ...
        a.registerReachabilityHandler(this::nativeDbReachable, new Object[]{this.method(SQLiteJDBCLoader.class, "initialize", new Class[0])});
    }
    ...
    private void registerJNICalls() {
        ...
        RuntimeJNIAccess.register((Field[])this.fields(NativeDB.class, "pointer", "busyHandler", "commitListener", "updateListener", "progressHandler"));
        RuntimeJNIAccess.register((Executable[])new Executable[]{this.method(DB.class, "onUpdate", Integer.TYPE, String.class, String.class, Long.TYPE)});
        RuntimeJNIAccess.register((Executable[])new Executable[]{this.method(DB.class, "onCommit", Boolean.TYPE)});
        RuntimeJNIAccess.register((Executable[])new Executable[]{this.method(NativeDB.class, "stringToUtf8ByteArray", String.class)});
        RuntimeJNIAccess.register((Executable[])new Executable[]{this.method(DB.class, "throwex", new Class[0])});
        RuntimeJNIAccess.register((Executable[])new Executable[]{this.method(DB.class, "throwex", Integer.TYPE)});
        RuntimeJNIAccess.register((Executable[])new Executable[]{this.method(NativeDB.class, "throwex", String.class)});
        RuntimeJNIAccess.register((Class[])new Class[]{Function.class});
        RuntimeJNIAccess.register((Field[])this.fields(Function.class, "context", "value", "args"));
        ...
        RuntimeJNIAccess.register((Executable[])new Executable[]{this.method(Collation.class, "xCompare", String.class, String.class)});
        ...
        RuntimeJNIAccess.register((Executable[])new Executable[]{this.method(DB.ProgressObserver.class, "progress", Integer.TYPE, Integer.TYPE)});
        ...
        RuntimeJNIAccess.register((Executable[])new Executable[]{this.method(BusyHandler.class, "callback", Integer.TYPE)});
    ...
    private static class SqliteJdbcFeatureException
