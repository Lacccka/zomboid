...
Externalizable {
    ...
    extends MapBackedView<V> {
        ...
        public boolean removeElement(V value) {
            V[] values2 = THashMap.this._values;
            Object[] set = THashMap.this._set;
            int i = values2.length;
            while (i-- > 0) {
                if ((set[i] == TObjectHash.FREE || set[i] == TObjectHash.REMOVED || value != values2[i]) && (null == values2[i] || !THashMap.this.equals(values2[i], value))) continue;
