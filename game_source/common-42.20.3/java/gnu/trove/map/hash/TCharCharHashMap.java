...
Externalizable {
    ...
    public TCharCharHashMap(char[] keys2, char[] values2) {
    ...
    implements TCharCollection {
        ...
        public boolean remove(char entry) {
            char[] values2 = TCharCharHashMap.this._values;
            char[] set = TCharCharHashMap.this._set;
            int i = values2.length;
            while (i-- > 0) {
                if (set[i] == '\u0000' || set[i] == '\u0002' || entry != values2[i]) continue;
