...
extends THash {
    ...
    private static String detectKeyLoss(Object[] keys2, int oldSize) {
        StringBuilder buf = new StringBuilder();
        Set<Object> k = TObjectHash.makeKeySet(keys2);
        if (k.size() != oldSize) {
    ...
    private static Set<Object> makeKeySet(Object[] keys2) {
