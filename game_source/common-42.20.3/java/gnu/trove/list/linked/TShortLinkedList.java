...
Externalizable {
    ...
    public TShortLinkedList(TShortList list) {
        ...
        TShortIterator iterator2 = list.iterator();
    ...
    public void insert(int offset, short[] values2) {
        this.insert(offset, TShortLinkedList.link(values2, 0, values2.length));
    }

    @Override
    public void insert(int offset, short[] values2, int valOffset, int len) {
        this.insert(offset, TShortLinkedList.link(values2, valOffset, len));
    }
    ...
    static TShortLinkedList link(short[] values2, int valOffset, int len) {
    ...
    public void set(int offset, short[] values2, int valOffset, int length) {
        for (int i = 0; i < length; ++i) {
            short value = values2[valOffset + i];
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        ...
        TShortIterator iterator2 = this.iterator();
        while (iterator2.hasNext()) {
            short next = iterator2.next();
            out.writeShort(next);
        }
