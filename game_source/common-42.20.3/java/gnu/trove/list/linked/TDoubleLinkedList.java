...
Externalizable {
    ...
    public TDoubleLinkedList(TDoubleList list) {
        ...
        TDoubleIterator iterator2 = list.iterator();
    ...
    public void insert(int offset, double[] values2) {
        this.insert(offset, TDoubleLinkedList.link(values2, 0, values2.length));
    }

    @Override
    public void insert(int offset, double[] values2, int valOffset, int len) {
        this.insert(offset, TDoubleLinkedList.link(values2, valOffset, len));
    }
    ...
    static TDoubleLinkedList link(double[] values2, int valOffset, int len) {
    ...
    public void set(int offset, double[] values2, int valOffset, int length) {
        for (int i = 0; i < length; ++i) {
            double value = values2[valOffset + i];
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        ...
        TDoubleIterator iterator2 = this.iterator();
        while (iterator2.hasNext()) {
            double next = iterator2.next();
