...
Externalizable {
    ...
    public TLongLinkedList(TLongList list) {
        ...
        TLongIterator iterator2 = list.iterator();
    ...
    public void insert(int offset, long[] values2) {
        this.insert(offset, TLongLinkedList.link(values2, 0, values2.length));
    }

    @Override
    public void insert(int offset, long[] values2, int valOffset, int len) {
        this.insert(offset, TLongLinkedList.link(values2, valOffset, len));
    }
    ...
    static TLongLinkedList link(long[] values2, int valOffset, int len) {
    ...
    public void set(int offset, long[] values2, int valOffset, int length) {
        for (int i = 0; i < length; ++i) {
            long value = values2[valOffset + i];
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        ...
        TLongIterator iterator2 = this.iterator();
        while (iterator2.hasNext()) {
            long next = iterator2.next();
            out.writeLong(next);
        }
