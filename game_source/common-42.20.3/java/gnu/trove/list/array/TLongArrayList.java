...
Externalizable {
    ...
    protected TLongArrayList(long[] values2, long no_entry_value, boolean wrap) {
        if (!wrap) {
    ...
    public static TLongArrayList wrap(long[] values2) {
        return TLongArrayList.wrap(values2, 0L);
    }

    public static TLongArrayList wrap(long[] values2, long no_entry_value) {
        return new TLongArrayList(values2, no_entry_value, true){
