...
Externalizable {
    ...
    public TCharArrayList(char[] values2) {
        this(values2.length);
        this.add(values2);
    }

    protected TCharArrayList(char[] values2, char no_entry_value, boolean wrap) {
        if (!wrap) {
    ...
    public static TCharArrayList wrap(char[] values2) {
        return TCharArrayList.wrap(values2, '\u0000');
    }

    public static TCharArrayList wrap(char[] values2, char no_entry_value) {
        return new TCharArrayList(values2, no_entry_value, true){
