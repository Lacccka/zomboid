...
Externalizable {
    ...
    protected TDoubleArrayList(double[] values2, double no_entry_value, boolean wrap) {
        if (!wrap) {
    ...
    public static TDoubleArrayList wrap(double[] values2) {
        return TDoubleArrayList.wrap(values2, 0.0);
    }

    public static TDoubleArrayList wrap(double[] values2, double no_entry_value) {
        return new TDoubleArrayList(values2, no_entry_value, true){
