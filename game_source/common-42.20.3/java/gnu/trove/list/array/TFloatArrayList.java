...
Externalizable {
    ...
    protected TFloatArrayList(float[] values2, float no_entry_value, boolean wrap) {
        if (!wrap) {
    ...
    public static TFloatArrayList wrap(float[] values2) {
        return TFloatArrayList.wrap(values2, 0.0f);
    }

    public static TFloatArrayList wrap(float[] values2, float no_entry_value) {
        return new TFloatArrayList(values2, no_entry_value, true){
