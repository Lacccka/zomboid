...
public class TradingManager {
    ...
    private final List<Trading> tradings = new ArrayList<Trading>();
    private final List<Trading> finalisingTradings = new ArrayList<Trading>();
    private final List<Trading> finalisedTradings = new ArrayList<Trading>();
    ...
    public void addNewTrading(IsoPlayer playerA, IsoPlayer playerB) {
        this.tradings.add(new Trading(playerA, playerB));
    }
    ...
    public void finishTrading(IsoPlayer player) {
        ...
        if (trading.isPresent()) {
            List<Trading> list = this.finalisingTradings;
            synchronized (list) {
    ...
    private static final class Trading {
        ...
        final List<InventoryItem> playerAItems = new ArrayList<InventoryItem>();
        final List<InventoryItem> playerBItems = new ArrayList<InventoryItem>();
