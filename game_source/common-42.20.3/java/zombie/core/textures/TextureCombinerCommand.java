...
public final class TextureCombinerCommand {
    ...
    public static final ObjectPool<TextureCombinerCommand> pool = new ObjectPool<TextureCombinerCommand>(TextureCombinerCommand::new, "TextureCombinerCommand.pool");

    public String toString() {
        String nl = System.lineSeparator();
        String cm = ",";
        String tb = "\t";
        return "{" + nl + "\tpos: " + this.x + "," + this.y + nl + "\tsize: " + this.w + "," + this.h + nl + "\tmask:" + String.valueOf(this.mask) + nl + "\ttex:" + String.valueOf(this.tex) + nl + "\tblendSrc:" + this.blendSrc + nl + "\tblendDest:" + this.blendDest + nl + "\tblendSrcA:" + this.blendSrcA + nl + "\tblendDestA:" + this.blendDestA + nl + "\tshader:" + String.valueOf(this.shader) + nl + "\tshaderParams:" + PZArrayUtil.arrayToString(this.shaderParams) + nl + "}";
    }
    ...
    public TextureCombinerCommand initSeparate(Texture tex, SmartShader shader, ArrayList<TextureCombinerShaderParam> params, Texture mask, int src, int dest, int srcA, int destA) {
        this.tex = this.requireNonNull(tex);
        this.shader = shader;
        this.blendSrc = src;
        this.blendDest = dest;
