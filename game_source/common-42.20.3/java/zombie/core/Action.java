...
implements INetworkPacketField {
    ...
    public void copyFrom(Action act) {
        ...
        if (act.state == Transaction.TransactionState.Request || act.state == Transaction.TransactionState.Reject || act.state == Transaction.TransactionState.Done) {
    ...
    public void parse(ByteBufferReader b, IConnection connection) {
        ...
        if (this.state == Transaction.TransactionState.Request || this.state == Transaction.TransactionState.Reject || this.state == Transaction.TransactionState.Done) {
