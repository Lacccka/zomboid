...
public final class ExceptionLogger {
    ...
    public static synchronized void logException(Throwable ex) {
        ExceptionLogger.logException(ex, DebugLogStream.generateCallerPrefix(), null, DebugType.General, LogSeverity.Error);
    }

    public static synchronized void logException(Throwable ex, String errorMessage) {
        ExceptionLogger.logException(ex, DebugLogStream.generateCallerPrefix(), errorMessage, DebugType.General, LogSeverity.Error);
    }

    public static synchronized void logException(Throwable ex, String errorMessage, DebugType out, LogSeverity severity) {
        ExceptionLogger.logException(ex, DebugLogStream.generateCallerPrefix(), errorMessage, out, severity);
    }
    ...
    public static void render() {
        ...
        TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)(x + 50), (double)y, "ERROR", 1.0, 0.0, 0.0, 1.0);
        TextManager.instance.DrawStringCentre(UIFont.DebugConsole, (double)(x + 50), (double)(y + fontHgt), Integer.toString(exceptionCount), 0.0, 0.0, 0.0, 1.0);
