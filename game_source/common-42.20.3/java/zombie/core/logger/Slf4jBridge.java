    ...
    public ILoggerFactory getLoggerFactory() {
        return name -> new LegacyAbstractLogger(this){
            ...
            protected void handleNormalizedLoggingCall(Level level, Marker marker, String msg, Object[] args2, Throwable t) {
                ...
                if (t == null) {
                    DebugType.General.routedWrite(3, LOG_SEVERITY_BY_LEVEL.get((Object)level), msg.formatted(args2));
                } else {
                    DebugType.General.printException(t, LOG_SEVERITY_BY_LEVEL.get((Object)level), msg, args2);
                }
            }
