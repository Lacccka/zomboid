...
public final class TransitionNodeProxy {
    ...
    private static final ObjectPool<NodeLayerPair> s_nodeLayerPairPool = new ObjectPool<NodeLayerPair>(NodeLayerPair::new, "TransitionNodeProxy.s_nodeLayerPairPool");
    private static final ObjectPool<TransitionNodeProxyData> s_transitionNodeProxyDataPool = new ObjectPool<TransitionNodeProxyData>(TransitionNodeProxyData::new, "TransitionNodeProxy.s_transitionNodeProxyDataPool");
