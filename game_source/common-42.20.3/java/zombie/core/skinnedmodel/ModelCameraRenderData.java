...
extends TextureDraw.GenericDrawer {
    ...
    public static final ObjectPool<ModelCameraRenderData> s_pool = new ObjectPool<ModelCameraRenderData>(ModelCameraRenderData::new, "ModelCameraRenderData.s_pool");
