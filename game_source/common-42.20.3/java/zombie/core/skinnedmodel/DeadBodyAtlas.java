...
public final class DeadBodyAtlas {
    ...
    private final ObjectPool<BodyTextureDrawer> bodyTextureDrawerPool = new ObjectPool<BodyTextureDrawer>(BodyTextureDrawer::new, "DeadBodyAtlas.bodyTextureDrawerPool");
    private static final ObjectPool<BodyTextureDepthDrawer> s_BodyTextureDepthDrawerPool = new ObjectPool<BodyTextureDepthDrawer>(BodyTextureDepthDrawer::new, "DeadBodyAtlas.s_BodyTextureDepthDrawerPool");
