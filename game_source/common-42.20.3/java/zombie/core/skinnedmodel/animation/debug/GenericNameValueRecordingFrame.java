...
public abstract class GenericNameValueRecordingFrame {
    ...
    public static StringBuilder appendCell(StringBuilder logLine, String cell) {
        return logLine.append(delim).append(GenericNameValueRecordingFrame.encodeCellString(cell));
    }
    ...
    private static String encodeCellString(String cell) {
        ...
        String encodedCell = cell.replaceAll(delim, "%2C").replaceAll("\t", "%09").replaceAll("\"", "%22").replaceAll("'", "%27").replaceAll("~", "%7E").replaceAll("\r", "").replaceAll("\n", "%0A");
        return encodedCell;
    }
}
