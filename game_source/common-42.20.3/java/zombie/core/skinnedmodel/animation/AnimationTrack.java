...
extends PooledObject {
    ...
    private void tickCurrentTimeInternal(float time) {
        ...
        if (this.triggerOnNonLoopedAnimFadeOutEvent && this.previousTimeValue < (earlyBlendOutAtTime = endDuration - this.earlyBlendOutTime * this.speedDelta) && earlyBlendOutAtTime <= this.currentTimeValue) {
    ...
    public static AnimationTrack createClone(AnimationTrack source2, Supplier<AnimationTrack> allocator) {
        ...
        newTrack.accumulatedTimeValue = source2.accumulatedTimeValue;
