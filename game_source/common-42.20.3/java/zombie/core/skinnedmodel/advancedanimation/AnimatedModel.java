...
IHumanVisual {
    ...
    private static final ObjectPool<AnimatedModelInstanceRenderData> instDataPool = new ObjectPool<AnimatedModelInstanceRenderData>(AnimatedModelInstanceRenderData::new, "AnimatedModel.instDataPool");
