...
public final class HelperFunctions {
    ...
    private static final ObjectPool<Vector3f> VectorPool = new ObjectPool<Vector3f>(Vector3f::new, "HelperFunctions.VectorPool");
    private static final ObjectPool<Quaternion> QuaternionPool = new ObjectPool<Quaternion>(Quaternion::new, "HelperFunctions.QuaternionPool");
