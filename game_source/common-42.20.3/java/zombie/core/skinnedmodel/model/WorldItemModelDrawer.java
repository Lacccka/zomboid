...
extends TextureDraw.GenericDrawer {
    private static final ObjectPool<WorldItemModelDrawer> s_modelDrawerPool = new ObjectPool<WorldItemModelDrawer>(WorldItemModelDrawer::new, "WorldItemModelDrawer.s_modelDrawerPool");
