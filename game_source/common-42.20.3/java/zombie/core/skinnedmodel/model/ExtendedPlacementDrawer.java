...
extends TextureDraw.GenericDrawer {
    ...
    float depth;
    static final ObjectPool<ExtendedPlacementDrawer> s_pool = new ObjectPool<ExtendedPlacementDrawer>(ExtendedPlacementDrawer::new, "ExtendedPlacementDrawer.s_pool");
