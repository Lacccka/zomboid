...
@Deprecated
public final class AiSceneAssetManager
extends AssetManager {
    ...
    protected void startLoading(Asset asset) {
        ...
        FileTask_LoadAiScene fileTask = new FileTask_LoadAiScene(asset.getPath().getPath(), ((AiSceneAsset)asset).postProcessStepSet, result -> this.onFileTaskFinished((AiSceneAsset)asset, result), fs);
    ...
    public void onFileTaskFinished(AiSceneAsset asset, Object result) {
        if (result instanceof AiScene) {
            AiScene aiScene;
            asset.scene = aiScene = (AiScene)result;
    ...
    static class FileTask_LoadAiScene
    extends FileTask {
        String filename;
