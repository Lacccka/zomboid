...
extends TextureDraw.GenericDrawer {
    ...
    private static final ObjectPool<ModelInstanceTextureCreator> pool = new ObjectPool<ModelInstanceTextureCreator>(ModelInstanceTextureCreator::new, "ModelInstanceTextureCreator.pool");
    ...
    private static final class ItemData {
        ...
        static final ObjectPool<ItemData> pool = new ObjectPool<ItemData>(ItemData::new, "ItemData.pool");
