...
public enum CreditsRole {
    ...
    ENGINEERS(CreditsName.CHRIS_SIMPSON, CreditsName.TIMOTHY_BAKER, CreditsName.ZAC_CONGO, CreditsName.THOMAS_GUIMBRETIERE, CreditsName.DEREK_BUCHANAN, CreditsName.ERIS_CLARK, CreditsName.BLAIR_FITZPATRICK, CreditsName.RAPHAEL_BARANDAS, CreditsName.NORMAN_VEZINA, CreditsName.KEES_BEKKEMA),
    ADDITIONAL_CODE(CreditsName.STEVE_NORTH, CreditsName.FOX_CHAOTICA, CreditsName.CONNALL_LINDSAY, CreditsName.CHRIS_WOOD, CreditsName.STEVE_SHARP, CreditsName.NICK_COWEN, CreditsName.CASEY_JO_KENNY, CreditsName.AITOR_CRUZ, CreditsName.JESSE_BURLAND_LOKKO, CreditsName.SAM_SPAWTON, CreditsName.CASPIAN_PRINCE),
    PRODUCER(CreditsName.YANA_DUNCAN),
    ASSOCIATE_PRODUCER(CreditsName.MAX_NUTTALL),
    ARTISTS(CreditsName.MARINA_SIU_CHONG, CreditsName.ANDY_HODGETTS, CreditsName.ILJA_GAIDENKO, CreditsName.DYLAN_MYERS, CreditsName.ERIKA_EDGREN, CreditsName.NIKOLA_KAPIDZIC, CreditsName.MARK_WRIGHT, CreditsName.ANDRES_CASTRO, CreditsName.FILIBUSTER_RHYMES, CreditsName.MARTIN_GREENALL),
    ...
    MIDDLE_SOFTWARE_DEVELOPER(CreditsName.ILIA_TEPLISHCHEV, CreditsName.ANDREI_MELNIKOV, CreditsName.DANIIL_KLESHCHEVNIKOV, CreditsName.ALEXANDER_BLINOV, CreditsName.ALEKSEI_KHOKHOLOV),
    ...
    SPECIAL_INFECTED(CreditsName.BENJAMIN_SCHIEDER, CreditsName.ALEXA_ALTEZ, CreditsName.ALICE_BONNEAU, CreditsName.AMBIGUOUSAMPHIBIAN, CreditsName.ANTTI_RIIKONEN, CreditsName.AWPENHEIMER, CreditsName.BEAR_GRANANDER, CreditsName.BENJAMIN_JAMES, CreditsName.BILL_REDPATH, CreditsName.CHARLIE_SLOAN, CreditsName.CHRISTIAN_JORGE, CreditsName.CHRISTOPHER_GREEN, CreditsName.CLEMENT_GIRAUDEAU, CreditsName.CROMULENT_ARCHER, CreditsName.DANIEL_SOBHI, CreditsName.DITOSEADIO, CreditsName.DMITRY_BOROVSKY, CreditsName.DR_COX1911, CreditsName.DRAKE_BARRON, CreditsName.EDWARD_SMALLWOOD, CreditsName.FRANCOIS_DESFORGES, CreditsName.HENRY_PATTERSON, CreditsName.HOODIE_GUY, CreditsName.JACOB_HALEY, CreditsName.JONES_GAMBARINE, CreditsName.KEVIN_KING, CreditsName.KIM_METZGER, CreditsName.KRZYSZTOF_SAGOLA, CreditsName.LEO_DIMILO, CreditsName.LEO_IVANOV, CreditsName.LEONKIEL, CreditsName.LOUIS_KEEP, CreditsName.MARC_TOOKEY, CreditsName.MARCO_PURSCHLER, CreditsName.MARCUS_GONCALVES, CreditsName.MARCUS_HILL, CreditsName.MARK_SANDERS, CreditsName.MARK_EXE, CreditsName.MIDDLEAGEDBOB, CreditsName.MR_BROLLOW, CreditsName.MR_L_TARTAN, CreditsName.MISTER_LAMPREY, CreditsName.PAUL_MCALOON, CreditsName.PAUL_WRIGHT, CreditsName.PETER_LOVERSO, CreditsName.PUPPERS, CreditsName.RASMUS_NIELSEN, CreditsName.REKKIE, CreditsName.ROBOMAT, CreditsName.ROYALEWITHCHEESE, CreditsName.RUAL_STORGE, CreditsName.SAVELIY_ZELOVSKIY, CreditsName.STEVE_YOUNG, CreditsName.THE_COMMANDER, CreditsName.TITOPEI, CreditsName.ANONYMOUS),
    SPECIAL_THANKS(CreditsName.THE_COMMUNITY, CreditsName.PETER_LEWIN, CreditsName.ALAN_CARTER, CreditsName.ANGELA_BATEMAN, CreditsName.BOBHECKLING, CreditsName.BOXER, CreditsName.BRIAN_HICKS, CreditsName.CALLY, CreditsName.CHET_FALISZEK, CreditsName.CHIEF, CreditsName.DEAN_HALL, CreditsName.DEAN_TROTMAN, CreditsName.DUFFY_DAVIS, CreditsName.ECKYMAN, CreditsName.ELSPETH_EDMONDS, CreditsName.EMILY_RICHARDSON, CreditsName.FRANK_JORDAN, CreditsName.GRAEME_STRUTHERS, CreditsName.JAIME_BYRNE, CreditsName.JAS_PUREWAL, CreditsName.JOSH_HENNING, CreditsName.KIWO, CreditsName.KLEAN, CreditsName.MATHAS, CreditsName.MATT_SCHILLACI, CreditsName.MAYATUTORS, CreditsName.MRATOMICDUCK, CreditsName.NJ_APOSTOL, CreditsName.NOTCH, CreditsName.OLIVIA_WHITE, CreditsName.PAUL_JR, CreditsName.PHILL_CAMERON, CreditsName.PR1VATELIME, CreditsName.REDWIRE, CreditsName.ROBBAZ, CreditsName.SACRIEL, CreditsName.SARAH_NEWELL, CreditsName.SAUDIGAMER, CreditsName.SCOTT_REISMANIS, CreditsName.SHANNON_KILLER, CreditsName.THE_PUB, CreditsName.TIM_BUCKLEY, CreditsName.TOM_PORTER, CreditsName.TRAILER_FARM, CreditsName.TWIGGY),
    ...
    LOCALIZATION(new CreditsName[0]),
    ...
    TMG_PL(CreditsName.KAROLINA_BARSZCZ, CreditsName.WOJCIECH_BRUDZI\u0143SKI, CreditsName.TOMEK_KALISZEWSKI, CreditsName.PIOTR_HELAK, CreditsName.ASIA_MLECZAK, CreditsName.NATALIA_PATEREK),
    WIKI_EDITORS(CreditsName.EDWIN_TRAN, CreditsName.SHARPGOLDEN, CreditsName.SIMON_CADET, CreditsName.MACA, CreditsName.VIBRANCE, CreditsName.MATHILDACHAN, CreditsName.ALBION),
    IN_LOVING_MEMORY_OF(CreditsName.ROMUALD_DRON, CreditsName.VICKI_WOODS);

    public static final String TRANSLATOR = "Translator";
    public static final Path TRANSLATION_FOLDER;
    public static final Path CREDITS_TRANSLATOR_JSON;
    private final String title = "credits_role.%s".formatted(this.name().toLowerCase());
    private final List<CreditsName> names;

    private CreditsRole(boolean sort, CreditsName ... names) {
        this.names = sort ? Arrays.stream(names).sorted(Comparator.comparing(CreditsName::getSort)).toList() : List.of(names);
    }

    private CreditsRole(CreditsName ... names) {
        this(true, names);
    }
    ...
    public static KahluaTable getTranslatorCredits() {
        ...
        try {
            if (!Files.exists(TRANSLATION_FOLDER, new LinkOption[0])) {
                DebugLog.log(DebugType.Translation, "Translations folder not found at " + String.valueOf(TRANSLATION_FOLDER));
                return map;
            }
            try (Stream<Path> stream = Files.walk(TRANSLATION_FOLDER, 1, new FileVisitOption[0]);){
                stream.filter(x$0 -> Files.isDirectory(x$0, new LinkOption[0])).filter(path -> !path.equals(TRANSLATION_FOLDER)).forEach(file -> {
                    ...
                    List<String> translatorCredits = CreditsRole.getTranslatorCreditsList(fileLanguage);
    ...
    public static List<String> getTranslatorCreditsList(Language language) {
        ArrayList<String> translatorsList = new ArrayList<String>();
        try {
    ...
    static {
        TRANSLATION_FOLDER = Path.of("media/lua/shared/Translate", new String[0]);
        CREDITS_TRANSLATOR_JSON = Path.of("Credits_Translator.json", new String[0]);
        if (Core.IS_DEV) {
            for (CreditsRole entry : CreditsRole.values()) {
