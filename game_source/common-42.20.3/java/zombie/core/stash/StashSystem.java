        ...
        if ("Map".equals(stash.type)) {
            ...
            if (stash.annotations != null) {
                for (int i = 0; i < stash.annotations.size(); ++i) {
                    ...
                    } else if (annotation.text != null && Translator.getTextOrNull(annotation.text, new Object[0]) != null) {
                ...
                for (int y = def.y - 1; y < def.y2 + 1; ++y) {
                    for (int z = -32; z < 31; ++z) {
                        ...
                        for (int o = 0; o < sq.getObjects().size(); ++o) {
                            ...
                            if (container != null && room != null && room.getBuilding().getDef() == def && room.getName() != null && buildingLoot != null && buildingLoot.containers.containsKey(container.getType())) {
