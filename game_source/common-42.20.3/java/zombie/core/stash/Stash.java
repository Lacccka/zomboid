...
public final class Stash {
    ...
    public void load(KahluaTableImpl stashDesc) {
        ...
        this.customName = Translator.getText(stashDesc.rawgetStr("customName"), new Object[0]);
    ...
    public void applyAnnotations(UIWorldMap ui) {
        ...
        for (int i = 0; i < this.annotations.size(); ++i) {
            ...
            WorldMapTextSymbol symbol = Translator.getTextOrNull(annotation.text, new Object[0]) == null ? ui.getSymbolsDirect().addTranslatedText(annotation.text, "note", annotation.x, annotation.y, annotation.r, annotation.g, annotation.b, 1.0f) : ui.getSymbolsDirect().addUntranslatedText(annotation.text, "note", annotation.x, annotation.y, annotation.r, annotation.g, annotation.b, 1.0f);
