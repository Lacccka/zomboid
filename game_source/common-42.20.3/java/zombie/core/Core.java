...
lbl12:
        ...
        try {
            while ((line = br.readLine()) != null) {
                block146: {
                    ...
                    if (!line.startsWith("autozoom=")) break block146;
                ...
                if (line.startsWith("mapViewPause=")) {
                ...
                if (line.startsWith("populateServerListOnStart=")) {
                ...
                if (line.startsWith("gamepadBindingPreset=")) {
    ...
    private String upgradeOptionValue(String optionName, String optionValue, int version) {
        if (version < 8 && (Objects.equals(optionName, "textureCompression") || Objects.equals(optionName, "doWindSpriteEffects"))) {
            return "false";
        }
        return optionValue;
    }
    ...
    public String getVersion() {
        return String.valueOf(gameVersion) + ".3 " + Core.getGitRevisionString();
    }
    ...
    public String getGitSha() {
        if (this.gitSha == null) {
            this.gitSha = IS_DEV ? DevMainScreenState.getDevSha() : "70207f62e0";
        }
        return this.gitSha;
    }
    ...
    public String getGitRevision() {
        if (this.gitRevisionString == null) {
            this.gitRevisionString = IS_DEV ? DevMainScreenState.getDevVersion() : "70207f62e0".substring(0, Math.min("70207f62e0".length(), 20));
        }
    ...
    public int getOptionFontSizeReal() {
        ...
        if (size == 6) {
            ...
            int maxHeight = 2400;
            int divisions = 132;
            int scale = (int)PZMath.floor((float)(Core.getInstance().getScreenHeight() - 1080) / 132.0f) + 1;
    ...
    static {
        gameVersion = new GameVersion(42, 20, "");
