...
public final class MediaData {
    ...
    public void addLine(String text, float r, float g, float b, String codes) {
        MediaLineData line = new MediaLineData(text, r, g, b, codes);
        this.lines.add(line);
    }
    ...
    public String getTranslatedItemDisplayName() {
        return Translator.getText(this.itemDisplayName, new Object[0]);
    }
    ...
    public String getTranslatedTitle() {
        return this.title != null ? Translator.getText(this.title, new Object[0]) : null;
    }
    ...
    public String getTranslatedSubTitle() {
        return this.subtitle != null ? Translator.getText(this.subtitle, new Object[0]) : null;
    }
    ...
    public String getTranslatedAuthor() {
        return this.author != null ? Translator.getText(this.author, new Object[0]) : null;
    }
    ...
    public String getTranslatedExtra() {
        return this.extra != null ? Translator.getText(this.extra, new Object[0]) : null;
    }
    ...
    public MediaLineData getLine(int index) {
    ...
    public static final class MediaLineData {
        ...
        public String getTranslatedText() {
            return Translator.getText(this.text, new Object[0]);
        }
