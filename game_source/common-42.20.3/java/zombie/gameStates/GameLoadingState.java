...
extends GameState {
    ...
    public void enter() {
        ...
        if (GameClient.client && !GameClient.instance.connected) {
            ...
            int id = GameClient.instance.id & 0xFF;
            Core.gameSaveWorld = "clienttest" + id;
            LuaManager.GlobalObject.deleteSave("clienttest" + id);
            LuaManager.GlobalObject.createWorld("clienttest" + id);
        }
    ...
    public void render() {
        ...
        this.loadingDotTick += GameTime.getInstance().getMultiplierInMenu();
        ...
        this.time += GameTime.instance.getTimeDeltaInMenu();
        float alpha1 = 0.0f;
        float alpha2 = 0.0f;
        float alpha3 = 0.0f;
        if (this.stage == 0) {
        ...
        if (mapDownloadFailed) {
            ...
            TextManager.instance.DrawStringCentre(UIFont.Medium, (double)cx, (double)top, reason, 0.8, 0.1, 0.1, 1.0);
            UIManager.render();
        ...
        if (unexpectedError) {
            ...
            int cy = Core.getInstance().getScreenHeight() / 2;
            int top = cy - dy / 2;
            TextManager.instance.DrawStringCentre(UIFont.Medium, (double)cx, (double)top, Translator.getText("UI_GameLoad_UnexpectedError1", new Object[0]), 0.8, 0.1, 0.1, 1.0);
            TextManager.instance.DrawStringCentre(UIFont.Small, (double)cx, (double)(top + mediumHgt + 8), Translator.getText("UI_GameLoad_UnexpectedError2", new Object[0]), 1.0, 1.0, 1.0, 1.0);
            String consoleDotTxt = ZomboidFileSystem.instance.getCacheDir() + File.separator + "console.txt";
            TextManager.instance.DrawStringCentre(UIFont.Small, (double)cx, (double)(top + mediumHgt + 8 + smallHgt + 2), consoleDotTxt, 1.0, 1.0, 1.0, 1.0);
            UIManager.render();
            Core.getInstance().EndFrameUI();
            return;
        }
        ...
        if (worldVersionError) {
            if (WorldConverter.convertingVersion == 0) {
                TextManager.instance.DrawStringCentre(UIFont.Small, (double)(Core.getInstance().getScreenWidth() / 2), (double)(Core.getInstance().getScreenHeight() - 100), Translator.getText("UI_CorruptedWorldVersion", new Object[0]), 0.8, 0.1, 0.1, 1.0);
            } else if (WorldConverter.convertingVersion < 1) {
                TextManager.instance.DrawStringCentre(UIFont.Small, (double)(Core.getInstance().getScreenWidth() / 2), (double)(Core.getInstance().getScreenHeight() - 100), Translator.getText("UI_ConvertWorldFailure", new Object[0]), 0.8, 0.1, 0.1, 1.0);
            }
        } else if (convertingWorld) {
            TextManager.instance.DrawStringCentre(UIFont.Small, (double)(Core.getInstance().getScreenWidth() / 2), (double)(Core.getInstance().getScreenHeight() - 100), Translator.getText("UI_ConvertWorld", new Object[0]), 0.5, 0.5, 0.5, 1.0);
        ...
        if (playerWrongIP) {
            ...
            TextManager.instance.DrawStringCentre(UIFont.Medium, (double)cx, (double)top, str, 0.8, 0.1, 0.1, 1.0);
            UIManager.render();
            Core.getInstance().EndFrameUI();
            return;
        }
        if (GameClient.client) {
            ...
            TextManager.instance.DrawStringCentre(UIFont.Small, (double)(Core.getInstance().getScreenWidth() / 2), (double)((float)(Core.getInstance().getScreenHeight() - 40) - fontHeightSmall - 5.0f), str, 0.5, 0.5, 0.5, 1.0);
            if (GameClient.connection.getConnectionType() == UdpConnection.ConnectionType.Steam) {
                ...
                TextManager.instance.DrawStringCentre(UIFont.Medium, (double)(Core.getInstance().getScreenWidth() / 2), (double)((float)(Core.getInstance().getScreenHeight() - 40) - fontHeightSmall * 2.0f - 5.0f), this.text, 0.1, 0.1, 0.1, 1.0);
            }
        } else if (!playerCreated && newGame && !Core.isLastStand()) {
            TextManager.instance.DrawStringCentre(UIFont.NewSmall, (double)(Core.getInstance().getScreenWidth() / 2), (double)((float)(Core.getInstance().getScreenHeight() - 40) - fontHeightSmall - 5.0f), Translator.getText("UI_Loading", new Object[0]).replace(".", ""), 0.5, 0.5, 0.5, 1.0);
            TextManager.instance.DrawString(UIFont.NewSmall, Core.getInstance().getScreenWidth() / 2 + TextManager.instance.MeasureStringX(UIFont.Small, Translator.getText("UI_Loading", new Object[0]).replace(".", "")) / 2 + 1, (float)(Core.getInstance().getScreenHeight() - 40) - fontHeightSmall - 5.0f, this.loadingDot, 0.5, 0.5, 0.5, 1.0);
        }
        this.doQuickTips();
        if (this.stage == 0) {
            ...
            TextManager.instance.DrawStringCentre(UIFont.Intro, (double)x, (double)y, Translator.getText("UI_Intro1", new Object[0]), 1.0, 1.0, 1.0, (double)alpha1);
        }
        if (this.stage == 1) {
            int x = Core.getInstance().getScreenWidth() / 2;
            int y = Core.getInstance().getScreenHeight() / 2 - TextManager.instance.getFontFromEnum(UIFont.Intro).getLineHeight() / 2;
            TextManager.instance.DrawStringCentre(UIFont.Intro, (double)x, (double)y, Translator.getText("UI_Intro2", new Object[0]), 1.0, 1.0, 1.0, (double)alpha2);
        }
        if (this.stage == 2) {
            int x = Core.getInstance().getScreenWidth() / 2;
            int y = Core.getInstance().getScreenHeight() / 2 - TextManager.instance.getFontFromEnum(UIFont.Intro).getLineHeight() / 2;
            TextManager.instance.DrawStringCentre(UIFont.Intro, (double)x, (double)y, Translator.getText("UI_Intro3", new Object[0]), 1.0, 1.0, 1.0, (double)alpha3);
        }
        ...
        if (done && playerCreated && (!newGame || this.time >= 33.0f || Core.isLastStand() || "Tutorial".equals(Core.gameMode))) {
            if (this.clickToSkipFadeIn) {
                this.clickToSkipAlpha += GameTime.getInstance().getThirtyFPSMultiplierInMenu() / 30.0f;
            ...
            if (GameWindow.activatedJoyPad == null || JoypadManager.instance.joypadList.isEmpty()) {
                TextManager.instance.DrawStringCentre(UIFont.NewLarge, (double)(Core.getInstance().getScreenWidth() / 2), (double)((float)(baseline - 40) - fontHeightSmall - 5.0f), Translator.getText("UI_ClickToSkip", new Object[0]), 1.0, 1.0, 1.0, (double)this.clickToSkipAlpha);
            } else {
                ...
                if (tex != null) {
                    ...
                    SpriteRenderer.instance.renderi(tex, Core.getInstance().getScreenWidth() / 2 - TextManager.instance.MeasureStringX(UIFont.Small, Translator.getText("UI_PressAToStart", new Object[0])) / 2 - 8 - tex.getWidth(), baseline - 60 + fontHgt / 2 - tex.getHeight() / 2, tex.getWidth(), tex.getHeight(), 1.0f, 1.0f, 1.0f, this.clickToSkipAlpha, null);
                }
                TextManager.instance.DrawStringCentre(UIFont.Small, (double)(Core.getInstance().getScreenWidth() / 2), (double)((float)(baseline - 40) - fontHeightSmall - 5.0f), Translator.getText("UI_PressAToStart", new Object[0]), 1.0, 1.0, 1.0, (double)this.clickToSkipAlpha);
            }
        }
        ActiveMods.renderUI();
        Core.getInstance().EndFrameUI();
    ...
    private void doQuickTips() {
        ...
        this.quickTipsTimer += GameTime.getInstance().getMultiplierInMenu();
        if (!StringUtils.isNullOrEmpty(this.quickTipsText)) {
            TextManager.instance.DrawStringCentre(UIFont.NewMedium, (double)Core.getInstance().getScreenWidth() / 2.0, (double)(Core.getInstance().getScreenHeight() - 40), this.quickTipsText, 0.5, 0.5, 0.5, 1.0);
        }
    }
