...
extends GameState {
    ...
    public GameStateMachine.StateAction update() {
        try {
            ...
            DebugType.General.printException(e, LogSeverity.Error, "StateAction Exception thrown. Handled gracefully, returning StateAction.Continue", new Object[0]);
            return GameStateMachine.StateAction.Continue;
        }
    }
    ...
    private void TestTCP() {
        ...
        if (Core.debug && !GameClient.connection.getRole().hasCapability(Capability.ConnectWithDebug) && !CoopMaster.instance.isRunning()) {
            LuaEventManager.triggerEvent("OnConnectFailed", Translator.getText("UI_OnConnectFailed_DebugNotAllowed", new Object[0]));
    ...
    private void WorkshopInit() {
        ...
        if (this.query.handle != 0L) {
            ...
            this.query = null;
            LuaEventManager.triggerEvent("OnConnectFailed", Translator.getText("UI_OnConnectFailed_CreateQueryUGCDetailsRequest", new Object[0]));
