...
IUpdater {
    ...
    private final List<String> mountOn = new ArrayList<String>();
    private final List<String> mountOnDisplayName = new ArrayList<String>();
    ...
    public void DoTooltip(ObjectTooltip tooltipUI, ObjectTooltip.Layout layout) {
        ...
        item = layout.addItem();
        String mountTxt = Translator.getText("Tooltip_weapon_CanBeMountOn", new Object[0]) + ": " + this.mountOnDisplayName.toString().replaceAll("\\[", "").replaceAll("\\]", "");
    ...
    public void setMountOn(List<String> mountOn) {
        ...
        for (int i = 0; i < mountOn.size(); ++i) {
            Item scriptItem;
            Object weaponType = mountOn.get(i);
            if (!((String)weaponType).contains(".")) {
                weaponType = this.getModule() + "." + (String)weaponType;
            }
            if ((scriptItem = ScriptManager.instance.getItem((String)weaponType)) == null) continue;
