...
implements IUpdater {
    ...
    public void DoTooltip(ObjectTooltip tooltipUI, ObjectTooltip.Layout layout) {
        ...
        if (this.cantAttackWithLowestEndurance) {
            item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_weapon_Unusable_at_max_exertion", new Object[0]), Core.getInstance().getBadHighlitedColor().getR(), Core.getInstance().getBadHighlitedColor().getG(), Core.getInstance().getBadHighlitedColor().getB(), 1.0f);
        }
        ...
        if (this.isJammed()) {
            item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_weapon_Jammed", new Object[0]), Core.getInstance().getBadHighlitedColor().getR(), Core.getInstance().getBadHighlitedColor().getG(), Core.getInstance().getBadHighlitedColor().getB(), 1.0f);
            ...
            item.setLabel(Translator.getText(xln, new Object[0]), Core.getInstance().getBadHighlitedColor().getR(), Core.getInstance().getBadHighlitedColor().getG(), Core.getInstance().getBadHighlitedColor().getB(), 1.0f);
        } else if (this.getSpentRoundCount() > 0) {
            item = layout.addItem();
            item.setLabel(Translator.getText("Tooltip_weapon_SpentRounds", new Object[0]) + ":", Core.getInstance().getBadHighlitedColor().getR(), Core.getInstance().getBadHighlitedColor().getG(), Core.getInstance().getBadHighlitedColor().getB(), 1.0f);
