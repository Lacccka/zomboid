...
extends InventoryItem {
    ...
    public void initAnimalData() {
        this.animalName = !StringUtils.isNullOrEmpty(this.animal.getCustomName()) ? this.animal.getCustomName() : Translator.getText("IGUI_Breed_" + this.animal.getBreed().getName(), new Object[0]) + " " + Translator.getText("IGUI_AnimalType_" + this.animal.getAnimalType(), new Object[0]);
