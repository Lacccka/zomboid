...
extends InventoryItem {
    ...
    public void DoTooltip(ObjectTooltip tooltipUI, ObjectTooltip.Layout layout) {
        ...
        if (this.getLearnedRecipes() != null && !illiterate) {
            ...
            item = layout.addItem();
            Object label2 = Translator.getText("Tooltip_literature_NotBeenRead", new Object[0]);
            ...
            item = layout.addItem();
            String label4 = Translator.getText("ContextMenu_Illiterate", new Object[0]);
        ...
        if (modData.rawget("learnedRecipe") != null && !illiterate) {
            ...
            item = layout.addItem();
            String label5 = Translator.getText("ContextMenu_Illiterate", new Object[0]);
        ...
        if (modData.rawget("literatureTitle") != null && character.isLiteratureRead(title = (String)modData.rawget("literatureTitle"))) {
            item = layout.addItem();
            label = Translator.getText("ContextMenu_RecentlyRead", new Object[0]);
