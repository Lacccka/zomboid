...
extends InventoryItem {
    ...
    public String getName(IsoPlayer player) {
        Object prefix = "";
        if (this.isDirty()) {
            prefix = (String)prefix + Translator.getText("IGUI_ClothingName_Dirty", new Object[0]) + ", ";
        }
        if (this.isBloody()) {
            prefix = (String)prefix + Translator.getText("IGUI_ClothingName_Bloody", new Object[0]) + ", ";
        }
        if (this.getWetness() >= 100.0f) {
            prefix = (String)prefix + Translator.getText("IGUI_ClothingName_Soaked", new Object[0]) + ", ";
        } else if (this.getWetness() > 25.0f) {
            prefix = (String)prefix + Translator.getText("IGUI_ClothingName_Wet", new Object[0]) + ", ";
        }
        if (this.isBroken()) {
            prefix = (String)prefix + Translator.getText("Tooltip_Clothing_broken", new Object[0]) + ", ";
        } else if ((float)this.getCondition() < (float)this.getConditionMax() / 3.0f) {
            prefix = (String)prefix + Translator.getText("IGUI_ClothingName_Worn", new Object[0]) + ", ";
        }
    ...
    public boolean hasFilter() {
        if (!this.hasTag(ItemTag.GAS_MASK, ItemTag.RESPIRATOR, ItemTag.IMPROVISED_GAS_MASK) || this.getModData().rawget("filterType") == null || this.getModData().rawget("filterType") == "none") {
            return false;
        }
    ...
    public void setNoFilter() {
        ...
        if (this.is(ItemKey.Clothing.HAT_IMPROVISED_GAS_MASK)) {
            this.getModData().rawset("customInventoryIcon", (Object)"Item_GasMask_Crafted");
            this.syncItemFields();
        }
    }
    ...
    public void setFilterType(String filterType) {
        ...
        if (this.is(ItemKey.Clothing.HAT_IMPROVISED_GAS_MASK)) {
            this.getModData().rawset("customInventoryIcon", (Object)"Item_GasMask_Crafted_Filtre");
            this.syncItemFields();
        }
    }
    ...
    public void setNoTank() {
        ...
        if (this.is(ItemKey.Clothing.SCBA)) {
            this.getModData().rawset("customInventoryIcon", (Object)"Item_SCBA");
            this.syncItemFields();
        }
    }
    ...
    public void setTankType(String tankType) {
        ...
        if (this.is(ItemKey.Clothing.SCBA)) {
            this.getModData().rawset("customInventoryIcon", (Object)"Item_SCBA_Tank");
            this.syncItemFields();
        }
    }
    ...
    public String getAlternateModelName() {
        ...
        if (this.hasTag(ItemTag.GAS_MASK, ItemTag.RESPIRATOR, ItemTag.IMPROVISED_GAS_MASK) && !this.hasFilter() && !StringUtils.isNullOrWhitespace(this.getWithoutDrainable()) && (withoutDrainableItem = ScriptManager.instance.getItem(this.getWithoutDrainable())) != null && withoutDrainableItem.getClothingItemAsset() != null) {
            return "WithoutDrainable";
        }
        if (this.hasTag(ItemTag.SCBA) && !this.hasTank() && !StringUtils.isNullOrWhitespace(this.getWithoutDrainable()) && (withoutDrainableItem = ScriptManager.instance.getItem(this.getWithoutDrainable())) != null && withoutDrainableItem.getClothingItemAsset() != null) {
            return "WithoutDrainable";
        }
    ...
    public void drainGasMask(float rate) {
        ...
        if (GameServer.server && (currentMinute = GameTime.getInstance().getMinutes()) != this.lastGasMaskSyncMinute) {
            this.syncItemFields();
    ...
    public float getCorpseSicknessDefense() {
        ...
        if (this.hasFilter()) {
            ...
            if (this.getUsedDelta() > 0.0f) {
                float f = value = this.hasTag(ItemTag.IMPROVISED_GAS_MASK) ? ZomboidGlobals.improvisedGasMaskDefense : ZomboidGlobals.standardGasMaskDefense;
            }
            if (value > defense) {
                defense = value;
            }
