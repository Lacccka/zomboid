...
extends GameEntity {
    ...
    protected String offString = Translator.getText("Tooltip_food_Rotten", new Object[0]);
    protected String freshString = Translator.getText("Tooltip_food_Fresh", new Object[0]);
    protected String staleString = Translator.getText("Tooltip_food_Stale", new Object[0]);
    protected String cookedString = Translator.getText("Tooltip_food_Cooked", new Object[0]);
    protected String toastedString = Translator.getText("Tooltip_food_Toasted", new Object[0]);
    protected String grilledString = Translator.getText("Tooltip_food_Grilled", new Object[0]);
    protected String unCookedString = Translator.getText("Tooltip_food_Uncooked", new Object[0]);
    protected String frozenString = Translator.getText("Tooltip_food_Frozen", new Object[0]);
    protected String burntString = Translator.getText("Tooltip_food_Burnt", new Object[0]);
    protected String emptyString = Translator.getText("ContextMenu_Empty", new Object[0]);
    ...
    public void DoTooltipEmbedded(ObjectTooltip tooltipUI, ObjectTooltip.Layout layoutOverride, int offsetY) {
        ...
        if (this.extraItems != null && !this.extraItems.isEmpty()) {
            tooltipUI.DrawText(font, Translator.getText("Tooltip_item_Contains", new Object[0]), tooltipUI.padLeft, y, 1.0, 1.0, 0.8f, 1.0);
            x = tooltipUI.padLeft + TextManager.instance.MeasureStringX(font, Translator.getText("Tooltip_item_Contains", new Object[0])) + 4;
        ...
        if (this instanceof Food && ((Food)this).spices != null) {
            tooltipUI.DrawText(font, Translator.getText("Tooltip_item_Spices", new Object[0]), tooltipUI.padLeft, y, 1.0, 1.0, 0.8f, 1.0);
            x = tooltipUI.padLeft + TextManager.instance.MeasureStringX(font, Translator.getText("Tooltip_item_Spices", new Object[0])) + 4;
            dy = (lineSpacing - iconSize) / 2;
        ...
        if (SandboxOptions.instance.isUnstableScriptNameSpam()) {
            ...
            item2.setLabel(Translator.getText("Item Report", new Object[0]) + ":", 1.0f, 0.4f, 0.7f, 1.0f);
        ...
        if (player != null && this.scriptItem != null && !this.scriptItem.getResearchableRecipes(player).isEmpty()) {
            ...
            if (this.scriptItem.getResearchableRecipes(player).size() == 1) {
                item3.setLabel(Translator.getText("Tooltip_item_CanResearch", new Object[0]), color.getR(), color.getG(), color.getB(), 1.0f);
            } else {
                item3.setLabel(Translator.getText("Tooltip_item_CanResearchPlural", new Object[0]), color.getR(), color.getG(), color.getB(), 1.0f);
            }
        }
        if (player != null && this.scriptItem != null && this.scriptItem.isFavouriteRecipeInput(player)) {
            ...
            item4.setLabel(Translator.getText("Tooltip_item_IsFavouriteInput", new Object[0]), color.getR(), color.getG(), color.getB(), 1.0f);
        }
        if (player != null && this.isNoRecipes(player)) {
            ...
            item5.setLabel(Translator.getText("Tooltip_NoRecipes_More", new Object[0]), color.getR(), color.getG(), color.getB(), 1.0f);
        }
        if (player != null && this.isUnwanted(player)) {
            ColorInfo color = Core.getInstance().getBadHighlitedColor();
            ObjectTooltip.LayoutItem item6 = layout.addItem();
            item6.setLabel(Translator.getText("Tooltip_Unwanted_More", new Object[0]), color.getR(), color.getG(), color.getB(), 1.0f);
        }
        ObjectTooltip.LayoutItem item7 = layout.addItem();
        item7.setLabel(Translator.getText("Tooltip_item_Weight", new Object[0]) + ":", 1.0f, 1.0f, 0.8f, 1.0f);
        ...
        if (this instanceof HandWeapon || this instanceof Clothing || this instanceof DrainableComboItem || this.getFullType().contains("Walkie") || this.isKeyRing()) {
            if (isEquipped || this.isFakeEquipped()) {
                item7.setValue(this.getCleanString(this.getEquippedWeight()) + "    (" + this.getCleanString(this.getUnequippedWeight()) + " " + Translator.getText("Tooltip_item_Unequipped", new Object[0]) + ")", 1.0f, 1.0f, 1.0f, 1.0f);
            } else if (this.getAttachedSlot() > -1) {
                item7.setValue(this.getCleanString(this.getHotbarEquippedWeight()) + "    (" + this.getCleanString(this.getUnequippedWeight()) + " " + Translator.getText("Tooltip_item_Unattached", new Object[0]) + ")", 1.0f, 1.0f, 1.0f, 1.0f);
            } else {
                item7.setValue(this.getCleanString(this.getUnequippedWeight()) + "    (" + this.getCleanString(this.getEquippedWeight()) + " " + Translator.getText("Tooltip_item_Equipped", new Object[0]) + ")", 1.0f, 1.0f, 1.0f, 1.0f);
            }
        ...
        if (tooltipUI.getWeightOfStack() > 0.0f) {
            ...
            item7.setLabel(Translator.getText("Tooltip_item_StackWeight", new Object[0]) + ":", 1.0f, 1.0f, 0.8f, 1.0f);
        ...
        if (this.getMaxAmmo() > 0 && !(this instanceof HandWeapon)) {
            item7 = layout.addItem();
            item7.setLabel(Translator.getText("Tooltip_weapon_AmmoCount", new Object[0]) + ":", 1.0f, 1.0f, 0.8f, 1.0f);
        ...
        if (!(this instanceof HandWeapon) && this.getAmmoType() != null) {
            item7 = layout.addItem();
            item7.setLabel(Translator.getText("ContextMenu_AmmoType", new Object[0]) + ":", 1.0f, 1.0f, 0.8f, 1.0f);
            ...
            item7.setValue(Translator.getText(displayName, new Object[0]), 1.0f, 1.0f, 1.0f, 1.0f);
        }
        if (this.gunType != null) {
            item7 = layout.addItem();
            item7.setLabel(Translator.getText("ContextMenu_GunType", new Object[0]) + ":", 1.0f, 1.0f, 0.8f, 1.0f);
        ...
        if (Core.debug && DebugOptions.instance.tooltipInfo.getValue() || LuaManager.GlobalObject.isAdmin()) {
            ...
            String category = Translator.getText("Sandbox_" + this.getLootType() + "LootNew", new Object[0]);
        ...
        if (this instanceof DrainableComboItem && !this.hasTag(ItemTag.HIDE_REMAINING)) {
            item7 = layout.addItem();
            item7.setLabel(Translator.getText("IGUI_invpanel_Remaining", new Object[0]) + ": ", 1.0f, 1.0f, 0.8f, 1.0f);
        ...
        if (this instanceof Food && ((Food)this).isTainted() && SandboxOptions.instance.enableTaintedWaterText.getValue()) {
            item7 = layout.addItem();
            if (!this.hasMetal()) {
                item7.setLabel(Translator.getText("Tooltip_item_TaintedWater", new Object[0]), 1.0f, 0.5f, 0.5f, 1.0f);
            } else {
                item7.setLabel(Translator.getText("Tooltip_item_TaintedWater_Plastic", new Object[0]), 1.0f, 0.5f, 0.5f, 1.0f);
            }
        }
        if (!this.scriptItem.getForageFocusCategories().isEmpty()) {
            for (String categoryName : this.scriptItem.getForageFocusCategories()) {
                item7 = layout.addItem();
                item7.setLabel(Translator.getText("UI_search_mode_item_focus", new Object[0]) + ":", 1.0f, 1.0f, 0.8f, 1.0f);
                item7.setValue(Translator.getText("IGUI_SearchMode_Categories_" + categoryName, new Object[0]), 1.0f, 1.0f, 1.0f, 1.0f);
            }
        }
        if (this.getFatigueChange() != 0.0f) {
            item7 = layout.addItem();
            item7.setLabel(Translator.getText("Tooltip_item_Fatigue", new Object[0]) + ": ", 1.0f, 1.0f, 0.8f, 1.0f);
            if (this.getFatigueChange() < 0.0f) {
        ...
        if (this.getRemoteControlID() != -1) {
            item7 = layout.addItem();
            item7.setLabel(Translator.getText("Tooltip_TrapControllerID", new Object[0]), 1.0f, 1.0f, 0.8f, 1.0f);
            item7.setValue(Integer.toString(this.getRemoteControlID()), 1.0f, 1.0f, 0.8f, 1.0f);
        }
        if (this.getHaveBeenRepaired() > 0) {
            item7 = layout.addItem();
            item7.setLabel(Translator.getText("Tooltip_weapon_Repaired", new Object[0]) + ":", 1.0f, 1.0f, 0.8f, 1.0f);
            if (this.hasTimesHeadRepaired()) {
                item7.setLabel(Translator.getText("Tooltip_handle_Repaired", new Object[0]) + ":", 1.0f, 1.0f, 0.8f, 1.0f);
            }
            item7.setValue(this.getHaveBeenRepaired() + "x", 1.0f, 1.0f, 1.0f, 1.0f);
        }
        if (this.hasTimesHeadRepaired() && this.getTimesHeadRepaired() > 0) {
            item7 = layout.addItem();
            item7.setLabel(Translator.getText("Tooltip_head_Repaired", new Object[0]) + ":", 1.0f, 1.0f, 0.8f, 1.0f);
            item7.setValue(this.getTimesHeadRepaired() + "x", 1.0f, 1.0f, 1.0f, 1.0f);
        }
        if (this.isEquippedNoSprint()) {
            item7 = layout.addItem();
            item7.setLabel(Translator.getText("Tooltip_CantSprintEquipped", new Object[0]), 1.0f, 0.1f, 0.1f, 1.0f);
        }
        if (this.isWet()) {
            item7 = layout.addItem();
            item7.setLabel(Translator.getText("Tooltip_Wetness", new Object[0]) + ": ", 1.0f, 1.0f, 0.8f, 1.0f);
        ...
        if (this.getMaxCapacity() > 0) {
            item7 = layout.addItem();
            item7.setLabel(Translator.getText("Tooltip_container_Capacity", new Object[0]) + ":", 1.0f, 1.0f, 0.8f, 1.0f);
        ...
        if (!(this instanceof HandWeapon) && this.hasSharpness()) {
            ...
            ColorInfo g2Bgrad = new ColorInfo();
            item7 = layout.addItem();
            item7.setLabel(Translator.getText("Tooltip_weapon_Sharpness", new Object[0]) + ":", 1.0f, 1.0f, 0.8f, 1.0f);
        ...
        if (!(this instanceof HandWeapon || this instanceof Clothing || this.getConditionMax() <= 0 || this.getMechanicType() <= 0 && !this.hasTag(ItemTag.SHOW_CONDITION) && this.getConditionMax() <= this.getCondition())) {
            ...
            item7.setLabel(Translator.getText(text, new Object[0]) + ":", 1.0f, 1.0f, 0.8f, 1.0f);
        ...
        if (player != null && player.hasReadMap(this)) {
            item7 = layout.addItem();
            String label = Translator.getText("Tooltip_literature_HasBeenRead", new Object[0]);
        ...
        if (this.isRecordedMedia()) {
            ...
            if (data != null) {
                if (data.getTranslatedTitle() != null) {
                    item7 = layout.addItem();
                    item7.setLabel(Translator.getText("Tooltip_media_title", new Object[0]) + ":", 1.0f, 1.0f, 0.8f, 1.0f);
                ...
                if (data.getTranslatedAuthor() != null) {
                    item7 = layout.addItem();
                    item7.setLabel(Translator.getText("Tooltip_media_author", new Object[0]) + ":", 1.0f, 1.0f, 0.8f, 1.0f);
            ...
            if (tooltipUI.getCharacter() instanceof IsoPlayer && this.hasBeenSeen((IsoPlayer)tooltipUI.getCharacter())) {
                item7 = layout.addItem();
                String label = Translator.getText("ContextMenu_Watched", new Object[0]);
                item7.setLabel(label, 1.0f, 1.0f, 0.8f, 1.0f);
            }
            if (tooltipUI.getCharacter() instanceof IsoPlayer && this.hasBeenHeard((IsoPlayer)tooltipUI.getCharacter())) {
                item7 = layout.addItem();
                String label = Translator.getText("ContextMenu_Heard", new Object[0]);
                item7.setLabel(label, 1.0f, 1.0f, 0.8f, 1.0f);
            }
        }
        if (this.hasTag(ItemTag.COMPASS) && this.isInPlayerInventory()) {
            ...
            item7 = layout.addItem();
            item7.setLabel(Translator.getText(COMPASS_TOOLTIP.get((Object)dir), new Object[0]), 1.0f, 1.0f, 0.8f, 1.0f);
        }
        if (this.isFishingLure()) {
            item7 = layout.addItem();
            item7.setLabel(Translator.getText("Tooltip_IsFishingLure", new Object[0]), 1.0f, 1.0f, 0.8f, 1.0f);
        }
        ...
        if (this.getVisionModifier() != 1.0f) {
            item7 = layout.addItem();
            item7.setLabel(Translator.getText("Tooltip_item_VisionImpariment", new Object[0]) + ": ", 1.0f, 1.0f, 0.8f, 1.0f);
            if (this.getVisionModifier() < 1.0f) {
        ...
        if (this.getHearingModifier() != 1.0f) {
            item7 = layout.addItem();
            item7.setLabel(Translator.getText("Tooltip_item_HearingImpariment", new Object[0]) + ": ", 1.0f, 1.0f, 0.8f, 1.0f);
            if (this.getHearingModifier() < 1.0f) {
        ...
        if (this.getDiscomfortModifier() != 0.0f) {
            item7 = layout.addItem();
            item7.setLabel(Translator.getText("Tooltip_item_Discomfort", new Object[0]) + ": ", 1.0f, 1.0f, 0.8f, 1.0f);
            if (this.getDiscomfortModifier() > 0.0f) {
        ...
        if (this.getTooltip() != null) {
            item7 = layout.addItem();
            item7.setLabel(Translator.getText(this.getTooltip(), new Object[0]), 1.0f, 1.0f, 0.8f, 1.0f);
        }
        if (layoutOverride == null) {
    ...
    private boolean shouldUpdateInRain() {
        ...
        boolean validFood = inventoryItem instanceof Food && !(food = (Food)inventoryItem).isTainted();
    ...
    private void handleWorldItemInRain() {
        if (GameClient.client || this.getWorldItem() == null || !RainManager.isRaining().booleanValue()) {
            return;
        }
    ...
    public void update() {
        ...
        if (this.isWet()) {
            this.wetCooldown -= 1.0f * this.timeMultiplier;
            if (this.wetCooldown <= 0.0f) {
                ...
                if (worldItem != null) {
                    worldItem.swapItem((InventoryItem)dryItem);
                } else if (container != null) {
                    container.addItem((InventoryItem)dryItem);
        ...
        if (this.hasComponent(ComponentType.FluidContainer)) {
            ...
            if (outermostContainer != null) {
                ...
                if (temp == 1.0f && this.itemHeat < 1.0f) {
                    this.itemHeat += tempChange * this.timeMultiplier;
                ...
                if (this.itemHeat < temp && (this.hasTag(ItemTag.COOKABLE) || this.hasTag(ItemTag.COOKABLE_MICROWAVE) && outermostContainer.getType().equals("microwave"))) {
                    this.itemHeat += temp / (float)(GameServer.server ? 16 : 1000) * this.timeMultiplier;
        ...
        if ((this.container == null || this.getWorldItem() != null) && this.itemHeat != 1.0f) {
            ...
            if (this.itemHeat > 1.0f) {
                this.itemHeat -= 0.001f * this.timeMultiplier;
                if (this.itemHeat < 1.0f) {
                    this.itemHeat = 1.0f;
                }
            }
    ...
    public InventoryItem createCloneItem() {
        if (Core.getInstance().getDebug()) {
            ...
            try {
                ...
                tempBuffer.getShort();
                tempBuffer.get();
                ((InventoryItem)newItem).load(tempBuffer, 249);
    ...
    public ClothingItem getClothingItem() {
        ...
        if ("WithoutDrainable".equalsIgnoreCase(alternateModelName1) && (withoutDrainableItem = ScriptManager.instance.getItem(this.getWithoutDrainable())) != null && withoutDrainableItem.getClothingItemAsset() != null) {
    ...
    public String getName(IsoPlayer player) {
        ...
        if (this.getMechanicType() > 0) {
            fakeName = Translator.getText("IGUI_ItemNameMechanicalType", fakeName, Translator.getText("IGUI_VehicleType_" + this.getMechanicType(), new Object[0]));
        }
        Object prefix = "";
        if (this.isBloody()) {
            prefix = (String)prefix + Translator.getText("IGUI_ClothingName_Bloody", new Object[0]) + ", ";
        }
        if (this.isBroken()) {
            prefix = (String)prefix + Translator.getText("Tooltip_broken", new Object[0]) + ", ";
        } else if ((float)this.getCondition() < (float)this.getConditionMax() / 3.0f) {
            prefix = (String)prefix + Translator.getText("IGUI_Name_Worn", new Object[0]) + ", ";
        }
        if (!this.isBroken() && this.hasSharpness() && this.getSharpness() < 0.33333334f) {
            prefix = this.getSharpness() <= 0.0f ? (String)prefix + Translator.getText("Tooltip_blunt", new Object[0]) + ", " : (String)prefix + Translator.getText("Tooltip_dull", new Object[0]) + ", ";
        }
        ...
        if (this.canBeActivated() && this.isActivated()) {
            prefix = (String)prefix + Translator.getText("Tooltip_activated", new Object[0]) + ", ";
        }
    ...
    public boolean isWaterOnlySource() {
        return this.hasComponent(ComponentType.FluidContainer) && this.getFluidContainer().isWaterOnlySource() && !this.getFluidContainer().isMultiTileMoveable();
    }
    ...
    public float getContentsWeight() {
        Item scriptAmmo;
        if (this.ammoType != null && (scriptAmmo = ScriptManager.instance.FindItem(this.ammoType.getItemKey())) != null) {
    ...
    public void syncItemFields() {
        ...
        if (GameServer.server && this.getWorldItem() != null) {
            ...
            INetworkPacket.sendToRelative(PacketTypes.PacketType.ItemStats, this.getWorldItem().getSquare().x, (float)this.getWorldItem().getSquare().y, container, this);
        }
    }
    ...
    public void nameAfterDescriptor(SurvivorDesc desc) {
        ...
        name = Translator.getText(name, new Object[0]);
