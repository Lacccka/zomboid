...
public final class ErosionSeason {
    ...
    String[] namesTranslated = new String[]{Translator.getText("IGUI_Season_Default", new Object[0]), Translator.getText("IGUI_Season_Spring", new Object[0]), Translator.getText("IGUI_Season_SummerE", new Object[0]), Translator.getText("IGUI_Season_SummerL", new Object[0]), Translator.getText("IGUI_Season_Autumn", new Object[0]), Translator.getText("IGUI_Season_Winter", new Object[0])};
