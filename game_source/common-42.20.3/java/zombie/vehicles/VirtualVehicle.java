...
IVehicleAlarmListener {
    ...
    public void save() {
        ...
        VirtualVehicle.fakeChunk.wx = PZMath.coorddivision(this.getXi(), 8);
        VirtualVehicle.fakeChunk.wy = PZMath.coorddivision(this.getYi(), 8);
    ...
    public boolean isEngineSounding() {
        ...
        boolean bl = isStartingWithCombinedSound = this.getEngineState() == BaseVehicle.engineStateTypes.StartingSuccess && this.getVehicleSounds().isCombinedWithEngineSound(this.getVehicleSounds().getEngineStartSound());
