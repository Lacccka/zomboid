...
public class VehiclePedestrianContactTracking {
    private final Set<IsoGameCharacter> hitsThisFrame = new HashSet<IsoGameCharacter>();
    private final Set<IsoGameCharacter> hitsCausingDamage = new HashSet<IsoGameCharacter>();
    private final Set<VehiclePedestrianContact> oldContacts = new HashSet<VehiclePedestrianContact>();
    private final Set<VehiclePedestrianContact> persistentContacts = new HashSet<VehiclePedestrianContact>();
    ...
    private void populateHitsCausingDamage(BaseVehicle vehicle) {
        ...
        for (IsoGameCharacter hitChar : this.hitsThisFrame) {
            ...
            if (this.isPersistentContact(hitChar)) {
