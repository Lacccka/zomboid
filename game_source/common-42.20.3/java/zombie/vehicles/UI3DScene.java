...
extends UIElement {
    ...
    private static final ObjectPool<SetModelCamera> s_SetModelCameraPool = new ObjectPool<SetModelCamera>(SetModelCamera::new, "UI3DScene.s_SetModelCameraPool");
    ...
    static {
        s_posRotPool = new ObjectPool<PositionRotation>(PositionRotation::new, "UI3DScene.s_posRotPool");
        s_aabbPool = new ObjectPool<AABB>(AABB::new, "UI3DScene.s_aabbPool");
        s_box3DPool = new ObjectPool<Box3D>(Box3D::new, "UI3DScene.s_box3DPool");
        s_physicsMeshPool = new ObjectPool<PhysicsMesh>(PhysicsMesh::new, "UI3DScene.s_physicsMeshPool");
    ...
    private static class SceneObjectRenderData {
        ...
        private static final ObjectPool<SceneObjectRenderData> s_pool = new ObjectPool<SceneObjectRenderData>(SceneObjectRenderData::new, "SceneObjectRenderData.s_pool");
    ...
    extends ObjectPool<Plane> {
        ...
        public PlaneObjectPool() {
            super(Plane::new, Plane.class.getSimpleName());
        }
    ...
    extends ObjectPool<Ray> {
        ...
        public RayObjectPool() {
            super(Ray::new, Ray.class.getSimpleName());
        }
    ...
    private static class VehicleModelRenderData {
        ...
        private static final ObjectPool<VehicleModelRenderData> s_pool = new ObjectPool<VehicleModelRenderData>(VehicleModelRenderData::new, "VehicleModelRenderData.s_pool");
    ...
    extends SceneObjectRenderData {
        ...
        private static final ObjectPool<VehicleRenderData> s_pool = new ObjectPool<VehicleRenderData>(VehicleRenderData::new, "VehicleRenderData.s_pool");
    ...
    extends SceneObjectRenderData {
        ...
        private static final ObjectPool<ModelRenderData> s_pool = new ObjectPool<ModelRenderData>(ModelRenderData::new, "ModelRenderData.s_pool");
    ...
    extends SceneObjectRenderData {
        ...
        private static final ObjectPool<CharacterRenderData> s_pool = new ObjectPool<CharacterRenderData>(CharacterRenderData::new, "CharacterRenderData.s_pool");
    ...
    extends SceneObjectRenderData {
        ...
        private static final ObjectPool<ScenePolygonRenderData> s_pool = new ObjectPool<ScenePolygonRenderData>(ScenePolygonRenderData::new, "ScenePolygonRenderData.s_pool");
    ...
    extends TextureDraw.GenericDrawer {
        ...
        int slices = 32;
        int stacks = 2;
        private static final ObjectPool<SceneCylinderDrawer> s_pool = new ObjectPool<SceneCylinderDrawer>(SceneCylinderDrawer::new, "SceneCylinderDrawer.s_pool");
    ...
    private static final class SceneVehicleModelInfo {
        ...
        private static final ObjectPool<SceneVehicleModelInfo> s_pool = new ObjectPool<SceneVehicleModelInfo>(SceneVehicleModelInfo::new, "SceneVehicleModelInfo.s_pool");
