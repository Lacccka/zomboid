...
public class XuiSkin {
    ...
    private void LoadDefaultStyle(String luaClassName, XuiSkinScript.StyleInfoScript script) throws Exception {
        ...
        for (Map.Entry kv : map.entrySet()) {
            ...
            DebugType.General.warn("Cannot load key = " + (String)kv.getKey() + ", val = " + (String)kv.getValue() + " for class = " + luaClassName);
            assert (false);
        }
    }
    ...
    public static class EntityUiStyle {
        ...
        public String getDisplayName() {
            return Translator.getText(this.displayName, new Object[0]);
        }

        public String getDescription() {
            return Translator.getText(this.description, new Object[0]);
        }

        public String getBuildDescription() {
            return Translator.getText(this.buildDescription, new Object[0]);
        }
