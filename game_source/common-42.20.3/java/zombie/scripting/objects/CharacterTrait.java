...
public class CharacterTrait {
    ...
    public static final CharacterTrait HERBALIST_PROF = CharacterTrait.registerBase("Herbalist_Prof");
    ...
    public static final CharacterTrait INVENTIVE_PROF = CharacterTrait.registerBase("Inventive_prof");
    ...
    public static final CharacterTrait TARGET_SHOOTER = CharacterTrait.registerBase("target_shooter");
    ...
    public static final CharacterTrait TINKERER = CharacterTrait.registerBase("tinkerer");
