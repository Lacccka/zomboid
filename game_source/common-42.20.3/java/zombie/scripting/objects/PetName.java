...
public class PetName {
    ...
    public static final PetName FRAIDY = PetName.registerBase("Fraidy");
    ...
    public static final PetName LITTLEGRAY = PetName.registerBase("LittleGray");
    ...
    public static final PetName MR_CHEESE = PetName.registerBase("MrCheese");
    ...
    public static final PetName PAULY = PetName.registerBase("Pauly");
