...
extends BaseScriptObject {
    ...
    public void Load(String name, String body) throws Exception {
        ...
        for (ScriptParser.Value value : block.values) {
            ...
            if (key.equalsIgnoreCase("faceObject")) {
                this.faceObject = Boolean.parseBoolean(val);
                continue;
            }
            if (key.equalsIgnoreCase("cantSit")) {
                this.cantSit = Boolean.parseBoolean(val);
                continue;
            }
            if (key.equalsIgnoreCase("prop1")) {
                this.prop1 = val;
                continue;
            }
            if (key.equalsIgnoreCase("prop2")) {
                this.prop2 = val;
                continue;
            }
            if (key.equalsIgnoreCase("actionAnim")) {
                this.actionAnim = val;
                continue;
            }
            if (key.equalsIgnoreCase("animVarKey")) {
                this.animVarKey = val;
                continue;
            }
            if (key.equalsIgnoreCase("animVarVal")) {
                this.animVarVal = val;
                continue;
            }
            ...
            if (key.equalsIgnoreCase("soundTime")) {
            ...
            if (key.equalsIgnoreCase("muscleStrainFactor")) {
                this.muscleStrainFactor = Float.parseFloat(val);
                continue;
            }
            if (key.equalsIgnoreCase("muscleStrainSkill")) {
            ...
            if (!key.equalsIgnoreCase("muscleStrainParts")) continue;
    ...
    public void applyMuscleStrain(IsoGameCharacter player) {
        ...
        if (this.muscleStrainSkill != null) {
            ...
            strain *= (float)(1.0 - (double)skillLvl * 0.5);
        }
