...
public class Registries {
    ...
    public static final Registry<GameMode> GAME_MODE = Registries.register("game_mode", () -> GameMode.APOCALYPSE);
    ...
    public static final Registry<SurvivalGuideEntry> SURVIVAL_GUIDE_ENTRY = Registries.register("survival_guide_entry", () -> SurvivalGuideEntry.MOVEMENT);
    public static final Registry<WeaponCategory> WEAPON_CATEGORY = Registries.register("weapon_category", () -> WeaponCategory.BLUNT);
    public static final Registry<ContainerType> CONTAINER_TYPE = Registries.register("container_type", () -> ContainerType.BARBECUE);
