...
extends ComponentScript {
    ...
    protected void load(ScriptParser.Block block) throws Exception {
        ...
        for (ScriptParser.Block child : block.children) {
            ...
            for (ScriptParser.Value value : block.values) {
                ...
                if (k.equalsIgnoreCase("isProp")) {
                    this.isProp = Boolean.parseBoolean(v);
                    continue;
                }
                if (k.equalsIgnoreCase("skillBaseHealth")) {
                    this.skillBaseHealth = PZMath.tryParseInt(v, 0);
                    continue;
                }
                if (k.equalsIgnoreCase("lightRadius")) {
                    this.lightRadius = PZMath.tryParseInt(v, 10);
                    continue;
                }
                if (k.equalsIgnoreCase("lightsourceItem")) {
                    if (v.contains("tags")) {
                ...
                if (k.equalsIgnoreCase("lightsourceFuel")) {
                    this.lightsourceFuel = v;
                    continue;
                }
                if (k.equalsIgnoreCase("debugItem")) {
                    this.debugItem = v;
                    continue;
                }
                if (k.equalsIgnoreCase("OnCreate")) {
                    this.onCreate = v;
                    continue;
                }
                if (k.equalsIgnoreCase("OnIsValid")) {
                    this.onIsValid = v;
                    continue;
                }
                if (k.equalsIgnoreCase("TimedActionOnIsValid")) {
                    this.timedActionOnIsValid = v;
                    continue;
                }
                if (k.equalsIgnoreCase("isThumpable")) {
                    this.isThumpable = v.equalsIgnoreCase("true");
                    continue;
                }
                if (k.equalsIgnoreCase("breakSound")) {
                    this.breakSound = v;
                    continue;
                }
                if (k.equalsIgnoreCase("corner")) {
                    this.cornerSprite = v;
                    continue;
                }
                if (k.equalsIgnoreCase("dontNeedFrame")) {
                    this.dontNeedFrame = v.equalsIgnoreCase("true");
                    continue;
                }
                if (k.equalsIgnoreCase("needWindowFrame")) {
                    this.needWindowFrame = v.equalsIgnoreCase("true");
                    continue;
                }
                if (k.equalsIgnoreCase("isPole")) {
                    this.isPole = v.equalsIgnoreCase("true");
                    continue;
                }
                if (k.equalsIgnoreCase("needToBeAgainstWall")) {
                    this.needToBeAgainstWall = Boolean.parseBoolean(v);
                    continue;
                }
                if (k.equalsIgnoreCase("canBePadlocked")) {
                    this.canBePadlocked = Boolean.parseBoolean(v);
                    continue;
                }
                if (k.equalsIgnoreCase("previousStage")) {
                ...
                if (!k.equalsIgnoreCase("bonusHealth")) continue;
    ...
    private void checkScripts() {
        if (this.isSingleFace) {
            for (int i = 0; i < 6; ++i) {
                FaceScript faceScript = this.faces[i];
        ...
        int faceCount = 0;
        for (FaceScript faceScript : this.faces) {
            ...
            for (ZLayer layer : faceScript.layers) {
                ...
                for (XRow row : layer.rows) {
                    ...
                    for (TileScript tileScript : row.tiles) {
                        if (tileScript.tileName == null) continue;
        ...
        for (FaceScript faceScript : this.faces) {
            ...
            if (complementaryFace == -1 || this.getFace(complementaryFace) == null || faceScript.totalWidth == this.getFace((int)complementaryFace).totalWidth && faceScript.totalHeight == this.getFace((int)complementaryFace).totalHeight) continue;
    ...
    private void loadFace(FaceScript faceScript, ScriptParser.Block block) {
        ...
        for (ScriptParser.BlockElement element : block.elements) {
            ...
            if (!k.equalsIgnoreCase("lightOffsetZ")) continue;
