...
extends RecipeCodeHelper {
    ...
    public static void onCreateStockCertificate(Literature item) {
        ...
        if (Rand.NextBool(2)) {
            text = Translator.getText("IGUI_ItemWithDisplayNameNoQuote", displayName, Translator.getText(Rand.Next(ItemGenerationConstants.STOCK_CERTIFICATE_2).getTranslation(), new Object[0]));
            item.setTexture(Texture.getSharedTexture("Item_StockCertificate2"));
            item.setWorldStaticModel(ModelKey.STOCK_CERTIFICATE_2);
        } else {
            text = Translator.getText("IGUI_ItemWithDisplayNameNoQuote", displayName, Translator.getText(Rand.Next(ItemGenerationConstants.STOCK_CERTIFICATE_1).getTranslation(), new Object[0]));
        }
        item.setName(text);
    ...
    public static void onCreateDogTagPet(InventoryItem item) {
        ...
        String dogTagName = Translator.getText("IGUI_ItemWithDisplayName", item.getDisplayName(), Translator.getText(petName, new Object[0]));
    ...
    public static void onCreatePhoto(InventoryItem item) {
        ItemCodeOnCreate.onCreatePhoto(item, "OldPhoto", Rand.Next(ItemGenerationConstants.PHOTOS).getTranslationKey());
    }
    ...
    private static void onCreatePhoto(InventoryItem item, String type, String translationKey) {
        String title = Translator.getText("IGUI_PhotoOf", item.getDisplayName(), Translator.getText(translationKey, new Object[0]));
    ...
    public static void onCreateHottieZ(InventoryItem item) {
        ...
        if (hunkZ) {
            ...
            name = Translator.getText("IGUI_MagazineTitle_HunkZ", new Object[0]);
        }
    ...
    private static void setMagazineName(InventoryItem item, String type, String name, RecipeCodeHelper.DateResult dateResult) {
        String title = Translator.getText("IGUI_MagazineName", name, Translator.getText("Sandbox_StartMonth_option" + dateResult.month(), new Object[0]), dateResult.year());
    ...
    public static void onCreateOldNewspaper(InventoryItem item) {
        ...
        String title = Translator.getText("IGUI_Newspaper_Name", item.getDisplayName(), Translator.getText(paper.getTranslationKey(), new Object[0]));
    ...
    private static void setFlierName(String mediaId, String mediaTitle, String mediaInfo, String printText, InventoryItem item) {
        String title = Translator.getText("IGUI_Newspaper_Name", item.getDisplayName(), Translator.getText(mediaTitle, new Object[0]));
    ...
    private static void nameComicBook(InventoryItem item, ComicBook comicBook) {
        ...
        if (issues == 0) {
            item.setName(Translator.getText("IGUI_MagazineNameNoIssue", item.getDisplayName(), Translator.getText(translationKey, new Object[0])));
        ...
        item.setName(Translator.getText("IGUI_MagazineName", item.getDisplayName(), Translator.getText(translationKey, new Object[0]), issueName));
    }
    ...
    public static void onCreateSubjectBook(InventoryItem item) {
        ...
        item.setName(Translator.getText("IGUI_MagazineNameNoIssue", item.getDisplayName(), Translator.getText(book.translationKey(), new Object[0])));
    ...
    public static void onCreateSubjectMagazine(InventoryItem item) {
        ...
        ItemCodeOnCreate.setMagazineName(item, magazine.translationKey(), Translator.getText(magazine.translationKey(), new Object[0]), ItemCodeOnCreate.getDate(item, item.hasTag(ItemTag.NEW) ? 1993 : 1970));
    }

    public static void onCreateBusinessCard(InventoryItem item) {
        ItemCodeOnCreate.setBusinessCardName(item, Translator.getText(Rand.Next(Registries.JOB.values()).translationKey(), new Object[0]));
    }

    public static void onCreateBusinessCardNolan(InventoryItem item) {
        ItemCodeOnCreate.setBusinessCardName(item, Translator.getText(Flier.NOLANS_USED_CARS.getTranslationKey(), new Object[0]));
    }
    ...
    public static void onCreateGenericMail(InventoryItem item) {
        item.setName(Translator.getText(ItemGenerationConstants.GENERIC_MAIL.getRandom().getTranslationKey(), new Object[0]));
    }

    public static void onCreateLetterHandwritten(InventoryItem item) {
        item.setName(Translator.getText(ItemGenerationConstants.LETTER_HANDWRITTEN.getRandom().getTranslationKey(), new Object[0]));
    }
    ...
    public static void onCreateLocket(InventoryItem item) {
        ...
        item.setName(Translator.getText("IGUI_LocketText", item.getDisplayName(), Translator.getText(translationKey, new Object[0])));
    ...
    public static void onCreatePostcard(InventoryItem item) {
        ItemCodeOnCreate.onCreatePhoto(item, "Postcard", Rand.Next(Registries.POSTCARD.values()).getTranslationKey());
    }
    ...
    public static void onCreateSnowGlobe(InventoryItem item) {
        ...
        String title = Translator.getText("IGUI_SnowGlobeOf", item.getDisplayName(), Translator.getText(translationKey, new Object[0]));
        item.setName(title);
    ...
    public static void onCreateCookwareSchematic(Literature item) {
        ItemCodeOnCreate.setSchematicLearnedRecipes(item, ItemGenerationConstants.COOKWARE_SCHEMATIC, 40);
    }
    ...
    public static void onCreateGasMask(Clothing item) {
        if (item.hasTag(ItemTag.GAS_MASK)) {
            ...
            ItemCodeOnCreate.createFilterForMask(item, ItemKey.Drainable.RAG_FILTER.id(), "filterType");
