...
public enum CharacterJoypadButtonBinding {
    ...
    private final IsDownBinding defaultBinding;
    private IsDownBinding binding;
    private static final CharacterJoypadButtonBinding[] values;
    ...
    private CharacterJoypadButtonBinding(JoypadButton buttonBinding) {
        this.defaultBinding = new JoypadButtonBinding(buttonBinding);
        this.setDefault();
    }

    private CharacterJoypadButtonBinding(JoypadAxis1d axis1d, float min, float max) {
        this.defaultBinding = new Axis1dMinMaxBinding(axis1d, min, max);
        this.setDefault();
    }

    private CharacterJoypadButtonBinding(JoypadAxis1d axis1d, float min) {
        this.defaultBinding = new Axis1dMinMaxBinding(axis1d, min, Float.MAX_VALUE);
        this.setDefault();
    }

    private CharacterJoypadButtonBinding(JoypadAxis2d axis2d, float min, float max) {
        this.defaultBinding = new Axis2dMinMaxBinding(axis2d, min, max);
        this.setDefault();
    }

    private CharacterJoypadButtonBinding(JoypadAxis2d axis2d, float min) {
        this.defaultBinding = new Axis2dMinMaxBinding(axis2d, min, Float.MAX_VALUE);
        this.setDefault();
    }
    ...
    public static CharacterJoypadButtonBinding findBinding(JoypadButton joypadButton) {
        return PZArrayUtil.find(CharacterJoypadButtonBinding.allBindings(), joypadButton, (binding, button) -> binding.getJoypadButton() == button);
    }

    @UsedFromLua
    public static CharacterJoypadButtonBinding[] findBindings(JoypadButton joypadButton) {
        return PZArrayUtil.filtered(CharacterJoypadButtonBinding.allBindings(), joypadButton, (binding, button) -> binding.getJoypadButton() == button);
    }

    @UsedFromLua
    public static CharacterJoypadButtonBinding[] findBindings(JoypadAxis1d joypadAxis) {
        return PZArrayUtil.filtered(CharacterJoypadButtonBinding.allBindings(), joypadAxis, (binding, axis) -> binding.getJoypadAxis1d() == axis);
    }

    @UsedFromLua
    public static CharacterJoypadButtonBinding[] findBindings(JoypadAxis2d joypadAxis) {
        return PZArrayUtil.filtered(CharacterJoypadButtonBinding.allBindings(), joypadAxis, (binding, axis) -> binding.getJoypadAxis2d() == axis);
    }
    ...
    public IsDownBinding getBinding() {
        return this.binding;
    }
    ...
    public void setBinding(JoypadButton newBinding) {
        this.binding = new JoypadButtonBinding(newBinding);
    }

    public void setBinding(JoypadAxis1d axis1d, float min, float max) {
        this.binding = new Axis1dMinMaxBinding(axis1d, min, max);
    }

    public void setBinding(JoypadAxis1d axis1d, float min) {
        this.binding = new Axis1dMinMaxBinding(axis1d, min, Float.MAX_VALUE);
    }

    public void setBinding(JoypadAxis2d axis2d, float min, float max) {
        this.binding = new Axis2dMinMaxBinding(axis2d, min, max);
    }

    public void setBinding(JoypadAxis2d axis2d, float min) {
        this.binding = new Axis2dMinMaxBinding(axis2d, min, Float.MAX_VALUE);
    }
    ...
    public static void setAllToDefault() {
        for (CharacterJoypadButtonBinding binding : CharacterJoypadButtonBinding.allBindings()) {
            binding.setDefault();
        }
    }
    ...
    static {
        values = CharacterJoypadButtonBinding.values();
    }

    public static interface IsDownBinding {
        public boolean isDown(int var1);

        default public JoypadButton getButton() {
            return null;
        }

        default public JoypadAxis1d getAxis1d() {
            return null;
        }

        default public JoypadAxis2d getAxis2d() {
            return null;
        }
        ...
        default public float getMax() {
            return 0.0f;
        }
    }

    public static class JoypadButtonBinding
    implements IsDownBinding {
    ...
    public static class Axis1dMinMaxBinding
    implements IsDownBinding {
    ...
    public static class Axis2dMinMaxBinding
    implements IsDownBinding {
