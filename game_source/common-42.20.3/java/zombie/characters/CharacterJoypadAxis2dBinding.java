...
public enum CharacterJoypadAxis2dBinding {
    ...
    private static final CharacterJoypadAxis2dBinding[] values;

    private CharacterJoypadAxis2dBinding(JoypadAxis2d axisBinding) {
    ...
    public static void setAllToDefault() {
        for (CharacterJoypadAxis2dBinding binding : CharacterJoypadAxis2dBinding.allBindings()) {
            binding.setDefault();
        }
    }
    ...
    public static CharacterJoypadAxis2dBinding[] findBindings(JoypadAxis2d joypadAxis) {
        return PZArrayUtil.filtered(CharacterJoypadAxis2dBinding.allBindings(), joypadAxis, (binding, axis) -> binding.getJoypadAxis() == axis);
    }

    static {
        values = CharacterJoypadAxis2dBinding.values();
    }
}
