...
public final class SurvivorFactory {
    ...
    public static void addSurname(String surName) {
        Surnames.add(Translator.getText("SurvivorSurname_" + surName, new Object[0]));
    }

    public static void addFemaleForename(String forename) {
        FemaleForenames.add(Translator.getText("SurvivorName_" + forename, new Object[0]));
    }

    public static void addMaleForename(String forename) {
        MaleForenames.add(Translator.getText("SurvivorName_" + forename, new Object[0]));
    }
