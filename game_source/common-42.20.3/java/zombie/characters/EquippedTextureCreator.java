...
extends TextureDraw.GenericDrawer {
    ...
    private static final ObjectPool<EquippedTextureCreator> pool = new ObjectPool<EquippedTextureCreator>(EquippedTextureCreator::new, "EquippedTextureCreator.pool");
