...
implements IListBoxItem {
    public static Map<CharacterProfession, CharacterProfessionDefinition> characterProfessionDefinitions = new LinkedHashMap<CharacterProfession, CharacterProfessionDefinition>();
    ...
    public CharacterProfessionDefinition(CharacterProfession characterProfessionType, String name, int cost, String description, String iconPathName) {
        ...
        this.displayName = Translator.getText(name, new Object[0]);
        this.cost = cost;
        if (description != null && !description.isEmpty()) {
            this.description = Translator.getText(description, new Object[0]);
        }
    ...
    public static ArrayList<CharacterProfessionDefinition> getProfessions() {
        return new ArrayList<CharacterProfessionDefinition>(characterProfessionDefinitions.values());
    }
