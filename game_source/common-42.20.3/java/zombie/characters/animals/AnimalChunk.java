...
public final class AnimalChunk {
    ...
    static final ObjectPool<AnimalChunk> pool = new ObjectPool<AnimalChunk>(AnimalChunk::new, "AnimalChunk.pool");
    ...
    boolean isEmpty() {
        return this.animals.isEmpty() && this.animalTracks.isEmpty();
    }

    static void saveEmpty(ByteBuffer output) {
