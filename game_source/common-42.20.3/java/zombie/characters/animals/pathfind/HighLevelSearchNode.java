...
import zombie.characters.animals.pathfind.HighLevelAStar;
import zombie.characters.animals.pathfind.Mesh;
import zombie.popman.ObjectPool;

public final class HighLevelSearchNode
extends ASearchNode {
    static int nextID = 1;
    Integer id = nextID++;
    ...
    Mesh mesh;
    static final ObjectPool<HighLevelSearchNode> pool = new ObjectPool<HighLevelSearchNode>(HighLevelSearchNode::new, "HighLevelSearchNode.pool");
