...
public class AnimalTracks {
    ...
    public static AnimalTracks addAnimalTrack(VirtualAnimal animal, AnimalTracksDefinitions.AnimalTracksType trackType) {
        ...
        AnimalTracks.broadcastAnimalTrackToAdminsDebug(track, true);
        return track;
    }
    ...
    public static void broadcastAnimalTrackToAdminsDebug(AnimalTracks track, boolean state) {
        if (GameServer.server) {
            for (IsoPlayer player : GameServer.IDToPlayerMap.values()) {
                if (player == null || !player.getRole().hasCapability(Capability.AnimalCheats)) continue;
    ...
    public static String getTrackStr(String trackType) {
        return Translator.getText("IGUI_AnimalTracks_" + trackType, new Object[0]);
    }
    ...
    public ArrayList<IsoAnimalTrack> addToWorld() {
        ...
        if (this.dir != null) {
            ...
            String sprite;
            IsoGridSquare sq = IsoWorld.instance.currentCell.getGridSquare(this.x, this.y, 0);
            if (sq != null && (sprite = this.getTrackSprite()) != null) {
                result.add(new IsoAnimalTrack(sq, sprite, this));
            }
        }
        return result;
    ...
    public String getFreshnessString(int trackingLevel) {
        ...
        if (trackingLevel > 6) {
            if (hour < 12) {
                return Translator.getText("IGUI_AnimalTracks_Time_12Hours", new Object[0]);
            }
            if (hour < 24) {
                return Translator.getText("IGUI_AnimalTracks_Time_24Hours", new Object[0]);
            }
            if (hour < 48) {
                return Translator.getText("IGUI_AnimalTracks_Time_2Days", new Object[0]);
            }
            if (hour < 72) {
                return Translator.getText("IGUI_AnimalTracks_Time_3Days", new Object[0]);
            }
            if (hour < 96) {
                return Translator.getText("IGUI_AnimalTracks_Time_4Days", new Object[0]);
            }
            return Translator.getText("IGUI_AnimalTracks_Time_5Days", new Object[0]);
        }
        if (trackingLevel > 3) {
            if (hour < 24) {
                return Translator.getText("IGUI_AnimalTracks_Time_VeryRecent", new Object[0]);
            }
            if (hour < 48) {
                return Translator.getText("IGUI_AnimalTracks_Time_Recent", new Object[0]);
            }
            if (hour < 72) {
                return Translator.getText("IGUI_AnimalTracks_Time_SomeDays", new Object[0]);
            }
            return Translator.getText("IGUI_AnimalTracks_Time_Old", new Object[0]);
        }
        if (hour < 24) {
            return Translator.getText("IGUI_AnimalTracks_Time_Recent", new Object[0]);
        }
