...
import zombie.vehicleSound.AlarmSound;
import zombie.vehicleSound.BackupBeeperSound;
import zombie.vehicleSound.DoorAlarmSound;
import zombie.vehicleSound.EngineSound;
import zombie.vehicleSound.HornSound;
import zombie.vehicleSound.SirenSound;
...
import zombie.vehicleSound.parameters.ParameterVehicleRoadMaterial;
...
IFMODParameterUpdater {
    ...
    public FMODParameterList getFMODParameters() {
        if (this.fmodParameters.parameterList.isEmpty()) {
            ...
            this.fmodParameters.add(new ParameterVehicleRoadMaterial(this));
    ...
    public void startEvent(long eventInstance, GameSoundClip clip, boolean remote, BitSet parameterSet) {
        ...
        for (int i = 0; i < eventParameters.size(); ++i) {
            ...
            FMOD_STUDIO_PARAMETER_DESCRIPTION eventParameter = (FMOD_STUDIO_PARAMETER_DESCRIPTION)eventParameters.get(i);
