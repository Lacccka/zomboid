    ...
    public static void init() {
        ...
        try {
            ...
            for (String info : split = buffer.toString().split("<br>")) {
                ...
                DebugType.DetailedInfo.trace("The IP address (" + GameServer.ip + ") looks like the IPv6 address. Please make sure IPv4 server address is set to the " + ServerOptions.getInstance().serverBrowserAnnouncedIp.getName() + " server option.");
            }
        }
