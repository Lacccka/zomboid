...
public final class UIManager {
    ...
    private static final IsoObjectPicker.ClickObject pickedCopy;
    ...
    public static Vector2 getTileFromMouse(double mx, double my, double z) {
        ...
        UIManager.PickedTile.x = IsoUtils.XToIso(0, (float)(mx - 0.0), (float)(my - 0.0), (float)z);
        UIManager.PickedTile.y = IsoUtils.YToIso(0, (float)(mx - 0.0), (float)(my - 0.0), (float)z);
    ...
    static {
        pickedCopy = new IsoObjectPicker.ClickObject();
        UI = new ArrayList();
