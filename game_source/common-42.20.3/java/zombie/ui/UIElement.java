...
implements UIElementInterface {
    ...
    private void invokeOnScrollPosChanged() {
        if (UIManager.tableget(this.table, "onScrollPosChanged") != null) {
            LuaManager.caller.protectedCallVoid(UIManager.getDefaultThread(), UIManager.tableget(this.table, "onScrollPosChanged"), this.table, this.getXScroll(), this.getYScroll());
        }
    }
    ...
    public void DrawText(UIFont font, String text, double x, double y, double zoom, double r, double g, double b, double alpha) {
        TextManager.instance.DrawString(font, x + this.getAbsoluteX() + this.xScroll, y + this.getAbsoluteY() + this.yScroll, (float)zoom, text, r, g, b, alpha);
    }
    ...
    public void DrawTextUntrimmed(UIFont font, String text, double x, double y, double r, double g, double b, double alpha) {
        ...
        TextManager.instance.DrawStringUntrimmed(font, x + this.getAbsoluteX() + this.xScroll, y + this.getAbsoluteY() + this.yScroll, text, r, g, b, alpha);
    }
    ...
    public void drawTextWithBackground(UIFont font, String text, double x, double y, double r, double g, double b, double a, double padX, double padY, double bgR, double bgG, double bgB, double bgA) {
        ...
        this.DrawTextureScaledColor(null, x - padX, y - padY, (double)textWidth + padX * 2.0, (double)fontHgt + padY * 2.0, bgR, bgG, bgB, bgA);
    ...
    public void DrawTextureAngle(Texture tex, double centerX, double centerY, double angle, double r, double g, double b, double a) {
        ...
        double x4 = xCos + ySin;
        double y4 = -yCos + xSin;
        SpriteRenderer.instance.render(tex, x1 += this.getAbsoluteX() + centerX, y1 += this.getAbsoluteY() + centerY, x2 += this.getAbsoluteX() + centerX, y2 += this.getAbsoluteY() + centerY, x3 += this.getAbsoluteX() + centerX, y3 += this.getAbsoluteY() + centerY, x4 += this.getAbsoluteX() + centerX, y4 += this.getAbsoluteY() + centerY, (float)r, (float)g, (float)b, (float)a, (float)r, (float)g, (float)b, (float)a, (float)r, (float)g, (float)b, (float)a, (float)r, (float)g, (float)b, (float)a, null);
    }
    ...
    public void DrawTexture(Texture tex, double tlx, double tly, double trx, double try2, double brx, double bry, double blx, double bly, double r, double g, double b, double a) {
        SpriteRenderer.instance.render(tex, tlx, tly, trx, try2, brx, bry, blx, bly, (float)r, (float)g, (float)b, (float)a, (float)r, (float)g, (float)b, (float)a, (float)r, (float)g, (float)b, (float)a, (float)r, (float)g, (float)b, (float)a, null);
    }
    ...
    public void DrawTexture(Texture tex, double x, double y, double alpha) {
        ...
        if (tex != null) {
            ...
            dy += (double)tex.offsetY;
            getHeight = tex.getHeight();
            width = tex.getWidth();
            height = tex.getHeight();
        }
        if ((double)(top = (int)(dy + this.yScroll)) + getHeight < 0.0 || top > 4096) {
            return;
        }
        SpriteRenderer.instance.renderi(tex, (int)(dx + this.xScroll), (int)(dy + this.yScroll), (int)width, (int)height, 1.0f, 1.0f, 1.0f, (float)alpha, null);
    }
    ...
    public void DrawTextureCol(Texture tex, double x, double y, Color col) {
        ...
        if ((top = (int)(dy + this.yScroll)) + hei < 0 || top > 4096) {
            return;
        }
    ...
    public void DrawTextureScaledUniform(Texture tex, double x, double y, double scale, double r, double g, double b, double alpha) {
        if (!this.isVisible().booleanValue() || tex == null) {
            return;
        }
        double dx = x + this.getAbsoluteX();
        double dy = y + this.getAbsoluteY();
        SpriteRenderer.instance.renderi(tex, (int)((dx += (double)tex.offsetX * scale) + this.xScroll), (int)((dy += (double)tex.offsetY * scale) + this.yScroll), (int)((double)tex.getWidth() * scale), (int)((double)tex.getHeight() * scale), (float)r, (float)g, (float)b, (float)alpha, null);
    }
    ...
    public void DrawTextureScaledAspect(Texture tex, double x, double y, double width, double height, double r, double g, double b, double alpha) {
        ...
        if (tex.getWidth() > 0 && tex.getHeight() > 0 && width > 0.0 && height > 0.0) {
            double ratio = Math.min(width / (double)tex.getWidthOrig(), height / (double)tex.getHeightOrig());
            double oldWidth = width;
            double oldHeight = height;
            width = (double)tex.getWidth() * ratio;
            height = (double)tex.getHeight() * ratio;
            dx -= (width - oldWidth) / 2.0;
            dy -= (height - oldHeight) / 2.0;
        }
        SpriteRenderer.instance.renderi(tex, (int)(dx + this.xScroll), (int)(dy + this.yScroll), (int)width, (int)height, (float)r, (float)g, (float)b, (float)alpha, null);
    }
    ...
    public void DrawTextureScaledAspect2(Texture tex, double x, double y, double width, double height, double r, double g, double b, double alpha) {
        ...
        double dy = y + this.getAbsoluteY();
        if (tex.getWidth() > 0 && tex.getHeight() > 0 && width > 0.0 && height > 0.0) {
            double ratio = Math.min(width / (double)tex.getWidth(), height / (double)tex.getHeight());
            double oldWidth = width;
            double oldHeight = height;
            width = (double)tex.getWidth() * ratio;
            height = (double)tex.getHeight() * ratio;
        ...
        SpriteRenderer.instance.render(tex, (int)(dx + this.xScroll), (int)(dy + this.yScroll), (int)width, (int)height, (float)r, (float)g, (float)b, (float)alpha, null);
    }
    ...
    public void DrawTextureScaledAspect3(Texture tex, double x, double y, double width, double height, double r, double g, double b, double alpha) {
        ...
        double dy = y + this.getAbsoluteY();
        if (tex.getWidth() > 0 && tex.getHeight() > 0 && width > 0.0 && height > 0.0) {
            double ratio = Math.max(width / (double)tex.getWidthOrig(), height / (double)tex.getHeightOrig());
            double oldWidth = width;
            double oldHeight = height;
            width = (double)tex.getWidth() * ratio;
            height = (double)tex.getHeight() * ratio;
    ...
    public void DrawTextureScaledCol(Texture tex, double x, double y, double width, double height, double r, double g, double b, double a) {
        ...
        if ((double)top + height < 0.0 || top > 4096) {
            return;
        }
        SpriteRenderer.instance.renderi(tex, (int)(dx + this.xScroll), (int)(dy + this.yScroll), (int)width, (int)height, (float)r, (float)g, (float)b, (float)a, null);
    }
    ...
    public void DrawTextureColor(Texture tex, double x, double y, double r, double g, double b, double a) {
        UIElement.tempcol.r = (float)r;
        UIElement.tempcol.g = (float)g;
        UIElement.tempcol.b = (float)b;
        UIElement.tempcol.a = (float)a;
    ...
    public void DrawLine(Texture tex, double x1, double y1, double x2, double y2, float thickness, double r, double g, double b, double a) {
        ...
        SpriteRenderer.instance.renderline(tex, (int)((x1 += this.getAbsoluteX().doubleValue()) + this.xScroll), (int)((y1 += this.getAbsoluteY().doubleValue()) + this.yScroll), (int)((x2 += this.getAbsoluteX().doubleValue()) + this.xScroll), (int)((y2 += this.getAbsoluteY().doubleValue()) + this.yScroll), (float)r, (float)g, (float)b, (float)a, thickness);
    }
    ...
    public void DrawPolygon(Texture tex, double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4, double r, double g, double b, double a) {
        ...
        SpriteRenderer.instance.renderPoly(tex, (float)(x1 += dx), (float)(y1 += dy), (float)(x2 += dx), (float)(y2 += dy), (float)(x3 += dx), (float)(y3 += dy), (float)(x4 += dx), (float)(y4 += dy), (float)r, (float)g, (float)b, (float)a);
    }

    public void DrawItemIcon(InventoryItem item, double x, double y, double alpha, double width, double height) {
        if (!this.isVisible().booleanValue() || item == null) {
            return;
        }
        ...
        if (tex != null) {
            ...
            if (fluidContainer != null && item.getTextureFluidMask() != null) {
                texMask = item.getTextureFluidMask();
            ...
            if (item.getTextureColorMask() != null) {
                texMask = item.getTextureColorMask();
    ...
    public void DrawScriptItemIcon(Item scriptItem, double x, double y, double alpha, double width, double height) {
        if (!this.isVisible().booleanValue() || scriptItem == null) {
            return;
        }
    ...
    public void DrawTextureIcon(Texture tex, double x, double y, double width, double height, double r, double g, double b, double alpha) {
        ...
        if (tex.getWidth() > 0 && tex.getHeight() > 0 && width > 0.0 && height > 0.0) {
            double ratio = Math.min(width / (double)tex.getWidthOrig(), height / (double)tex.getHeightOrig());
            double offX = (int)((double)tex.offsetX * ratio);
            double offY = (int)((double)tex.offsetY * ratio);
            width = (int)((double)tex.getWidth() * ratio);
            height = (int)((double)tex.getHeight() * ratio);
            dx += offX;
            dy += offY;
        }
        SpriteRenderer.instance.renderi(tex, (int)(dx + this.xScroll), (int)(dy + this.yScroll), (int)width, (int)height, (float)r, (float)g, (float)b, (float)alpha, null);
    ...
    public void DrawTextureIconMask(Texture tex, double yRatio, double x, double y, double width, double height, double r, double g, double b, double alpha) {
        ...
        dy += height - h;
        height = h;
        h = (int)((double)tex.getHeight() * yRatio);
        double subX = 0.0;
        double subY = (double)tex.getHeight() - h;
        double subW = tex.getWidth();
        double subH = h;
        dx += this.xScroll.doubleValue();
        dy += this.yScroll.doubleValue();
        dx = (int)dx;
        if ((dy = (double)((int)dy)) + height < 0.0 || dy > 4096.0) {
            return;
        }
        ...
        SpriteRenderer.instance.render(tex, (float)dx, (float)dy, (float)width, (float)height, (float)r, (float)g, (float)b, (float)alpha, u0, v0, u1, v0, u1, v1, u0, v1);
    }
    ...
    public void DrawTexturePercentage(Texture tex, double yRatio, double x, double y, double width, double height, double r, double g, double b, double alpha) {
        ...
        double subX = 0.0;
        double subY = 0.0;
        double subW = (double)tex.getWidth() * yRatio;
    ...
    public void DrawSubTextureRGBA(Texture tex, double subX, double subY, double subW, double subH, double x, double y, double w, double h, double r, double g, double b, double a) {
        if (tex == null || this.isVisible() == false || subW <= 0.0 || subH <= 0.0 || w <= 0.0 || h <= 0.0) {
            return;
        }
    ...
    public void DrawTextureTiled(Texture tex, double x, double y, double w, double h, double r, double g, double b, double a) {
        if (tex == null || !this.isVisible().booleanValue() || w <= 0.0 || h <= 0.0) {
            return;
        }
        for (double y1 = y; y1 < y + h; y1 += (double)tex.getHeight()) {
            for (double x1 = x; x1 < x + w; x1 += (double)tex.getWidth()) {
                double width1 = tex.getWidth();
                double height1 = tex.getHeight();
                if (x1 + width1 > x + w) {
                    width1 = x + w - x1;
                }
                if (y1 + (double)tex.getHeight() > y + h) {
                    height1 = y + h - y1;
                }
    ...
    public void DrawTextureTiledYOffset(Texture tex, double x, double y, double w, double h, double r, double g, double b, double a) {
        ...
        double subY = y % (double)tex.getHeight();
        for (double y1 = y; y1 < y + h; y1 += height1) {
            double width1 = w;
            height1 = (double)tex.getHeight() - subY;
            if (height1 == 0.0) {
                subY = 0.0;
    ...
    public void DrawUVSliceTexture(Texture tex, double x, double y, double width, double height, Color col, double xStart, double yStart, double xEnd, double yEnd) {
        ...
        xE -= (1.0 - xEnd) * xTot;
        yE -= (1.0 - yEnd) * yTot;
        xS = (float)((int)(xS * 1000.0)) / 1000.0f;
        xE = (float)((int)(xE * 1000.0)) / 1000.0f;
        yS = (float)((int)(yS * 1000.0)) / 1000.0f;
        yE = (float)((int)(yE * 1000.0)) / 1000.0f;
        double x2 = dx + width;
        double y2 = dy + height;
        SpriteRenderer.instance.render(tex, (float)(dx += xStart * width) + (float)this.getXScroll().intValue(), (float)(dy += yStart * height) + (float)this.getYScroll().intValue(), (float)((x2 -= (1.0 - xEnd) * width) - dx), (float)((y2 -= (1.0 - yEnd) * height) - dy), col.r, col.g, col.b, col.a, (float)xS, (float)yS, (float)xE, (float)yS, (float)xE, (float)yE, (float)xS, (float)yE);
    }
    ...
    void onRightMouseUpOutside(double x, double y) {
        if (this.getTable() != null && UIManager.tableget(this.table, "onRightMouseUpOutside") != null) {
            LuaManager.caller.protectedCallVoid(UIManager.getDefaultThread(), UIManager.tableget(this.table, "onRightMouseUpOutside"), this.table, BoxedStaticValues.toDouble(x - this.xScroll), BoxedStaticValues.toDouble(y - this.yScroll));
        }
        for (int i = this.getControls().size() - 1; i >= 0; --i) {
            UIElement ui = this.getControls().get(i);
            ui.onRightMouseUpOutside(x - (double)ui.getXScrolled(this).intValue(), y - (double)ui.getYScrolled(this).intValue());
        }
    }
    ...
    void onRightMouseDownOutside(double x, double y) {
        if (this.getTable() != null && UIManager.tableget(this.table, "onRightMouseDownOutside") != null) {
            LuaManager.caller.protectedCallVoid(UIManager.getDefaultThread(), UIManager.tableget(this.table, "onRightMouseDownOutside"), this.table, BoxedStaticValues.toDouble(x - this.xScroll), BoxedStaticValues.toDouble(y - this.yScroll));
        }
        for (int i = this.getControls().size() - 1; i >= 0; --i) {
            UIElement ui = this.getControls().get(i);
            ui.onRightMouseDownOutside(x - (double)ui.getXScrolled(this).intValue(), y - (double)ui.getYScrolled(this).intValue());
        }
    }

    public void onMouseUpOutside(double x, double y) {
        if (this.getTable() != null && UIManager.tableget(this.table, "onMouseUpOutside") != null) {
            LuaManager.caller.protectedCallVoid(UIManager.getDefaultThread(), UIManager.tableget(this.table, "onMouseUpOutside"), this.table, BoxedStaticValues.toDouble(x - this.xScroll), BoxedStaticValues.toDouble(y - this.yScroll));
        }
        for (int i = this.getControls().size() - 1; i >= 0; --i) {
            UIElement ui = this.getControls().get(i);
            ui.onMouseUpOutside(x - (double)ui.getXScrolled(this).intValue(), y - (double)ui.getYScrolled(this).intValue());
        }
    }

    void onMouseDownOutside(double x, double y) {
        if (this.getTable() != null && UIManager.tableget(this.table, "onMouseDownOutside") != null) {
            LuaManager.caller.protectedCallVoid(UIManager.getDefaultThread(), UIManager.tableget(this.table, "onMouseDownOutside"), this.table, BoxedStaticValues.toDouble(x - this.xScroll), BoxedStaticValues.toDouble(y - this.yScroll));
        }
        for (int i = this.getControls().size() - 1; i >= 0; --i) {
            UIElement ui = this.getControls().get(i);
            ui.onMouseDownOutside(x - (double)ui.getX().intValue(), y - (double)ui.getY().intValue());
        }
    }

    public Boolean onMouseDown(double x, double y) {
        if (this.clicked && UIManager.isDoubleClick((int)this.clickX, (int)this.clickY, (int)x, (int)y, this.leftDownTime).booleanValue() && this.getTable() != null && this.getTable().rawget("onMouseDoubleClick") != null) {
            this.clicked = false;
            return this.onMouseDoubleClick(x, y) != false ? Boolean.TRUE : Boolean.FALSE;
        }
        this.clicked = true;
        this.clickX = x;
        this.clickY = y;
        this.leftDownTime = System.currentTimeMillis();
        if (this.parent != null && this.parent.maxDrawHeight != -1 && (double)this.parent.maxDrawHeight <= y) {
            return Boolean.FALSE;
        }
        if (this.maxDrawHeight != -1 && (double)this.maxDrawHeight <= y) {
            return Boolean.FALSE;
        }
        if (!this.visible) {
            return Boolean.FALSE;
        ...
        if (this.getTable() != null && UIManager.tableget(this.table, "onFocus") != null) {
            LuaManager.caller.protectedCallVoid(UIManager.getDefaultThread(), UIManager.tableget(this.table, "onFocus"), this.table, BoxedStaticValues.toDouble(x - this.xScroll), BoxedStaticValues.toDouble(y - this.yScroll));
        }
        boolean bForceOutside = false;
        for (int i = this.getControls().size() - 1; i >= 0; --i) {
            UIElement ui = this.getControls().get(i);
            if (!bForceOutside && (x > ui.getXScrolled(this) && y > ui.getYScrolled(this) && x < ui.getXScrolled(this) + ui.getWidth() && y < ui.getYScrolled(this) + ui.getHeight() || ui.isCapture().booleanValue())) {
                if (!ui.onMouseDown(x - (double)ui.getXScrolled(this).intValue(), y - (double)ui.getYScrolled(this).intValue()).booleanValue()) continue;
                bForceOutside = true;
                continue;
            }
            if (ui.getTable() == null || UIManager.tableget(ui.getTable(), "onMouseDownOutside") == null) continue;
            LuaManager.caller.protectedCallVoid(UIManager.getDefaultThread(), UIManager.tableget(ui.getTable(), "onMouseDownOutside"), ui.getTable(), BoxedStaticValues.toDouble(x - this.xScroll), BoxedStaticValues.toDouble(y - this.yScroll));
        }
        if (this.getTable() != null) {
            if (bForceOutside) {
                if (UIManager.tableget(this.table, "onMouseDownOutside") != null) {
                    Boolean o = LuaManager.caller.protectedCallBoolean(UIManager.getDefaultThread(), UIManager.tableget(this.table, "onMouseDownOutside"), this.table, BoxedStaticValues.toDouble(x - this.xScroll), BoxedStaticValues.toDouble(y - this.yScroll));
                    if (o == null) {
                        return Boolean.TRUE;
                    }
                    if (o.booleanValue()) {
                ...
                Boolean o = LuaManager.caller.protectedCallBoolean(UIManager.getDefaultThread(), UIManager.tableget(this.table, "onMouseDown"), this.table, BoxedStaticValues.toDouble(x - this.xScroll), BoxedStaticValues.toDouble(y - this.yScroll));
                if (o == null) {
    ...
    private Boolean onMouseDoubleClick(double x2, double y2) {
        ...
        if (UIManager.tableget(this.table, "onMouseDoubleClick") != null) {
            Boolean o = LuaManager.caller.protectedCallBoolean(UIManager.getDefaultThread(), UIManager.tableget(this.table, "onMouseDoubleClick"), this.table, BoxedStaticValues.toDouble(x2 - this.xScroll), BoxedStaticValues.toDouble(y2 - this.yScroll));
            if (o == null) {
                return Boolean.TRUE;
            }
            if (o.booleanValue()) {
    ...
    public Boolean onConsumeMouseWheel(double del, double x, double y) {
        if (!this.isIgnoreLossControl().booleanValue() && TutorialManager.instance.stealControl) {
            return false;
        }
        if (!this.isVisible().booleanValue()) {
            return false;
        }
        return this.onMouseWheel(del);
    }
    ...
    public Boolean onMouseWheel(double del) {
        ...
        for (int i = this.getControls().size() - 1; i >= 0; --i) {
            UIElement ui = this.getControls().get(i);
            if (!ui.isVisible().booleanValue() || !((double)mx >= ui.getAbsoluteX() && (double)my >= ui.getAbsoluteY() && (double)mx < ui.getAbsoluteX() + ui.getWidth() && (double)my < ui.getAbsoluteY() + ui.getHeight()) && !ui.isCapture().booleanValue() || !ui.onMouseWheel(del).booleanValue()) continue;
            return this.consumeMouseEvents ? Boolean.TRUE : Boolean.FALSE;
        }
        if (this.getTable() != null && UIManager.tableget(this.table, "onMouseWheel") != null && (o = LuaManager.caller.protectedCallBoolean(UIManager.getDefaultThread(), UIManager.tableget(this.table, "onMouseWheel"), this.table, BoxedStaticValues.toDouble(del))) == Boolean.TRUE) {
            return Boolean.TRUE;
        }
        return Boolean.FALSE;
    }
    ...
    public Boolean onMouseMove(double dx, double dy) {
        ...
        if (this.maxDrawHeight != -1 && (double)this.maxDrawHeight <= (double)my - this.getAbsoluteY()) {
            return Boolean.FALSE;
        }
        if (!this.visible) {
            return Boolean.FALSE;
        ...
        if (this.getTable() != null && UIManager.tableget(this.table, "onMouseMove") != null) {
            LuaManager.caller.protectedCallVoid(UIManager.getDefaultThread(), UIManager.tableget(this.table, "onMouseMove"), this.table, BoxedStaticValues.toDouble(dx), BoxedStaticValues.toDouble(dy));
        }
        boolean consumedMove = false;
        for (int i = this.getControls().size() - 1; i >= 0; --i) {
            UIElement ui = this.getControls().get(i);
            if (!ui.isVisible().booleanValue()) continue;
            if ((double)mx >= ui.getAbsoluteX() && (double)my >= ui.getAbsoluteY() && (double)mx < ui.getAbsoluteX() + ui.getWidth() && (double)my < ui.getAbsoluteY() + ui.getHeight() || ui.isCapture().booleanValue()) {
                if (consumedMove && !ui.isCapture().booleanValue() || !ui.onMouseMove(dx, dy).booleanValue()) continue;
                consumedMove = true;
                continue;
            }
            ui.onMouseMoveOutside(dx, dy);
        }
        return consumedMove || this.consumeMouseEvents ? Boolean.TRUE : Boolean.FALSE;
    }

    public String toString() {
        if (this.getTable() != null) {
            return KahluaUtil.tostring(this.getTable(), UIManager.getDefaultThread());
        }
    ...
    public void onMouseMoveOutside(double dx, double dy) {
        if (this.getTable() != null && UIManager.tableget(this.table, "onMouseMoveOutside") != null) {
            LuaManager.caller.protectedCallVoid(UIManager.getDefaultThread(), UIManager.tableget(this.table, "onMouseMoveOutside"), this.table, BoxedStaticValues.toDouble(dx), BoxedStaticValues.toDouble(dy));
        }
        for (int i = this.getControls().size() - 1; i >= 0; --i) {
            UIElement ui = this.getControls().get(i);
            if (!ui.isVisible().booleanValue()) continue;
    ...
    public Boolean onMouseUp(double x, double y) {
        ...
        for (int i = this.getControls().size() - 1; i >= 0; --i) {
            UIElement ui = this.getControls().get(i);
            if (!bForceOutside && (x >= ui.getXScrolled(this) && y >= ui.getYScrolled(this) && x < ui.getXScrolled(this) + ui.getWidth() && y < ui.getYScrolled(this) + ui.getHeight() || ui.isCapture().booleanValue())) {
                if (ui.onMouseUp(x - (double)ui.getXScrolled(this).intValue(), y - (double)ui.getYScrolled(this).intValue()).booleanValue()) {
                    bForceOutside = true;
                }
            } else {
                ui.onMouseUpOutside(x - (double)ui.getXScrolled(this).intValue(), y - (double)ui.getYScrolled(this).intValue());
        ...
        if (this.getTable() != null) {
            if (bForceOutside) {
                if (UIManager.tableget(this.table, "onMouseUpOutside") != null) {
                    Boolean o = LuaManager.caller.protectedCallBoolean(UIManager.getDefaultThread(), UIManager.tableget(this.table, "onMouseUpOutside"), this.table, BoxedStaticValues.toDouble(x - this.xScroll), BoxedStaticValues.toDouble(y - this.yScroll));
                    if (o == null) {
                        return Boolean.TRUE;
                    }
                    if (o.booleanValue()) {
                ...
                Boolean o = LuaManager.caller.protectedCallBoolean(UIManager.getDefaultThread(), UIManager.tableget(this.table, "onMouseUp"), this.table, BoxedStaticValues.toDouble(x - this.xScroll), BoxedStaticValues.toDouble(y - this.yScroll));
                if (o == null) {
                    return this.consumeMouseEvents ? Boolean.TRUE : Boolean.FALSE;
                }
                if (o.booleanValue()) {
    ...
    public void onMouseButtonDown(int btn, double x, double y) {
        ...
        for (int i = this.getControls().size() - 1; i >= 0; --i) {
            if (!this.getControls().get(i).isMouseOver().booleanValue()) continue;
            return;
        }
        LuaManager.caller.protectedCallVoid(UIManager.getDefaultThread(), UIManager.tableget(this.getTable(), "onMouseButtonDown"), this.getTable(), BoxedStaticValues.toDouble(btn));
    }
    ...
    public boolean onConsumeMouseButtonUp(int btn, double x, double y) {
        ...
        if (btn == 1) {
            return this.onRightMouseUp(x, y);
        }
        return false;
    }
    ...
    public Boolean onRightMouseDown(double x, double y) {
        ...
        for (int i = this.getControls().size() - 1; i >= 0; --i) {
            UIElement ui = this.getControls().get(i);
            if (!bForceOutside && (x >= ui.getXScrolled(this) && y >= ui.getYScrolled(this) && x < ui.getXScrolled(this) + ui.getWidth() && y < ui.getYScrolled(this) + ui.getHeight() || ui.isCapture().booleanValue())) {
                if (!ui.onRightMouseDown(x - (double)ui.getXScrolled(this).intValue(), y - (double)ui.getYScrolled(this).intValue()).booleanValue()) continue;
                bForceOutside = true;
                continue;
            }
            if (ui.getTable() == null || UIManager.tableget(ui.getTable(), "onRightMouseDownOutside") == null) continue;
            LuaManager.caller.protectedCallVoid(UIManager.getDefaultThread(), UIManager.tableget(ui.getTable(), "onRightMouseDownOutside"), ui.getTable(), BoxedStaticValues.toDouble(x - this.xScroll), BoxedStaticValues.toDouble(y - this.yScroll));
        }
        if (this.getTable() != null) {
            if (bForceOutside) {
                if (UIManager.tableget(this.table, "onRightMouseDownOutside") != null) {
                    Boolean o = LuaManager.caller.protectedCallBoolean(UIManager.getDefaultThread(), UIManager.tableget(this.table, "onRightMouseDownOutside"), this.table, BoxedStaticValues.toDouble(x - this.xScroll), BoxedStaticValues.toDouble(y - this.yScroll));
                    if (o == null) {
                        return Boolean.TRUE;
                    }
                    if (o.booleanValue()) {
                ...
                Boolean o = LuaManager.caller.protectedCallBoolean(UIManager.getDefaultThread(), UIManager.tableget(this.table, "onRightMouseDown"), this.table, BoxedStaticValues.toDouble(x - this.xScroll), BoxedStaticValues.toDouble(y - this.yScroll));
                if (o == null) {
                    return Boolean.TRUE;
                }
                if (o.booleanValue()) {
    ...
    public Boolean onRightMouseUp(double x, double y) {
        ...
        for (int i = this.getControls().size() - 1; i >= 0; --i) {
            UIElement ui = this.getControls().get(i);
            if (!bForceOutside && (x >= ui.getXScrolled(this) && y >= ui.getYScrolled(this) && x < ui.getXScrolled(this) + ui.getWidth() && y < ui.getYScrolled(this) + ui.getHeight() || ui.isCapture().booleanValue())) {
                if (!ui.onRightMouseUp(x - (double)ui.getXScrolled(this).intValue(), y - (double)ui.getYScrolled(this).intValue()).booleanValue()) continue;
                bForceOutside = true;
                continue;
            }
            ui.onRightMouseUpOutside(x - (double)ui.getXScrolled(this).intValue(), y - (double)ui.getYScrolled(this).intValue());
        ...
        if (this.getTable() != null) {
            if (bForceOutside) {
                if (UIManager.tableget(this.table, "onRightMouseUpOutside") != null) {
                    Boolean o = LuaManager.caller.protectedCallBoolean(UIManager.getDefaultThread(), UIManager.tableget(this.table, "onRightMouseUpOutside"), this.table, BoxedStaticValues.toDouble(x - this.xScroll), BoxedStaticValues.toDouble(y - this.yScroll));
                    if (o == null) {
                        return Boolean.TRUE;
                    }
                    if (o.booleanValue()) {
                ...
                Boolean o = LuaManager.caller.protectedCallBoolean(UIManager.getDefaultThread(), UIManager.tableget(this.table, "onRightMouseUp"), this.table, BoxedStaticValues.toDouble(x - this.xScroll), BoxedStaticValues.toDouble(y - this.yScroll));
                if (o == null) {
                    return Boolean.TRUE;
                }
                if (o.booleanValue()) {
    ...
    public void render() {
        ...
        if (this.getTable() != null && (prerender = UIManager.tableget(this.table, "prerender")) != null) {
            try {
        ...
        if (this.getTable() != null && (render = UIManager.tableget(this.table, "render")) != null) {
        ...
        if (Core.debug && DebugOptions.instance.uiRenderOutline.getValue()) {
            ...
            double height = this.maxDrawHeight == -1 ? (double)this.height : (double)this.maxDrawHeight;
            this.DrawTextureScaledColor(null, x, y, 1.0, height, r, 1.0, 1.0, 0.5);
            this.DrawTextureScaledColor(null, x + 1.0, y, (double)this.width - 2.0, 1.0, r, 1.0, 1.0, 0.5);
            this.DrawTextureScaledColor(null, x + (double)this.width - 1.0, y, 1.0, height, r, 1.0, 1.0, 0.5);
            this.DrawTextureScaledColor(null, x + 1.0, y + height - 1.0, (double)this.width - 2.0, 1.0, r, 1.0, 1.0, 0.5);
        }
    }
    ...
    public void update() {
        ...
        for (i = 0; i < this.controls.size(); ++i) {
            if (!this.toTop.contains(this.controls.get(i))) continue;
        ...
        for (i = 0; i < this.getControls().size(); ++i) {
    ...
    public boolean isModalVisible() {
        ...
        for (int i = 0; i < this.getControls().size(); ++i) {
            ...
            if (!child.isModalVisible()) continue;
            return true;
        }
        return false;
    }
    ...
    public boolean isReallyVisible() {
        ...
        if (this.getParent() != null) {
            if (!this.getParent().getControls().contains(this)) {
                return false;
            }
            return this.getParent().isReallyVisible();
        }
    ...
    public Double getXScrolled(UIElement parent) {
        if (parent != null && parent.scrollChildren && this.scrollWithParent) {
            return BoxedStaticValues.toDouble(this.x + parent.getXScroll());
        }
        return BoxedStaticValues.toDouble(this.x);
    }
    ...
    public Double getYScrolled(UIElement parent) {
        if (parent != null && parent.scrollChildren && this.scrollWithParent) {
            return BoxedStaticValues.toDouble(this.y + parent.getYScroll());
        }
    ...
    public boolean isOverElement(double mx, double my) {
        return mx >= this.x && my >= this.y && mx < this.x + (double)this.width && my < this.y + (double)this.height;
    }
    ...
    public void setStencilRect(double x, double y, double width, double height) {
        x += this.getAbsoluteX().doubleValue();
        y += this.getAbsoluteY().doubleValue();
    ...
    public void repaintStencilRect(double x, double y, double width, double height) {
        ...
        IndieGL.glColorMask(false, false, false, false);
        SpriteRenderer.instance.renderi(null, (int)(x += this.getAbsoluteX().doubleValue()), (int)(y += this.getAbsoluteY().doubleValue()), (int)width, (int)height, 1.0f, 0.0f, 0.0f, 1.0f, null);
        IndieGL.glColorMask(true, true, true, true);
        IndieGL.glStencilOp(7680, 7680, 7680);
        IndieGL.glStencilFunc(514, stencilLevel, 255);
    }
    ...
    public Double clampToParentX(double x) {
        ...
        double parentX2 = this.getParent().clampToParentX(parentX1 + (double)this.getParent().getWidth().intValue());
        if (x < parentX1) {
            x = parentX1;
        }
        if (x > parentX2) {
    ...
    public Double clampToParentY(double y) {
        ...
        double parentY2 = this.getParent().clampToParentY(parentY1 + (double)this.getParent().getHeight().intValue());
        if (y < parentY1) {
            y = parentY1;
        }
        if (y > parentY2) {
    ...
    public Boolean isPointOver(double screenX, double screenY) {
        ...
        if (localX < 0.0 || localX >= this.getWidth() || localY < 0.0 || localY >= (double)height) {
            return Boolean.FALSE;
        }
        if (this.parent == null) {
            UIElementInterface other2;
            ArrayList<UIElementInterface> uis = UIManager.getUI();
            for (int i = uis.size() - 1; i >= 0 && (other2 = uis.get(i)) != this; --i) {
                if (!other2.isPointOver(screenX, screenY).booleanValue()) continue;
                return Boolean.FALSE;
            }
            return Boolean.TRUE;
        }
        for (int i = this.parent.controls.size() - 1; i >= 0 && (other = this.parent.controls.get(i)) != this; --i) {
            if (!other.isVisible().booleanValue() || !other.consumeMouseEvents) continue;
            ...
            if (!(localX >= 0.0) || !(localX < other.getWidth()) || !(localY >= 0.0) || !(localY < (double)height)) continue;
            return Boolean.FALSE;
        }
        return this.parent.isPointOver(screenX, screenY) != false ? Boolean.TRUE : Boolean.FALSE;
    }
    ...
    protected Object tryGetTableValue(String key) {
        ...
        return UIManager.tableget(this.table, key);
    }
    ...
    public boolean isKeyConsumed(int key) {
        ...
        return result == null ? Boolean.FALSE.booleanValue() : result.booleanValue();
    }
