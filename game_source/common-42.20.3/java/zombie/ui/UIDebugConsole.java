...
extends NewWindow {
    ...
    public void render() {
        ...
        super.render();
        this.DrawTextCentre(UIFont.DebugConsole, Translator.getText("IGUI_CommandConsole", new Object[0]), this.getWidth() / 2.0, 2.0, 1.0, 1.0, 1.0, 1.0);
        this.DrawText(UIFont.DebugConsole, Translator.getText("IGUI_OutputLog", new Object[0]), 7.0, this.titleMiddle.getHeight(), 0.7f, 0.7f, 1.0, 1.0);
        this.DrawText(UIFont.DebugConsole, Translator.getText("IGUI_LuaCommandLine", new Object[0]), 7.0, this.outputLog.getY() + this.outputLog.getHeight() + 1.0, 0.7f, 0.7f, 1.0, 1.0);
