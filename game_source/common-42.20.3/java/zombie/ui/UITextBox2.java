...
implements UITextEntryInterface {
    ...
    public void update() {
        ...
        if (this.blinkFrame > 0.0f) {
            this.blinkFrame = UIManager.defaultthread == LuaManager.debugthread ? (this.blinkFrame -= 0.5f) : (this.blinkFrame -= GameTime.getInstance().getRealworldSecondsSinceLastUpdate() * 30.0f);
        } else {
