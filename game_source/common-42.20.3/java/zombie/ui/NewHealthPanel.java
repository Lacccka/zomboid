...
extends NewWindow {
    ...
    public String getDamageStatusString() {
        ...
        if (bodyDamage.getHealth() == 100.0f) {
            return Translator.getText("IGUI_health_ok", new Object[0]);
        }
        if (bodyDamage.getHealth() > 90.0f) {
            return Translator.getText("IGUI_health_Slight_damage", new Object[0]);
        }
        if (bodyDamage.getHealth() > 80.0f) {
            return Translator.getText("IGUI_health_Very_Minor_damage", new Object[0]);
        }
        if (bodyDamage.getHealth() > 70.0f) {
            return Translator.getText("IGUI_health_Minor_damage", new Object[0]);
        }
        if (bodyDamage.getHealth() > 60.0f) {
            return Translator.getText("IGUI_health_Moderate_damage", new Object[0]);
        }
        if (bodyDamage.getHealth() > 50.0f) {
            return Translator.getText("IGUI_health_Severe_damage", new Object[0]);
        }
        if (bodyDamage.getHealth() > 40.0f) {
            return Translator.getText("IGUI_health_Very_Severe_damage", new Object[0]);
        }
        if (bodyDamage.getHealth() > 20.0f) {
            return Translator.getText("IGUI_health_Crital_damage", new Object[0]);
        }
        if (bodyDamage.getHealth() > 10.0f) {
            return Translator.getText("IGUI_health_Highly_Crital_damage", new Object[0]);
        }
        if (bodyDamage.getHealth() > 0.0f) {
            return Translator.getText("IGUI_health_Terminal_damage", new Object[0]);
        }
        return Translator.getText("IGUI_health_Deceased", new Object[0]);
    }
}
