...
UIEventHandler {
    ...
    public UIServerToolbox(int x, int y) {
        ...
        int cx = 6;
        int px = 37;
        this.outputLog = new UITextBox2(UIFont.Small, 5, 33, 330, 260, Translator.getText("IGUI_ServerToolBox_Status", new Object[0]), true);
        ...
        this.buttonAccept = new DialogButton(this, 30, 225, Translator.getText("IGUI_ServerToolBox_acccept", new Object[0]), "accept");
        this.buttonReject = new DialogButton(this, 80, 225, Translator.getText("IGUI_ServerToolBox_reject", new Object[0]), "reject");
        ...
        if (CoopMaster.instance.isRunning()) {
            ...
            CoopMaster.instance.invokeServer("get-parameter", "external-ip", new ICoopServerMessageListener(this){
                ...
                public void OnCoopServerMessage(String tag, String cookie, String payload) {
                    ...
                    String address = "null".equals(this.this$0.externalAddress) ? Translator.getText("IGUI_ServerToolBox_IPUnknown", new Object[0]) : this.this$0.externalAddress;
            ...
            if (SteamUtils.isSteamModeEnabled()) {
                CoopMaster.instance.invokeServer("get-parameter", "steam-id", new ICoopServerMessageListener(this){
                    ...
                    public void OnCoopServerMessage(String tag, String cookie, String payload) {
                        ...
                        this.this$0.PrintLine("");
                        this.this$0.PrintLine(Translator.getText("IGUI_ServerToolBox_Invite1", new Object[0]));
                        this.this$0.PrintLine("");
                        this.this$0.PrintLine(Translator.getText("IGUI_ServerToolBox_Invite2", new Object[0]));
                        this.this$0.PrintLine(Translator.getText("IGUI_ServerToolBox_Invite3", new Object[0]));
                        this.this$0.PrintLine("");
                        this.this$0.PrintLine(Translator.getText("IGUI_ServerToolBox_Invite4", new Object[0]));
                        this.this$0.PrintLine("");
                        this.this$0.PrintLine(Translator.getText("IGUI_ServerToolBox_Invite5", new Object[0]));
                    }
                });
            }
        }
    ...
    public void render() {
        ...
        super.render();
        this.DrawTextCentre(Translator.getText("IGUI_ServerToolBox_Title", new Object[0]), this.getWidth() / 2.0, 2.0, 1.0, 1.0, 1.0, 1.0);
        String string = address = "null".equals(this.externalAddress) ? Translator.getText("IGUI_ServerToolBox_IPUnknown", new Object[0]) : this.externalAddress;
        if (!Core.getInstance().getOptionStreamerMode()) {
