...
extends UIElement {
    ...
    public void render() {
        ...
        for (String text : this.lines) {
            if (this.centered) {
                TextManager.instance.DrawStringCentre(this.font, (double)this.getAbsoluteX().intValue() + this.getWidth() / 2.0, (double)(this.getAbsoluteY().intValue() + y), text, 1.0, 1.0, 1.0, 1.0);
            } else {
