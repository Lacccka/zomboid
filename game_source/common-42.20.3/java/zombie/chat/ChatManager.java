...
public class ChatManager {
    ...
    public synchronized void sendWhisperMessage(String destPlayerName, String msg) {
        ...
        if (ChatUtility.chatStreamEnabled(ChatType.whisper)) {
            if (destPlayerName == null || destPlayerName.equalsIgnoreCase(this.myNickname)) {
                ...
                this.showServerChatMessage(Translator.getText("UI_chat_whisper_message_to_yourself_error", new Object[0]));
                return;
            }
    ...
    private void showChatDisabledMessage(ChatType expectedChat) {
        ...
        text.append(Translator.getText("UI_chat_chat_disabled_msg", Translator.getText(expectedChat.getTitleID(), new Object[0])));
        ...
        for (ChatType chat : allowedChats) {
            ...
            text.append("    * ").append(Translator.getText(chat.getTitleID(), new Object[0])).append(" <LINE> ");
        }
