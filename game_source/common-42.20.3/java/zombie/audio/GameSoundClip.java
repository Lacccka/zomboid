...
public final class GameSoundClip {
    ...
    public GameSoundClip checkReloaded() {
        ...
        for (int i = 0; i < this.gameSound.clips.size(); ++i) {
            ...
            if (otherClip.file == null || !otherClip.file.equals(this.file)) continue;
            bestClip = otherClip;
        }
        if (bestClip == null) {
    ...
    public boolean hasSustainPoints(boolean remote) {
        return this.getEventDescription(remote) != null && this.getEventDescription((boolean)remote).hasSustainPoints;
    }
