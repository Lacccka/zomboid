...
public final class ObjectAmbientEmitters {
    ...
    private final ObjectPool<ObjectWithDistance> objectPool = new ObjectPool<ObjectWithDistance>(ObjectWithDistance::new, "ObjectAmbientEmitters.objectPool");
    ...
    private ObjectAmbientEmitters() {
        ...
        this.powerPolicyMap.put(SoundKey.WATER_TOWER_AMBIENCE.getSoundName(), PowerPolicy.NotRequired);
    }
    ...
    public void update() {
        ...
        for (i2 = 0; i2 < this.objects.size(); ++i2) {
            ...
            owd.distSq = FMODParameterUtils.getClosestListenerDistanceSquared(ObjectAmbientEmitters.tempVector2.x, ObjectAmbientEmitters.tempVector2.y, object.square.z);
        }
    ...
    extends PerObjectLogic {
        ...
        public boolean shouldPlaySound() {
            ...
            return this.object.hasProperty(IsoPropertyType.AMBIENT_SOUND);
        }
        ...
        public void checkParameters(BaseSoundEmitter emitter, long instance) {
            ...
            if ((isoObject = this.object) instanceof IsoLightSwitch) {
                IsoLightSwitch lightSwitch = (IsoLightSwitch)isoObject;
    ...
    extends PerObjectLogic {
        ...
        public void startPlaying(BaseSoundEmitter emitter, long instance) {
            ...
            if (sinkTypeStr != null) {
                ...
                this.setParameterValue(0, emitter, instance, "SinkType", (float)sinkType.getValue());
            }
        }
    ...
    extends PerObjectLogic {
        static SoundKey[] soundNames = new SoundKey[]{SoundKey.FRIDGE_HUM_A, SoundKey.FRIDGE_HUM_B, SoundKey.FRIDGE_HUM_C, SoundKey.FRIDGE_HUM_D, SoundKey.FRIDGE_HUM_E, SoundKey.FRIDGE_HUM_F};
        int choice = -1;
