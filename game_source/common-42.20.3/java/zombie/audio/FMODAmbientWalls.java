...
public final class FMODAmbientWalls {
    ...
    private final ObjectPool<ObjectWithDistance> objectPool = new ObjectPool<ObjectWithDistance>(ObjectWithDistance::new, "FMODAmbientWalls.objectPool");
    private final ArrayList<ObjectWithDistance> objects = new ArrayList();
    private final Slot[] slots;
    private final ObjectPool<ObjectAmbientEmitters.DoorLogic> doorLogicPool = new ObjectPool<ObjectAmbientEmitters.DoorLogic>(ObjectAmbientEmitters.DoorLogic::new, "FMODAmbientWalls.doorLogicPool");
    private final ObjectPool<ObjectAmbientEmitters.WindowLogic> windowLogicPool = new ObjectPool<ObjectAmbientEmitters.WindowLogic>(ObjectAmbientEmitters.WindowLogic::new, "FMODAmbientWalls.windowLogicPool");
    private final ObjectPool<OpenWallLogic> openWallLogicPool = new ObjectPool<OpenWallLogic>(OpenWallLogic::new, "FMODAmbientWalls.openWallLogicPool");
    ...
    private void updateEmitters() {
        ...
        for (i2 = 0; i2 < this.objects.size(); ++i2) {
            ...
            owd2.distSq = FMODParameterUtils.getClosestListenerDistanceSquared(this.tempVector2.x, this.tempVector2.y, owd2.z);
