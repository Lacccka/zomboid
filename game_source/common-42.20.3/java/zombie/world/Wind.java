...
public class Wind {
    ...
    public static String getName(int beaufortNumber) {
        return String.format(Translator.getText("UI_GameLoad_windName" + beaufortNumber, new Object[0]), new Object[0]);
    }

    public static String getDescription(int beaufortNumber) {
        return String.format(Translator.getText("UI_GameLoad_windDescription" + beaufortNumber, new Object[0]), new Object[0]);
    }
}
