...
public class DictionaryData {
    ...
    protected void load() throws IOException, WorldDictionaryException {
        ...
        try (FileInputStream inStream = new FileInputStream(path);){
            ...
            DebugType.General.printException(e, LogSeverity.Error, "Error loading WorldDictionary.", new Object[0]);
    ...
    protected void saveAsText(String saveFile) throws IOException, WorldDictionaryException {
        ...
        if (path.exists() && path.isDirectory()) {
            ...
            try (FileWriter w = new FileWriter(f, false);){
                ...
                DebugType.General.printException(ex, LogSeverity.Error, "Error saving WorldDictionary as text.", new Object[0]);
