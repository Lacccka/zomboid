...
public final class VisibilityPolygon2 {
    ...
    private final ObjectPool<VisibilityWall> visibilityWallPool = new ObjectPool<VisibilityWall>(VisibilityWall::new, "VisibilityPolygon2.visibilityWallPool", 2048);
    ...
    static final class L_render {
        ...
        static final ObjectPool<ClipperPolygon> clipperPolygonPool = new ObjectPool<ClipperPolygon>(ClipperPolygon::new, "L_render.clipperPolygonPool");
        static final ObjectPool<TFloatArrayList> floatArrayListPool = new ObjectPool<TFloatArrayList>(TFloatArrayList::new, "L_render.floatArrayListPool");
    ...
    static final class L_calculateVisibilityPolygon {
        static final ObjectPool<Segment> m_segmentPool = new ObjectPool<Segment>(Segment::new, "L_calculateVisibilityPolygon.m_segmentPool");
    ...
    public static final class ChunkLevelData {
        ...
        private final List<VisibilityWall> allWalls = new ArrayList<VisibilityWall>();
        private final List<IsoGridSquare> solidSquares = new ArrayList<IsoGridSquare>();
