...
public class AddUserToSafehouseCommand
extends CommandBase {
    ...
    protected String Command() {
        ...
        LoggerManager.getLogger(FileName.sanitize(executorName)).write(executorName + " invited user " + username.trim() + " to safehouse " + safeHouseTitle.trim());
