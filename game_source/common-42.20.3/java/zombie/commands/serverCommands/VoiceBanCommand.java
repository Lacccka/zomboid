...
extends CommandBase {
    ...
    protected String Command() {
        ...
        if (this.getCommandArgsCount() > 0) {
            boolean bl = value = !this.getCommandArg(this.getCommandArgsCount() - 1).equals("-false");
        }
        if ((p = GameServer.getPlayerByUserNameForCommand(username)) != null) {
