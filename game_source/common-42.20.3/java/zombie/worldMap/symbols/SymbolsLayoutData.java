...
public final class SymbolsLayoutData {
    static final ObjectPool<SymbolLayout> s_layoutPool = new ObjectPool<SymbolLayout>(SymbolLayout::new, "SymbolsLayoutData.s_layoutPool");
    ...
    void initMainThread(WorldMapBaseSymbol originalSymbol, WorldMapBaseSymbol symbolCopy, SymbolsLayoutData originalLayoutData, WorldMapStyle styleCopy) {
        ...
        boolean bl = layoutCopy.isAuthorHidden = originalSymbol.isShared() && WorldMapClient.getInstance().isAuthorHidden(originalSymbol.getNetworkInfo().getAuthor());
