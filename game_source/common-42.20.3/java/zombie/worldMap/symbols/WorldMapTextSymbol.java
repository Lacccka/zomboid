...
extends WorldMapBaseSymbol {
    static final ObjectPool<WorldMapTextSymbol> s_pool = new ObjectPool<WorldMapTextSymbol>(WorldMapTextSymbol::new, "WorldMapTextSymbol.s_pool");
    ...
    public String getTranslatedText() {
        ...
        if (illiterate) {
            String text = this.translated ? this.text : Translator.getText(this.text, new Object[0]);
            text = text.replaceAll("[^ ]", "?");
            return text;
        }
        return this.translated ? this.text : Translator.getText(this.text, new Object[0]);
    }
