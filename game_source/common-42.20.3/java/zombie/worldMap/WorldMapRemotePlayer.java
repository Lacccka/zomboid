...
public final class WorldMapRemotePlayer {
    ...
    public void setFullData(short changeCount, String username, String forename, String surname, String accessLevel, int rolePower, float x, float y, boolean invisible, boolean disguised, boolean seesInvisiblePlayers) {
    ...
    public String getUsername(Boolean canShowFirstname) {
        ...
        if (GameClient.client) {
            ...
            if (!bViewerIsAdmin && this.disguised) {
                nameStr = Translator.getText("IGUI_Disguised_Player_Name", new Object[0]);
