...
public class UIWorldMapV1 {
    ...
    public void addData(String fileName) {
        ...
        if (!hasData && this.ui.getWidth() > 0.0 && this.ui.getHeight() > 0.0) {
            this.renderer.setMap(this.worldMap, this.ui.getAbsoluteX().intValue(), this.ui.getAbsoluteY().intValue(), this.ui.getWidth().intValue(), this.ui.getHeight().intValue());
            this.resetView();
        }
    }
    ...
    public void setBoundsInCells(int minX, int minY, int maxX, int maxY) {
        int cellSize = 256;
        boolean changed = minX * 256 != this.worldMap.minX || minY * 256 != this.worldMap.minY || maxX * 256 + 256 - 1 != this.worldMap.maxX || maxY + 256 + 256 - 1 != this.worldMap.maxY;
    ...
    public float uiToWorldX(float uiX, float uiY) {
        ...
        return this.uiToWorldX(uiX, uiY, this.renderer.getDisplayZoomF(), this.renderer.getCenterWorldX(), this.renderer.getCenterWorldY());
    }
    ...
    public float uiToWorldY(float uiX, float uiY) {
        ...
        return this.uiToWorldY(uiX, uiY, this.renderer.getDisplayZoomF(), this.renderer.getCenterWorldY(), this.renderer.getCenterWorldY());
    }
    ...
    public float worldToUIX(float worldX, float worldY) {
        ...
        return this.worldToUIX(worldX, worldY, this.renderer.getDisplayZoomF(), this.renderer.getCenterWorldX(), this.renderer.getCenterWorldY(), this.renderer.getModelViewProjectionMatrix());
    }
    ...
    public float worldToUIY(float worldX, float worldY) {
        ...
        return this.worldToUIY(worldX, worldY, this.renderer.getDisplayZoomF(), this.renderer.getCenterWorldX(), this.renderer.getCenterWorldY(), this.renderer.getModelViewProjectionMatrix());
    }
