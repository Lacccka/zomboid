...
public enum BloodBodyPartType {
    ...
    MAX("IGUI_health_Unknown_Body_Part", new CharacterMask.Part[0]);

    private static final BloodBodyPartType[] VALUES;
    private static final Map<String, BloodBodyPartType> BY_NAME;
    private final String translationKey;
    private final CharacterMask.Part[] characterMaskParts;

    private BloodBodyPartType(String translationKey, CharacterMask.Part ... parts) {
    ...
    public String getDisplayName() {
        return Translator.getText(this.translationKey, new Object[0]);
    }

    static {
        VALUES = BloodBodyPartType.values();
        BY_NAME = new HashMap<String, BloodBodyPartType>();
