...
extends BiomeAbstract {
    ...
    extends Biome {
        public DefaultBiome() {
            super("DEFAULT", null, true, DefaultBiome.defaultMap(), null, EnumSet.of(BiomeType.Landscape.NONE), EnumSet.of(BiomeType.Plant.NONE), EnumSet.of(BiomeType.Bush.NONE), EnumSet.of(BiomeType.Temperature.NONE), EnumSet.of(BiomeType.Hygrometry.NONE), EnumSet.of(BiomeType.OreLevel.NONE), 0.0f, Map.of(), Map.of(), List.of(), new Grass(0.0f, 1.0f, List.of(Double.valueOf(0.4)), List.of(Double.valueOf(0.33), Double.valueOf(0.5))));
        }
