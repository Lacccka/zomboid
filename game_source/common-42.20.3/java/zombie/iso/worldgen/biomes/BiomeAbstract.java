...
implements IBiome {
    ...
    protected Map<FeatureType, Map<FeatureType, List<IBiome>>> subBiomes = new HashMap<FeatureType, Map<FeatureType, List<IBiome>>>();
    ...
    public boolean equals(Object o) {
        ...
        return this.generate == that.generate && Float.compare(this.zombies, that.zombies) == 0 && Objects.equals(this.landscape, that.landscape) && Objects.equals(this.plant, that.plant) && Objects.equals(this.bush, that.bush) && Objects.equals(this.temperature, that.temperature) && Objects.equals(this.hygrometry, that.hygrometry) && Objects.equals(this.oreLevel, that.oreLevel) && Objects.equals(this.placements, that.placements) && Objects.equals(this.subBiomes, that.subBiomes) && Objects.equals(this.name, that.name) && Objects.equals(this.parent, that.parent) && Objects.equals(this.grass, that.grass);
    }
