...
import zombie.iso.worldgen.maps.BiomeRaster;
...
public class BiomeMap {
    ...
    private Map<CellCoord, BiomeRaster> cache = new CacheMap<CellCoord, BiomeRaster>(16);
    ...
    public BiomeMap() {
        ...
        this.foragingZones = new ArrayList<String>();
        for (Map.Entry<Integer, BiomeMapEntry> entry : this.zoneMap.entrySet()) {
    ...
    public int[] getCell(int cellX, int cellY, Type type) {
    ...
    public int[] getZones(int chunkX, int chunkY, Type type) {
        int cellX = chunkX / 32;
        int cellY = chunkY / 32;
