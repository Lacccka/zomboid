...
extends IsoGameCharacter {
    ...
    public void render(float x, float y, float z, ColorInfo col, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        ...
        this.sprite.render(this.def, this, this.getX(), this.getY(), this.getZ(), this.getForwardIsoDirection(), offsetXX -= 34.0f, offsetYY -= 100.0f, col, true);
        try {
