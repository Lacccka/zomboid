...
public class NearestWalls {
    ...
    public static void render(int x, int y, int z, boolean exterior) {
        ...
        TextManager.instance.DrawStringCentre(UIFont.Small, (double)sx, (double)sy, String.format("%d", NearestWalls.ClosestWallDistance(chunk, x, y, z, exterior)), 1.0, 1.0, 1.0, 1.0);
    }
