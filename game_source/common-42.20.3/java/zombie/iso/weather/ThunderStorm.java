            ...
            for (i = 0; i < this.clouds.length; ++i) {
                ...
                if (currentTime < cloud.endTime) {
                    ...
                    if (Rand.Next(0.0f, 1.0f) < cloud.thunderRatio) {
                        ...
                        this.triggerThunderEvent(Rand.Next(cloud.currentX - this.strikeRadius, cloud.currentX + this.strikeRadius), Rand.Next(cloud.currentY - this.strikeRadius, cloud.currentY + this.strikeRadius), true, !Core.getInstance().getOptionDisableLightningDuringStorms(), Rand.Next(0.0f, 1.0f) > 0.4f);
                        continue;
                    }
