            ...
            block31: {
                block34: {
                    block33: {
                        block32: {
                            ...
                            block30: {
                                block28: {
                                    ...
                                    if (texdModifier != CutawayAttachedModifier.instance) break block28;
                                    IndieGL.enableDepthTest();
                                ...
                                if (dir != IsoDirections.NW) break block30;
                            ...
                            if (texdModifier == WallShaperWhole.instance || texdModifier == WallShaperSliceW.instance || texdModifier == WallShaperSliceN.instance) break block31;
                            float z2 = z;
                            if (obj != null && obj.getRenderYOffset() != 0.0f) {
                                z2 += obj.getRenderYOffset() / 96.0f;
                            }
                            if (!this.setupTileDepth(obj, x, y, z, z2, true)) break block32;
                        ...
                        if (!(obj instanceof IsoTree)) break block33;
                        IsoTree tree = (IsoTree)obj;
                        if (tree.useTreeShader) break block34;
                    }
                    IndieGL.StartShader(0);
                }
                if (FBORenderCell.instance.renderTranslucentOnly) {
