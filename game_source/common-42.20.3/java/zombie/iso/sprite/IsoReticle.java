...
public final class IsoReticle {
    ...
    public static IsoReticle getInstance(int playerIndex) {
        ...
        if (instances[playerIndex] == null) {
            IsoReticle.instances[playerIndex] = new IsoReticle(playerIndex);
        }
    ...
    public static void trySetTargetReticleMode(int playerIndex, IsoReticleMode isoReticleMode) {
        IsoReticle instance = IsoReticle.getInstance(playerIndex);
        if (instance != null) {
    ...
    public void render() {
        ...
        this.isoReticleShader.screenX = (int)((float)(screenX + AimingReticle.getXA(this.playerIndex)) - (float)width / 2.0f);
        this.isoReticleShader.screenY = (int)((float)(screenY + AimingReticle.getYA(this.playerIndex)) - (float)height / 2.0f);
