...
public class ISWorldObjectContextMenuLogic {
    ...
    public static void fetch(KahluaTable fetch, IsoObject v, double player, boolean doSquare) {
        ...
        if (doSquare && v.getSquare() != null) {
            ...
            if (worldItems != null && !worldItems.isEmpty()) {
                fetch.rawset("worldItem", (Object)worldItems.getFirst());
            }
            fetch.rawset("building", (Object)v.getSquare().getBuilding());
        }
        if (v.hasFluid()) {
            KahluaTable storeWater = (KahluaTable)fetch.rawget("storeWater");
            if (v instanceof IsoFeedingTrough) {
                IsoFeedingTrough feedingTrough = (IsoFeedingTrough)v;
                if ((feedingTrough = feedingTrough.getMasterTrough()) != null && !LuaHelpers.tableContainsValue(storeWater, feedingTrough)) {
                    storeWater.rawset(storeWater.size() + 1, (Object)feedingTrough);
                }
        ...
        if (playerObj.isDraggingCorpse() && playerObj.getJoypadBind() != -1 && playerObj.getCurrentSquare() != null) {
            IsoThumpable thumpableWindowFrame;
            IsoWindowFrame windowFrame;
            dir = playerObj.getCardinalDirection().Rot180();
            oppositeSq = playerObj.getCurrentSquare().getAdjacentSquare(dir);
            IsoWindow window = playerObj.getCurrentSquare().getWindowTo(oppositeSq);
            if (window != null) {
                fetch.rawset("window", (Object)window);
            }
            if ((windowFrame = playerObj.getCurrentSquare().getWindowFrameTo(oppositeSq)) != null) {
                fetch.rawset("windowFrame", (Object)windowFrame);
            }
            if ((thumpableWindowFrame = playerObj.getCurrentSquare().getWindowThumpableTo(oppositeSq)) != null) {
                fetch.rawset("thumpableWindow", (Object)thumpableWindowFrame);
            }
        }
        if (playerObj.isDraggingCorpse() && fetch.rawget("throwCorpseOver") == null) {
            ISWorldObjectContextMenuLogic.fetchThrowCorpseOver(playerObj, fetch, "hoppableW");
            ISWorldObjectContextMenuLogic.fetchThrowCorpseOver(playerObj, fetch, "hoppableN");
            if (playerObj.getJoypadBind() != -1 && playerObj.canThrowCorpseOver(dir = playerObj.getCardinalDirection().Rot180())) {
                oppositeSq = playerObj.getCurrentSquare().getAdjacentSquare(dir);
                IsoObject hoppable = playerObj.getCurrentSquare().getHoppableTo(oppositeSq);
                fetch.rawset("throwCorpseOver", (Object)hoppable);
            }
        }
        ...
        if (v instanceof IsoFeedingTrough) {
            IsoFeedingTrough feedingTrough = (IsoFeedingTrough)v;
            if ((feedingTrough = feedingTrough.getMasterTrough()) != null && feedingTrough.hasComponent(ComponentType.FluidContainer) && !LuaHelpers.tableContainsValue(fluidcontainer = (KahluaTable)fetch.rawget("fluidcontainer"), feedingTrough)) {
                fluidcontainer.rawset(fluidcontainer.size() + 1, (Object)feedingTrough);
            }
        } else if (v.hasComponent(ComponentType.FluidContainer) && !LuaHelpers.tableContainsValue(fluidcontainer = (KahluaTable)fetch.rawget("fluidcontainer"), v)) {
    ...
    private static KahluaTable getAllObjects(KahluaTable worldobjects) {
        ...
        HashSet<IsoGridSquare> doneSquares = new HashSet<IsoGridSquare>();
        HashSet<IsoObject> doneObjects = new HashSet<IsoObject>();
        KahluaTableIterator it = worldobjects.iterator();
        while (it.advance()) {
            IsoObject object = (IsoObject)it.getValue();
            if (doneObjects.contains(object)) continue;
            ISWorldObjectContextMenuLogic.getAllObjectOnSquare(object.getSquare(), doneSquares, doneObjects, copy);
            if (!doneObjects.add(object)) continue;
            copy.rawset(copy.len() + 1, (Object)object);
        }
        doneSquares.clear();
        doneObjects.clear();
        return copy;
    ...
    private static void getAllObjectOnSquare(IsoGridSquare square, Set<IsoGridSquare> doneSquares, Set<IsoObject> doneObjects, KahluaTable worldobjects) {
        ...
        for (int i = 0; i < square.getObjects().size(); ++i) {
            ...
            if (!doneObjects.add(object)) continue;
            worldobjects.rawset(worldobjects.len() + 1, (Object)object);
        }
    }
    ...
    public static boolean createMenuEntries(KahluaTable fetch, KahluaTable context, double player, KahluaTable worldobjects, int x, int y, boolean test) {
        ...
        if (DebugOptions.instance.uiShowContextMenuReportOptions.getValue() && health != null && Core.debug && health.getMaxHealth() > 0) {
            String text = String.format(Locale.ENGLISH, "%s: %d/%d", Translator.getText("ContextMenu_ObjectHealth", new Object[0]), health.getHealth(), health.getMaxHealth());
        ...
        if (DebugOptions.instance.uiShowContextMenuReportOptions.getValue() && (Core.debug || SandboxOptions.instance.isUnstableScriptNameSpam())) {
            if (clickedSquare != null && clickedSquare.getRoom() != null && clickedSquare.getRoom().getRoomDef() != null) {
                contextWrapper.addDebugOption(String.format(Locale.ENGLISH, "%s: %s, x: %d, y: %d, z: %d", Translator.getText("Room Report", new Object[0]), clickedSquare.getRoom().getRoomDef().getName(), clickedSquare.getX(), clickedSquare.getY(), clickedSquare.getZ()), null, null, new Object[0]);
            ...
            contextWrapper.addDebugOption(String.format("Seed: %s", WorldGenParams.INSTANCE.getSeedString()), null, null, new Object[0]);
        }
        KahluaTable allObjects = ISWorldObjectContextMenuLogic.getAllObjects(worldobjects);
        ...
        if (safehouseAllowInteract) {
            ...
            if (LuaHelpers.getJoypadState(player) != null && playerObj.getCurrentSquare() != null) {
                ...
                if (window != null && thumpableWindow != null) {
                    IsoObject thumpableWindow2 = ISWorldObjectContextMenuLogic.getBestWindowFrame(playerObj);
                    if (thumpableWindow2 instanceof IsoWindowFrame) {
                        IsoWindowFrame windowFrame = (IsoWindowFrame)thumpableWindow2;
                        fetch.rawset("window", (Object)thumpableWindow2.getSquare().getWindow(windowFrame.getNorth()));
                        fetch.rawset("windowFrame", (Object)thumpableWindow2);
                    } else if (thumpableWindow2 instanceof IsoThumpable) {
                        IsoThumpable windowFrame = (IsoThumpable)thumpableWindow2;
                        fetch.rawset("window", (Object)thumpableWindow2.getSquare().getWindow(windowFrame.getNorth()));
                        fetch.rawset("thumpableWindow", (Object)thumpableWindow2);
                    }
                }
            }
            ...
            boolean thumpableWindowResult = ISWorldObjectContextMenuLogic.doThumpableWindowFrameMenu(fetch, worldobjects, test, contextWrapper, player, hasRemoveBarricadeTool);
            ...
            if (throwOver != null && ISWorldObjectContextMenuLogic.doHoppableMenu(test, contextWrapper, throwOver, playerObj)) {
                return true;
            }
            ...
            if ((brokenGlass = (IsoBrokenGlass)fetch.rawget("brokenGlass")) != null) {
                contextWrapper.addGetUpOption(Translator.getText("ContextMenu_PickupBrokenGlass", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onPickupBrokenGlass"), brokenGlass, playerObj.getIndex());
            }
            ...
            if ((haveFuelDebug = (IsoObject)fetch.rawget("haveFuelDebug")) != null && Core.debug) {
                contextWrapper.addDebugOption(String.format(Locale.ENGLISH, "%s: %d", Translator.getText("ContextMenu_PumpFuelAmount", new Object[0]), haveFuelDebug.getPipedFuelAmount()), null, null, new Object[0]);
            }
            if ((butcherHook = fetch.rawget("butcherHook")) != null && playerObj.getVehicle() == null) {
                if (test) {
                    return true;
                }
                contextWrapper.addGetUpOption(Translator.getText("ContextMenu_ButcherHook", new Object[0]), butcherHook, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onButcherHook"), playerObj);
            }
            ...
            if ((ashes = fetch.rawget("ashes")) != null) {
                ...
                contextWrapper.addGetUpOption(Translator.getText("ContextMenu_Clear_Ashes", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onClearAshes"), player, ashes);
            }
            if ((ore = fetch.rawget("ore")) != null && playerObj.getVehicle() == null) {
                if (test) {
                    return true;
                }
                contextWrapper.addGetUpOption(Translator.getText("ContextMenu_Remove_Ore", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onRemoveGroundCoverItemHammerOrPickAxe"), player, ore);
            }
            ...
            if ((sheetRopeSquare = (IsoGridSquare)fetch.rawget("sheetRopeSquare")) != null && playerObj.canClimbSheetRope(sheetRopeSquare) && playerObj.getPerkLevel(PerkFactory.Perks.Strength) >= 0) {
                ...
                contextWrapper.addGetUpOption(Translator.getText("ContextMenu_Climb_Sheet_Rope", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onClimbSheetRope"), sheetRopeSquare, false, player);
            }
            ...
            while (iterator2.advance()) {
                ...
                if (fluidcontainer instanceof IsoFeedingTrough) {
                    IsoFeedingTrough feedingTrough = (IsoFeedingTrough)fluidcontainer;
        ...
        if ((safehouse = (SafeHouse)fetch.rawget("safehouse")) != null && safehouse.playerAllowed(playerObj)) {
            ...
            contextWrapper.addOption(Translator.getText("ContextMenu_ViewSafehouse", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onViewSafeHouse"), safehouse, playerObj);
        }
        if (!(safehouseAllowLoot = LuaHelpers.castBoolean(fetch.rawget("safehouseAllowLoot")))) {
            KahluaTable nope = contextWrapper.addOption(Translator.getText("ContextMenu_NoSafehousePermissionObjects", new Object[0]), null, null, new Object[0]);
            nope.rawset("notAvailable", (Object)true);
            LuaHelpers.callLuaClass("HaloTextHelper", "addBadText", null, playerObj, Translator.getText("ContextMenu_NoSafehousePermissionObjects", new Object[0]));
        }
        if (safehouse == null && clickedSquare != null && clickedSquare.getBuilding() != null && clickedSquare.getBuilding().getDef() != null && (reason = SafeHouse.canBeSafehouse(clickedSquare, playerObj)) != null) {
            ...
            KahluaTable option = contextWrapper.addOption(Translator.getText("ContextMenu_SafehouseClaim", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onTakeSafeHouse"), clickedSquare, player);
            if (!reason.isEmpty()) {
        ...
        if (SafeHouse.isSafehouseAllowClaimWar(safehouse, playerObj)) {
            contextWrapper.addOption(Translator.getText("ContextMenu_WarClaim", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onClaimWar"), safehouse.getOnlineID(), playerObj.getUsername());
        }
        ...
        if (safehouseAllowInteract && playerObj.getVehicle() == null) {
            ...
            if (rakedung != null && playerObj.getVehicle() == null && rakedung != shovel) {
                KahluaTable rakeOption = contextWrapper.addOption(Translator.getText("ContextMenu_Rake", new Object[0]), worldobjects, null, new Object[0]);
                ...
                rakeMenu.addGetUpOption(Translator.getText("ContextMenu_RakeDung", new Object[0]), playerObj, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onRakeDung"), rakedung);
            }
        ...
        if (playerObj.getVehicle() == null && !playerObj.isSitOnGround() && !playerObj.isSittingOnFurniture()) {
            ...
            contextWrapper.addOption(Translator.getText("ContextMenu_SitGround", new Object[0]), player, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onSitOnGround"), new Object[0]);
        }
        if (LuaHelpers.getJoypadState(player) == null && playerObj.getVehicle() == null) {
            if (test) {
                return true;
            }
            contextWrapper.addGetUpOption(Translator.getText("ContextMenu_Walk_to", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onWalkTo"), fetch.rawget("item"), player);
        }
        return false;
    }
    ...
    private static void doDestroyMenu(KahluaTable worldobjects, ItemContainer playerInv, ISContextMenuWrapper contextWrapper, IsoPlayer playerObj) {
        ...
        if (!(sledgehammer == null || sledgehammer.isBroken() || GameClient.client && !ServerOptions.getInstance().getBoolean("AllowDestructionBySledgehammer").booleanValue())) {
            KahluaTable option = contextWrapper.addOption(Translator.getText("ContextMenu_Destroy", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onDestroy"), playerObj, sledgehammer);
    ...
    private static boolean doClickedPlayerMenu(KahluaTable worldobjects, boolean test, IsoPlayer playerObj, IsoPlayer clickedPlayer, ISContextMenuWrapper contextWrapper) {
        KahluaTable option;
        boolean clickedPlayerConditionsCheck;
        boolean bl = clickedPlayerConditionsCheck = !clickedPlayer.isAnimal() && (!clickedPlayer.isInvisible() || playerObj.getRole() != null && playerObj.getRole().hasCapability(Capability.SeesInvisiblePlayers));
        if (!playerObj.hasTrait(CharacterTrait.HEMOPHOBIC) && clickedPlayerConditionsCheck) {
            if (test) {
                return true;
            }
            option = contextWrapper.addGetUpOption(Translator.getText("ContextMenu_Medical_Check", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onMedicalCheck"), playerObj, clickedPlayer);
        ...
        if (!clickedPlayer.isAsleep() && clickedPlayerConditionsCheck && GameClient.client) {
            ...
            KahluaTable kahluaTable = tradingUiInstance = tradingUi != null ? (KahluaTable)LuaHelpers.callLuaClass("ISTradingUI", "GetUIForPlayer", null, playerObj) : null;
    ...
    private static boolean doBurnBodyMenu(double player, KahluaTable worldobjects, boolean test, ItemContainer playerInv, ISContextMenuWrapper contextWrapper, IsoDeadBody body) {
        ...
        if (hasHalfLitrePetrol && (playerInv.containsTagRecurse(ItemTag.START_FIRE) || playerInv.containsTypeRecurse("Lighter") || playerInv.containsTypeRecurse("Matches"))) {
            ...
            contextWrapper.addGetUpOption(Translator.getText("ContextMenu_Burn_Corpse", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onBurnCorpse"), player, body);
        }
        return false;
    }
    ...
    private static boolean doExtinguishFireMenu(KahluaTable worldobjects, boolean test, ISContextMenuWrapper contextWrapper, IsoGridSquare firetile, InventoryItem extinguisher, IsoPlayer playerObj) {
        ...
        contextWrapper.addGetUpOption(Translator.getText("ContextMenu_ExtinguishFire", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onRemoveFire"), firetile, extinguisher, playerObj);
        return false;
    }
    ...
    private static boolean doBuryCorpseMenu(double player, boolean test, IsoObject graves, ISContextMenuWrapper contextWrapper, IsoPlayer playerObj) {
        ...
        if (playerObj.DistToSquared(graves.getX() + 0.5f, graves.getY() + 0.5f) > 1.5f) {
            ...
            toolTipWrapper.getTable().rawset("description", (Object)Translator.getText("Tooltip_grave_addcorpse_far", new Object[0]));
        }
        return false;
    }
    ...
    private static boolean doWashClothingOrYourselfMenu(KahluaTable fetch, double player, KahluaTable worldobjects, KahluaTable fetchStoreWater, KahluaTable fluidcontainer, ISContextMenuWrapper contextWrapper, IsoClothingWasher clothingWasher, IsoCombinationWasherDryer comboWasherDryer, IsoPlayer playerObj) {
        ...
        while (iterator2.advance()) {
            ...
            if (source2 == null) {
                source2 = Translator.getText("ContextMenu_NaturalWaterSource", new Object[0]);
            }
    ...
    private static boolean doShovelAndRackMenu(double player, KahluaTable worldobjects, boolean test, ISContextMenuWrapper contextWrapper, InventoryItem shovel, InventoryItem rakedung, IsoPlayer playerObj, IsoObject graves) {
        KahluaTable shovelOption = contextWrapper.addOption(Translator.getText("ContextMenu_Shovel", new Object[0]), worldobjects, null, new Object[0]);
        ...
        if (rakedung != null && playerObj.getVehicle() == null) {
            ...
            shovelMenu.addGetUpOption(Translator.getText("ContextMenu_RakeDung", new Object[0]), playerObj, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onRakeDung"), rakedung);
        }
        if ((LuaHelpers.getJoypadState(player) != null || ISWorldObjectContextMenuLogic.ISEmptyGraves_canDigHere(worldobjects)) && playerObj.getVehicle() == null) {
            ...
            shovelMenu.addGetUpOption(Translator.getText("ContextMenu_DigGraves", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onDigGraves"), player, shovel);
        }
        if (graves != null) {
            if (test) {
                return true;
    ...
    private static boolean doPadLockMenu(KahluaTable fetch, double player, KahluaTable worldobjects, boolean test, ItemContainer playerInv, ISContextMenuWrapper contextWrapper) {
        ...
        if (padlockThump != null) {
            ...
            if (padlock != null && padlock.getNumberOfKey() > 0) {
                ...
                contextWrapper.addGetUpOption(Translator.getText("ContextMenu_PutPadlock", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onPutPadlock"), player, padlockThump, padlock);
            }
            if ((digitalPadlock = playerInv.FindAndReturn("CombinationPadlock")) != null) {
                if (test) {
                    return true;
                }
                contextWrapper.addGetUpOption(Translator.getText("ContextMenu_PutCombinationPadlock", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onPutDigitalPadlock"), player, padlockThump, digitalPadlock);
            }
        }
        if ((padlockedThump = (IsoObject)fetch.rawget("padlockedThump")) != null && playerInv.haveThisKeyId(padlockedThump.getKeyId()) != null) {
            ...
            contextWrapper.addGetUpOption(Translator.getText("ContextMenu_RemovePadlock", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onRemovePadlock"), player, padlockedThump);
        }
        if ((digitalPadlockedThump = (IsoObject)fetch.rawget("digitalPadlockedThump")) != null) {
            if (test) {
                return true;
            }
            contextWrapper.addGetUpOption(Translator.getText("ContextMenu_RemoveCombinationPadlock", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onRemoveDigitalPadlock"), player, digitalPadlockedThump);
        }
        return false;
    }
    ...
    private static boolean doFishingMenu(KahluaTable fetch, KahluaTable worldobjects, boolean test, ISContextMenuWrapper contextWrapper, IsoPlayer playerObj, IsoGridSquare clickedSquare, double player, ItemContainer playerInv) {
        ...
        if (!(isNoFishZone = LuaHelpers.castBoolean(LuaHelpers.callLuaClass("Fishing", "isNoFishZone", null, clickedSquare.getX(), clickedSquare.getY())))) {
            ...
            if (LuaHelpers.castBoolean(fetch.rawget("canFish"))) {
                KahluaTable opt = contextWrapper.addOption(Translator.getText("ContextMenu_Fishing", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.openFishWindow"), new Object[0]);
    ...
    private static boolean doBedMenu(double player, boolean test, ISContextMenuWrapper contextWrapper, IsoObject bed, IsoPlayer playerObj) {
        ...
        if (!(ISWorldObjectContextMenuLogic.isSomethingTo(bed, playerObj) || bed.isFurnitureOccupied(playerObj) || playerObj.isSittingOnFurniture() && playerObj.isSitOnFurnitureObject(bed))) {
            if (test) {
                return true;
            }
            if (bed.getSquare().getRoom() == playerObj.getSquare().getRoom() || bed.getSquare().isCanSee((int)player)) {
                bedSubmenu.addGetUpOption(Translator.getText("ContextMenu_Rest", new Object[0]), bed, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onRest"), player);
            }
        }
    ...
    private static IsoObject getBestWindowFrame(IsoPlayer playerObj) {
        ...
        for (IsoDirections dir2 : dirs = new IsoDirections[]{dir, dir.Rot180(), dir.RotRight(2), dir.RotLeft(2)}) {
            IsoGridSquare square = playerSq.getAdjacentSquare(dir2);
            IsoThumpable thumpableWindow = playerSq.getWindowThumpableTo(square);
            if (thumpableWindow == null) continue;
            return thumpableWindow;
        }
        return null;
    }

    private static boolean doThumpableWindowFrameMenu(KahluaTable fetch, KahluaTable worldobjects, boolean test, ISContextMenuWrapper contextWrapper, double player, boolean hasRemoveBarricadeTool) {
        IsoPlayer playerObj = IsoPlayer.players[(int)player];
        ItemContainer playerInv = playerObj.getInventory();
        IsoThumpable thumpableWindow = (IsoThumpable)fetch.rawget("thumpableWindow");
        ...
        String windowOptionTxt = Translator.getText("ContextMenu_Window", new Object[0]);
        ...
        if (addCurtains == null && playerInv.containsTypeRecurse("Sheet")) {
            ...
            windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Add_sheet", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onAddSheet"), thumpableWindow, player);
        }
        if (thumpableWindow.canClimbThrough(playerObj)) {
            IGrappleable thrownTarget;
            if (test) {
                return true;
            }
            KahluaTable climboption = windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Climb_through", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onClimbThroughWindow"), thumpableWindow, player);
            if (LuaHelpers.getJoypadState(player) == null) {
                ISToolTipWrapper tooltip = ISWorldObjectContextMenuLogic.addToolTip();
                tooltip.setName(Translator.getText("ContextMenu_Info", new Object[0]));
            ...
            if (playerObj.isDraggingCorpse() && (thrownTarget = playerObj.getGrapplingTarget()) instanceof IsoGameCharacter) {
                ...
                params.release();
                if (canClimb) {
                    String optionTxt = Translator.getText("ContextMenu_ThrowCorpseThroughWindow", new Object[0]);
        ...
        if (thumpableWindow.isBarricadeAllowed()) {
            ISWorldObjectContextMenuLogic.doBarricadeMenu(thumpableWindow, playerObj, playerInv, windowContextWrapper);
            ...
            if (barricade != null && barricade.getNumPlanks() > 0 && hasRemoveBarricadeTool) {
                ...
                windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Unbarricade", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onUnbarricade"), thumpableWindow, playerObj.getIndex());
            }
            if (!thumpableWindow.haveSheetRope() && barricade == null && ISWorldObjectContextMenuLogic.checkBlowTorchForBarricade(playerObj) && playerInv.containsTypeRecurse("SheetMetal") && test) {
                return false;
            }
            if (!thumpableWindow.haveSheetRope() && barricade == null && ISWorldObjectContextMenuLogic.checkBlowTorchForBarricade(playerObj) && playerInv.getItemCountRecurse("Base.MetalBar") >= 3 && test) {
                return false;
            }
            if (barricade != null && barricade.isMetal() && ISWorldObjectContextMenuLogic.checkBlowTorchForBarricade(playerObj)) {
                ...
                windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Unbarricade", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onUnbarricadeMetal"), thumpableWindow, playerObj.getIndex());
            }
            if (barricade != null && barricade.isMetalBar() && ISWorldObjectContextMenuLogic.checkBlowTorchForBarricade(playerObj)) {
                if (test) {
                    return false;
                }
                windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Unbarricade", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onUnbarricadeMetalBar"), thumpableWindow, playerObj.getIndex());
            }
        }
        return false;
    }
    ...
    private static boolean doThumpableMenu(IsoThumpable thump, double player, KahluaTable worldobjects, boolean test, boolean invincibleWindow, IsoPlayer playerObj, boolean hasRemoveBarricadeTool, ISContextMenuWrapper contextWrapper) {
        if (thump.isBarricadeAllowed()) {
            ...
            if (barricade != null && barricade.getNumPlanks() > 0 && hasRemoveBarricadeTool) {
                ...
                contextWrapper.addGetUpOption(Translator.getText("ContextMenu_Unbarricade", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onUnbarricade"), thump, player);
            }
            if (barricade != null && barricade.isMetal() && ISWorldObjectContextMenuLogic.checkBlowTorchForBarricade(playerObj)) {
                if (test) {
                    return true;
                }
                contextWrapper.addGetUpOption(Translator.getText("ContextMenu_Unbarricade", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onUnbarricadeMetal"), thump, player);
            }
            if (barricade != null && barricade.isMetalBar() && ISWorldObjectContextMenuLogic.checkBlowTorchForBarricade(playerObj)) {
                if (test) {
                    return true;
                }
                contextWrapper.addGetUpOption(Translator.getText("ContextMenu_Unbarricade", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onUnbarricadeMetalBar"), thump, player);
            }
        }
        return false;
    }
    ...
    private static boolean doTreeMenu(KahluaTable fetch, KahluaTable context, KahluaTable worldobjects, boolean test, IsoPlayer playerObj, ItemContainer playerInv, ISContextMenuWrapper contextWrapper) {
        ...
        if (tree != null && (axe = playerInv.getFirstRecurse(item -> !item.isBroken() && item.hasTag(ItemTag.CHOP_TREE))) != null) {
            ...
            KahluaTable option = contextWrapper.addGetUpOption(Translator.getText("ContextMenu_Chop_Tree", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onChopTree"), playerObj, tree);
    ...
    private static boolean doFuelMenu(KahluaTable fetch, KahluaTable context, double player, boolean test, ISContextMenuWrapper contextWrapper) {
        ...
        if (haveFuel != null && fuelPower) {
            ...
            KahluaTable option = contextWrapper.addOption(Translator.getText("ContextMenu_FuelPumpNoPower", new Object[0]), null, null, new Object[0]);
            option.rawset("notAvailable", (Object)true);
        } else if (fuelPump != null && fuelPump.getPipedFuelAmount() <= 0) {
            KahluaTable option = contextWrapper.addOption(Translator.getText("ContextMenu_FuelPumpEmpty", new Object[0]), null, null, new Object[0]);
            option.rawset("notAvailable", (Object)true);
        } else if (fuelPump != null && fuelPump.getPipedFuelAmount() > 0) {
            KahluaTable option = contextWrapper.addOption(Translator.getText("ContextMenu_FuelPumpNoContainer", new Object[0]), null, null, new Object[0]);
            option.rawset("notAvailable", (Object)true);
        }
        return false;
    }
    ...
    private static boolean doPlayerMenu(KahluaTable fetch, KahluaTable worldobjects, boolean test, IsoPlayer playerObj, ISContextMenuWrapper contextWrapper) {
        ...
        if (clickedPlayer != null && clickedPlayer != playerObj) {
            boolean clickedPlayerConditionsCheck;
            boolean bl = clickedPlayerConditionsCheck = !clickedPlayer.isAnimal() && (!clickedPlayer.isInvisible() || playerObj.getRole().hasCapability(Capability.SeesInvisiblePlayers));
            if (!playerObj.hasTrait(CharacterTrait.HEMOPHOBIC) && clickedPlayerConditionsCheck) {
                if (test) {
                    return true;
                }
                KahluaTable option = contextWrapper.addGetUpOption(Translator.getText("ContextMenu_Medical_Check", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onMedicalCheck"), playerObj, clickedPlayer);
                if (RequestMedicalCheckPacket.isCheckForbidden(playerObj, clickedPlayer)) {
                    ISToolTipWrapper tooltip = ISWorldObjectContextMenuLogic.addToolTip();
                    option.rawset("notAvailable", (Object)true);
                    tooltip.getTable().rawset("description", (Object)Translator.getText("ContextMenu_GetCloser", clickedPlayer.getDisplayName()));
    ...
    private static boolean doCleaningMenu(KahluaTable fetch, double player, KahluaTable worldobjects, boolean test, IsoPlayer playerObj, ISContextMenuWrapper contextWrapper) {
        ...
        if (haveBlood != null && playerObj.getVehicle() == null) {
            ...
            KahluaTable option = contextWrapper.addGetUpOption(Translator.getText("ContextMenu_CleanStains", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onCleanBlood"), haveBlood, player);
            ISToolTipWrapper tooltip = ISWorldObjectContextMenuLogic.addToolTip();
            tooltip.getTable().rawset("description", (Object)Translator.getText("Tooltip_CleanStains", new Object[0]));
            option.rawset("toolTip", (Object)tooltip.getTable());
        }
        if ((haveGraffiti = (IsoGridSquare)fetch.rawget("haveGraffiti")) != null && playerObj.getVehicle() == null) {
            ...
            KahluaTable option = contextWrapper.addGetUpOption(Translator.getText("ContextMenu_CleanGraffiti", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onCleanGraffiti"), haveGraffiti, player);
            ISToolTipWrapper tooltip = ISWorldObjectContextMenuLogic.addToolTip();
            tooltip.getTable().rawset("description", (Object)Translator.getText("Tooltip_CleanGraffiti", new Object[0]));
            option.rawset("toolTip", (Object)tooltip.getTable());
        }
        return false;
    }
    ...
    private static boolean doGeneratorMenu(KahluaTable fetch, double player, KahluaTable worldobjects, boolean test, IsoPlayer playerObj, ISContextMenuWrapper contextWrapper, ItemContainer playerInv) {
        ...
        if (generator != null && playerObj.getVehicle() == null) {
            ...
            KahluaTable generatorOption = contextWrapper.addOption(Translator.getText("ContextMenu_Generator", new Object[0]), worldobjects, null, new Object[0]);
            ...
            KahluaTable option = generatorSubmenu.addGetUpOption(Translator.getText("ContextMenu_GeneratorInfo", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onInfoGenerator"), generator, player);
            if (playerObj.DistToSquared(generator.getX() + 0.5f, generator.getY() + 0.5f) < 4.0f) {
                tooltip = ISWorldObjectContextMenuLogic.addToolTip();
                tooltip.setName(Translator.getText("IGUI_Generator_TypeGas", new Object[0]));
            ...
            if (generator.isConnected()) {
                if (generator.isActivated()) {
                    generatorSubmenu.addGetUpOption(Translator.getText("ContextMenu_Turn_Off", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onActivateGenerator"), false, generator, player);
                } else {
                    option = generatorSubmenu.addGetUpOption(Translator.getText("ContextMenu_GeneratorUnplug", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onPlugGenerator"), generator, player, false);
                    if (generator.getFuel() > 0.0f) {
                        option = generatorSubmenu.addGetUpOption(Translator.getText("ContextMenu_Turn_On", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onActivateGenerator"), true, generator, player);
                        ...
                        if (!description.isEmpty()) {
                            ...
                            tooltip2.setName(Translator.getText("IGUI_Generator_TypeGas", new Object[0]));
                ...
                option = generatorSubmenu.addGetUpOption(Translator.getText("ContextMenu_GeneratorPlug", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onPlugGenerator"), generator, player, true);
                if (!canDo) {
                    tooltip = ISWorldObjectContextMenuLogic.addToolTip();
                    option.rawset("notAvailable", (Object)true);
                    tooltip.getTable().rawset("description", (Object)Translator.getText("ContextMenu_GeneratorPlugTT", new Object[0]));
                    option.rawset("toolTip", (Object)tooltip.getTable());
                }
            }
            ...
            if (!generator.isActivated() && generator.getFuelPercentage() < 100.0f && playerInv.getFirstRecurse(predicatePetrol) != null) {
                ...
                LuaHelpers.callLuaClass("ISWorldObjectContextMenu", "onAddFuelGenerator", null, worldobjects, petrolCan, generator, player, contextWrapper.getContextFromOption(Translator.getText("ContextMenu_Generator", new Object[0])));
            }
            if (!generator.isActivated() && (float)generator.getCondition() < 100.0f) {
                ISToolTipWrapper tooltip3;
                option = generatorSubmenu.addGetUpOption(Translator.getText("ContextMenu_GeneratorFix", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onFixGenerator"), generator, player);
                if (!canDo) {
                    tooltip3 = ISWorldObjectContextMenuLogic.addToolTip();
                    option.rawset("notAvailable", (Object)true);
                    tooltip3.getTable().rawset("description", (Object)Translator.getText("ContextMenu_GeneratorPlugTT", new Object[0]));
                    option.rawset("toolTip", (Object)tooltip3.getTable());
                }
                if (!playerInv.containsTypeRecurse("ElectronicsScrap")) {
                    tooltip3 = ISWorldObjectContextMenuLogic.addToolTip();
                    option.rawset("notAvailable", (Object)true);
                    tooltip3.getTable().rawset("description", (Object)Translator.getText("ContextMenu_GeneratorFixTT", new Object[0]));
                    option.rawset("toolTip", (Object)tooltip3.getTable());
                }
            }
            if (!generator.isConnected()) {
                generatorSubmenu.addGetUpOption(Translator.getText("ContextMenu_GeneratorTake", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onTakeGenerator"), generator, player);
            }
        }
        return false;
    }
    ...
    private static ISContextMenuWrapper doDoorMenu(KahluaTable fetch, KahluaTable context, KahluaTable worldobjects, boolean test, ISContextMenuWrapper contextWrapper, IsoPlayer playerObj, boolean hasRemoveBarricadeTool) {
        ItemContainer playerInv = playerObj.getInventory();
        String doorOptionTxt = Translator.getText("ContextMenu_Door_option", new Object[0]);
        ...
        if (door != null) {
            ...
            if (doorCurtain != null) {
                ...
                text = Translator.getText(doorCurtain.isCurtainOpen() ? "ContextMenu_Close_curtains" : "ContextMenu_Open_curtains", new Object[0]);
                doorContextWrapper.addGetUpOption(text, worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onOpenCloseCurtain"), door, playerObj.getIndex());
                ...
                KahluaTable addSheetOption = doorContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Add_sheet", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onAddSheet"), door, playerObj.getIndex());
                addSheetOption.rawset("iconTexture", (Object)Texture.getSharedTexture("Item_Sheet"));
            }
            if (test) {
                return null;
            }
            text = Translator.getText("ContextMenu_Open_door", new Object[0]);
            if (door.IsOpen()) {
                text = Translator.getText("ContextMenu_Close_door", new Object[0]);
            }
            KahluaTable opendooroption = doorContextWrapper.addGetUpOption(text, worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onOpenCloseDoor"), door, playerObj.getIndex());
            if (LuaHelpers.getJoypadState(playerObj.getIndex()) == null) {
                tooltip2 = ISWorldObjectContextMenuLogic.addToolTip();
                tooltip2.setName(Translator.getText("ContextMenu_Info", new Object[0]));
                tooltip2.getTable().rawset("description", (Object)Translator.getText("Tooltip_OpenClose", Input.getKeyName(Core.getInstance().getKey("Interact"))));
                opendooroption.rawset("toolTip", (Object)tooltip2.getTable());
            }
            if (!door.couldBeOpen(playerObj)) {
                tooltip2 = ISWorldObjectContextMenuLogic.addToolTip();
                tooltip2.setName(Translator.getText("Tooltip_DoorIsLocked", new Object[0]));
                opendooroption.rawset("toolTip", (Object)tooltip2.getTable());
                opendooroption.rawset("notAvailable", (Object)true);
            }
            if ((doorIsoObj = (IsoObject)((Object)door)).isHoppable() && door.canClimbOver(playerObj)) {
                option = doorContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Climb_over", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onClimbOverFence"), door, null, playerObj.getIndex());
                if (LuaHelpers.getJoypadState(playerObj.getIndex()) == null) {
                    tooltip = ISWorldObjectContextMenuLogic.addToolTip();
                    tooltip.setName(Translator.getText("ContextMenu_Info", new Object[0]));
            ...
            if (!door.IsOpen() && doorKeyId != null && playerObj.getInventory().haveThisKeyId((Integer)doorKeyId) != null) {
                ...
                option = !door.isLockedByKey() ? doorContextWrapper.addGetUpOption(Translator.getText("ContextMenu_LockDoor", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onLockDoor"), playerObj.getIndex(), door) : doorContextWrapper.addGetUpOption(Translator.getText("ContextMenu_UnlockDoor", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onUnLockDoor"), playerObj.getIndex(), door, doorKeyId);
                if (!door.couldBeOpen(playerObj)) {
                    tooltip = ISWorldObjectContextMenuLogic.addToolTip();
                    tooltip.setName(Translator.getText("Tooltip_DoorIsLocked", new Object[0]));
                    option.rawset("toolTip", (Object)tooltip.getTable());
                    option.rawset("notAvailable", (Object)true);
                }
            }
            ...
            if (barricade != null && barricade.getNumPlanks() > 0 && hasRemoveBarricadeTool) {
                ...
                doorContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Unbarricade", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onUnbarricade"), door, playerObj.getIndex());
            }
            if (barricade != null && barricade.isMetal() && ISWorldObjectContextMenuLogic.checkBlowTorchForBarricade(playerObj)) {
                if (test) {
                    return null;
                }
                doorContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Unbarricade", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onUnbarricadeMetal"), door, playerObj.getIndex());
            }
            if (barricade != null && barricade.isMetalBar() && ISWorldObjectContextMenuLogic.checkBlowTorchForBarricade(playerObj)) {
                if (test) {
                    return null;
                }
                doorContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Unbarricade", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onUnbarricadeMetalBar"), door, playerObj.getIndex());
            }
        }
    ...
    private static boolean doHoppableMenu(boolean test, ISContextMenuWrapper contextWrapper, IsoObject hoppable, IsoPlayer playerObj) {
        ...
        if (playerObj.isDraggingCorpse() && playerObj.canThrowCorpseOver(fromSquare, dir)) {
            ...
            String optionTxt = Translator.getText("ContextMenu_ThrowCorpseOverFence", new Object[0]);
            Object functionObj = LuaManager.getFunctionObject("ISWorldObjectContextMenu.onThrowCorpseOverFence");
            KahluaTable kahluaTable = contextWrapper.addOption(optionTxt, playerObj, functionObj, new Object[]{hoppable, dir});
        }
        return false;
    }
    ...
    private static ISContextMenuWrapper doWindowMenu(KahluaTable fetch, KahluaTable worldObjects, boolean test, ISContextMenuWrapper contextWrapper, IsoWindow window, boolean invincibleWindow, IsoPlayer playerObj, boolean hasRemoveBarricadeTool, boolean hasHammer) {
        ...
        IsoThumpable thumpableWindow = (IsoThumpable)fetch.rawget("thumpableWindow");
        String windowOptionTxt = window != null || windowFrame != null || thumpableWindow != null ? Translator.getText("ContextMenu_Window", new Object[0]) : Translator.getText("ContextMenu_escape_rope", new Object[0]);
        KahluaTable windowOption = contextWrapper.addOption(windowOptionTxt, null, null, new Object[0]);
        ISContextMenuWrapper windowContextWrapper = ISContextMenuWrapper.getNew(contextWrapper);
        contextWrapper.addSubMenu(windowOption, windowContextWrapper.getTable());
        ...
        if (window != null && !invincibleWindow) {
            ...
            Object[] curtain2 = window.HasCurtains();
            IsoCurtain isoCurtain = curtain = curtain != null ? curtain : curtain2;
            if (window.isSmashed() && !window.isGlassRemoved() && barricade == null) {
                if (test) {
                    return null;
                }
                KahluaTable option = windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_RemoveBrokenGlass", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onRemoveBrokenGlass"), window, playerObj.getIndex());
                if (playerObj.getPrimaryHandItem() == null) {
                    option.rawset("notAvailable", (Object)true);
                    tooltip = ISWorldObjectContextMenuLogic.addToolTip();
                    tooltip.getTable().rawset("description", (Object)Translator.getText("Tooltip_RemoveBrokenGlassNoItem", new Object[0]));
                    option.rawset("toolTip", (Object)tooltip.getTable());
                }
            }
            if (curtain2 == null && playerInv.containsTypeRecurse("Sheet")) {
                ...
                KahluaTable addSheetOption = windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Add_sheet", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onAddSheet"), window, playerObj.getIndex());
                addSheetOption.rawset("iconTexture", (Object)Texture.getSharedTexture("Item_Sheet"));
            }
            if (window.canClimbThrough(playerObj)) {
                ...
                KahluaTable climboption = windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Climb_through", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onClimbThroughWindow"), window, playerObj.getIndex());
                if (LuaHelpers.getJoypadState(playerObj.getIndex()) == null) {
                    tooltip = ISWorldObjectContextMenuLogic.addToolTip();
                    tooltip.setName(Translator.getText("ContextMenu_Info", new Object[0]));
                ...
                if (playerObj.isDraggingCorpse() && (thrownTarget = playerObj.getGrapplingTarget()) instanceof IsoGameCharacter) {
                    params = ClimbThroughWindowPositioningParams.alloc();
                    ClimbThroughWindowState.getClimbThroughWindowPositioningParams(playerObj, window, params);
                    canClimb = params.canClimb;
                    params.release();
                    if (canClimb) {
                        optionTxt = Translator.getText("ContextMenu_ThrowCorpseThroughWindow", new Object[0]);
                        functionObj = LuaManager.getFunctionObject("ISWorldObjectContextMenu.onThrowCorpseThroughWindow");
            ...
            if (window.IsOpen() && !window.isSmashed() && barricade == null) {
                ...
                opencloseoption = windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Close_window", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onOpenCloseWindow"), window, playerObj.getIndex());
                if (LuaHelpers.getJoypadState(playerObj.getIndex()) == null) {
                    tooltip = ISWorldObjectContextMenuLogic.addToolTip();
                    tooltip.setName(Translator.getText("ContextMenu_Info", new Object[0]));
            ...
            if (!window.IsOpen() && !window.isSmashed() && barricade == null) {
                ...
                if (window.getSprite() == null || !window.getSprite().getProperties().has("WindowLocked")) {
                    opencloseoption = windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Open_window", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onOpenCloseWindow"), window, playerObj.getIndex());
                    if (LuaHelpers.getJoypadState(playerObj.getIndex()) == null) {
                        tooltip = ISWorldObjectContextMenuLogic.addToolTip();
                        tooltip.setName(Translator.getText("ContextMenu_Info", new Object[0]));
                        tooltip.getTable().rawset("description", (Object)Translator.getText("Tooltip_OpenClose", Input.getKeyName(Core.getInstance().getKey("Interact"))));
                ...
                windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Smash_window", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onSmashWindow"), window, playerObj.getIndex());
            }
        }
        for (Object object : sheetRopeCandidates = new Object[]{fetch.rawget("window"), fetch.rawget("hoppableN"), fetch.rawget("hoppableN_2"), fetch.rawget("hoppableW"), fetch.rawget("hoppableW_2"), fetch.rawget("thumpableWindowN"), fetch.rawget("thumpableWindowN_2"), fetch.rawget("thumpableWindowW"), fetch.rawget("thumpableWindowW_2")}) {
            IsoObject isoObject;
            if (object == null || object instanceof IsoObject && (isoObject = (IsoObject)object).getSprite().getProperties().has(IsoFlagType.makeWindowInvincible)) continue;
            LuaHelpers.callLuaClass("ISWorldObjectContextMenu", "doSheetRopeOptions", null, windowContext, object, worldObjects, playerObj.getIndex(), playerObj, playerInv, hasHammer, test);
        }
        ...
        if (curtain != null && !invincibleWindow) {
            String text = Translator.getText("ContextMenu_Open_curtains", new Object[0]);
            if (curtain.IsOpen()) {
                text = Translator.getText("ContextMenu_Close_curtains", new Object[0]);
            }
            if (test) {
                return null;
            }
            ...
            if (window == null) {
                windowOption.rawset("name", (Object)Translator.getText("ContextMenu_Curtain", new Object[0]));
            ...
            if (!curtain.getSquare().getProperties().has(IsoFlagType.exterior)) {
                if (!playerObj.getCurrentSquare().has(IsoFlagType.exterior)) {
                    KahluaTable option = windowContextWrapper.addGetUpOption(text, worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onOpenCloseCurtain"), curtain, playerObj.getIndex());
                ...
                windowContextWrapper.addGetUpOption(text, worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onOpenCloseCurtain"), curtain, playerObj.getIndex());
                LuaHelpers.callLuaClass("ISWorldObjectContextMenu", "addRemoveCurtainOption", null, windowContext, worldObjects, curtain, playerObj.getIndex());
            }
        }
        if (window != null && !invincibleWindow) {
            ...
            if (barricade != null && barricade.getNumPlanks() > 0 & hasRemoveBarricadeTool) {
                ...
                windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Unbarricade", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onUnbarricade"), window, playerObj.getIndex());
            }
            if (barricade != null && barricade.isMetal() && ISWorldObjectContextMenuLogic.checkBlowTorchForBarricade(playerObj)) {
                if (test) {
                    return null;
                }
                windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Unbarricade", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onUnbarricadeMetal"), window, playerObj.getIndex());
            }
            if (barricade != null && barricade.isMetalBar() && ISWorldObjectContextMenuLogic.checkBlowTorchForBarricade(playerObj)) {
                if (test) {
                    return null;
                }
                windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Unbarricade", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onUnbarricadeMetalBar"), window, playerObj.getIndex());
            }
        }
        if (windowFrame != null && window == null && thumpableWindow == null) {
            if (windowFrame.getCurtain() == null && playerInv.containsTypeRecurse("Sheet")) {
                ...
                windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Add_sheet", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onAddSheet"), windowFrame, playerObj.getIndex());
            }
            ...
            if (windowFrame.canAddSheetRope() && !windowFrame.isBarricaded() && playerObj.getCurrentSquare().getZ() > 0 && playerInv.containsTypeRecurse("Nails")) {
                if (playerInv.getItemCountRecurse("SheetRope") >= numSheetRope) {
                    ...
                    windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Add_escape_rope_sheet", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onAddSheetRope"), windowFrame, playerObj.getIndex(), true);
                } else if (playerInv.getItemCountRecurse("Rope") >= numSheetRope) {
                    if (test) {
                        return null;
                    }
                    windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Add_escape_rope", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onAddSheetRope"), windowFrame, playerObj.getIndex(), false);
                }
            }
            if (windowFrame.haveSheetRope()) {
                ...
                windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Remove_escape_rope", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onRemoveSheetRope"), windowFrame, playerObj.getIndex());
            }
            if (windowFrame.isBarricadeAllowed()) {
                ISWorldObjectContextMenuLogic.doBarricadeMenu(windowFrame, playerObj, playerInv, windowContextWrapper);
                IsoBarricade barricade = windowFrame.getBarricadeForCharacter(playerObj);
                if (barricade != null && barricade.getNumPlanks() > 0 && hasRemoveBarricadeTool) {
                    if (test) {
                        return null;
                    }
                    windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Unbarricade", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onUnbarricade"), windowFrame, playerObj.getIndex());
                }
                ...
                if (barricade != null && barricade.isMetal() && ISWorldObjectContextMenuLogic.checkBlowTorchForBarricade(playerObj)) {
                    ...
                    windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Unbarricade", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onUnbarricadeMetal"), windowFrame, playerObj.getIndex());
                }
                if (barricade != null && barricade.isMetalBar() && ISWorldObjectContextMenuLogic.checkBlowTorchForBarricade(playerObj)) {
                    if (test) {
                        return null;
                    }
                    windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Unbarricade", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onUnbarricadeMetalBar"), windowFrame, playerObj.getIndex());
                }
            }
            if (test) {
                return null;
            ...
            if (windowFrame.canClimbThrough(playerObj) && !windowFrame.hasWindow()) {
                IGrappleable thrownTarget;
                KahluaTable climboption = windowContextWrapper.addGetUpOption(Translator.getText("ContextMenu_Climb_through", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onClimbThroughWindow"), windowFrame, playerObj.getIndex());
                if (LuaHelpers.getJoypadState(playerObj.getIndex()) == null) {
                    ISToolTipWrapper tooltip = ISWorldObjectContextMenuLogic.addToolTip();
                    tooltip.setName(Translator.getText("ContextMenu_Info", new Object[0]));
                    tooltip.getTable().rawset("description", (Object)Translator.getText("Tooltip_TapKey", Input.getKeyName(Core.getInstance().getKey("Interact"))));
    ...
    private static void doBarricadeOption(IsoPlayer playerObj, ISContextMenuWrapper contextWrapper, String tile, String itemIcon, String optionName) {
        KahluaTable option = contextWrapper.addGetUpOption(Translator.getText(optionName, new Object[0]), tile, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onBarricade"), playerObj);
        option.rawset("iconTexture", (Object)Texture.trygetTexture(itemIcon));
        if (playerObj.tooDarkToRead()) {
            option.rawset("notAvailable", (Object)true);
            ISToolTipWrapper toolTip = ISWorldObjectContextMenuLogic.addToolTip();
            option.rawset("toolTip", (Object)toolTip.getTable());
            toolTip.getTable().rawset("description", (Object)Translator.getText("IGUI_CraftingWindow_RequiresLight", new Object[0]));
        }
    }
    ...
    private static void doGardeningSubmenu(ISContextMenuWrapper contextWrapper, KahluaTable worldObjects, IsoPlayer playerObj, KahluaTable fetch, boolean test) {
        ...
        KahluaTable gardeningOption = contextWrapper.addOption(Translator.getText("ContextMenu_Gardening", new Object[0]), worldObjects, null, new Object[0]);
        ...
        if (scythe != null && playerObj.getVehicle() == null) {
            KahluaTable option = gardeningSubMenu.addGetUpOption(Translator.getText("ContextMenu_ScytheGrass", new Object[0]), playerObj, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onScytheGrass"), scythe);
        ...
        if ((canBeRemoved = (IsoGridSquare)fetch.rawget("canBeRemoved")) != null && playerObj.getVehicle() == null) {
            gardeningSubMenu.addGetUpOption(Translator.getText("ContextMenu_RemoveGrass", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onRemoveGrass"), canBeRemoved, playerNum);
        }
        ...
        if ((canBeCut = (IsoGridSquare)fetch.rawget("canBeCut")) != null && playerObj.getVehicle() == null) {
            gardeningSubMenu.addGetUpOption(Translator.getText("ContextMenu_RemoveBush", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onRemovePlant"), canBeCut, false, playerNum);
        }
        if ((wallVine = (IsoGridSquare)fetch.rawget("wallVine")) != null && playerObj.getVehicle() == null) {
            gardeningSubMenu.addGetUpOption(Translator.getText("ContextMenu_RemoveWallVine", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onRemovePlant"), wallVine, true, playerNum);
        }
        if ((stump = (IsoObject)fetch.rawget("stump")) != null && playerObj.getVehicle() == null) {
            KahluaTable option = gardeningSubMenu.addGetUpOption(Translator.getText("ContextMenu_Remove_Stump", new Object[0]), worldObjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onRemoveGroundCoverItemPickAxe"), playerNum, stump);
    ...
    private static void fetchThrowCorpseOver(IsoPlayer playerObj, KahluaTable fetch, String key) {
        ...
        Object object = fetch.rawget(key);
        if (object instanceof IsoObject) {
            IsoDirections dir;
            IsoGridSquare fromSquare;
            IsoObject object2 = (IsoObject)object;
            if (object2.hasProperty(IsoFlagType.HoppableN)) {
                if (object2.getY() <= playerObj.getY()) {
                    fromSquare = object2.getSquare();
                    dir = IsoDirections.N;
                } else {
                    fromSquare = object2.getSquare().getAdjacentSquare(IsoDirections.N);
                    dir = IsoDirections.S;
                }
            } else if (object2.getX() <= playerObj.getX()) {
                fromSquare = object2.getSquare();
                dir = IsoDirections.W;
            } else {
                fromSquare = object2.getSquare().getAdjacentSquare(IsoDirections.W);
                dir = IsoDirections.E;
            }
            if (playerObj.canThrowCorpseOver(fromSquare, dir)) {
                fetch.rawset("throwCorpseOver", (Object)object2);
            }
        }
    }
    ...
    private static boolean handleInteraction(int x, int y, boolean test, ISContextMenuWrapper context, KahluaTable worldobjects, IsoPlayer playerObj, ItemContainer playerInv) {
        ...
        while (iterator2.advance()) {
            ...
            KahluaTable option = context.addGetUpOption(Translator.getText("IGUI_DeviceOptions", new Object[0]), playerObj, LuaManager.getFunctionObject("ISWorldObjectContextMenu.activateRadio"), obj);
    ...
    private static boolean handleGrabWorldItem(KahluaTable fetch, int x, int y, boolean test, ISContextMenuWrapper context, KahluaTable worldobjects, IsoPlayer playerObj, ItemContainer playerInv) {
        ...
        if (playerObj.isGrappling()) {
            KahluaTable dropCorpseOption = context.addOption(Translator.getText("ContextMenu_Drop_Corpse", new Object[0]), playerObj, LuaManager.getFunctionObject("ISWorldObjectContextMenu.handleGrabWorldItem_onDropCorpse"), new Object[0]);
            ISToolTipWrapper toolTip = ISWorldObjectContextMenuLogic.addToolTip();
            toolTip.getTable().rawset("description", (Object)Translator.getText("Tooltip_GrappleCorpse", new Object[0]));
        ...
        while (iterator2.advance()) {
            ...
            if (worldObject instanceof IsoWorldInventoryObject) {
                IsoWorldInventoryObject inventoryObject = (IsoWorldInventoryObject)worldObject;
                InventoryItem inventoryItem = inventoryObject.getItem();
        ...
        KahluaTable grabOption = context.addOption(Translator.getText("ContextMenu_Grab", new Object[0]), worldobjects, null, new Object[0]);
        ...
        while (iterator2.advance()) {
            ...
            if (items.size() > 2) {
                ...
                subMenuItem.addOption(Translator.getText("ContextMenu_Grab_one", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onGrabWItem"), itemOne, player);
                subMenuItem.addOption(Translator.getText("ContextMenu_Grab_half", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onGrabHalfWItems"), items, player);
                subMenuItem.addOption(Translator.getText("ContextMenu_Grab_all", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onGrabAllWItems"), items, player);
                continue;
            }
        ...
        if (addedExtended) {
            KahluaTable extendedPlacementOption = context.addOption(Translator.getText("ContextMenu_ExtendedPlacement", new Object[0]), null, null, new Object[0]);
    ...
    private static void addGrabCorpseSubmenuOption(KahluaTable worldobjects, ISContextMenuWrapper subMenuGrab, IsoDeadBody corpse, double player) {
        KahluaTable opt = subMenuGrab.addGetUpOption(Translator.getText("IGUI_ItemCat_Corpse", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onGrabCorpseItem"), corpse, player);
        ...
        if (corpse.getSquare().haveFire()) {
            ...
            toolTip.getTable().rawset("description", (Object)Translator.getText("Tooltip_GrappleCorpseFire", new Object[0]));
        }
    ...
    private static void prePickupGroundCoverItem(ISContextMenuWrapper context, KahluaTable worldobjects, double player, IsoObject pickupItem) {
        ...
        if (customName != null && (groundCoverItemName = (String)(groundCoverItems = (KahluaTable)LuaManager.env.rawget("GroundCoverItems")).rawget(customName)) != null && (groundCoverItem = ScriptManager.instance.getItem(groundCoverItemName)) != null) {
            itemName = Translator.getText(groundCoverItem.getDisplayName(), new Object[0]);
        }
        if (itemName == null) {
            return;
        }
    ...
    private static void doFishNetOptions(ISContextMenuWrapper context, IsoPlayer playerObj, IsoGridSquare square) {
        KahluaTable fishNetOption = context.addOption(Translator.getText("ContextMenu_Place_Fishing_Net", new Object[0]), null, null, new Object[0]);
        ...
        ArrayList<InventoryItem> nets = playerObj.getInventory().getAllRecurse(item -> ISWorldObjectContextMenuLogic.compareType("Base.FishingNet", item));
    ...
    private static void doPlacedFishNetOptions(ISContextMenuWrapper context, IsoPlayer playerObj, IsoObject trapFish) {
        ...
        KahluaTable subOptionFishingNet = context.addOption(Translator.getText("ContextMenu_FishingNet", new Object[0]), null, null, new Object[0]);
        ...
        if (fishingNetTSObj != null) {
            ...
            if (hourElapsed > 0.0) {
                KahluaTable kahluaTable = context.addGetUpOption(Translator.getText("ContextMenu_Check_Trap", new Object[0]), null, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onCheckFishingNet"), playerObj, trapFish, hourElapsed);
            }
        }
        KahluaTable suboption = context.addGetUpOption(Translator.getText("ContextMenu_Remove_Trap", new Object[0]), null, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onRemoveFishingNet"), playerObj, trapFish);
        if (trapFish.getSquare().getModData().rawget("fishingNetBait") == null) {
            boolean isNotAvailable = false;
            suboption = context.addOption(Translator.getText("ContextMenu_Add_Bait", new Object[0]), null, null, new Object[0]);
            ...
            for (int i = 0; i < items.size(); ++i) {
                ...
                opt2.rawset("notAvailable", (Object)false);
            }
            if (items.isEmpty()) {
                suboption.rawset("notAvailable", (Object)true);
                ISToolTipWrapper toolTip = ISWorldObjectContextMenuLogic.addToolTip();
                suboption.rawset("toolTip", (Object)toolTip.getTable());
                toolTip.getTable().rawset("description", (Object)Translator.getText("Tooltip_NeedChumForAddToFishingNet", new Object[0]));
            }
        }
    }

    private static void doChumOptions(ISContextMenuWrapper context, IsoPlayer playerObj, IsoGridSquare square) {
        KahluaTable option = context.addOption(Translator.getText("ContextMenu_AddChum", new Object[0]), null, null, new Object[0]);
        ISContextMenuWrapper submenu = ISContextMenuWrapper.getNew(context);
    ...
    private static void doCreateChumOptions(ISContextMenuWrapper context, IsoPlayer playerObj, IsoGridSquare square) {
        context.addGetUpOption(Translator.getText("ContextMenu_MakeChum", new Object[0]), playerObj, LuaManager.getFunctionObject("ISWorldObjectContextMenu.doCreateChumOptions_makeChum"), square);
    }
    ...
    private static void doSleepOption(ISContextMenuWrapper context, IsoObject bed, double player, IsoPlayer playerObj) {
        ...
        String text = bed != null ? Translator.getText("ContextMenu_Sleep", new Object[0]) : Translator.getText("ContextMenu_SleepOnGround", new Object[0]);
        String bedType = ISWorldObjectContextMenuLogic.getBedQuality(playerObj, bed);
        if (bedType.equals("floorPillow")) {
            text = Translator.getText("ContextMenu_SleepOnGroundPillow", new Object[0]);
        }
        ...
        if (sleepNeeded && playerObj.getStats().get(CharacterStat.FATIGUE) <= 0.3f) {
            ...
            tooltipText = Translator.getText("IGUI_Sleep_NotTiredEnough", new Object[0]);
        }
        ...
        if (sleepNeeded && isZombies) {
            sleepOption.rawset("notAvailable", (Object)true);
            tooltipText = Translator.getText("IGUI_Sleep_NotSafe", new Object[0]);
        }
        if (sleepNeeded && playerObj.getHoursSurvived() - (double)playerObj.getLastHourSleeped() <= 1.0) {
            sleepOption.rawset("notAvailable", (Object)true);
            tooltipText = Translator.getText("ContextMenu_NoSleepTooEarly", new Object[0]);
            ...
            if (playerObj.getMoodles().getMoodleLevel(MoodleType.PAIN) >= 2 && playerObj.getStats().get(CharacterStat.FATIGUE) <= 0.85f) {
                sleepOption.rawset("notAvailable", (Object)true);
                tooltipText = Translator.getText("ContextMenu_PainNoSleep", new Object[0]);
            } else if (playerObj.getMoodles().getMoodleLevel(MoodleType.PANIC) >= 1) {
                sleepOption.rawset("notAvailable", (Object)true);
                tooltipText = Translator.getText("ContextMenu_PanicNoSleep", new Object[0]);
            }
        }
        if (bed != null && (bedTypeXln = Translator.getTextOrNull(String.format(Locale.ENGLISH, "%s%s", "Tooltip_BedType_", bedType), new Object[0])) != null) {
        ...
        if (tooltipText != null) {
            ...
            sleepTooltip.setName(Translator.getText("ContextMenu_Sleeping", new Object[0]));
    ...
    private static ISContextMenuWrapper doFluidContainerMenu(ISContextMenuWrapper context, IsoObject object, double player, IsoPlayer playerObj, KahluaTable worldObjects) {
        ...
        if (object instanceof IsoFeedingTrough) {
            IsoFeedingTrough feedingTrough = (IsoFeedingTrough)object;
        ...
        if (!isTrough) {
            mainSubMenu.addOption(Translator.getText("Fluid_Show_Info", new Object[0]), player, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onFluidInfo"), fluidContainer);
        }
        if (fluidContainer != null && fluidContainer.canPlayerEmpty()) {
            KahluaTable addFluidOption;
            mainSubMenu.addOption(Translator.getText("Fluid_Transfer_Fluids", new Object[0]), player, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onFluidTransfer"), fluidContainer);
            if (Core.debug && (addFluidOption = mainSubMenu.addDebugOption(Translator.getText("ContextMenu_AddFluid", new Object[0]), player, null, null, null)) != null) {
                ...
                for (FluidType fluidType : fluidTypes) {
                    ...
                    if (fluid == null || !fluidContainer.canAddFluid(fluid)) continue;
                    addFluidSubmenu.addOption(fluidType.toString(), playerObj, LuaManager.getFunctionObject("ISWorldObjectContextMenu.addFluidDebug"), fluidContainer, fluid);
                }
            }
            if (object.hasFluid()) {
            ...
            if (object.hasFluid() && object.getFluidCapacity() < 9999.0f) {
                mainSubMenu.addOption(Translator.getText("Fluid_Empty", new Object[0]), player, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onFluidEmpty"), fluidContainer);
            }
        }
        return mainSubMenu;
    }
    ...
    private static void addFluidFromItem(KahluaTable fetch, boolean test, ISContextMenuWrapper context, IsoObject pourFluidInto, KahluaTable worldobjects, IsoPlayer playerObj, ItemContainer playerInv) {
        ...
        if (!pourOut.isEmpty() && !test && pourFluidInto.getFluidAmount() < pourFluidInto.getFluidCapacity()) {
            KahluaTable subMenuOption = context.addOption(Translator.getText("ContextMenu_AddFluidFromItem", new Object[0]), worldobjects, null, new Object[0]);
            ISContextMenuWrapper subMenu = ISContextMenuWrapper.getNew(context);
            ...
            while (iterator2.advance()) {
                ...
                int tx = TextManager.instance.MeasureStringX(font, String.format(Locale.ENGLISH, "%s:", Translator.getText("ContextMenu_WaterName", new Object[0]))) + 20;
                String descriptionText = String.format(Locale.ENGLISH, "%s: <SETX.%d> %d / %d", Translator.getText("ContextMenu_WaterName", new Object[0]), tx, item.getCurrentUses(), Double.valueOf(Math.floor(1.0f / drainableItem.getUseDelta() + 1.0E-4f)).intValue());
                ...
                if (fc != null && fc.isTainted() && SandboxOptions.getInstance().enableTaintedWaterText.getValue()) {
                    tooltip.getTable().rawset("description", (Object)String.format(Locale.ENGLISH, "%s <BR> <RGB.1,0.5,0.5> %s", descriptionText, Translator.getText("Tooltip_item_TaintedWater", new Object[0])));
                }
                subOption.rawset("toolTip", (Object)tooltip.getTable());
            }
        }
    ...
    private static String formatWaterAmount(IsoObject object, float amount, float max) {
        if (max >= 9999.0f) {
            return String.format(Locale.ENGLISH, "%s: %s", object.getFluidUiName(), Translator.getText("Tooltip_WaterUnlimited", new Object[0]));
        }
        return String.format(Locale.ENGLISH, "%s: %.2fL / %.2fL", object.getFluidUiName(), Float.valueOf(amount), Float.valueOf(max));
    }
    ...
    private static void doDrinkWaterMenu(IsoObject object, double player, IsoPlayer playerObj, KahluaTable worldobjects, ISContextMenuWrapper context) {
        ...
        KahluaTable option = context.addGetUpOption(Translator.getText("ContextMenu_Drink", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onDrink"), object, player);
        ...
        descriptionText = String.format(Locale.ENGLISH, "%s%s", descriptionText, ISWorldObjectContextMenuLogic.formatWaterAmount(object, waterAmount, waterMax));
        tooltip.getTable().rawset("description", (Object)descriptionText);
        if (object.isTaintedWater() && SandboxOptions.getInstance().enableTaintedWaterText.getValue()) {
            descriptionText = String.format(Locale.ENGLISH, "%s <BR> <RGB.1,0.5,0.5> %s", descriptionText, Translator.getText("Tooltip_item_TaintedWater", new Object[0]));
            tooltip.getTable().rawset("description", (Object)descriptionText);
        }
        option.rawset("toolTip", (Object)tooltip.getTable());
    }
    ...
    private static void doFillFluidMenu(IsoObject sink2, double playerNum, IsoPlayer playerObj, KahluaTable worldobjects, ISContextMenuWrapper context) {
        ...
        KahluaTable fillOption = context.addOption(Translator.getText("ContextMenu_Fill", new Object[0]), worldobjects, null, new Object[0]);
        ...
        if (playerObj.hasFullInventory()) {
            ISToolTipWrapper tooltip = ISWorldObjectContextMenuLogic.addToolTip();
            fillOption.rawset("notAvailable", (Object)true);
            tooltip.getTable().rawset("description", (Object)Translator.getText("ContextMenu_FullInventory", new Object[0]));
        ...
        if (allContainers.size() > 1) {
            containerOption = containerMenu.addGetUpOption(Translator.getText("ContextMenu_FillAll", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onTakeWater"), sink2, allContainers, null, playerNum);
        ...
        while (iterator2.advance()) {
            ...
            if (containerType.size() > 1) {
                ...
                containerTypeOption = containerTypeMenu.addGetUpOption(Translator.getText("ContextMenu_FillOne", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onTakeWater"), sink2, LuaManager.platform.newTable(), destItem, playerNum);
                containerTypeOption.rawset("toolTip", (Object)tooltipTable);
                if (containerType.rawget(2) == null) continue;
                containerTypeOption = containerTypeMenu.addGetUpOption(Translator.getText("ContextMenu_FillAll", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onTakeWater"), sink2, containerType, null, playerNum);
                containerTypeOption.rawset("toolTip", (Object)tooltipTable);
                continue;
            }
            ...
            if (t != null) {
                if (destItem instanceof DrainableComboItem) {
                    ...
                    newDescription = String.format(Locale.ENGLISH, "%s <LINE> %s: %d/10", newDescription, Translator.getText("ContextMenu_ItemWaterCapacity", new Object[0]), Double.valueOf(Math.floor(destItem.getCurrentUsesFloat() * 10.0f)).intValue());
    ...
    private static ISToolTipWrapper createWaterSourceTooltip(IsoObject sink2) {
        ...
        if (sink2.isTaintedWater() && SandboxOptions.getInstance().enableTaintedWaterText.getValue()) {
            if (!description.isEmpty()) {
                description = String.format(Locale.ENGLISH, "%s\n<RGB:1,0.5,0.5> %s", description, Translator.getText("Tooltip_item_TaintedWater", new Object[0]));
                tooltip.getTable().rawset("description", (Object)description);
            } else {
                description = String.format(Locale.ENGLISH, "<RGB:1,0.5,0.5> %s", Translator.getText("Tooltip_item_TaintedWater", new Object[0]));
                tooltip.getTable().rawset("description", (Object)description);
            }
        }
    ...
    private static void setWashClothingTooltip(double soapRemaining, double waterRemaining, double soapRequired, double waterRequired, KahluaTable washList, KahluaTable option) {
        ...
        description = soapRemaining < soapRequired ? (String)description + Translator.getText("IGUI_Washing_WithoutSoap", new Object[0]) + " <LINE> " : String.format(Locale.ENGLISH, "%s%s: %.2f / %.0f <LINE> ", description, Translator.getText("IGUI_Washing_Soap", new Object[0]), Math.min(soapRemaining, soapRequired), soapRequired);
        description = String.format(Locale.ENGLISH, "%s%s: %.2f / %.0f", description, Translator.getText("ContextMenu_WaterName", new Object[0]), Math.min(waterRemaining, waterRequired), waterRequired);
    ...
    private static void doWashClothingMenu(IsoObject sink2, double player, IsoPlayer playerObj, ISContextMenuWrapper context) {
        ...
        if (washYourself || washEquipment) {
            ...
            double soapRequired;
            KahluaTable mainOption = context.addOption(Translator.getText("ContextMenu_Wash", new Object[0]), null, null, new Object[0]);
            ISContextMenuWrapper mainSubMenu = ISContextMenuWrapper.getNew(context);
            ...
            if (washYourself) {
                ...
                KahluaTable option = mainSubMenu.addGetUpOption(Translator.getText("ContextMenu_Yourself", new Object[0]), playerObj, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onWashYourself"), sink2, barSoapsList);
                tooltip = ISWorldObjectContextMenuLogic.addToolTip();
                description = LuaHelpers.castString(tooltip.getTable().rawget("description"));
                description = soapRemaining < soapRequired ? String.format(Locale.ENGLISH, "%s%s <LINE> ", description, Translator.getText("IGUI_Washing_WithoutSoap", new Object[0])) : String.format(Locale.ENGLISH, "%s%s: %.2f / %.2f <LINE> ", description, Translator.getText("IGUI_Washing_Soap", new Object[0]), Math.min(soapRemaining, soapRequired), soapRequired);
                description = String.format(Locale.ENGLISH, "%s%s: %.2f / %.2f", description, Translator.getText("ContextMenu_WaterName", new Object[0]), Math.min((double)waterRemaining, waterRequired), waterRequired);
                ...
                if (bodyBlood > 0.0f) {
                    description = String.format(Locale.ENGLISH, "%s <LINE> %s: %.0f / 100", description, Translator.getText("Tooltip_clothing_bloody", new Object[0]), Math.ceil(bodyBlood / (float)BloodBodyPartType.MAX.index() * 100.0f));
                }
                if (bodyDirt > 0.0f) {
                    description = String.format(Locale.ENGLISH, "%s <LINE> %s: %.0f / 100", description, Translator.getText("Tooltip_clothing_dirty", new Object[0]), Math.ceil(bodyDirt / (float)BloodBodyPartType.MAX.index() * 100.0f));
                }
                tooltip.getTable().rawset("description", description);
                option.rawset("toolTip", (Object)tooltip.getTable());
            ...
            if (washEquipment) {
                ...
                if (!washList.isEmpty()) {
                    ...
                    if (!washClothing.isEmpty()) {
                        ...
                        option = mainSubMenu.addGetUpOption(Translator.getText("ContextMenu_WashAllClothing", new Object[0]), playerObj, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onWashClothing"), sink2, soapList, washClothing, null);
                    ...
                    if (!washContainer.isEmpty()) {
                        ...
                        soapRequired = LuaHelpers.castDouble(result[0]);
                        waterRequired = LuaHelpers.castDouble(result[1]);
                        option = mainSubMenu.addGetUpOption(Translator.getText("ContextMenu_WashAllContainer", new Object[0]), playerObj, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onWashClothing"), sink2, soapList, washContainer, null);
                    ...
                    if (!washWeapon.isEmpty()) {
                        ...
                        soapRequired = LuaHelpers.castDouble(result[0]);
                        waterRequired = LuaHelpers.castDouble(result[1]);
                        option = mainSubMenu.addGetUpOption(Translator.getText("ContextMenu_WashAllWeapon", new Object[0]), playerObj, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onWashClothing"), sink2, soapList, washWeapon, null);
                    ...
                    if (!washOther.isEmpty()) {
                        ...
                        soapRequired = LuaHelpers.castDouble(result[0]);
                        waterRequired = LuaHelpers.castDouble(result[1]);
                        option = mainSubMenu.addGetUpOption(Translator.getText("ContextMenu_WashAllBandage", new Object[0]), playerObj, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onWashClothing"), sink2, soapList, washOther, null);
                ...
                while (iterator2.advance()) {
                    ...
                    tooltip = ISWorldObjectContextMenuLogic.addToolTip();
                    description = LuaHelpers.castString(tooltip.getTable().rawget("description"));
                    description = soapRemaining < soapRequired2 ? (String)description + Translator.getText("IGUI_Washing_WithoutSoap", new Object[0]) + " <LINE> " : String.format(Locale.ENGLISH, "%s%s: %.0f / %.0f <LINE> ", description, Translator.getText("IGUI_Washing_Soap", new Object[0]), Math.min(soapRemaining, soapRequired2), soapRequired2);
                    description = String.format(Locale.ENGLISH, "%s%s: %.2f / %.0f", description, Translator.getText("ContextMenu_WaterName", new Object[0]), Math.min((double)waterRemaining, waterRequired2), waterRequired2);
                    if ((item.IsClothing() || item.IsInventoryContainer() || item.IsWeapon()) && item.getBloodLevel() > 0.0f) {
                        description = String.format(Locale.ENGLISH, "%s <LINE> %s: %.0f / 100", description, Translator.getText("Tooltip_clothing_bloody", new Object[0]), Math.ceil(item.getBloodLevelAdjustedHigh()));
                    }
                    if (item.IsClothing() && ((Clothing)item).getDirtiness() > 0.0f) {
                        description = String.format(Locale.ENGLISH, "%s <LINE> %s: %.0f / 100", description, Translator.getText("Tooltip_clothing_dirty", new Object[0]), Math.ceil(((Clothing)item).getDirtiness()));
                    }
                    tooltip.getTable().rawset("description", description);
    ...
    private static void doRecipeUsingWaterMenu(IsoObject waterObject, IsoPlayer playerObj, ISContextMenuWrapper context) {
        ...
        ISContextMenuWrapper subMenu = ISContextMenuWrapper.getNew(context);
        KahluaTable subOption = context.addOption(Translator.getText("ContextMenu_CleanBandageEtc", new Object[0]), null, null, new Object[0]);
        context.addSubMenu(subOption, subMenu.getTable());
        double numItems = 0.0;
        ...
        if (waterObject.isTaintedWater() && SandboxOptions.getInstance().enableTaintedWaterText.getValue()) {
            ISToolTipWrapper tooltip = ISWorldObjectContextMenuLogic.addToolTip();
            tooltip.getTable().rawset("description", (Object)(" <RGB.1,0.5,0.5> " + Translator.getText("Tooltip_item_TaintedWater", new Object[0])));
            tooltip.getTable().rawset("maxLineWidth", (Object)512.0);
            option.rawset("toolTip", (Object)tooltip.getTable());
            option.rawset("notAvailable", (Object)true);
        }
    ...
    private static boolean toggleClothingWasher(ISContextMenuWrapper context, KahluaTable worldobjects, double playerId, IsoPlayer playerObj, IsoClothingWasher object) {
        ...
        KahluaTable option = object.isActivated() ? context.addGetUpOption(Translator.getText("ContextMenu_Turn_Off", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onToggleClothingWasher"), object, playerId) : context.addGetUpOption(Translator.getText("ContextMenu_Turn_On", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onToggleClothingWasher"), object, playerId);
        if (!object.getContainer().isPowered() || object.getFluidAmount() <= 0.0f) {
            ...
            if (!object.getContainer().isPowered()) {
                description = Translator.getText("IGUI_RadioRequiresPowerNearby", new Object[0]);
            }
            if (object.getFluidAmount() <= 0.0f) {
                description = !((String)description).isEmpty() ? (String)description + "\n" + Translator.getText("IGUI_RequiresWaterSupply", new Object[0]) : Translator.getText("IGUI_RequiresWaterSupply", new Object[0]);
            }
            toolTip.getTable().rawset("description", description);
        }
        return false;
    ...
    private static boolean toggleComboWasherDryer(ISContextMenuWrapper context, IsoPlayer playerObj, IsoCombinationWasherDryer object, boolean bAddObjectSubmenu) {
        ...
        KahluaTable option = object.isActivated() ? subMenu.addGetUpOption(Translator.getText("ContextMenu_Turn_Off", new Object[0]), playerObj, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onToggleComboWasherDryer"), object) : subMenu.addGetUpOption(Translator.getText("ContextMenu_Turn_On", new Object[0]), playerObj, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onToggleComboWasherDryer"), object);
        String string = label = object.isModeWasher() ? Translator.getText("ContextMenu_ComboWasherDryer_SetModeDryer", new Object[0]) : Translator.getText("ContextMenu_ComboWasherDryer_SetModeWasher", new Object[0]);
    ...
    private static boolean toggleClothingDryer(ISContextMenuWrapper context, double playerId, IsoPlayer playerObj, KahluaTable worldobjects, IsoClothingDryer object) {
        ...
        KahluaTable option = object.isActivated() ? context.addGetUpOption(Translator.getText("ContextMenu_Turn_Off", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onToggleClothingDryer"), object, playerId) : context.addGetUpOption(Translator.getText("ContextMenu_Turn_On", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onToggleClothingDryer"), object, playerId);
        if (!object.getContainer().isPowered()) {
            option.rawset("notAvailable", (Object)true);
            ISToolTipWrapper toolTip = ISWorldObjectContextMenuLogic.addToolTip();
            option.rawset("toolTip", (Object)toolTip.getTable());
            toolTip.setVisible(false);
            toolTip.setName(ISWorldObjectContextMenuLogic.getMoveableDisplayName(object));
            toolTip.getTable().rawset("description", (Object)Translator.getText("IGUI_RadioRequiresPowerNearby", new Object[0]));
        }
        return false;
    }
    ...
    private static boolean onWashingDryer(String source2, ISContextMenuWrapper context, IsoClothingDryer object, IsoPlayer player, KahluaTable worldobjects) {
        ...
        ISContextMenuWrapper mainSubMenu = ISContextMenuWrapper.getNew(context);
        context.addSubMenu(mainOption, mainSubMenu.getTable());
        return ISWorldObjectContextMenuLogic.toggleClothingDryer(mainSubMenu, player.getIndex(), player, worldobjects, object);
    }
    ...
    private static boolean doStoveOption(KahluaTable fetch, boolean test, ISContextMenuWrapper context, double player, IsoPlayer playerObj) {
        ...
        if (stove != null && !ISWorldObjectContextMenuLogic.isSomethingTo(stove, playerObj) && !Core.getInstance().getGameMode().equals("LastStand") && stove.getContainer() != null && stove.getContainer().isPowered()) {
            ...
            stoveMenu.addGetUpOption(Translator.getText(key, new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onToggleStove"), stove, player);
            ...
            if (itemContainer instanceof ItemContainer) {
                ...
                if (container.isMicrowave()) {
                    stoveMenu.addGetUpOption(Translator.getText("ContextMenu_StoveSetting", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onMicrowaveSetting"), stove, player);
                } else if (container.isStove()) {
                    stoveMenu.addGetUpOption(Translator.getText("ContextMenu_StoveSetting", new Object[0]), worldobjects, LuaManager.getFunctionObject("ISWorldObjectContextMenu.onStoveSetting"), stove, player);
                }
            }
        }
        return false;
    ...
    private static void addTileDebugInfo(ISContextMenuWrapper context, KahluaTable fetch) {
        ...
        KahluaTable option = context.addDebugOption(Translator.getText("Tile Report", new Object[0]) + ": " + LuaHelpers.castString(fetch.rawget("tilename")), null, null, new Object[0]);
        if (option == null) {
            return;
        }
        ISToolTipWrapper toolTipWrapper = new ISToolTipWrapper();
        ...
        if (tileObj != null) {
            ...
            params.append("\n").append(Translator.getText("ContextMenu_IsMovedThumpable", new Object[0])).append(" = ").append(movedThumpable).append("\n");
            params.append(Translator.getText("ContextMenu_IsThumpable", new Object[0])).append(" = ").append(thumpable).append("\n");
            params.append(Translator.getText("ContextMenu_HasHealth", new Object[0])).append(" = ").append(health != null).append("\n");
            params.append(Translator.getText("ContextMenu_IsBreakableFence", new Object[0])).append(" = ").append(BrokenFences.getInstance().isBreakableObject(tileObj)).append("\n");
            params.append("\n");
            if (movedThumpable || thumpable || BrokenFences.getInstance().isBreakableObject(tileObj) || health != null) {
                params.append(Translator.getText("ContextMenu_IsZombieThumpable", new Object[0])).append("\n");
            } else {
                params.append(Translator.getText("ContextMenu_IsNotZombieThumpable", new Object[0])).append("\n");
            }
            if (thumpable || health != null) {
                params.append(Translator.getText("ContextMenu_IsPlayerThumpable", new Object[0])).append("\n");
            } else {
                params.append(Translator.getText("ContextMenu_IsNotPlayerThumpable", new Object[0])).append("\n");
            }
        }
    ...
    private static void doContextConfigOptions(ISContextMenuWrapper context, GameEntity entity, IsoPlayer playerObj) {
        ...
        for (int n = 0; n < entries.size(); ++n) {
            ...
            String textRef = Translator.getText(String.valueOf(text.append(entry.getMenu())), new Object[0]);
