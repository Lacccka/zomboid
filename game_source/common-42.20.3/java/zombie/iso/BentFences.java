...
public class BentFences {
    ...
    public void bendFence(IsoObject obj, IsoDirections dir) {
        ...
        SoundKey thumpSound = obj.getProperties().get("ThumpSound") != null ? SoundKey.get(ResourceLocation.of(obj.getProperties().get("ThumpSound"))) : SoundKey.ZOMBIE_THUMP_GENERIC;
