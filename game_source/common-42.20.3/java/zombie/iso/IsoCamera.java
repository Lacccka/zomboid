...
public class IsoCamera {
    ...
    public static void SetCharacterToFollow(IsoGameCharacter isoGameCharacter) {
        ...
        if (!GameClient.client && !GameServer.server && (isoGameCharacter2 = (isoCameraGameCharacter = isoGameCharacter)) instanceof IsoPlayer && (isoPlayer = (IsoPlayer)isoGameCharacter2).isLocalPlayer() && UIManager.getMoodleUI(isoPlayer.getIndex()) != null) {
    ...
    public static float getRightClickOffX() {
        return IsoCamera.cameras[IsoPlayer.getPlayerIndex()].rightClickX;
    }

    public static float getRightClickOffY() {
        return IsoCamera.cameras[IsoPlayer.getPlayerIndex()].rightClickY;
    }
