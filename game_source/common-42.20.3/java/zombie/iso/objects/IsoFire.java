...
extends IsoObject {
    ...
    public void renderAnimatedAttachments(float x, float y, float z, ColorInfo col) {
        ...
        for (int i = 0; i < this.attachedAnimSprite.size(); ++i) {
            ...
            if (sprite == null || sprite.def == null || (tex = sprite.getTextureForCurrentFrame(this.getForwardIsoDirection(), this)) == null) continue;
            ...
            spriteInstance.getParentSprite().render(spriteInstance, this, x + 0.0f, y + 0.0f, z, this.getForwardIsoDirection(), offsetX, offsetY, tempColorInfo, true);
            sprite.soffX = soffX;
            sprite.soffY = soffY;
        }
    }
