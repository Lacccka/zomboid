...
implements IItemProvider {
    ...
    public String getFluidUiName() {
        ...
        return Translator.getText("Fluid_HoldingOneType", this.getFluidContainer().getTranslatedContainerName(), Translator.getText("Fluid_Empty", new Object[0]));
    }
    ...
    public void render(float x, float y, float z, ColorInfo col, boolean bDoChild, boolean bWallLightingPass, Shader shader) {
        ...
        this.sprite.render(this, x + this.xoff, y + this.yoff, z + this.zoff, this.getForwardIsoDirection(), this.offsetX + dx, this.offsetY + dy, col, true);
        col.set(r, g, b, a);
