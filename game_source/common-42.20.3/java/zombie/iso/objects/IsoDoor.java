...
ICurtain {
    ...
    private void prerender1xN(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        if (this.curtainInside) {
            if (!this.north && this.isOpen()) {
                (this.curtainOpen ? this.curtainSopen : this.curtainS).render(null, x, y - 1.0f, z, this.getForwardIsoDirection(), this.offsetX + 3.0f, this.offsetY + (float)(this.curtainOpen ? -14 : -14), info, true);
            }
        } else if (this.north && !this.isOpen()) {
            (this.curtainOpen ? this.curtainSopen : this.curtainS).render(null, x, y - 1.0f, z, this.getForwardIsoDirection(), this.offsetX - 1.0f - 1.0f, this.offsetY + -15.0f, info, true);
        }
    }
    ...
    private void postrender1xN(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        if (this.curtainInside) {
            if (this.north && !this.isOpen()) {
                (this.curtainOpen ? this.curtainNopen : this.curtainN).render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX - 10.0f - 1.0f, this.offsetY + -10.0f, info, true);
            }
        } else if (!this.north && this.isOpen()) {
            (this.curtainOpen ? this.curtainNopen : this.curtainN).render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX - 4.0f, this.offsetY + (float)(this.curtainOpen ? -10 : -10), info, true);
        }
    }
    ...
    private void prerender1xS(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        ...
        if (!this.curtainInside) {
            (this.curtainOpen ? this.curtainSopen : this.curtainS).render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX + (float)((this.curtainOpen ? -14 : -14) / 2), this.offsetY + (float)((this.curtainOpen ? -16 : -16) / 2), info, true);
        }
    }
    ...
    private void postrender1xS(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        assert (!this.north && this.isOpen());
        if (this.curtainInside) {
            (this.curtainOpen ? this.curtainNopen : this.curtainN).render(null, x, y + 1.0f, z, this.getForwardIsoDirection(), this.offsetX + (float)((this.curtainOpen ? -28 : -28) / 2), this.offsetY + (float)((this.curtainOpen ? -8 : -8) / 2), info, true);
        }
    }
    ...
    private void prerender1xW(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        if (this.curtainInside) {
            if (this.north && this.isOpen()) {
                (this.curtainOpen ? this.curtainEopen : this.curtainE).render(null, x - 1.0f, y, z, this.getForwardIsoDirection(), this.offsetX + (float)(this.curtainOpen ? -16 : -18), this.offsetY + (float)(this.curtainOpen ? -14 : -15), info, true);
            }
            if (!this.north && this.isOpen()) {
                (this.curtainOpen ? this.curtainSopen : this.curtainS).render(null, x, y - 1.0f, z, this.getForwardIsoDirection(), this.offsetX + 3.0f, this.offsetY + (float)(this.curtainOpen ? -14 : -14), info, true);
            }
            ...
            if (!this.north && !this.isOpen()) {
                (this.curtainOpen ? this.curtainEopen : this.curtainE).render(null, x - 1.0f, y, z, this.getForwardIsoDirection(), this.offsetX + (float)(this.curtainOpen ? -12 : -14), this.offsetY + (float)(this.curtainOpen ? -14 : -15), info, true);
            }
        }
    }
    ...
    private void postrender1xW(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        if (this.curtainInside) {
            ...
            if (!this.north && !this.isOpen()) {
                (this.curtainOpen ? this.curtainWopen : this.curtainW).render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX - 2.0f - 1.0f, this.offsetY + -10.0f, info, true);
            }
        } else {
            if (this.north && this.isOpen()) {
                (this.curtainOpen ? this.curtainWopen : this.curtainW).render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX - 9.0f, this.offsetY + -10.0f, info, true);
            }
            if (!this.north && this.isOpen()) {
                (this.curtainOpen ? this.curtainNopen : this.curtainN).render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX - 4.0f, this.offsetY + (float)(this.curtainOpen ? -10 : -10), info, true);
            }
    ...
    private void prerender1xE(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        assert (this.north && this.isOpen());
        if (!this.curtainInside) {
            (this.curtainOpen ? this.curtainEopen : this.curtainE).render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX + (float)((this.curtainOpen ? -13 : -18) / 2), this.offsetY + (float)((this.curtainOpen ? -15 : -18) / 2), info, true);
        }
    }
    ...
    private void postrender1xE(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        assert (this.north && this.isOpen());
        if (this.curtainInside) {
            (this.curtainOpen ? this.curtainWopen : this.curtainW).render(null, x + 1.0f, y, z, this.getForwardIsoDirection(), this.offsetX + (float)(this.curtainOpen ? false : false), this.offsetY + (float)(this.curtainOpen ? false : false), info, true);
        }
    }
    ...
    private void prerender2xN(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        if (this.curtainInside) {
            if (!this.north && this.isOpen()) {
                (this.curtainOpen ? this.curtainSopen : this.curtainS).render(null, x, y - 1.0f, z, this.getForwardIsoDirection(), this.offsetX + 7.0f, this.offsetY + (float)(this.curtainOpen ? -28 : -28), info, false);
            }
        } else if (this.north && !this.isOpen()) {
            (this.curtainOpen ? this.curtainSopen : this.curtainS).render(null, x, y - 1.0f, z, this.getForwardIsoDirection(), this.offsetX - 3.0f, this.offsetY + (float)(this.curtainOpen ? -30 : -30), info, false);
        }
    }
    ...
    private void postrender2xN(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        if (this.curtainInside) {
            if (this.north && !this.isOpen()) {
                (this.curtainOpen ? this.curtainNopen : this.curtainN).render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX - 20.0f, this.offsetY + (float)(this.curtainOpen ? -20 : -20), info, false);
            }
        } else if (!this.north && this.isOpen()) {
            (this.curtainOpen ? this.curtainNopen : this.curtainN).render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX - 8.0f, this.offsetY + (float)(this.curtainOpen ? -20 : -20), info, false);
        }
    }
    ...
    private void prerender2xS(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        assert (!this.north && this.isOpen());
        if (!this.curtainInside) {
            (this.curtainOpen ? this.curtainSopen : this.curtainS).render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX + (float)(this.curtainOpen ? -14 : -14), this.offsetY + (float)(this.curtainOpen ? -16 : -16), info, false);
        }
    }
    ...
    private void postrender2xS(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        assert (!this.north && this.isOpen());
        if (this.curtainInside) {
            (this.curtainOpen ? this.curtainNopen : this.curtainN).render(null, x, y + 1.0f, z, this.getForwardIsoDirection(), this.offsetX + (float)(this.curtainOpen ? -28 : -28), this.offsetY + (float)(this.curtainOpen ? -8 : -8), info, false);
        }
    }
    ...
    private void prerender2xW(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        if (this.curtainInside) {
            if (this.north && this.isOpen()) {
                (this.curtainOpen ? this.curtainEopen : this.curtainE).render(null, x - 1.0f, y, z, this.getForwardIsoDirection(), this.offsetX + (float)(this.curtainOpen ? -32 : -37), this.offsetY + (float)(this.curtainOpen ? -28 : -31), info, false);
            }
        } else if (!this.north && !this.isOpen()) {
            (this.curtainOpen ? this.curtainEopen : this.curtainE).render(null, x - 1.0f, y, z, this.getForwardIsoDirection(), this.offsetX + (float)(this.curtainOpen ? -22 : -26), this.offsetY + (float)(this.curtainOpen ? -28 : -31), info, false);
        }
    }
    ...
    private void postrender2xW(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        if (this.curtainInside) {
            if (!this.north && !this.isOpen()) {
                (this.curtainOpen ? this.curtainWopen : this.curtainW).render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX - 5.0f, this.offsetY + (float)(this.curtainOpen ? -20 : -20), info, false);
            }
        } else if (this.north && this.isOpen()) {
            (this.curtainOpen ? this.curtainWopen : this.curtainW).render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX - 19.0f, this.offsetY + (float)(this.curtainOpen ? -20 : -20), info, false);
        }
    }
    ...
    private void prerender2xE(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        assert (this.north && this.isOpen());
        if (!this.curtainInside) {
            (this.curtainOpen ? this.curtainEopen : this.curtainE).render(null, x, y, z, this.getForwardIsoDirection(), this.offsetX + (float)(this.curtainOpen ? -13 : -18), this.offsetY + (float)(this.curtainOpen ? -15 : -18), info, false);
        }
    }
    ...
    private void postrender2xE(float x, float y, float z, ColorInfo info, boolean bDoAttached, boolean bWallLightingPass, Shader shader) {
        assert (this.north && this.isOpen());
        if (this.curtainInside) {
            (this.curtainOpen ? this.curtainWopen : this.curtainW).render(null, x + 1.0f, y, z, this.getForwardIsoDirection(), this.offsetX + (float)(this.curtainOpen ? false : false), this.offsetY + (float)(this.curtainOpen ? false : false), info, false);
        }
    }
    ...
    public void Thump(IsoMovingObject thumper, int thumpEventCount) {
        ...
        if (thumper instanceof IsoZombie) {
            ...
            if (!(isoZombie.cognition != 1 || this.isOpen() || this.locked && (thumper.getCurrentSquare() == null || thumper.getCurrentSquare().has(IsoFlagType.exterior)))) {
        ...
        if (this.health <= 0) {
            ...
            if (GameServer.server) {
                GameServer.PlayWorldSoundServer((IsoGameCharacter)thumper, this.getSoundPrefix() + "Break", false, thumper.getCurrentSquare(), 0.2f, 70.0f, 1.1f, true);
            }
    ...
    private boolean canBeOpenFromInside(IsoGameCharacter chr) {
        return chr instanceof IsoPlayer && !chr.isOutside() && (chr.getCurrentSquare().getRoom() == this.getSquare().getRoom() || chr.getCurrentSquare().getRoom() == this.getOppositeSquare().getRoom()) && !this.getProperties().has("forceLocked");
    }
    ...
    public boolean couldBeOpen(IsoGameCharacter chr) {
        ...
        if (chr instanceof IsoPlayer && !DebugOptions.instance.cheat.door.unlock.getValue() && (this.isLockedByKey() || (object = this.getModData().rawget("CustomLock")) instanceof Boolean && (customLock = (Boolean)object).booleanValue()) && chr.getInventory().haveThisKeyId(this.getKeyId()) == null) {
            return false;
        }
    ...
    public void ToggleDoorActual(IsoGameCharacter chr) {
        ...
        if (chr instanceof IsoPlayer && (this.isLockedByKey() || (object2 = this.getModData().rawget("CustomLock")) instanceof Boolean && (customLock = (Boolean)object2).booleanValue()) && !this.isOpen()) {
        ...
        boolean bl = bUnlock = chr.getInventory().haveThisKeyId(this.getKeyId()) != null;
        ...
        if (this.getSprite().getProperties().has(IsoPropertyType.DOUBLE_DOOR)) {
            if (IsoDoor.isDoubleDoorObstructed(this)) {
                ...
                chr.setHaloNote(Translator.getText("IGUI_PlayerText_DoorBlocked", new Object[0]), 255, 255, 255, 256.0f);
                return;
            }
    ...
    private void TriggerBarricadedDoor(IsoGameCharacter chr) {
        ...
        if (chr instanceof IsoPlayer && (player = (IsoPlayer)chr).isLocalPlayer()) {
            chr.setHaloNote(Translator.getText("IGUI_PlayerText_DoorBarricaded", new Object[0]), 255, 255, 255, 256.0f);
        }
        this.setRenderEffect(RenderEffectType.Hit_Door, true);
    }
    ...
    public void syncIsoObject(boolean bRemote, byte val, UdpConnection source2, ByteBufferReader bb) {
        ...
        if (this.getObjectIndex() == -1) {
            DebugType.Multiplayer.error("ERROR: " + this.getClass().getSimpleName() + " not found on square " + this.square.getX() + "," + this.square.getY() + "," + this.square.getZ());
            return;
        }
        if (!bRemote) {
            if (GameClient.client) {
        ...
        if (bRemote) {
            ...
            if (GameClient.client && this.lastPlayerOnlineId != -1 && (player = GameClient.IDToPlayerMap.get(this.lastPlayerOnlineId)) != null) {
                ((IsoPlayer)player).getNetworkCharacterAI().setNoCollision(1000L);
            }
                ...
                if (bOpen != this.isOpen()) {
                    ...
                    if (player != null) {
                        ...
                        if (((IsoPlayer)player).isLocalPlayer()) {
                            ((IsoPlayer)player).triggerMusicIntensityEvent(this.isOpen() ? "DoorOpen" : "DoorClose");
                        }
                    }
                }
            } else if (bOpen != this.isOpen()) {
                this.setOpen(bOpen);
                IsoSprite isoSprite = this.sprite = this.isOpen() ? this.openSprite : this.closedSprite;
                if (player != null) {
                    this.playDoorSound(player.getEmitter(), this.isOpen() ? "Open" : "Close");
                    if (((IsoPlayer)player).isLocalPlayer()) {
                        ((IsoPlayer)player).triggerMusicIntensityEvent(this.isOpen() ? "DoorOpen" : "DoorClose");
    ...
    public boolean isFacingSheet(IsoGameCharacter chr) {
        ...
        IsoDirections dir = this.curtainInside ? (this.isOpen() ? (this.north ? IsoDirections.E : IsoDirections.S) : (this.north ? IsoDirections.N : IsoDirections.W)) : (this.isOpen() ? (this.north ? IsoDirections.W : IsoDirections.N) : (this.north ? IsoDirections.S : IsoDirections.E));
        IsoDirections edge = this.getSpriteEdge(false);
    ...
    public static int getDoubleDoorIndex(IsoObject oneOfFour) {
        ...
        boolean bl = open = door == null ? thump.open : door.isOpen();
        if (open) {
            if (ddIndex >= 5) {
                return ddIndex - 4;
            }
    ...
    private static void toggleGarageDoorObject(IsoObject oneOfThree) {
        ...
        boolean bl = open = door == null ? thumpable.open : door.isOpen();
        if (door != null) {
            door.setOpen(!open);
            door.setLockedByKey(false, false);
            IsoSprite isoSprite = door.sprite = door.isOpen() ? door.openSprite : door.closedSprite;
        }
        if (thumpable != null) {
            thumpable.open = !open;
    ...
    public String getSoundPrefix() {
        ...
        PropertyContainer props = this.closedSprite.getProperties();
        if (props.has(IsoPropertyType.DOOR_SOUND)) {
            return props.get(IsoPropertyType.DOOR_SOUND);
        }
        return "WoodDoor";
    }
