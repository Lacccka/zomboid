...
public final class IsoPuddlesCompute {
    ...
    public static float computePuddle(IsoGridSquare square) {
        ...
        if (GameServer.server) {
            ...
            puddlesDirAll = 1.0f;
            puddlesDirNone = 0.0f;
            float rawX = IsoUtils.XToScreen((float)square.x + 0.5f - (float)square.z * 3.0f, (float)square.y + 0.5f - (float)square.z * 3.0f, 0.0f, 0);
            float rawY = IsoUtils.YToScreen((float)square.x + 0.5f - (float)square.z * 3.0f, (float)square.y + 0.5f - (float)square.z * 3.0f, 0.0f, 0);
            return IsoPuddlesCompute.GetPuddlesFromPerlinNoise(temp_vector2f.set((rawX - 90000.0f) * 8.0E-4f + (float)square.z * 7.0f, (rawY - 640000.0f) * 8.0E-4f + (float)square.z * 7.0f));
        }
    ...
    static {
        ...
        pool_vector3f = new ObjectPool<Vector3f>(Vector3f::new, "IsoPuddlesCompute.pool_vector3f");
