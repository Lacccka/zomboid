...
public final class IsoWaterGeometry {
    ...
    public static final ObjectPool<IsoWaterGeometry> pool = new ObjectPool<IsoWaterGeometry>(IsoWaterGeometry::new, "IsoWaterGeometry.pool", 2048);
    ...
    private void initRender() {
        ...
        this.x[0] = IsoUtils.XToScreen((float)this.square.x + dx0, this.square.y, this.square.z, 0);
        this.y[0] = IsoUtils.YToScreen((float)this.square.x + dx0, this.square.y, this.square.z, 0);
        this.x[1] = IsoUtils.XToScreen((float)this.square.x + dx0, (float)(this.square.y + 1) + dy1, this.square.z, 0);
        this.y[1] = IsoUtils.YToScreen((float)this.square.x + dx0, (float)(this.square.y + 1) + dy1, this.square.z, 0);
        this.x[2] = IsoUtils.XToScreen(this.square.x + 1, (float)(this.square.y + 1) + dy1, this.square.z, 0);
        this.y[2] = IsoUtils.YToScreen(this.square.x + 1, (float)(this.square.y + 1) + dy1, this.square.z, 0);
