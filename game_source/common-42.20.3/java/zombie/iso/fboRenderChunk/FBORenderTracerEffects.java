...
public final class FBORenderTracerEffects {
    ...
    private final ObjectPool<Effect> effectPool = new ObjectPool<Effect>(Effect::new, "FBORenderTracerEffects.effectPool");
    private final ObjectPool<Drawer> drawerPool = new ObjectPool<Drawer>(Drawer::new, "FBORenderTracerEffects.drawerPool");
