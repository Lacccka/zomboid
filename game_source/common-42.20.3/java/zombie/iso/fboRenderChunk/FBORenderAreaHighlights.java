...
public class FBORenderAreaHighlights {
    ...
    private final ObjectPool<AreaHighlight> highlightPool = new ObjectPool<AreaHighlight>(AreaHighlight::new, "FBORenderAreaHighlights.highlightPool");
    private final ObjectPool<Drawer> drawerPool = new ObjectPool<Drawer>(Drawer::new, "FBORenderAreaHighlights.drawerPool");
