...
public final class FBORenderObjectOutline {
    ...
    private final ObjectPool<Drawer> drawerPool = new ObjectPool<Drawer>(Drawer::new, "FBORenderObjectOutline.drawerPool");
    private final ObjectPool<Drawer2> drawer2Pool = new ObjectPool<Drawer2>(Drawer2::new, "FBORenderObjectOutline.drawer2Pool");
