...
public class FBORenderWorldMarkers {
    ...
    private final ObjectPool<Marker> highlightPool = new ObjectPool<Marker>(Marker::new, "FBORenderWorldMarkers.highlightPool");
    private final ObjectPool<Drawer> drawerPool = new ObjectPool<Drawer>(Drawer::new, "FBORenderWorldMarkers.drawerPool");
