...
public final class FBORenderShadows {
    ...
    private final ObjectPool<Drawer> drawerPool = new ObjectPool<Drawer>(Drawer::new, "FBORenderShadows.drawerPool");
    private final ObjectPool<Shadow> shadowPool = new ObjectPool<Shadow>(Shadow::new, "FBORenderShadows.shadowPool");
