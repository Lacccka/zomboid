...
extends State {
    ...
    private ParameterFenceTypeLow.FenceType getFenceType(IsoObject fence) {
        ...
        if (typeStr != null) {
            if (ParameterFenceTypeLow.FenceType.SANDBAG.getName().equals(typeStr) && fence.getName() != null && StringUtils.containsIgnoreCase(fence.getName(), "Gravel")) {
                return ParameterFenceTypeLow.FenceType.GRAVELBAG;
            }
            return ParameterFenceTypeLow.FenceType.fromString(typeStr, ParameterFenceTypeLow.FenceType.WOOD);
        }
        ...
        if (typeStr != null) {
            ...
            return switch (fenceType) {
                ...
                case ParameterFenceTypeHigh.FenceType.WOOD -> ParameterFenceTypeLow.FenceType.WOOD;
                case ParameterFenceTypeHigh.FenceType.METAL -> ParameterFenceTypeLow.FenceType.METAL;
                case ParameterFenceTypeHigh.FenceType.METAL_GATE -> ParameterFenceTypeLow.FenceType.METAL_GATE;
            };
        }
        return ParameterFenceTypeLow.FenceType.WOOD;
    }
    ...
    private ParameterTripObstacleType.ObstacleType getTripType(IsoObject fence) {
        ...
        if (typeStr != null) {
            ...
            return switch (fenceType) {
                default -> throw new MatchException(null, null);
                case ParameterFenceTypeLow.FenceType.WOOD -> ParameterTripObstacleType.ObstacleType.WOOD;
                case ParameterFenceTypeLow.FenceType.METAL -> ParameterTripObstacleType.ObstacleType.METAL;
                case ParameterFenceTypeLow.FenceType.SANDBAG -> ParameterTripObstacleType.ObstacleType.SANDBAG;
                case ParameterFenceTypeLow.FenceType.GRAVELBAG -> ParameterTripObstacleType.ObstacleType.GRAVELBAG;
                case ParameterFenceTypeLow.FenceType.BARBWIRE -> ParameterTripObstacleType.ObstacleType.BARBWIRE;
                case ParameterFenceTypeLow.FenceType.ROADBLOCK -> ParameterTripObstacleType.ObstacleType.WOOD;
                case ParameterFenceTypeLow.FenceType.METAL_GATE -> ParameterTripObstacleType.ObstacleType.METAL_BARS;
            };
        }
        typeStr = props.get(IsoPropertyType.FENCE_TYPE_HIGH);
        if (typeStr != null) {
            ...
            return switch (fenceType) {
                default -> throw new MatchException(null, null);
                case ParameterFenceTypeHigh.FenceType.WOOD -> ParameterTripObstacleType.ObstacleType.WOOD;
                case ParameterFenceTypeHigh.FenceType.METAL -> ParameterTripObstacleType.ObstacleType.METAL;
                case ParameterFenceTypeHigh.FenceType.METAL_GATE -> ParameterTripObstacleType.ObstacleType.METAL_BARS;
            };
        }
        return ParameterTripObstacleType.ObstacleType.WOOD;
    }
