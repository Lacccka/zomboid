...
extends State {
    ...
    private static ClimbStatus calculateClimbOutcome(IsoGameCharacter isoGameCharacter) {
        ...
        if (isoThumpable != null) {
            if (!IsoWindow.canClimbThroughHelper(isoGameCharacter, climbData.targetGridSquare, exitDirectionIsqGridSquare, isoGameCharacter.getForwardIsoDirection() == IsoDirections.N || isoGameCharacter.getForwardIsoDirection() == IsoDirections.S)) {
                return ClimbStatus.Blocked;
            }
