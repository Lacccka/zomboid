...
extends State {
    ...
    public void enter(IsoGameCharacter owner) {
        ...
        owner.set(STRAIN, Float.valueOf(0.0f));
    }
    ...
    public void execute(IsoGameCharacter owner) {
        ...
        float painFactor = (float)(0.02 * (double)GameTime.instance.getMultiplier() * (double)(owner.getMoodles().getMoodleLevel(MoodleType.HEAVY_LOAD) + 1)) * ((15.0f - skillFactor) / 10.0f) * (GameTime.instance.getMultiplier() / 0.8f);
        owner.addBothArmMuscleStrain(painFactor);
        owner.set(STRAIN, Float.valueOf(owner.get(STRAIN).floatValue() + painFactor));
    ...
    public void processOnExit(IsoGameCharacter owner, Map<Object, Object> delegate) {
        float painFactor = STRAIN.fromDelegate(delegate).floatValue();
        owner.addBothArmMuscleStrain(painFactor);
    }
}
