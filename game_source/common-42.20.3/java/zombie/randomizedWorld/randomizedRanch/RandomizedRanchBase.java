    ...
    public static void randomizeRanch(Zone zone, DesignationZoneAnimal newDZone) {
        ...
        for (i = 0; i < femaleNb; ++i) {
            ...
            if (Core.getInstance().animalCheat) {
                animal.setCustomName(Translator.getText("IGUI_AnimalType_" + animal.getAnimalType(), new Object[0]) + " " + animal.getAnimalID());
            }
            IsoAnimal baby = null;
        ...
        newDZone.setName(Translator.getText("UI_Ranch", Translator.getText("IGUI_AnimalType_Global_" + choosenDef.globalName, new Object[0]), Rand.Next(10000)));
    }
