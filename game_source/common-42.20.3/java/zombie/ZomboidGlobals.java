...
public final class ZomboidGlobals {
    ...
    public static float basicMaskDefense;
    public static float improvisedGasMaskDefense;
    public static float standardGasMaskDefense;
    ...
    static {
        ...
        basicMaskDefense = 25.0f;
        improvisedGasMaskDefense = 85.0f;
        standardGasMaskDefense = 100.0f;
    }
}
