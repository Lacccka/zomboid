...
public abstract class AttributeInstance<C extends AttributeInstance<C, T>, T extends AttributeType> {
    ...
    protected boolean canSetValue() {
        if (this.isReadOnly()) {
            DebugType.General.error("Trying to set value on a read-only attribute [" + java.lang.String.valueOf(this) + "]");
            return false;
        }
        return true;
    }
    ...
    extends Numeric<Double, AttributeType.Double> {
        ...
        public float floatValue() {
            if (this.value < -3.4028234663852886E38 || this.value > 3.4028234663852886E38) {
                DebugType.General.error("Attribute '" + java.lang.String.valueOf(this.type) + "' double value exceeds float bounds.");
            }
    ...
    extends AttributeInstance<EnumStringSet<E>, AttributeType.EnumStringSet<E>> {
        ...
        public void load(ByteBuffer input) {
            ...
            for (i = 0; i < size; ++i) {
                ...
                DebugType.General.error("Could not load value for EnumStringSet attribute '" + java.lang.String.valueOf(this.type) + "'.");
            }
            size = input.get();
            for (i = 0; i < size; ++i) {
    ...
    extends AttributeInstance<EnumSet<E>, AttributeType.EnumSet<E>> {
        ...
        public boolean setValueFromScriptString(java.lang.String val) {
            try {
                ...
                DebugType.General.printException(e, LogSeverity.Error, "Error in script string '" + val + "'", new Object[0]);
                return false;
            }
        }
        ...
        public void load(ByteBuffer input) {
            ...
            for (int i = 0; i < size; ++i) {
                ...
                DebugType.General.error("Could not load value for EnumSet attribute '" + java.lang.String.valueOf(this.type) + "'.");
            }
        }
    }
    ...
    extends AttributeInstance<Enum<E>, AttributeType.Enum<E>> {
        ...
        public void load(ByteBuffer input) {
            ...
            if (this.value == null) {
                DebugType.General.error("Could not load value for Enum attribute '" + java.lang.String.valueOf(this.type) + "', setting default.");
                this.value = ((AttributeType.Enum)this.type).getInitialValue();
            }
        }
    }
