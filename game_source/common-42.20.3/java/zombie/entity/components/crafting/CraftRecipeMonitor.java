...
public class CraftRecipeMonitor {
    ...
    public void logCraftLogic(CraftLogic logic) {
        ...
        this.log("StartMode = " + String.valueOf(logic.getStartMode()));
    ...
    public void logDryingLogic(DryingLogic logic) {
        ...
        this.open();
        for (i = 0; i < logic.getDryingRecipes().size(); ++i) {
    ...
    public void logResourcesList(String tag, List<Resource> resources) {
        ...
        for (int i = 0; i < resources.size(); ++i) {
            ...
            this.log("Type = " + String.valueOf((Object)resource.getType()));
            this.log("Io = " + String.valueOf((Object)resource.getIO()));
            this.log("Channel = " + String.valueOf(resource.getChannel()));
    ...
    public void logInputScript(InputScript input) {
        ...
        this.log("Type = " + String.valueOf((Object)input.getResourceType()));
        ...
        this.log("ItemApplyMode = " + String.valueOf((Object)input.getItemApplyMode()));
        this.log("FluidMatchMode = " + String.valueOf((Object)input.getFluidMatchMode()));
        if (input.isReplace()) {
            this.open();
    ...
    public void logOutputScript(OutputScript output) {
        ...
        this.log("Type = " + String.valueOf((Object)output.getResourceType()));
