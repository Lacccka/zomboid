...
extends Component {
    ...
    public void doProgressTooltip(ObjectTooltip.Layout layout, Resource resource, CraftRecipeData craftRecipeData) {
        if (!this.isRunning()) {
            ...
            item.setLabel(Translator.getText("EC_CraftLogicTooltip_NoCraftInProgress", new Object[0]), 1.0f, 1.0f, 1.0f, 1.0f);
            return;
        }
        if (craftRecipeData != null) {
            ObjectTooltip.LayoutItem item = layout.addItem();
            item.setLabel(Translator.getText("EC_CraftLogicTooltip_Progress", new Object[0]) + ":", 1.0f, 1.0f, 1.0f, 1.0f);
            ...
            item = layout.addItem();
            item.setLabel(Translator.getText("EC_CraftLogicTooltip_TimeRemaining", new Object[0]) + ":", 1.0f, 1.0f, 1.0f, 1.0f);
