        ...
        block11: {
            ...
            block10: {
                ...
                if (Core.debug && this.verbose) {
                    DebugType.Entity.println("testing entity = " + entity.getEntityNetID() + ", type=" + String.valueOf(entity.getGameEntityType()) + ", contains=" + containsEntity + ", accepts=" + acceptsEntity + ", removing=" + entity.removingFromEngine);
                }
                if (entity.removingFromEngine || containsEntity || !acceptsEntity) break block10;
                if (Core.debug && this.verbose) {
                    DebugType.Entity.println("adding entity = " + entity.getEntityNetID() + ", type=" + String.valueOf(entity.getGameEntityType()));
                }
            ...
            if (containsEntity && (entity.removingFromEngine || !acceptsEntity)) {
                if (Core.debug && this.verbose) {
                    DebugType.Entity.println("removing entity = " + entity.getEntityNetID() + ", type=" + String.valueOf(entity.getGameEntityType()));
                }
                if (Core.debug && GameEntityManager.debugMode && !this.entities.contains(entity, true)) {
