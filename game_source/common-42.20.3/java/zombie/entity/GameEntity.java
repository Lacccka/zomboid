...
public abstract class GameEntity {
    ...
    final boolean addComponent(Component component) {
        ...
        DebugType.General.error("Trying to add component but component type already exists: " + String.valueOf((Object)component.getComponentType()));
        return false;
    }
    ...
    final Component removeComponent(ComponentType componentType) {
        if (!this.hasComponents()) {
            DebugType.General.error("Trying to remove component but has no components: " + String.valueOf((Object)componentType));
            return null;
        }
    ...
    final Component removeComponent(Component component) {
        ...
        if (!this.hasComponents()) {
            DebugType.General.error("Trying to remove component but has no components: " + String.valueOf((Object)component.getComponentType()));
            return null;
        }
