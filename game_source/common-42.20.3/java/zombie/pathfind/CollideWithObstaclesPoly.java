...
public class CollideWithObstaclesPoly {
    ...
    public static final class ChunkDataZ {
        ...
        public int z;
        public static final ObjectPool<ChunkDataZ> pool = new ObjectPool<ChunkDataZ>(ChunkDataZ::new, "ChunkDataZ.pool");
    ...
    private static final class CCObstacle {
        ...
        private static final ObjectPool<CCObstacle> pool = new ObjectPool<CCObstacle>(CCObstacle::new, "CCObstacle.pool"){
    ...
    private static final class CCEdge {
        ...
        private static final ObjectPool<CCEdge> pool = new ObjectPool<CCEdge>(CCEdge::new, "CCEdge.pool");
    ...
    private static final class CCNode {
        ...
        private static final ObjectPool<CCNode> pool = new ObjectPool<CCNode>(CCNode::new, "CCNode.pool");
    ...
    extends ArrayList<CCEdge> {
        private static final ObjectPool<CCEdgeRing> pool = new ObjectPool<CCEdgeRing>(CCEdgeRing::new, "CCEdgeRing.pool"){
