...
lbl261:
    ...
    public void render() {
        ...
        if (DebugOptions.instance.pathfindRenderConnections.getValue() && (vg = this.getVisGraphAt(worldX = IsoUtils.XToIso(screenX = (float)Mouse.getX(), screenY = (float)Mouse.getY(), z = this.testZ), worldY = IsoUtils.YToIso(screenX, screenY, z), z, 1)) != null && (closest = vg.getClosestNodeTo(worldX, worldY)) != null) {
