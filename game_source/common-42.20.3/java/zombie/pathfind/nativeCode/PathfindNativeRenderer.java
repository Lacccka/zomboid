    ...
    extends TextureDraw.GenericDrawer {
        ...
        public void render() {
            ...
            synchronized (object) {
                ...
                instance.setDebugOption(DebugOptions.instance.pathfindRenderClusters.getName(), DebugOptions.instance.pathfindRenderClusters.getValueAsString());
                instance.setDebugOption(DebugOptions.instance.pathfindRenderConnections.getName(), DebugOptions.instance.pathfindRenderConnections.getValueAsString());
                instance.setDebugOption(DebugOptions.instance.pathfindRenderCrawling.getName(), DebugOptions.instance.pathfindRenderCrawling.getValueAsString());
                instance.setDebugOption(DebugOptions.instance.pathfindRenderNodes.getName(), DebugOptions.instance.pathfindRenderNodes.getValueAsString());
