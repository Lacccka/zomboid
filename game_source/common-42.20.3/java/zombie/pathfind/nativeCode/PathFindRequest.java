...
public final class PathFindRequest {
    ...
    static final ObjectPool<PathFindRequest> pool = new ObjectPool<PathFindRequest>(PathFindRequest::new, "PathFindRequest.pool");
    ...
    PathFindRequest init(IPathfinder pathfinder, Mover mover, float startX, float startY, float startZ, float targetX, float targetY, float targetZ) {
        ...
        if (mover instanceof IsoAnimal) {
            IsoAnimal animal = (IsoAnimal)mover;
        ...
        if (mover instanceof IsoZombie) {
            IsoZombie zombie = (IsoZombie)mover;
        ...
        if ((player = Type.tryCastTo(mover, IsoPlayer.class)) != null && !(mover instanceof IsoAnimal)) {
