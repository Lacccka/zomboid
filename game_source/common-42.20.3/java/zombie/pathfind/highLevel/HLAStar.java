...
extends AStar {
    ...
    void addChunkLevelAndAdjacentToList(HLChunkRegion chunkRegion, ArrayList<HLChunkLevel> chunkList) {
        ...
        HLSearchNode searchNode = this.nodeMapChunkRegion.get(chunkRegion);
        short wx = chunkLevel.getChunk().wx;
        short wy = chunkLevel.getChunk().wy;
        ...
        for (int i = 0; i < DIRECTIONS.length; ++i) {
            ...
            if (chunk2 == null || !chunk2.isValidLevel(level)) continue;
            ...
            if (searchNode != null) {
                ...
                } else if (searchNode.successors.stream().filter(hlSuccessor -> hlSuccessor.searchNode.chunkRegion != null && hlSuccessor.searchNode.chunkRegion.levelData == levelData2).findFirst().isEmpty()) continue;
            }
            if (chunkList.contains(levelData2)) continue;
