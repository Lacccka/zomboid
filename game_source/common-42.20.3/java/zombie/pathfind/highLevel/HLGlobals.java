...
public final class HLGlobals {
    static final ObjectPool<HLChunkRegion> chunkRegionPool = new ObjectPool<HLChunkRegion>(HLChunkRegion::new, "HLGlobals.chunkRegionPool");
    static final ObjectPool<HLStaircase> staircasePool = new ObjectPool<HLStaircase>(HLStaircase::new, "HLGlobals.staircasePool");
    static final ObjectPool<HLSlopedSurface> slopedSurfacePool = new ObjectPool<HLSlopedSurface>(HLSlopedSurface::new, "HLGlobals.slopedSurfacePool");
    static final ObjectPool<HLSuccessor> successorPool = new ObjectPool<HLSuccessor>(HLSuccessor::new, "HLGlobals.successorPool");
    ...
    static final ObjectPool<HLSearchNode> searchNodePool = new ObjectPool<HLSearchNode>(HLSearchNode::new, "HLGlobals.searchNodePool");
