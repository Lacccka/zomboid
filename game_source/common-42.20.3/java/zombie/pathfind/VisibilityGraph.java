...
public final class VisibilityGraph {
    ...
    void render() {
        ...
        for (Obstacle obstacle : this.obstacles) {
            ...
            if (!DebugOptions.instance.pathfindRenderCrawling.getValue()) continue;
        ...
        for (Node node1 : this.perimeterNodes) {
            ...
            if (!DebugOptions.instance.pathfindRenderNodes.getValue()) continue;
            float r1 = 1.0f;
            float g1 = 0.5f;
            float b1 = 0.0f;
            if (node1.ignore) {
        ...
        for (Node node1 : this.nodes) {
            ...
            if (!DebugOptions.instance.pathfindRenderNodes.getValue() && !node1.ignore) continue;
