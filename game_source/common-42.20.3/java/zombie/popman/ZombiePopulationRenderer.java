...
public final class ZombiePopulationRenderer {
    ...
    private final BooleanDebugOption worldSounds = new BooleanDebugOption(this, "WorldSounds", false);
    ...
    public void renderCellInfo(int cellX, int cellY, int effectivePopulation, int targetPopulation, float lastRepopTime) {
        ...
        String str = Translator.getText("IGUI_ZombiePopulation_PopulationEffective", new Object[0]) + ": " + effectivePopulation + newLine + Translator.getText("IGUI_ZombiePopulation_PopulationTarget", new Object[0]) + ": " + targetPopulation;
        if (lastRepopTime > 0.0f) {
            str = str + newLine + Translator.getText("IGUI_ZombiePopulation_LastRepopTime", new Object[0]) + ": " + String.format(" %.2f", Float.valueOf(lastRepopTime));
        }
    ...
    private void _render(UIElement ui, float zoom, float xPos, float yPos) {
        ...
        if (bShowZombieIntensity) {
            ...
            if (metaCell != null && metaCell.info != null) {
                ...
                Object intensityStr = String.format(Translator.getText("IGUI_ZombiePopulation_Intensity", new Object[0]) + ": %d", intensity);
                ...
                if (chunk != null) {
                    ...
                    if (total > 0) {
                        intensityStr = (String)intensityStr + "\n" + String.format(Translator.getText("IGUI_ZombiePopulation_Zombies", new Object[0]) + ": %d", total);
                    }
                }
