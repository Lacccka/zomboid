...
public final class MPDebugInfo {
    ...
    public final ObjectPool<MPCell> cellPool = new ObjectPool<MPCell>(MPCell::new, "MPDebugInfo.cellPool");
    public final LoadedAreas loadedAreas = new LoadedAreas(false);
    public ArrayList<MPRepopEvent> repopEvents = new ArrayList();
    public final ObjectPool<MPRepopEvent> repopEventPool = new ObjectPool<MPRepopEvent>(MPRepopEvent::new, "MPDebugInfo.repopEventPool");
