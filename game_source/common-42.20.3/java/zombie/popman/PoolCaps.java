...
public final class PoolCaps {
    ...
    public static void updateServerCaps() {
        ...
        IsoGridSquare.isoGridSquareCache.setMaxSize(PoolCaps.scale(24576, 4096, players, 49152));
        IsoChunkMap.chunkStore.setMaxSize(PoolCaps.scale(1024, 256, players, 4096));
        IsoChunkLevel.pool.setMaxSize(PoolCaps.scale(4096, 1024, players, 12288));
        IsoSpriteInstance.pool.setMaxSize(PoolCaps.scale(8192, 2048, players, 32768));
    }
