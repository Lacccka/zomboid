...
public final class TileGeometry {
    ...
    public void copyGeometry(String tilesetName, int col, int row, ArrayList<TileGeometryFile.Geometry> geometries) {
        ArrayList<TileGeometryFile.Geometry> geometriesCopy = new ArrayList<TileGeometryFile.Geometry>();
    ...
    void renderGeometry(IsoObject object) {
        ...
        SpriteRenderer.instance.drawGeneric(Drawer.s_pool.alloc().init(tile, object.square.x, object.square.y, object.square.z));
    }
    ...
    extends TextureDraw.GenericDrawer {
        static final ObjectPool<Drawer> s_pool = new ObjectPool<Drawer>(Drawer::new, "Drawer.s_pool");
        TileGeometryFile.Tile tile;
        float x;
        float y;
        float z;
        ...
        Drawer init(TileGeometryFile.Tile tile, float x, float y, float z) {
            this.tile = tile;
            for (TileGeometryFile.Geometry geometry : this.tile.geometry) {
                TileGeometryFile.Polygon polygon = geometry.asPolygon();
                if (polygon == null || !polygon.triangles.isEmpty()) continue;
                polygon.triangulate();
            }
            this.x = x;
            this.y = y;
