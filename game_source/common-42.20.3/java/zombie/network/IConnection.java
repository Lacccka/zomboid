...
public interface IConnection {
    ...
    public boolean isHashEquals(PacketTypes.PacketType var1, Integer var2);

    public boolean isLimitExceeded(PacketTypes.PacketType var1);
    ...
    public boolean hasPlayer(short var1);
    ...
    default public void addChunkObjectState(short w) {
    }
