...
public class Server {
    ...
    public String getUserName() {
        if (!this.accounts.isEmpty()) {
            return this.accounts.get(0).getUserName();
        }
        return "";
    }
    ...
    public String getPwd() {
        if (!this.accounts.isEmpty()) {
            return this.accounts.get(0).getPwd();
        }
        return "";
    }
    ...
    public boolean getUseSteamRelay() {
        if (!this.accounts.isEmpty()) {
            return this.accounts.get(0).getUseSteamRelay();
        }
        return true;
    }
    ...
    public boolean isSavePwd() {
        if (!this.accounts.isEmpty()) {
            return this.accounts.get(0).isSavePwd();
        }
        return true;
    }
    ...
    public int getAuthType() {
        if (!this.accounts.isEmpty()) {
            return this.accounts.get(0).getAuthType();
        }
        return 1;
    }
    ...
    public int getTimeFromServerCustomizationLastUpdate() {
        if (this.serverCustomizationLastUpdate == 0) {
            return 1000000;
        }
        return (int)(System.currentTimeMillis() / 1000L - (long)this.serverCustomizationLastUpdate);
    }
