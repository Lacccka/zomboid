...
implements INetworkPacketField {
    ...
    public String getDescription() {
        return "\n\tBite [ eatBodyTarget=" + ((this.flags & 1) != 0) + " | attackDidDamage=" + ((this.flags & 2) != 0) + " | biteDefended=" + ((this.flags & 4) != 0) + " | scratch=" + ((this.flags & 8) != 0) + " | laceration=" + ((this.flags & 0x10) != 0) + " | hitDirection=" + this.hitDirection + " | bodyPart=" + this.bodyPart + " ]";
    }
