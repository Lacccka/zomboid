...
implements INetworkPacket {
    ...
    public void parse(ByteBufferReader b, IConnection connection) {
        ...
        this.predictionTimeRemaining = this.distance > 0 ? (float)this.distance / (this.speed * 8.0f) : 0.0f;
    }
    ...
    public void update() {
        ...
        this.position.set(delta * this.speed * (float)Math.cos(this.moveDirection) + this.position.x, delta * this.speed * (float)Math.sin(this.moveDirection) + this.position.y, this.position.z);
    }
    ...
    public void updateLerp(IsoPlayer player) {
        ...
        float totalPredictionTime = (float)this.distance / (this.speed * 8.0f);
        float delta = GameTime.instance.getTimeDelta();
        this.predictionTimeRemaining -= delta;
