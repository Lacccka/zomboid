...
public class ConnectionQueueStatistic
extends Statistic
implements IStatistic {
    private static final ConnectionQueueStatistic instance = new ConnectionQueueStatistic("connection");
    public final Counter zombiesKilledByFireToday = new Counter(this, "zombies-killed-by-fire-today", 0.0, null, "Zombies killed by fire today", "number", false);
    ...
    public final Counter playersKilledByFireToday = new Counter(this, "players-killed-by-fire-today", 0.0, null, "Players killed by fire today", "number", false);
    public final Counter playersKilledByZombieToday = new Counter(this, "players-killed-by-zombie-today", 0.0, null, "Players killed by zombie today", "number", false);
    public final Counter playersKilledByPlayerToday = new Counter(this, "players-killed-by-player-today", 0.0, null, "Players killed by player today", "number", false);
