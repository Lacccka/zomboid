...
implements IStatistic {
    ...
    public void update() {
        ...
        for (Counter counter : this.counters.values()) {
            try {
                ...
                this.localTable.rawset(counter.getName(), (Object)value);
            }
            catch (Exception e) {
            ...
            if (!counter.isPerishable().booleanValue()) continue;
            counter.clear();
        }
    ...
    public String getValue(String counter) {
        if (this.statistics.containsKey(counter)) {
            return String.valueOf(this.statistics.get(counter));
        }
        return "";
    }
    ...
    public String getList() {
        ...
        for (Map.Entry<String, Double> counter : this.statistics.entrySet()) {
