...
public class ServerOptions {
    ...
    private static final int MAX_PLAYERS = 254;
    ...
    public IntegerServerOption maxPlayers = new IntegerServerOption(this, "MaxPlayers", 1, 254, 32);
    ...
    public BooleanServerOption war = new BooleanServerOption(this, "War", false);
    ...
    public BooleanServerOption disableSafehouseWhenOwnerConnected = new BooleanServerOption(this, "DisableSafehouseWhenOwnerConnected", false);
    ...
    public IntegerServerOption mapRemotePlayerVisibility = new IntegerServerOption(this, "MapRemotePlayerVisibility", 1, 4, 1);
    ...
    public EnumServerOption antiCheatSafety = new EnumServerOption(this, "AntiCheatSafety", 4, 2);
    public EnumServerOption antiCheatSpeed = new EnumServerOption(this, "AntiCheatSpeed", 4, 2);
    public EnumServerOption antiCheatNoClip = new EnumServerOption(this, "AntiCheatNoClip", 4, 4);
    public EnumServerOption antiCheatHit = new EnumServerOption(this, "AntiCheatHit", 4, 2);
    public EnumServerOption antiCheatPacketException = new EnumServerOption(this, "AntiCheatPacketException", 4, 4);
    public EnumServerOption antiCheatPermission = new EnumServerOption(this, "AntiCheatPermission", 4, 2);
    public EnumServerOption antiCheatXp = new EnumServerOption(this, "AntiCheatXP", 4, 2);
    public EnumServerOption antiCheatSafeHouse = new EnumServerOption(this, "AntiCheatSafeHouse", 4, 2);
    public EnumServerOption antiCheatPlayer = new EnumServerOption(this, "AntiCheatPlayer", 4, 2);
    public EnumServerOption antiCheatChecksum = new EnumServerOption(this, "AntiCheatChecksum", 4, 2);
    ...
    public IntegerServerOption maxPacketsPerSecond = new IntegerServerOption(this, "MaxPacketsPerSecond", 100, 1000, 300);
    public BooleanServerOption showCoordinates = new BooleanServerOption(this, "ShowCoordinates", false);
    ...
    public static void initClientCommandsHelp() {
        ...
        clientOptionsList.put("help", Translator.getText("UI_ServerOptionDesc_Help", new Object[0]));
        clientOptionsList.put("changepwd", Translator.getText("UI_ServerOptionDesc_ChangePwd", new Object[0]));
        clientOptionsList.put("roll", Translator.getText("UI_ServerOptionDesc_Roll", new Object[0]));
        clientOptionsList.put("card", Translator.getText("UI_ServerOptionDesc_Card", new Object[0]));
        clientOptionsList.put("safehouse", Translator.getText("UI_ServerOptionDesc_SafeHouse", new Object[0]));
    }
    ...
    public int getMaxPlayers() {
        return Math.min(254, ServerOptions.getInstance().maxPlayers.getValue());
    }
    ...
    implements ServerOption {
        ...
        public String getTooltip() {
            return Translator.getTextOrNull("UI_ServerOption_" + this.name + "_tooltip", new Object[0]);
        }
    }
    ...
    implements ServerOption {
        ...
        @Override
        public String getTooltip() {
            String s1 = Translator.getTextOrNull("UI_ServerOption_" + this.name + "_tooltip", new Object[0]);
    ...
    implements ServerOption {
        ...
        public String getValueTranslationByIndex(int index) {
            ...
            return Translator.getTextOrNull("UI_ServerOption_AntiCheat_option" + index, new Object[0]);
        }
    }
