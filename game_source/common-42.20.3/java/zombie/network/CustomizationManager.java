...
public class CustomizationManager {
    ...
    private ByteBuffer load(String filename, int dimensionW, int dimensionH) {
        ...
        if (!filename.isEmpty()) {
            ...
            try {
                ...
                bb = CustomizationManager.loadCompressAndResizeInstance(bufferedImage, dimensionW, dimensionH);
    ...
    public static ByteBuffer loadCompressAndResizeInstance(BufferedImage image, int dimensionW, int dimensionH) {
        ...
        double ratio = CustomizationManager.getIconRatio(image, scaledIcon);
        ...
        g.dispose();
        return CustomizationManager.compressToByteBuffer(scaledIcon, "jpg");
    }
    ...
    public static ByteBuffer loadAndResizeInstance(BufferedImage image, int dimensionW, int dimensionH) {
        ...
        g.drawImage(image, (int)(((double)scaledIcon.getWidth() - width) / 2.0), (int)(((double)scaledIcon.getHeight() - height) / 2.0), (int)width, (int)height, null);
        g.dispose();
        return CustomizationManager.convertToByteBuffer(scaledIcon);
    }
