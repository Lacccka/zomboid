...
implements INetworkPacket {
    ...
    private static final int BIT_IS_FERTILIZED = 0x2000000;
    ...
    public void parse(ByteBufferReader b, IConnection connection) {
        ...
        if (this.isFood) {
            ...
            if (!bits.equals(0)) {
                ...
                this.isFertilized = bits.hasFlags(0x2000000);
                if (this.isFertilized) {
    ...
    public void processServer(PacketTypes.PacketType packetType, UdpConnection connection) {
        ...
        IsoObject isoObject = container.getParent();
    ...
    public void processClient(UdpConnection connection) {
        ...
        InventoryItem item = container.getItemWithID(this.id);
        if (item == null && (isoObject = container.getParent()) instanceof IsoPlayer) {
            IsoPlayer player = (IsoPlayer)isoObject;
