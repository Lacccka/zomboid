    ...
    public void processServer(PacketTypes.PacketType packetType, UdpConnection connection) {
        try {
            ...
            switch (this.action.ordinal()) {
                ...
                case 1: {
                    if (!admin.getRole().hasCapability(Capability.ModifyNetworkUsers) || admin.getRole().getPosition() < ServerWorldDatabase.instance.getUserRoleNameByUsername(this.username).getPosition()) break;
