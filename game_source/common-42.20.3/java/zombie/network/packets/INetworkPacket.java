...
extends INetworkPacketField {
    ...
    default public boolean shouldInstantiate() {
        return false;
    }
    ...
    default public void logInconsistentPacket(IConnection connection, PacketTypes.PacketType packetType) {
    ...
    default public void sendToClient(PacketTypes.PacketType packetType, String username) {
        if (!GameServer.server) {
            return;
        }
    ...
    public static void send(IConnection connection, PacketTypes.PacketType packetType, Object ... values2) {
        if (connection != null && packetType != null) {
            try {
                ...
                ExceptionLogger.logException(e, "Packet \"" + String.valueOf((Object)packetType) + "\" send failed", DebugType.Multiplayer, LogSeverity.Error);
            }
        }
    }
