...
@PacketSetting(ordering=0, priority=0, reliability=3, requiredCapability=Capability.LoginOnServer, handlingType=1, anticheats={AntiCheat.HitDamage, AntiCheat.HitShortDistance, AntiCheat.Speed, AntiCheat.HitVehicle})
