...
implements HitCharacter {
    ...
    public void set(IsoPlayer wielder, IsoGameCharacter character, BaseVehicle vehicle, boolean isCriticalHit, float damage, boolean isTargetHitFromBehind, float vehicleSpeed) {
        this.wielder.set(wielder, isCriticalHit);
        this.vehicleId.set(vehicle);
        this.vehicleHit.set(false, damage, character.getHitForce(), character.getHitDir().x, character.getHitDir().y, vehicleSpeed, isTargetHitFromBehind, character.isStaggerBack(), character.isKnockedDown());
