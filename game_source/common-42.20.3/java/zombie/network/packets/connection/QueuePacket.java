    ...
    public void processClientLoading(UdpConnection connection) {
        switch (this.type.ordinal()) {
            ...
            case 2: {
                ...
                LuaEventManager.triggerEvent("OnConnectionStateChanged", "FormatMessage", "PlaceInQueue", this.placeInQueue & 0xFF);
                LoadingQueueState.onPlaceInQueue(this.placeInQueue & 0xFF, data);
            }
        }
    }
