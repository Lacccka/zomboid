...
implements INetworkPacket {
    ...
    public void setData(Object ... values2) {
        Object object;
        if (values2.length == 5 && (object = values2[0]) instanceof IsoGameCharacter) {
            IsoGameCharacter character = (IsoGameCharacter)object;
            object = values2[1];
            if (object instanceof InventoryItem) {
                InventoryItem invItem = (InventoryItem)object;
                object = values2[2];
                if (object instanceof Float) {
                    ...
                    if (object instanceof Float) {
                        ...
                        object = values2[4];
                        if (object instanceof Float) {
                            Float z = (Float)object;
                            this.set(character, invItem, x.floatValue(), y.floatValue(), z.floatValue());
                            return;
                        }
                    }
                }
