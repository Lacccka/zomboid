...
implements INetworkPacket {
    ...
    public void setData(Object ... values2) {
        if (values2.length == 2) {
        ...
        } else if (values2.length >= 4 && values2[3] instanceof BaseVehicle) {
            this.setForTrailer(values2);
            ...
            DebugType.Animal.error("No such packet set: %s", values2[0]);
        }
    }

    private void setForTrailer(Object ... values2) {
        Object object = values2[1];
        if (object instanceof IsoAnimal) {
            IsoAnimal animal = (IsoAnimal)object;
            this.set((Type)((Object)values2[0]), animal, (IsoPlayer)values2[2], (BaseVehicle)values2[3], (InventoryItem)values2[4]);
        } else {
            object = values2[1];
            if (object instanceof IsoDeadBody) {
                IsoDeadBody deadBody = (IsoDeadBody)object;
                this.set((Type)((Object)values2[0]), deadBody, (IsoPlayer)values2[2], (BaseVehicle)values2[3], (InventoryItem)values2[4]);
            }
        }
    }
    ...
    public void set(Type operation, IsoDeadBody deadBody, IsoPlayer player, BaseVehicle vehicle, InventoryItem item) {
        this.type = operation;
        ...
        if (this.isConsistent(connection)) {
            switch (this.type.ordinal()) {
                ...
                case 4: {
                    ...
                    InventoryItem vec = this.item;
                    if (vec instanceof InventoryItem) {
                        InventoryItem invItem = vec;
                        ...
                        if (!(invItem instanceof AnimalInventoryItem)) break;
                        AnimalInventoryItem animalItem = (AnimalInventoryItem)invItem;
                ...
                case 7: {
                    if (!this.animalId.isConsistent(connection) || !this.playerId.isConsistent(connection)) break;
                    InventoryItem animalItem = this.item;
                    if (animalItem instanceof AnimalInventoryItem) {
                        AnimalInventoryItem animal = (AnimalInventoryItem)animalItem;
                ...
                case 9: {
                    ...
                    if (newAnimal instanceof InventoryItem) {
                        InventoryItem inventoryItem = newAnimal;
                ...
                case 15: {
                    ...
                    if (!this.playerId.isConsistent(connection) || this.animalId.getID() == -1 || !((inventoryItem = this.item) instanceof AnimalInventoryItem)) break;
                    AnimalInventoryItem animal = (AnimalInventoryItem)inventoryItem;
                    AnimalInstanceManager.getInstance().add(animal.getAnimal(), this.animalId.getID());
                    this.playerId.getPlayer().getInventory().AddItem(animal);
                    break;
                }
                default: {
                    DebugType.Animal.warn("AnimalPacket \"%s\" is not supported", new Object[]{this.type});
                }
            }
        }
    }
