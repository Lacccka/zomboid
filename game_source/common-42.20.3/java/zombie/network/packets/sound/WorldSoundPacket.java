...
implements INetworkPacket {
    ...
    public void setData(Object ... values2) {
        ...
        Object object = worldSound.source;
        if (object instanceof IsoGameCharacter) {
            IsoGameCharacter sourceGameCharacter = (IsoGameCharacter)object;
    ...
    public void processClient(UdpConnection connection) {
        ...
        WorldSoundManager.instance.addSound(this.sourceCharacterId.getCharacter(), this.x, this.y, this.z, this.radius, this.volume, this.zombieIgnoreDist, this.stressMod, this.sourceIsZombie, false, true, this.repeating, flags);
    }
    ...
    public void processServer(PacketTypes.PacketType packetType, UdpConnection connection) {
        ...
        if ((sound = WorldSoundManager.instance.addSound(this.sourceCharacterId.getCharacter(), this.x, this.y, this.z, this.radius, this.volume, this.zombieIgnoreDist, this.stressMod, this.sourceIsZombie, false, true, this.repeating, flags)) == null) {
            return;
        }
