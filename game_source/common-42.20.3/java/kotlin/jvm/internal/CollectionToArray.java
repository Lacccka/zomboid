        ...
        block9: {
            ...
            if (size$iv == 0) {
                ...
                if (!iter$iv.hasNext()) {
                    ...
                    Intrinsics.checkNotNullExpressionValue(objectArray2, "Arrays.copyOf(result, size)");
                }
            }
        }
        return objectArray;
            ...
            if (size$iv == 0) {
                ...
                if (!iter$iv.hasNext()) {
                    ...
                    if (result == a) {
                        ...
                        Intrinsics.checkNotNullExpressionValue(objectArray3, "Arrays.copyOf(result, size)");
                    }
                }
            }
        }
