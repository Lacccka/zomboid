...
extends ImGuiStruct {
    ...
    public void addConfigFlags(int configFlags) {
        this.setConfigFlags(this.getConfigFlags() | configFlags);
    }
    ...
    public void addBackendFlags(int backendFlags) {
        this.setBackendFlags(this.getBackendFlags() | backendFlags);
    }
    ...
    public void setFontDefault(ImFont fontDefault) {
        this.nSetFontDefault(fontDefault.ptr);
    }
    ...
    public ImVec2 getDisplayFramebufferScale() {
        ImVec2 value = new ImVec2();
        this.getDisplayFramebufferScale(value);
        return value;
    }
