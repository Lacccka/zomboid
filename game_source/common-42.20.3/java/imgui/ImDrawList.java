...
extends ImGuiStruct {
    ...
    public void addImDrawListFlags(int flags) {
        this.setImDrawListFlags(this.getImDrawListFlags() | flags);
    }
    ...
    public boolean hasImDrawListFlags(int flags) {
        return (this.getImDrawListFlags() & flags) != 0;
    }
    ...
    public void addText(ImFont imFont, float fontSize, float posX, float posY, int col, String text) {
        this.nAddText(imFont.ptr, fontSize, posX, posY, col, text);
    }

    private native void nAddText(long var1, float var3, float var4, float var5, int var6, String var7);

    public void addText(ImFont imFont, float fontSize, float posX, float posY, int col, String text, float wrapWidth) {
        this.nAddText(imFont.ptr, fontSize, posX, posY, col, text, wrapWidth);
    }

    private native void nAddText(long var1, float var3, float var4, float var5, int var6, String var7, float var8);

    public void addText(ImFont imFont, float fontSize, float posX, float posY, int col, String text, float wrapWidth, float cpuFineClipRectX, float cpuFineClipRectY, float cpuFineClipRectZ, float cpuFineClipRectV) {
        this.nAddText(imFont.ptr, fontSize, posX, posY, col, text, wrapWidth, cpuFineClipRectX, cpuFineClipRectY, cpuFineClipRectZ, cpuFineClipRectV);
    }
