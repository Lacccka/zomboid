...
extends ImGuiStructDestroyable {
    ...
    public ImVec2 getWindowTitleAlign() {
        ImVec2 value = new ImVec2();
        this.getWindowTitleAlign(value);
        return value;
    }
    ...
    public ImVec2 getItemInnerSpacing() {
        ImVec2 value = new ImVec2();
        this.getItemInnerSpacing(value);
        return value;
    }
    ...
    public ImVec2 getTouchExtraPadding() {
        ImVec2 value = new ImVec2();
        this.getTouchExtraPadding(value);
        return value;
    }
    ...
    public ImVec2 getSelectableTextAlign() {
        ImVec2 value = new ImVec2();
        this.getSelectableTextAlign(value);
        return value;
    }
    ...
    public ImVec2 getDisplayWindowPadding() {
        ImVec2 value = new ImVec2();
        this.getDisplayWindowPadding(value);
        return value;
    }
    ...
    public ImVec2 getDisplaySafeAreaPadding() {
        ImVec2 value = new ImVec2();
        this.getDisplaySafeAreaPadding(value);
        return value;
    }
