...
public class javafmodJNI {
    public static void init() {
        DebugType.Sound.trace("[javafmodJNI] Init: Start");
        String suffix = "";
        if ("1".equals(System.getProperty("zomboid.debuglibs.fmod"))) {
            DebugType.Sound.trace("***** Loading debug version of fmodintegration");
            suffix = "d";
        }
        try {
            if (System.getProperty("os.name").contains("OS X")) {
                ...
                DebugType.Sound.trace("[javafmodJNI] Init: WIN 64");
                System.loadLibrary("fmod");
                System.loadLibrary("fmodstudio");
                System.loadLibrary("fmodintegration64" + suffix);
            } else {
                System.loadLibrary("fmod");
                System.loadLibrary("fmodstudio");
    ...
    public static final native int FMOD_System_GetRecordPosition(int var0, FMODRecordPosition var1);
    ...
    public static final native int FMOD_Sound_GetData(long var0, byte[] var2, FMODSoundData var3);
    ...
    public static final native int FMOD_Studio_Bank_GetVCACount(long var0);

    public static final native int FMOD_Studio_Bank_GetVCAList(long var0, long[] var2);
    ...
    public static native String FMOD_Studio_EventDescription_GetParameterLabelByIndex(long var0, int var2, int var3);

    public static native long FMOD_Studio_System_GetVCA(String var0);

    public static native String FMOD_Studio_VCA_GetPath(long var0);

    public static native float FMOD_Studio_VCA_GetVolume(long var0);

    public static native int FMOD_Studio_VCA_SetVolume(long var0, float var2);
}
